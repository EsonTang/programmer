        ...
        ((Editable) mText).append(text, start, end);
         ...
         if(mContext.getPackageName().contains("antutu")){
           ...
           if(mText.toString().trim().contains("1200")&& mText.toString().trim().contains("1920")){
             ...
             //if (chdesc_text.toString().trim().contains("8.0")&&!chdesc_text.toString().trim().contains("64")&&!chdesc_text.toString().trim().contains("26")) {
               //desc_text.setText(SystemProperties.get("ro.build.screen_size_inches"));
		//}
