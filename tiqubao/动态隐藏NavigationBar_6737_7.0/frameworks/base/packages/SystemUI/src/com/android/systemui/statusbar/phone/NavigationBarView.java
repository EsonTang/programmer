...
public class NavigationBarView extends LinearLayout {
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
       ...
       // MPlugin Navigation Bar creation and initialization
        ...
        mButtonDisatchers.put(R.id.hide_navbar, new ButtonDispatcher(R.id.hide_navbar)); //for jty hide_navbar
...
//longliang 
    public ButtonDispatcher getHideNavBarButton() {
        return mButtonDisatchers.get(R.id.hide_navbar);
    }
//end 
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
        ...
        getHideNavBarButton().setVisibility(disableBack       ? View.INVISIBLE : View.VISIBLE); //longliang 
    ...
    private void updateRestoreIcon() {
        ...
        getRestoreButton().setVisibility(mResizeMode ? View.VISIBLE : View.GONE);
    }
    /// @}
