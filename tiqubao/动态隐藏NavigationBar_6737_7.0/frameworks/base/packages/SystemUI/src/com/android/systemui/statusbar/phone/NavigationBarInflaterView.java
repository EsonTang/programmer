...
public class NavigationBarInflaterView extends FrameLayout implements TunerService.Tunable {
    ...
    public static final String HIDENAVBAR = "hide_navbar";  //for jty hide_navbar
    ...
    protected View inflateButton(String buttonSpec, ViewGroup parent, boolean landscape,
        ...
        /// @}
        } else if (SCREENSHOT.equals(button)) {//for jty screen shot start
            v = inflater.inflate(R.layout.screenshot, parent, false);
            if (landscape && isSw600Dp()) {
                setupLandButton(v);
            }//for jty screen shot end
        }else if (HIDENAVBAR.equals(button)) {//for jty hide_navbar start
            v = inflater.inflate(R.layout.hide_navbar, parent, false);
            if (landscape && isSw600Dp()) {
                setupLandButton(v);
            }//for jty hide_navbar end
