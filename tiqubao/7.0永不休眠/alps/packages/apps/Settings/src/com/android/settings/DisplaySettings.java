...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    private void updateTimeoutPreferenceDescription(long currentTimeout) {
        ...
        } else if (currentTimeout == 0) {//longliang 
            // Unsupported value
            summary = getString(R.string.zen_mode_when_never); //longliang 
        } else {
    ...
    private void updateFontSizeSummary() {
       ...
       String fontSize = android.os.SystemProperties.get("ro.romtool.fontsize","1.0f");
        float fontScale = 1.0f;
        if(fontSize!=null&&fontSize!=""){
          fontScale = Float.parseFloat(fontSize);
        }
