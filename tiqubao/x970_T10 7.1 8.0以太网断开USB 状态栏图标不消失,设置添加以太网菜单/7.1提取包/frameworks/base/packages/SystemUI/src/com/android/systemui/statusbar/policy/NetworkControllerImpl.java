...
public class NetworkControllerImpl extends BroadcastReceiver
    ...
    private void registerListeners() {
        ...
        filter.addAction("android.net.conn.INET_DISCONDITION_ACTION");//modify dengli for ethernet systemui icon
    ...
    public boolean discondition = false;//modify dengli for ethernet systemui icon
    @Override
    public void onReceive(Context context, Intent intent) {
		...
		//modify dengli for ethernet systemui icon
        if (action.equals("android.net.conn.INET_DISCONDITION_ACTION")) {
            discondition = true;
            updateConnectivity();
        }else 
