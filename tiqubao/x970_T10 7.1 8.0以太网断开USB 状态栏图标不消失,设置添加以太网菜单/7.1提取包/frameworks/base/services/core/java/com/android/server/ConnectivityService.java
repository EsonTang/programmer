...
//        }
    ...
    private void updateNetworkInfo(NetworkAgentInfo networkAgent, NetworkInfo newInfo) {
        ...
        if (!networkAgent.everConnected && state == NetworkInfo.State.CONNECTED) {
            ...
            if(networkAgent.name().contains("Ethernet")){
                sendGeneralBroadcast(newInfo,"android.net.conn.INET_DISCONDITION_ACTION");
                //log(networkAgent.name() + "dengli sendGeneralBroadcast");
            }
