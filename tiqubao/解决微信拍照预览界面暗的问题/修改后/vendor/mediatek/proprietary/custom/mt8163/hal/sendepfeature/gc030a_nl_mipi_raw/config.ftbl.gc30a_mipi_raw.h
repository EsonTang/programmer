 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_GC030A_NL_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "320x240",      /*"640x352",*/      "640x480",/*  "1024x768",     			"1280x720",     "1280x768",     "1280x960",  "1536x864"   ,  			"1440x864",   "1392x928" ,      "1600x1200" ,*/ 
            )
        ),
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("5000,30000"),//chenyl modify for bug: weixin preview is dark :("30000,30000"),
            ITEM_AS_USER_LIST_(
                "(15000,15000)",
                "(24000,24000)",
                "(5000,30000)", //chenyl add for bug: weixin preview is dark 
                "(30000,30000)",
            )
        ),
    )
