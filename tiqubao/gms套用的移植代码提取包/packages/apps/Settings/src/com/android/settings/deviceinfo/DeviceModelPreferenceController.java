...
public class DeviceModelPreferenceController extends PreferenceController {
    ...
    public DeviceModelPreferenceController(Context context, Fragment host) {
        super(context);
        mHost = host;
        mExt = UtilsExt.getDeviceInfoSettingsPlugin(context);
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (pref != null) {
            pref.setSummary(SystemProperties.get("ro.jty.product.model",
                	Build.MODEL) + DeviceInfoUtils.getMsvSuffix());
            mExt.updateSummary(pref, SystemProperties.get("ro.jty.product.model",
                	Build.MODEL),
                    SystemProperties.get("ro.jty.product.model",
                	Build.MODEL) + DeviceInfoUtils.getMsvSuffix());
        }
    }
    ...
    public static String getDeviceModel() {
        return SystemProperties.get("ro.jty.product.model",
                	Build.MODEL) + DeviceInfoUtils.getMsvSuffix();
    }
}
