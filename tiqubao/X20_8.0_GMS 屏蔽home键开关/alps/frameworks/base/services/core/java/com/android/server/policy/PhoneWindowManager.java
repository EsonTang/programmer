...
public class PhoneWindowManager implements WindowManagerPolicy {
                ...
                new SystemGesturesPointerEventListener.Callbacks() {
                    ...
                    public void onSwipeFromBottom() {
						...
						//longliang 
                           ...
                           Log.i("longliang", "onSwipeFromBottom->showNavigationBar");  
                           showNavigationBar();  
                        }  
						//end 
                    }
                    ...
                    public void onSwipeFromRight() {
						...
						//longliang 
                    /*    else{  
                           Log.i("longliang", "onSwipeFromRight->showNavigationBar");  
                           showNavigationBar();  
                         }   */  
                        //end 
                    }
    ...
    public long interceptKeyBeforeDispatching(WindowState win, KeyEvent event, int policyFlags) {
        ...
        if (keyCode == KeyEvent.KEYCODE_HOME) {
			...
			if(Settings.System.getInt(mContext.getContentResolver(), Settings.System.HOME_BUTTON_SWITCH,0)==0){
				return 0;
			}else{
				if (!down) {
    ...
    public void applyPostLayoutPolicyLw(WindowState win, WindowManager.LayoutParams attrs,
        ...
        if (DEBUG_LAYOUT) Slog.i(TAG, "applyPostLayoutPolicyLw Win " + win +
            ": affectsSystemUi = " + affectsSystemUi +
        ...
        synchronized (mScreenLockTimeout) {
            ...
            if (mLockScreenTimerActive != enable) {
                if (enable) {
                    ...
                    if (mLockScreenTimeout != 0)//longliang add if 
						mHandler.postDelayed(mScreenLockTimeout, mLockScreenTimeout);
                } else {
    ...
    static final boolean IS_USER_BUILD = false;//("user".equals(Build.TYPE)
