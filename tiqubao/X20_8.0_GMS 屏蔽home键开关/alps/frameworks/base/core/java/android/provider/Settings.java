...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
		...
		/** @hide */public static final String HOME_BUTTON_SWITCH = "home_button_switch";
		...
		/**
		 *is system first boot (0: yes 1: no)
		 *///longliang
		public static final String FIRST_BOOT = "first_boot";
		private static final Validator FIRST_BOOT_VALIDATOR = sBooleanValidator;
		...
		/** 
         * package name for net speed enable longliang 
         * @hide
         */
       ...
       /**
        ...
        static {
			...
			PUBLIC_SETTINGS.add(FIRST_BOOT); //longliang 
			...
			PUBLIC_SETTINGS.add(NET_SPEED_ENABLE);//longliang
        ...
        static {
			...
			VALIDATORS.put(FIRST_BOOT, FIRST_BOOT_VALIDATOR);//longliang 
    ...
    public static final class Global extends NameValueTable {
        ...
        */
        ...
        /**
         * Whether LWA is enabled/disabled
         *
         * @hide
         */
        public static final String LWA_ON = "lwa_on";
        /// MTK ADD END. @}
