...
class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
			...
			loadSetting(stmt, Settings.System.SHOW_BATTERY_PERCENT, 0);//longliang
            loadBooleanSetting(stmt, Settings.System.SCREEN_BRIGHTNESS_MODE,
                    R.bool.def_screen_brightness_automatic_mode);
			...
			loadSetting(stmt,Settings.System.HOME_BUTTON_SWITCH,0);
            loadDefaultHapticSettings(stmt);
            ...
            String time_12_24 = SystemProperties.get("ro.romtool.time_12_24","");
            if(time_12_24!=null&&time_12_24!=""){
