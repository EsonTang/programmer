...
import com.mediatek.storage.StorageManagerEx; // chenyl add for sd card	
...
public class StorageDefaultPathDialog extends AlertActivity implements DialogInterface.OnClickListener {
	...
	// chenyl modify start for sd card	
	   /*
        ...
        createDialog(); */
        StorageManagerEx.setDefaultPath("/storage/sdcard1");
        finish();  
	 // chenyl modify end	
    }
    ...
    protected void onResume() {
        ...
        //registerReceiver(mReceiver, mSDCardStateFilter);  chenyl del  for sd card	
    }
    @Override
    ...
    protected void onPause(){
       ...
       // unregisterReceiver(mReceiver); chenyl del  for sd card	
