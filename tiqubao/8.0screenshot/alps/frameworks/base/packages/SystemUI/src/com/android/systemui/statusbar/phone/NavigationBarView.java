...
public class NavigationBarView extends FrameLayout implements PluginListener<NavGesture> {
	...
	private KeyButtonDrawable mScreenShotIcon; //longliang 
    ...
    private OpSystemUICustomizationFactoryBase mSystemUICustomizationFactory = null;
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
		...
		mButtonDispatchers.put(R.id.screen_shot, new ButtonDispatcher(R.id.screen_shot));
    ...
    public ButtonDispatcher getScreenShotButton() {
        return mButtonDispatchers.get(R.id.screen_shot);
    }
    ...
    private void updateIcons(Context ctx, Configuration oldConfig, Configuration newConfig) {
        ...
        if (oldConfig.densityDpi != newConfig.densityDpi) {
            ...
            mBackAltIcon = getDrawable(iconLight,iconDark);
			...
			mScreenShotIcon = getDrawable(ctx, R.drawable.ic_sysbar_screenshot, R.drawable.ic_sysbar_screenshot_dark);//longliang 
    ...
    //// M: Added for plugin support.
    private KeyButtonDrawable getDrawable(Drawable lightDrawable, Drawable darkDrawable) {
        return KeyButtonDrawable.create(lightDrawable, darkDrawable);
    }
    ...
    public void setNavigationIconHints(int hints, boolean force) {
		...
		getScreenShotButton().setImageDrawable(mScreenShotIcon);//longliang 
    ...
    public void setDisabledFlags(int disabledFlags, boolean force) {
		...
		getScreenShotButton().setVisibility(disableBack ?  View.INVISIBLE : View.VISIBLE);
    }
