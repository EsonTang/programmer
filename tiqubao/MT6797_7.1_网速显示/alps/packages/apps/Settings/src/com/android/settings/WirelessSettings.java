...
public class WirelessSettings extends SettingsPreferenceFragment implements Indexable {
	...
	private static final String KEY_TOGGLE_NET_SPEED = "toggle_net_speed";
	...
	private SwitchPreference mNetSpeedPreference;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		mNetSpeedPreference = (SwitchPreference) findPreference(KEY_TOGGLE_NET_SPEED);
		mNetSpeedPreference.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
			...
			public boolean onPreferenceChange(Preference preference, Object newValue) {
				...
				if(value){
					activity.sendBroadcastAsUser(new Intent("intent_show_net_speed"), UserHandle.ALL);
				}else{
					activity.sendBroadcastAsUser(new Intent("intent_hide_net_speed"), UserHandle.ALL);
				}
                Settings.System.putInt(getActivity().getContentResolver(), Settings.System.NET_SPEED_ENABLE, value? 1:0);
				return true;
			}
		});
    ...
    public void onResume() {
		...
		if (mNetSpeedPreference != null) {
            mNetSpeedPreference.setChecked(Settings.System.getInt(getActivity().getContentResolver(),
                    Settings.System.NET_SPEED_ENABLE, 0) != 0);
        }
