...
CUSTOM_HAL_IMGSENSOR = imx499_mipi_raw imx298_mipi_raw ov8856_mipi_raw s5k3p8sx_mipi_raw s5k3p8sp_mipi_raw
CUSTOM_HAL_LENS = dw9714af dw9718saf dummy_lens
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_HAL_MAIN_BACKUP_LENS = 
CUSTOM_HAL_MAIN_IMGSENSOR = imx499_mipi_raw imx298_mipi_raw
CUSTOM_HAL_MAIN_LENS = dw9714af dw9718saf
...
CUSTOM_HAL_SENSOR_DAEMON = afx133d 
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_BACKUP_IMGSENSOR =
CUSTOM_HAL_SUB_BACKUP_LENS = 
CUSTOM_HAL_SUB_IMGSENSOR = ov8856_mipi_raw s5k3p8sx_mipi_raw s5k3p8sp_mipi_raw
...
CUSTOM_KERNEL_IMGSENSOR = imx499_mipi_raw imx298_mipi_raw ov8856_mipi_raw s5k3p8sx_mipi_raw s5k3p8sp_mipi_raw
CUSTOM_KERNEL_IN_POCKET_SENSOR = no
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LEDS = mt65xx
CUSTOM_KERNEL_LENS = dw9714af dw9718saf dummy_lens
CUSTOM_KERNEL_MAGNETOMETER = yes
CUSTOM_KERNEL_MAIN2_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN2_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_IMGSENSOR =
CUSTOM_KERNEL_MAIN_BACKUP_LENS =
CUSTOM_KERNEL_MAIN_IMGSENSOR = imx499_mipi_raw imx298_mipi_raw
CUSTOM_KERNEL_MAIN_LENS = dw9714af dw9718saf
...
CUSTOM_KERNEL_SUB_IMGSENSOR = ov8856_mipi_raw s5k3p8sx_mipi_raw s5k3p8sp_mipi_raw
...
MTK_BUILD_VERNO = alps-mp-n1.mp16-V1.147_pri6763.66l.kb.n1_P14
MTK_BWC_SUPPORT = yes
MTK_C2K_LTE_MODE = 2
...
MTK_GPU_SUPPORT = yes
MTK_GPU_VERSION = mali bifrost r5p0
MTK_HAC_SUPPORT = no
...
MTK_RELEASE_PACKAGE = rel_customer_basic rel_customer_platform_mt6763 rel_customer_kernel_4-4
...
CT6M_SUPPORT = yes
#CREATE_PROJECT_INFO=20171030103010
PRIZE_AUTO_ADD_GLOBAL_DEFINE_BY_NAME = GANGYUN_CAMERA_BEAUTY PRIZE_SALES_STATIS PRIZE_CAMERA_APP PRIZE_HONGBAO_AUTO_HELPER PRIZE_XIAOKU GANGYUN_BOKEH_SUPPORT FN_FACEBEAUTY_SUPPORT

DEFAULT_INPUT_METHOD = com.sohu.inputmethod.sogou/.SogouIME
#brand name
PRODUCT_BRAND_CUSTOM = koobee
#phone device name, bluetooth device name, wandoujia apps detected nam
PRODUCT_MODEL_CUSTOM = koobee F2 Plus
BUILD_SYSTEM_VERSION = dido OS 8.0
#software version: V5(cust codes).1(cust settings).0(version num).20130107(date times)
BUILD_DISPLAY_ID_CUSTOM = F2 Plus.V1.00
PRIZE_HW_PROJECT_NAME = K6206Q
#prize-finger-beign#
PRIZE_FINGER_PRINT = sw533_tee
MTK_CW2015_SUPPORT = yes
#prize-finger-end#
PRIZE_CUSTOMER_NAME = koobee


PRIZE_SETTINGS                 = V8
PRIZE_SOUNDRECORDER_APP        = V7
...
PRIZE_CALCULATOR               = V8
PRIZE_MMS                      = V8
PRIZE_DESKCLOCK_APP            = V8
PRIZE_NOTEPAD                  = V8
PRIZE_FILE_EXPLORER            = V8
PRIZE_SHUTMENU                 = yes		
PRIZE_GALLERY2_APP             = V8

PRIZE_CAMERA_APP               = DC
GANGYUN_CAMERA_BEAUTY          = no
GANGYUN_BOKEH_SUPPORT          = yes
GANGYUN_BOKEH_BLUR_SUPPORT     = no
FN_FACEBEAUTY_SUPPORT          = yes
PRIZE_SUPERZOOM_FROM_ARCSOFT   = yes  
PRIZE_NIGHTSHOT_FROM_ARCSOFT   = yes
PRIZE_HDR_FROM_ARCSOFT         = yes
PRIZE_SELFIE_FROM_ARCSOFT      = yes
PRIZE_BRAND_WATERMARK          = no
PRIZE_CAMERA_FACEBEAUTY        = yes

PRIZE_SYSTEMUI                 = yes
PRIZE_KEYGUARD                 = yes
PRIZE_HAOKAN_SCREENVIEW        = yes
PRIZE_CHANGED_WALLPAPER        = yes
PRIZE_LOCKSCREEN_INVERSE        = yes
PRIZE_NOTCH_SCREEN             = yes
L_SW_TOTAL_COPIED_PRIZE_WALLPAPERS   = 9

PRIZE_HOR_CALI				   = yes
PRIZE_HONGBAO_AUTO_HELPER      = yes
PRIZE_WELCOME_APP              = yes
PRIZE_GENE_APP                 = yes
PRIZE_FLASH_APP                = no
PRIZE_COMPASS_APP              = yes
PRIZE_SALES_STATIS             = 1
PRIZE_FLOAT_WINDOW             = yes
PRIZE_NET_CONTROL              = yes

PRIZE_FINGERPRINT_APPLOCK      = yes
PRIZE_POWER_EXTEND_MODE        = yes

PRIZE_SMART_CLEANER            = yes
PRIZE_SUPPORT_HIDING_NAVBAR    = yes
PRIZE_NAV_BAR_COLOR_CUST       = yes
PRIZE_ROOTCHECK_SUPPORT        = yes
PRIZE_TTS_SUPPORT              = yes
PRIZE_CLOUD_LIST               = yes
PRIZE_DIALER_TMSDK_CALLMARK_SUPPORT = yes
PRIZE_SUPPORT_APP_MULTI_INSTANCES   = yes
PRIZE_CONTROL_APP_MULTI_INST_TEST   = no
PRIZE_CREATE_SHORCUT_FOR_APP_MULTI_INST_TEST = no
PRIZE_CONTROL_APPS_NETWORK_FOR_SLEEPING      = yes


PRIZE_SECURITY_CENTER          = yes
PRIZE_XIAOKU                   = yes
ADUPS_FOTA_SUPPORT             = yes
ADUPS_FOTA_WITH_ICON           = no
ADUPS_FOTA_WITHOUT_MENU        = no
ADUPS_FOTA_KOOBEE_LOGO         = yes

PRIZE_WEATHER                  = yes
PRIZE_VIDEO            		   = yes
PRIZE_MUSIC                    = yes
L_PBAPK_PRIZE_LAUNCHER_SUPPORT = yes
L_PBAPK_PRIZE_EASYLAUNCHER     = yes
L_PBAPK_PRIZE_APP_CENTER       = yes
L_PBAPK_PRIZE_CLOUD            = no
FOUNDERFONTS_SUPPORT           = yes
PRIZE_OLD_LAUNCHER             = no

PRIZE_AutoTest_APP = yes
PRIZE_FACTORY_TEST = yes
PRIZE_HW_INFO = yes
FTM_COULOMBMETER_CW2015 = yes
#add oldtest
PRIZE_RUNOLDTEST_APP = yes

L_PBAPK_BAIDU_BROWSER_WITH_LOGO   = no
L_PBAPK_BAIDU_BROWSER_NO_LOGO_SYS = no
L_PBAPK_BAIDU_SEARCH              = yes
L_PBAPK_BAIDU_SEARCH_SYS          = no
L_PBAPK_QQ_BROWSER                = no
L_PBAPK_QQ_BROWSER_SYS            = no
L_PBAPK_QQ_MOBLIEMANAGER          = no
L_PBAPK_QQ_MOBLIEMANAGER_SYS      = no
L_PBAPK_QQ_MOBLIEASSISTANT        = no
L_PBAPK_QQ_MOBLIEASSISTANT_SYS    = no
L_PBAPK_360_MOBILESAFE            = no
L_PBAPK_360_CLOCKWEATHER          = no
L_PBAPK_360_BROWSER               = no
L_PBAPK_360_BROWSER_SYS           = no
L_PBAPK_BAIDU_INPUT               = no
L_PBAPK_MOBILEQQ                  = no
L_PBAPK_TENCENT_VIDEO             = no
L_PBAPK_TENCENT_VIDEO_SYS         = no
L_PBAPK_SOHU_NEWS                 = no
L_PBAPK_SOHU_NEWS_SYS             = no
L_PBAPK_CTRIP                     = no
L_PBAPK_CTRIP_SYS                 = no
L_PBAPK_QY_VIDEO                  = yes
L_PBAPK_QY_VIDEO_SYS              = no
L_PBAPK_PRIZE_GAMEPLAY            = no
L_PBAPK_KOOBEE_CENTER             = yes
L_PBAPK_KUSAI_CENTER              = no
L_PBAPK_MEITUAN                 = yes
L_PBAPK_MEITUAN_SYS               = no
L_PBAPK_NEWSARTICLE               = yes
L_PBAPK_NEWSARTICLE_SYS           = no
L_PBAPK_DIANPING                  = no
L_PBAPK_DIANPING_SYS              = no
L_PBAPK_READINGJOY                = no
L_PBAPK_READINGJOY_SYS            = no
L_PBAPK_PRIZE_IFENGNEWS           = no
L_PBAPK_PRIZE_IFENGNEWS_SYS       = no
L_PBAPK_XIAMI_MUSIC               = no
L_PBAPK_XIAMI_MUSIC_SYS           = no
L_PBAPK_SOGOU_INPUT               = no
L_PBAPK_SOGOU_INPUT_SYS           = yes
L_PBAPK_PPTV                      = no
L_PBAPK_PPTV_SYS                  = no
L_PBAPK_PRIZE_UC_BROWSER          = no
L_PBAPK_PRIZE_UC_BROWSER_SYS      = no
L_PBAPK_PRIZE_CLIOUD_MUSIC        = no
L_PBAPK_PRIZE_CLIOUD_MUSIC_SYS    = no
L_PBAPK_BAIDU_MAP_SYS             = no
L_PBAPK_BAIDU_MAP 	   	          = no
L_PBAPK_PRIZE_IREADER             = yes
L_PBAPK_PRIZE_IREADER_SYS         = no
L_PBAPK_PRIZE_ICONTROLRESISTANT   = no
L_PBAPK_PRIZE_ICONTROLRESISTANT_SYS = no
L_PBAPK_SHANCHUAN_VENDOR          = no
L_PBAPK_PRIZE_YIDIANZIXUN_SYS     = no
L_PBAPK_PRIZE_YIDIANZIXUN         = no
L_PBAPK_PRIZE_JOKEESSAY           = no
L_PBAPK_PRIZE_JOKEESSAY_SYS       = no
L_PBAPK_PRIZE_YOUKU_SYS           = no
L_PBAPK_PRIZE_YOUKU               = no
L_PBAPK_PRIZE_CHINESECALENDAR_SYS = no
L_PBAPK_PRIZE_CHINESECALENDAR     = no
L_PBAPK_AMAP                      = yes
L_PBAPK_AMAP_SYS                  = no
L_PBAPK_PINGAN_FEATURE            = no
L_PBAPK_PINGAN_FEATURE_SYS        = no
PRIZE_FACTORY_TEST_REAR_CAMERA_SUB_YUV = yes
L_PBAPK_PRIZE_MIGU_READER         = no
L_PBAPK_PRIZE_MIGU_READER_SYS     = no
L_PBAPK_PRIZE_HAOSOU              = no
L_PBAPK_PRIZE_HAOSOU_SYS          = no
L_PBAPK_PRIZE_QQSTOCK             = no
L_PBAPK_PRIZE_QQSTOCK_SYS         = no
L_PBAPK_PRIZE_QQbrowser			  = yes
L_PBAPK_PRIZE_TENCENT_NEWS        = no
L_PBAPK_PRIZE_TENCENT_NEWS_SYS    = no
L_PBAPK_PRIZE_QQREADER            = no
L_PBAPK_PRIZE_QQREADER_SYS        = no
L_PBAPK_360_VIDEO                 = no
L_PBAPK_360_VIDEO_SYS             = no
L_PBAPK_DISCOUNTEIGHTHUNDRED      = no
L_PBAPK_DISCOUNTEIGHTHUNDRED_SYS  = no
L_PBAPK_IFLYINPUT                 = no
L_PBAPK_IFLYINPUT_SYS             = no
L_PBAPK_SOGOUSEARCH               = no
L_PBAPK_SOGOUSEARCH_SYS           = no
L_PBAPK_PRIZE_TIANTIANKUAIBAO     = no
L_PBAPK_PRIZE_TIANTIANKUAIBAO_SYS = no
L_PBAPK_PRIZE_VIPSHOP             = no
L_PBAPK_PRIZE_VIPSHOP_SYS         = no
L_PBAPK_PRIZE_JD                  = no
L_PBAPK_PRIZE_JD_SYS              = no
L_PBAPK_PRIZE_SINABLOG            = no
L_PBAPK_PRIZE_SINABLOG_SYS        = no
L_PBAPK_PRIZE_SOUGOU_BROWSER      = no
L_PBAPK_PRIZE_SOUGOU_BROWSER_SYS  = no
L_PBAPK_PRIZE_MIAOPAI             = no
L_PBAPK_PRIZE_MIAOPAI_SYS         = no
L_PBAPK_PRIZE_TENCENT_NEWS        = no
L_PBAPK_PRIZE_TENCENT_NEWS_SYS    = no
L_PBAPK_EMAIL                     = yes
L_PBAPK_EMAIL_SYS                 = no
L_PBAPK_PRIZE_2345BROWSER         = no
L_PBAPK_PRIZE_2345BROWSER_SYS     = no
L_PBAPK_PRIZE_KUAIVIDEO_CPI       = no
L_PBAPK_PRIZE_KUAIVIDEO_CPI_SYS   = no 

L_PBAPK_PRIZE_TENCENTNEWS_CPI     = yes
L_PBAPK_PRIZE_TENCENTNEWS_CPI_SYS = no
L_PBAPK_PRIZE_TENCENT_VIDEO_CPI   = yes
L_PBAPK_PRIZE_TENCENT_VIDEO_SYS_CPI   = no
L_PBAPK_PRIZE_MIAOPAI_CPI         = no
L_PBAPK_PRIZE_MIAOPAI_CPI_SYS     = no
L_PBAPK_PRIZE_SOUGOU_BROWSER_CPI  = yes
L_PBAPK_PRIZE_SOUGOU_BROWSER_SYS_CPI = no
#-- prize-prebuild app -end

#-- prize-yumai app -begin
L_PBAKP_YM_360APPSTORE            = no
L_PBAKP_YM_360MOBILESAFE          = no
L_PBAKP_YM_360BROWSER             = no
L_PBAKP_YM_AMAP                   = no
L_PBAKP_YM_IREADER                = no
L_PBAKP_YM_YINGYONGBAO            = no
L_PBAKP_YM_UCBROWSER              = no
L_PBAKP_YM_SOHUNEWS               = no
L_PBAKP_YM_READINGJOY             = no
L_PBAKP_YM_IFLYIME                = no
L_PBAKP_YM_YOUKU                  = no
L_PBAKP_YM_WANDOUJIA              = no
L_PBAKP_YM_BAIDUAPPSTORE          = no
L_PBAKP_YM_DIANPING               = no
L_PBAPK_YM_TENCENTNEWS            = no
L_PBAPK_YM_BAIDUMAP               = no
L_PBAPK_KB_COMMUNITY              = yes
L_PBAPK_KB_COMMUNITY_SYS          = no
#-- prize-yumai app -begin

PRIZE_BACK_CAMERA_SUB_YUV = yes
PRIZE_FRONT_CAMERA_SUB_YUV = no
PRIZE_USER_MANUAL = yes
#prize-add-by-tangzeming-20171115-start
 PRIZE_FACE_ID = yes
 PRIZE_FACE_ID_KOOBEE = yes
#prize-add-by-tangzeming-20171115-end
#PRIZE-xuchunming-20170712-add circle window at screen four corner-start
PRIZE_SCREEN_CIRCLECORNER = yes
...
PRIZE_SUPPORT_NAV_BAR_FOR_MBACK_DEVICE = yes
PRIZE_SWIPE_UP_GESTURE_NAVIGATION = yes
#prize tangzhengrong 20180417 Swipe-up Gesture Nagation bar end

# prize doze white-list app. prize-linkh=2017121228
PRIZE_DOZE_WHITE_LIST_APP = yes

PRIZE_BOARD_NETWORK_TYPE = 6M
PRIZE_FP_SUNWAVE_SW531 = yes
PRIZE_HIDING_NAVBAR = yes
PRIZE_SUPPORT_SMART_KILLER_WITH_DEBUG_UI  = yes
PRIZE_SUPPORT_SMART_KILLER = no
PRIZE_FORBID_ERROR_DIALOG=no
PRIZE_ADB_MANAGER = no

PRIZE_TYPEC_HEADSET_SUPPORT = yes
#prize-xuchunming-201804026-add spotlight-start
PRIZE_SPOTLIGHT = no
#prize-xuchunming-201804026-add spotlight-end
#short video,portrait  start
PRIZE_SHORT_VIDEO   = yes
PRIZE_PORTRAIT_SUPPORT  = yes
#end
#-prize-add by taoyingyou, 4G+ project =yes,channel project =no-57339-2018-05-14-start
PRIZE_CMCC_SWITCH                    =no
#-prize-add by taoyingyou, 4G+ project =yes,channel project =no-57339-2018-05-14-end
#-prize-add by lihuangyuan,for insertsim reboot-2018-05-22-start
PRIZE_INSERTSIM_REBOOT = yes
#-prize-add by lihuangyuan,for insertsim reboot-2018-05-22-end
#prize-zenghui-20180530-add smart-wifi-switch-start
PRIZE_SMART_WIFI_SWITCH = yes
#prize-zenghui-20180530-add smart-wifi-switch-end

#prize add by xiarui 2018-06-30
PRIZE_VIBRATE_CONTROL = no

#prize add by xiarui 2018-08-07
PRIZE_LED_BLINK_WHEN_INCOMING = no
