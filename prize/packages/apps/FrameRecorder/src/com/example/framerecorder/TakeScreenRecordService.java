...
/*--prize-change--chenjiahua--20180521--start--*/
import android.util.DisplayMetrics;
import android.app.StatusBarManager;
import com.example.framerecorder.NotificationReceiver;
import android.app.PendingIntent;
...
public class TakeScreenRecordService extends Service
{
	...
	private void startScreenRecord(){
		...
		//add statusbar color
		StatusBarManager mStatusBarManager= (StatusBarManager) this.getSystemService(Context.STATUS_BAR_SERVICE);
		final Intent intent = new Intent("com.example.framerecorder.notification", null, this, NotificationReceiver.class);
		mStatusBarManager.setStatusBarBackgroundColor(0xFF4CD964);
		mStatusBarManager.setStatusBarText(this.getResources().getString(R.string.screenrecord_statusbar_hint));		
		mStatusBarManager.setStatusBarBackgroundClickEvent(PendingIntent.getBroadcast(this, 0, intent, 0));
		...
		{
			/*--prize-change--chenjiahua--20180521--start--*/
			//change time to 1800s
			//add auto resolution
			Resources resources = this.getResources();
			DisplayMetrics dm = resources.getDisplayMetrics();
			int width = dm.widthPixels;
			Log.d("Kehwa","Kehwa width: " + width);
			...
			String str3 = "screenrecord --size " + resolution + " --time-limit 1800 --verbose " + mFilePath;
			/*--prize-change--chenjiahua--20180521--end--*/
			...
			/*--prize-change--chenjiahua--20180521--start--*/
			//change time to 1800s
			mHandler.sendEmptyMessageDelayed(0, 1800000);
			/*--prize-change--chenjiahua--20180521--end--*/
	...
	private void stopScreenRecord(){
		...
		Log.d(TAG, "[stopScreenRecord]");
            /*-prize add by lihuangyuan,for notchscreen -2018-04-24-start*/
		/*--prize-change--chenjiahua--20180528--start--*/		
		...
		/*--prize-change--chenjiahua--20180528--end--*/
	...
	private void updateRecordingNotification(){
		Log.d(TAG, "[updateRecordingNotification]   sPid = "+sPid);
			...
			/*--prize-change--chenjiahua--20180521--start--*/
			//format time count in the form of mm:ss
			int min = (int)mTimeText/60;
			int sec = (int)mTimeText%60;
			String showText = String.format("%02d",min) + ":" + String.format("%02d",sec);
		    localRemoteViews.setTextViewText(R.id.time, showText);
			/*--prize-change--chenjiahua--20180521--end--*/
	...
	public class GlobalReceiver extends BroadcastReceiver
	{
		...
		public void register()
		{
			...
			/*localIntentFilter.addAction("com.android.deskclock.ALARM_ALERT");*///prize-remove fix bug[53593]-hpf-2018-3-24
