...
public class TelecomCallLogCache {
    ...
    private final Map<Integer, Integer> slotIdCache = new HashMap<>();//PRIZE-run smoohtlier in callllog -yuandailin-2016-9-21
    ...
    public void reset() {
        ...
        mSubIdCache.clear();
        slotIdCache.clear();//PRIZE-run smoohtlier in callllog -yuandailin-2016-9-23
    ...
    public int getSlotId(int subId) {
        if (!slotIdCache.containsKey(subId)) {
        	int slotId = SubscriptionManager.getSlotId(subId);
        	slotIdCache.put(subId, slotId);
            return slotId;
        }
        return slotIdCache.get(subId);
    }
