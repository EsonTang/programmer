...
final class PhoneQuery {
    ...
    static {
        List<String> projectionList = Lists.newArrayList(PHONE_LOOKUP_PROJECTION);
        if (DialerFeatureOptions.isSimContactsSupport()) {
            projectionList.add(PhoneLookup.INDICATE_PHONE_SIM);
            projectionList.add(PhoneLookup.IS_SDN_CONTACT);
        }
    ...
    static {
        List<String> projectionList = Lists
                .newArrayList(BACKWARD_COMPATIBLE_NON_SIP_PHONE_LOOKUP_PROJECTION);
        if (DialerFeatureOptions.isSimContactsSupport()) {
            projectionList.add(PhoneLookup.INDICATE_PHONE_SIM);
            projectionList.add(PhoneLookup.IS_SDN_CONTACT);
        }
