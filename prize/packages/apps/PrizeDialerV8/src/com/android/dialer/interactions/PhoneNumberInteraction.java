    ...
    private static class PhoneItemAdapter extends ArrayAdapter<PhoneItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (SipAddress.CONTENT_ITEM_TYPE.equals(item.mimeType) ||
                    ImsCall.CONTENT_ITEM_TYPE.equals(item.mimeType)) {
                if (ContactDisplayUtils.INTERACTION_CALL == mInteractionType) {
                    value = getContext().getResources()
                            .getText(ContactDisplayUtils.getPhoneLabelResourceId(null));
                } else {
                    value = getContext().getResources()
                            .getText(ContactDisplayUtils.getSmsLabelResourceId(null));
                }
            }
            /// @}
