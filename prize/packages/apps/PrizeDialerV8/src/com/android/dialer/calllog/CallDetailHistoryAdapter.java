...
public class CallDetailHistoryAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        /// M: The condition is not reasonable here, keep it consistent with PhoneCallDetailsHelper
       ...
       ExtensionManager.getInstance().getCallLogExtension().setShowVolteWifi(
                   callTypeIconView, details.features);

        /// M: trigger view relayout, invalidate is not enough. Because the width or height
        ...
        */
        if (DialerFeatureOptions.isIpPrefixSupport() && !TextUtils.isEmpty(details.ipPrefix)
            ...
            ExtensionManager.getInstance().getCallDetailExtension().changeVideoTypeText(mContext,
                callTypeTextView, isVideoCall, callType);
            /// @}
        }
        /// @}
        // Set the date.
