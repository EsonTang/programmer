...
public class SmartDialSearchFragment extends SearchFragment
        ...
        if (id == getDirectoryLoaderId()) {
            ...
            if (DialerFeatureOptions.isDialerSearchEnabled()) {
                DialerSearchCursorLoader loader = new DialerSearchCursorLoader(super.getContext(),
                        usesCallableUri(), id, getLoaderManager());
    ...
    public void onEmptyViewActionButtonClicked() {
        ...
        FragmentCompat.requestPermissions(this, /*M:*/CALL_PHONE,
    ...
    /// M: add observer to update search ui when db change @{
    ...
    private final ContentObserver mObserver = new CustomContentObserver();
    private void reloadSearchData() {
        if (!TextUtils.isEmpty(getQueryString())) {
            Log.d(TAG, "reloadSearchData query:" + getQueryString());
