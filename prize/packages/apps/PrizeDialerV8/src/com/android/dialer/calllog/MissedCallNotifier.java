...
import android.graphics.BitmapFactory; //prize-add-hpf-2017-10-17
...
public class MissedCallNotifier {
    ...
    public void updateMissedCallNotification(int count, String number) {
        ...
        if (count == 1) {
            ...
            /*prize-change icon -hpf-2017-10-17-start*/
            ...
            /*Bitmap photoIcon = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.prize_misscall_notification_big_icon);*/
            /*prize-change icon -hpf-2017-10-17-end*/
            /*if (photoIcon != null) {
        ...
        /*builder.setSmallIcon(R.drawable.prize_misscall_notification)*/
        builder.setSmallIcon(R.drawable.prize_misscall_notification_big_icon)
    ...
    private void clearMissedCalls() {
        /// M:check phone permission before update call log @{
