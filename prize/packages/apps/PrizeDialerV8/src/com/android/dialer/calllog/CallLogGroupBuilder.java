...
public class CallLogGroupBuilder {
    ...
    public void addGroups(Cursor cursor) {
        ...
        while (cursor.moveToNext()) {
            ...
            if ((isSameNumber && ExtensionManager.getInstance().getCallLogExtension().
                          sameCallFeature(cursor)) && isSameAccount && isSamePostDialDigits &&
                          isSameViaNumbers && areBothNotVoicemail(callType, groupCallType)
