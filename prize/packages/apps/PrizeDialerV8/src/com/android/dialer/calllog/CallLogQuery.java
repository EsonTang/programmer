...
public final class CallLogQuery {
    ...
    /// M:[MTK SIM Contacts feature] index of mtk column @{
    public static int CONTACT_SIM_INDICATE = -1;
    public static int IS_SDN_CONTACT = -1;
    /// @}
    ...
    static {
        ...
        CONTACT_SIM_INDICATE = projectionList.size() - 1;
        projectionList.add(Calls.CACHED_IS_SDN_CONTACT);
        IS_SDN_CONTACT = projectionList.size() - 1;
        /// @}
