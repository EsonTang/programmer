...
public abstract class IntentProvider {
    ...
    public static IntentProvider getIpDialCallIntentProvider(final String number) {
        return new IntentProvider() {
            @Override
            public Intent getIntent(Context context) {
                return IntentUtil.getCallIntent(IntentUtil.getCallUri(number),
                        LogState.INITIATION_CALL_LOG, Constants.DIAL_NUMBER_INTENT_IP);
            }
        };
    }
    /** @} */
        ...
        return new IntentProvider() {
            ...
            public Intent getIntent(Context context) {
                Intent intent = IntentUtil.getCallIntent(
                        IntentUtil.getCallUri(number), LogState.INITIATION_CALL_LOG,
        ...
        return new IntentProvider() {
            ...
            public Intent getIntent(Context context) {
                Intent confCallIntent = IntentUtil.getCallIntent(
                        ...
                        LogState.INITIATION_CALL_LOG, Constants.DIAL_NUMBER_INTENT_IMS);
                return confCallIntent;
            }
        };
    }
