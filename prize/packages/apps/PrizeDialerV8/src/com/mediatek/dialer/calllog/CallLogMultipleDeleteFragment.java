...
public class CallLogMultipleDeleteFragment extends Fragment implements
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedState) {
        ...
        /*View view = inflater.inflate(R.layout.mtk_call_log_multiple_delete_fragment,
                                     container, false);*/
        View view = inflater.inflate(R.layout.prize_mtk_call_log_multiple_delete_fragment, container, false);
    ...
    public void onResume() {
        ...
        final boolean hasReadCallLogPermission =
            PermissionsUtil.hasPermission(getActivity(), PermissionsUtil.PHONE_FULL_GROUP);
        if (mRefreshDataRequired || (!mHasReadCallLogPermission && hasReadCallLogPermission)) {
