...
public class InCallCameraManager {
    ...
    public InCallCameraManager(Context context) {
    	/*prize-add fix bug[55141]-hpf-2018-4-28-start*/
    	if(context == null){
    		android.util.Log.e("InCallCameraManager", "[init InCallCameraManager] context = null ...", new Throwable());
    	}
    	/*prize-add fix bug[55141]-hpf-2018-4-28-end*/
    ...
    private void maybeInitializeCameraList(Context context) {
    	Log.d(this, "[initializeCameraList]  mIsInitialized = "+mIsInitialized);//prize-add-hpf-2018-4-28
        ...
        try {
            ...
            Log.d(this, "[initializeCameraList]  cameraIds = "+cameraIds);//prize-add-hpf-2018-4-28
    ...
    public void updateContext(Context context){
    	if(mContext != null) {
    		Log.d(this, "[updateContext]  return");
    		return;
    	}
    	Log.d(this, "[updateContext]  context = "+context);
    	mContext = context;
    }
    /*prize-add fix bug[55141]-hpf-2018-4-28-end*/
}
