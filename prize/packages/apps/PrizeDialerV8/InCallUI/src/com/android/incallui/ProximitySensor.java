...
public class ProximitySensor implements AccelerometerListener.OrientationListener,
    ...
    /*PRIZE-Add-DialerV8-wangzhong-2017_7_19-start*/
    private boolean prizeIsSuportPSensor() {
        Log.d(TAG, "[Prize] Check whether the ProximitySensor is effective!");
        ...
        if (null != className && className.equals("com.android.incallui.InCallActivity")) {
            Log.d(TAG, "[Prize] ProximitySensor in InCallActivity!");
            return true;
        }
        return false;
    }
