...
public class CallInfoView extends FrameLayout {
    ...
    public TextView mCallLabelAndNumberAndLocation;/*PRIZE-add-yuandailin-2015-9-8*/
    public TextView mCallNumber;/*PRIZE-add-yuandailin-2015-9-8*/
    public ImageView prizeSmallCotentPhoto;//PRIZE-add -yuandailin-2016-7-14
    ...
    public CallInfoView(Context context, AttributeSet attrs) {
        ...
        inflate.inflate(R.layout.call_info_view_prize, this);//PRIZE-change-yuandailin-2016-3-9
        mCallLabelAndNumberAndLocation = (TextView) findViewById(R.id.callLabelAndNumberAndLocation);/*PRIZE-add-yuandailin-2015-9-8*/
        ...
        mCallNumber = (TextView) findViewById(R.id.callNumber);//PRIZE-add-yuandailin-2016-3-9
        prizeSmallCotentPhoto = (ImageView) findViewById(R.id.prize_samll_content_photo);//PRIZE-add -yuandailin-2016-7-14
    }
}
