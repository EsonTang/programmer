...
///@}
    ...
    public void rejectCall(String callId, boolean rejectWithMessage, String message) {//prize-change for Game-Modle -hpf-2018-3-16
        android.telecom.Call call = getTelecomCallById(callId);
        if (call != null) {
    ...
    public void disconnectCall(String callId) {//prize-change for Game-Modle -hpf-2018-3-16
        android.telecom.Call call = getTelecomCallById(callId);
        if (call != null) {
            call.disconnect();
        } else {
    ...
    public void setAudioRoute(int route) {//prize-change for Game-Modle -hpf-2018-3-16
        if (mInCallService != null) {
