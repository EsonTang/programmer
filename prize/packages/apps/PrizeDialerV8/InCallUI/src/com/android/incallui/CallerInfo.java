...
public class CallerInfo {
            ...
            if (cursor.moveToFirst()) {
                ...
                if (columnIndex != -1) {
                    ...
                    if (typeColumnIndex != -1) {
                        ...
                        info.phoneLabel = Phone.getTypeLabel(context,
    ...
    /* package */ CallerInfo markAsEmergency(Context context) {
        ...
        photoResource = R.drawable.prize_incallui_little_photo;
    ...
    public void updateGeoDescription(Context context, String fallbackNumber) {
        ...
        if (null == geoDescription || (null != geoDescription && geoDescription.equals(""))) {
            geoDescription = context.getResources().getString(R.string.prize_phone_location_default);
        }
