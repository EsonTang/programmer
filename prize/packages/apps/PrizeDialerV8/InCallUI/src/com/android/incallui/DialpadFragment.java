...
import com.android.phone.common.dialpad.InCallUIDialpadView;//PRIZE-change-yuandailin-2016-3-9

import java.util.HashMap;
/*PRIZE-add-yuandailin-2016-3-9-start*/
import android.graphics.Color;
import android.widget.ImageButton;
import android.view.View.OnClickListener;
/*PRIZE-add-yuandailin-2016-3-9-end*/
/**
...
public class DialpadFragment extends BaseFragment<DialpadPresenter, DialpadPresenter.DialpadUi>
    ...
    private InCallUIDialpadView mDialpadView;//PRIZE-change-yuandailin-2016-3-9
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*PRIZE-change-yuandailin-2016-3-9-start*/
        mDialpadView = (InCallUIDialpadView) parent.findViewById(R.id.dialpad_view);
        //mDialpadView.setCanDigitsBeEdited(false);
        //mDialpadView.setBackgroundResource(R.color.incall_dialpad_background);
        mDialpadView.setCanDigitsBeEdited(true);
        mDialpadView.setBackgroundResource(Color.TRANSPARENT);
        ImageButton overFlow = (ImageButton) mDialpadView.findViewById(R.id.dialpad_overflow);
        overFlow.setVisibility(View.GONE);
        View mDeleteButton = mDialpadView.getDeleteButton();
        ...
        /*PRIZE-change-yuandailin-2016-3-9-end*/
        mDtmfDialerField = (EditText) parent.findViewById(R.id.digits);
        mDtmfDialerField.setTextColor(Color.WHITE);//PRIZE-add-yuandailin-2016-3-9
    ...
    public void onResume() {
        super.onResume();
        //updateColors();//PRIZE-remove-yuandailin-2016-3-9
    }
    ...
    public void animateShowDialpad() {
        final InCallUIDialpadView dialpadView = (InCallUIDialpadView) getView().findViewById(R.id.dialpad_view);//PRIZE-change-yuandailin-2016-3-9
