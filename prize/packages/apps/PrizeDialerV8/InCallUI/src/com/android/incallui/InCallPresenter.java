...
public class InCallPresenter implements CallList.Listener,
    ...
    private boolean isMultipartyCalls = false;
    ...
    /*PRIZE-Change-DialerV8-wangzhong-2018_4_11-start*/
    ...
    /*PRIZE-Change-DialerV8-wangzhong-2018_4_11-end*/
    ...
    public void setUp(Context context,
        ...
        /*PRIZE-Add-DialerV8-wangzhong-2018_4_11-start*/
        android.os.HandlerThread ht = new android.os.HandlerThread("InCallPresenter HandlerThread");
        ht.start();
        mPhoneStateListener = new PhoneStateListener(ht.getLooper()) {
            public void onCallStateChanged(int state, String incomingNumber) {
                if (state == TelephonyManager.CALL_STATE_RINGING) {
                    if (FilteredNumbersUtil.hasRecentEmergencyCall(mContext)) {
                        return;
        ...
        /*PRIZE-Add-DialerV8-wangzhong-2018_4_11-end*/
    ...
    public void onCallListChange(CallList callList) {
        ...
        /*PRIZE-Add-DialerV8_InCallStatusBar-wangzhong-2017_7_19-start*/
        // TODO: Clear the status when closed all calls.
        if (oldState == InCallState.INCALL && mInCallState == InCallState.NO_CALLS) {
            Log.d(this, "InCallStatusBar  [clearInCallStatusBar]  mInCallState : " + mInCallState);
            //com.android.dialer.prize.incallwindow.InCallWindowPresenter.getInstance().deleteInCallWindow(mContext);
            com.android.dialer.prize.incallstatusbar.InCallStatusBarPresenter.getInstance()
                    .clearInCallStatusBar(mContext.getApplicationContext());
        }
        //Log.d(this, "InCallStatusBar   oldState : " + oldState + ",   mInCallState : " + mInCallState + ",    callList.getBackgroundCall : " + callList.getBackgroundCall());
        // TODO: 1. Set the Timer when changed the call status.
        if ((oldState == InCallState.INCOMING || oldState == InCallState.OUTGOING) && mInCallState == InCallState.INCALL) {
            boolean isShowInCallStatusBar = prizeIsShowInCallStatusBar(mContext.getApplicationContext());
            if (isShowInCallStatusBar) {
                ...
                if (inCallState == com.android.incallui.InCallPresenter.InCallState.OUTGOING
                    ...
                    com.android.dialer.prize.incallstatusbar.InCallStatusBarPresenter.getInstance()
                            .showInCallStatusBar(mContext.getApplicationContext());
                }
            }
            /** CallCardPresenter getCallToDisplay()*/
            Call primary = callList.getActiveCall();
            if (null != primary) {
                long callStart = primary.getConnectTimeMillis();
                Log.d(this, "InCallStatusBar  [1] [initCallTimer]  mInCallState : " + mInCallState + ",   callStart : " + callStart);
                //com.android.dialer.prize.incallwindow.InCallWindowPresenter.getInstance().initCallTimer(mContext, callStart);
                if (callStart > 1) {
                    com.android.dialer.prize.incallstatusbar.InCallStatusBarPresenter.getInstance()
                            .initCallTimer(mContext.getApplicationContext(), callStart);
                    isMultipartyCalls = null != callList.getBackgroundCall() ? true : false;
                    /*prize-add for Game-Modle -hpf-2018-4-18-start*/
                    if(mStatusBarNotifier != null && mStatusBarNotifier.isInGameModle()){
                    	mStatusBarNotifier.updateFloatWindowCallTime(callStart);
                    }
                    /*prize-add for Game-Modle -hpf-2018-4-18-end*/
                }
            }
        }
        // TODO: 2. MultipartyCalls, change the Timer when closed one call.
        if (oldState == InCallState.INCALL && mInCallState == InCallState.INCALL && null == callList.getBackgroundCall() && isMultipartyCalls) {
            isMultipartyCalls = false;
            Call primary = callList.getActiveCall();
            if (null != primary) {
                long callStart = primary.getConnectTimeMillis();
                Log.d(this, "InCallStatusBar  [2] [initCallTimer]  mInCallState : " + mInCallState + ",   callStart : " + callStart);
                if (callStart > 1) {
                    com.android.dialer.prize.incallstatusbar.InCallStatusBarPresenter.getInstance()
                            .initCallTimer(mContext.getApplicationContext(), callStart);
                    /*prize-add for Game-Modle -hpf-2018-4-18-start*/
        ...
        // TODO: 3. MultipartyCalls, switch the call.
        /*PRIZE-Add-DialerV8_InCallStatusBar-wangzhong-2017_7_19-end*/
    ...
    public void onIncomingCall(Call call) {
        ...
        Log.i(this, "Phone switching state: " + oldState + " -> " + newState);
        mInCallState = newState;
        DialerApplication.isInComing = true;//PRIZE-Add-SIMPLE_LAUNCHER_TTS-hpf-2017_11_25
    ...
    public void answerIncomingCall(Context context, int videoState) {
        ...
        if (call != null) {
            ...
            if(mStatusBarNotifier != null && mStatusBarNotifier.isInGameModle()){
            	Log.i(this, "[answerIncomingCall] In the Game-Modle it Can not to show InCallActivity...");
            	return;
            } 
            Log.i(this, "[answerIncomingCall] Showing InCallActivity");
    ...
    public void acceptUpgradeRequest(int videoState, Context context) {
        ...
        if (call != null && call.getVideoCall() != null) {
            ...
            /*PRIZE-Change-InCallUI_VideoCall-wangzhong-2017_5_23-start*/
            /*call.getVideoCall().sendSessionModifyResponse(videoProfile);*/
            if (null != call.getVideoCall()) call.getVideoCall().sendSessionModifyResponse(videoProfile);
            /*PRIZE-Change-InCallUI_VideoCall-wangzhong-2017_5_23-end*/
    ...
    /*PRIZE-clear StatusBarNotifier again in InCallActivity-yuandailin-2016-2-18-start*/
    public StatusBarNotifier getStatusBarNotifier() {
        return mStatusBarNotifier;
    }
    /*PRIZE-clear StatusBarNotifier again in InCallActivity-yuandailin-2016-2-18-end*/

    /// M:send cancel upgrade request out when the timer is timeout @{
    public void cancelUpgradeRequest(Context context) {
        Log.d(this, " cancelUpgradeRequest");
        // Bail if we have been shut down and the call list is null.
        if (mCallList == null) {
            StatusBarNotifier.clearAllCallNotifications(context);
            Log.e(this, " declineUpgradeRequest mCallList is empty so returning");
        ...
        Call call = mCallList.getSendingVideoUpgradeRequestCall();
        VideoSessionController.getInstance().stopTiming();

        if (call != null && call.getVideoCall() != null) {
            VideoProfile videoProfile = new VideoProfile(
            VideoProfile.STATE_CANCEL_UPGRADE_FOR_TIMEOUT, VideoProfile.QUALITY_DEFAULT);
    ...
    public boolean isShowingInCallUi() {
        ...
        return (isActivityStarted() && isTopShowingInCallUi(mContext));
        /*PRIZE-Change-DialerV8-wangzhong-2017_7_19-end*/
    }

    /*PRIZE-Add-DialerV8-wangzhong-2017_7_19-start*/
    private boolean isTopShowingInCallUi(Context context) {
        if (null != context) {
            String className = getTopActivityClassName(context);
            Log.d(this, "className : " + className);
            if (null != className && className.equals("com.android.incallui.InCallActivity")) {
                return true;
            }
        }
        return false;
    ...
    private String getTopActivityClassName(Context context) {
        ...
        if (runningTaskInfos != null) {
            android.content.ComponentName f = runningTaskInfos.get(0).topActivity;
    ...
    private boolean startUi(InCallState inCallState) {
        ...
        Call incomingCall = mCallList.getIncomingCall();
        boolean isVideoCall = CallUtils.isVideoCall(incomingCall);
        if (incomingCall != null && isVideoCall) {
            showInCall(false, false);
            Log.d(this, "start InCallActivity at here.");
        ...
        if (isCallWaiting) {
            if (mProximitySensor.isScreenReallyOff() && isActivityStarted()) {
            	...
            	/*prize-change for Game-Modle -hpf-2018-3-16-start*/
                if(mStatusBarNotifier != null && !mStatusBarNotifier.isInGameModle()){
                	Log.i(this, "[startUi]show InCallActivity for waiting call");
                    showInCall(false, false);
                } 
                /*prize-change for Game-Modle -hpf-2018-3-16-end*/
            }
        /// M: Fix ALPS01825035. @{
    ...
    public InCallCameraManager getInCallCameraManager() {
        synchronized(this) {
            ...
            mInCallCameraManager.updateContext(mContext);//prize-add fix bug[55141]-hpf-2018-4-28
    ...
    public void setThemeColors() {
        ...
        /*PRIZE-remove-yuandailin-2016-3-9-start*/
        ...
        /// @}*/
        /*PRIZE-remove-yuandailin-2016-3-9-end*/
    }
    ...
    /*PRIZE-Add-DialerV8_InCallStatusBar-wangzhong-2017_7_19-start*/
    public boolean prizeIsShowInCallStatusBar(Context context) {
        if (null == context) {
            return true;
        }
        String className = getTopActivityClassName(context);
        if (null != className && className.equals("com.android.incallui.InCallActivity")) {
            //Log.d(TAG, "[Prize] [InCallStatusBar] in InCallActivity!");
            return false;
        }
        return true;
    }
