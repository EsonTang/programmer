...
public class InCallUiWfcUtils {
    ...
    public static boolean maybeShowWfcError(Context context, DisconnectCause disconnectCause) {
        if(ImsManager.isWfcEnabledByUser(context)
                ...
                || ExtensionManager.getInCallExt().maybeShowErrorDialog(disconnectCause))) {
    ...
    public static class RoveOutReceiver extends WifiOffloadManager.Listener  {
           ...
           if (b != null) {
               ...
               if (b != null) {
                  try {
                     ...
                     Log.e(LOG_TAG, "can't get MwiService", e);
                  }
               }
           }
       ...
       public void onHandover(int simIdx, int stage, int ratType) {
           Log.d(LOG_TAG, "[WFC]onHandover stage: " + stage + "ratType : " + ratType);
