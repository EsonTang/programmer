...
public interface ICallCardExt {
     ...
     *
     * @param account call via account.
     * @internal
     */
    ...
    /**
     * Customize the CallerInfo after it is generated after query.
     * Plugin is able to modify any field of the CallerInfo if necessary.
     * Plugin can decide the content shown in the Call Card.
     *
     * @param context    the InCallUI context.
     * @param callerInfo the CallerInfo generated.
     * @param cursor     the cursor contains the caller info raw data.
     * @internal
     */
    void customizeCallerInfo(Context context, Object callerInfo, Cursor cursor);
}
