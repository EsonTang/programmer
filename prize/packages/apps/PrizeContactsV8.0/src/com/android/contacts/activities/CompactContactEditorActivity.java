...
public class CompactContactEditorActivity extends ContactEditorBaseActivity implements
    ...
    public void onCreate(Bundle savedState) {
        ...
        /// M: ALPS03154332: no need to load when editor recreates,
        /// for Fragment recreates before Activity, Fragment already restores its own fields @{
        if (savedState == null) {/// @}
