...
public final class GroupMemberLoader extends CursorLoader {
    ...
    public static class GroupEditorQuery {
        private static final String[] PROJECTION_INTERNAL = new String[] {
            Data.CONTACT_ID,                        // 0
        ...
        static {
            List<String> projectionList = Lists.newArrayList(PROJECTION_INTERNAL);
            ...
            if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
                ...
                projectionList.add(RawContacts.IS_SDN_CONTACT);       //7
                /// @}
            }
    ...
    public static class GroupDetailQuery {
        ...
        static {
            ...
            if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
                /// M: Add some columns for Contacts extensions. @{
                projectionList.add(RawContacts.INDICATE_PHONE_SIM);   //6
                projectionList.add(RawContacts.INDEX_IN_SIM);         //7
                projectionList.add(RawContacts.IS_SDN_CONTACT);       //8
                /// @}
            }
