...
public class GroupDeletionDialogFragment extends DialogFragment {
    ...
    protected void deleteGroup() {
         ...
         * (ContactSaveService.createGroupDeletionIntent( getActivity(),
         * groupId));
         */
        String groupName = arguments.getString(ARG_LABEL);
        int subId = arguments.getInt(ARG_SUB_ID);
        getActivity().startService(SimGroupUtils.createGroupDeletionIntentForIcc(
                getActivity(), groupId, subId, groupName));
        /*
