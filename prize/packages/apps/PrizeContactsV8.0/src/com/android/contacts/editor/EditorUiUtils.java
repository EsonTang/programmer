...
import android.telephony.SubscriptionManager;//PRIZE-add-yuandailin-2016-5-4
...
import com.mediatek.contacts.util.AccountTypeUtils;//PRIZE-add-yuandailin-2016-5-4
...
public class EditorUiUtils {
    ...
    public static Pair<String,String> getAccountInfo(Context context, String accountName,
        ...
        if (accountType != null && accountType.isIccCardAccount()) {
			/*PRIZE-change-yuandailin-2016-5-4-start*/
                int prizeSlotId = SubscriptionManager.getSlotId(AccountTypeUtils.getSubIdBySimAccountName(context, accountName)) + 1;
                accountTypeLabel = /*context.getString(R.string.account_type_format,
                        accountTypeDisplayLabel)*/context.getString(R.string.account_type_format1,
                                accountTypeDisplayLabel,prizeSlotId);
            } else {
                accountTypeLabel = /*(String) accountTypeDisplayLabel*/context.getString(R.string.account_type_format,
                        accountTypeDisplayLabel);
            }
			/*PRIZE-change-yuandailin-2016-5-4-end*/
        return new Pair<>(
                accountNameDisplayLabel,
                accountTypeLabel);
//        return new Pair<>(
    ...
    public static Drawable getMimeTypeDrawable(Context context, String mimeType) {
        switch (mimeType) {
            ...
            case ImsCall.CONTENT_ITEM_TYPE:
                return context.getResources().getDrawable(R.drawable.ic_dialer_ims_black);
            ///@}
            default:
                return null;
        }
