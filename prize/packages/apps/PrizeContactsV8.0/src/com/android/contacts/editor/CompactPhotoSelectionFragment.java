...
public class CompactPhotoSelectionFragment extends Fragment {
        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    ...
                    /// M: [Google Issue] ALPS03188970 3/3, pass view instead of position @{
                    handleAccessibility(photo, /*position*/view);
                    /// @}
                }
            }
        });
    ...
    /* M: [Google Issue] ALPS03188970: mGridView.getChildAt(position) is
     * not the right clicked view of position. 1/3 @{ */
    private void handleAccessibility(Photo photo, /*int position*/View view) {
    /* @} */
        ...
        /* M: [Google Issue] ALPS03188970 2/3
         * Original code @{
         ...
         * @}
         * New code @{ */
        view.announceForAccessibility(photo.contentDescriptionChecked);
        /* @} */
    }
