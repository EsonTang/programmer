...
public class ContactEditorUtils {
     ...
     */
    public AccountWithDataSet getDefaultAccountEx() {
        return ContactEditorUtilsEx.getDefaultAccountEx(mPrefs, getWritableAccounts(),
                mDefaultAccountKey, KEY_KNOWN_ACCOUNTS);
    }
}
