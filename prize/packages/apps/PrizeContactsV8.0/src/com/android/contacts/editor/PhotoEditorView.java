...
import com.android.contacts.prize.PrizeToastUtils;//prize-add for dido os8.0-hpf-2017-8-4
...
public class PhotoEditorView extends LinearLayout implements Editor {
    ...
    private boolean mReadOnly;//prize-add-huangliemin-2016-6-7
    
    /*prize-add for dido os8.0-hpf-2017-8-4-start*/
    private boolean mIsPhotoEnable = true;
    private Context mContext;
    /*prize-add for dido os8.0-hpf-2017-8-4-end*/
    ...
    public PhotoEditorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;//prize-add for dido os8.0-hpf-2017-8-4
    }

    @Override
    public void setEnabled(boolean enabled) {
        super.setEnabled(enabled);
        mPhotoImageView.setEnabled(enabled);//prize-add-huangliemin-2016-6-7
    }
    ...
    protected void onFinishInflate() {
        ...
        if (/*mChangeButton zhangzhonghao*/mPhotoImageView != null) {
            /*mChangeButton zhangzhonghao*/mPhotoImageView.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                	/*prize-add for dido os8.0-hpf-2017-8-4-start*/
                	if(!mIsPhotoEnable){
                		PrizeToastUtils.showToast(mContext, R.string.prize_add_photo_invalid_tips, 0);
                		return;
                	}
                	/*prize-add for dido os8.0-hpf-2017-8-4-end*/
                    if (mListener != null) {
    ...
    public void setValues(DataKind kind, ValuesDelta values, RawContactDelta state,
        ...
        mEntry = values;
        mReadOnly = readOnly;//prize-add-huangliemin-2016-6-7
        ...
        if (values != null) {
            ...
            if (photoBytes != null) {
                ...
                mPhotoImageView.setEnabled(isEnabled());//prize-add-huangliemin-2016-6-7
                mHasSetPhoto = true;
    ...
    public void setShowPrimary(boolean showPrimaryCheckBox) {
        //mPrimaryCheckBox.setVisibility(showPrimaryCheckBox ? View.VISIBLE : View.GONE);//prize-remove-hpf-2017-10-20
    }
    ...
    protected void resetDefault() {
        ...
        if (mDefaultIconDrawable != null) {
			...
			mPhotoImageView.setImageDrawable(mContext.getResources().getDrawable(R.drawable.prize_selector_contacts_editor_photo));
			/*prize-change for dido os 8.0-hpf-2017-7-19-end*/
        }
        mPhotoImageView.setEnabled(!mReadOnly && isEnabled());//prize-add-huangliemin-2016-6-7
        mHasSetPhoto = false;
    ...
    public void disableTriangleAffordance() {
        ...
        if(mChangeButton !=null)//PRIZE-change-yuandailin-2016-8-26
        mChangeButton.setClickable(false);
        
        /*prize-change for dido os8.0-hpf-2017-8-4-start*/
        //if(mPhotoImageView !=null)
        //mPhotoImageView.setClickable(false);
        mIsPhotoEnable = false;
        /*prize-change for dido os8.0-hpf-2017-8-4-end*/
    }
    /** @} */
}
