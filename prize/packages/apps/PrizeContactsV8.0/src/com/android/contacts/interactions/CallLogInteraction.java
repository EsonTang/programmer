...
public class CallLogInteraction implements ContactInteraction {
    ...
    public Intent getIntent() {
        ...
        /// M: Modify for Contacts Portable. @{
    ...
    public Drawable getFooterIcon(Context context) {
        ...
        /* prize change recent card huangliemin 2016-5-27 start */
        switch (type) {
            case Calls.INCOMING_TYPE:
                // callArrow = res.getDrawable(CALL_ARROW_ICON_RES);
                /// M: add for ALPS02124308
                callArrow = res.getDrawable(R.drawable.ic_call_arrow_incoming).mutate();
...
//                        PorterDuff.Mode.MULTIPLY);
            ...
            case Calls.MISSED_TYPE:
                // callArrow = res.getDrawable(CALL_ARROW_ICON_RES);
                /// M: add for ALPS02124308
                callArrow = res.getDrawable(R.drawable.ic_call_arrow_miss).mutate();
...
//                callArrow.setColorFilter(res.getColor(R.color.call_arrow_green),
//                        PorterDuff.Mode.MULTIPLY);
                callArrow = res.getDrawable(R.drawable.ic_call_arrow_outgoing).mutate();
                break;
            default:
                  callArrow = res.getDrawable(R.drawable.ic_call_arrow_miss).mutate();
            break;
        }
        /* prize change recent card huangliemin 2016-5-27 end */
