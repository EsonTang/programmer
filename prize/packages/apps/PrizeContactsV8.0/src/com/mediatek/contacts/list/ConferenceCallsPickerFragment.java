...
import com.android.contacts.R;//prize-add-fix bug[55313]-hpf-2018-5-3
...
public class ConferenceCallsPickerFragment extends DataKindBasePickerFragment {
    ...
    private static final String EXTRA_VOLTE_CONF_CALL_DIAL = "com.mediatek.volte.ConfCallDial";
    private static final String EXTRA_VOLTE_CONF_CALL_NUMBERS =
    ...
    public void onOptionAction() {
        ...
        if (ContactsIntent.CONFERENCE_CONTACTS.equals(mCallingActivity)) {
            ...
            confCallIntent.putExtra(EXTRA_VOLTE_CONF_CALL_DIAL, true);
            confCallIntent.putStringArrayListExtra(EXTRA_VOLTE_CONF_CALL_NUMBERS, numbers);
        ...
        activity.overridePendingTransition(0,R.anim.slide_down);//prize-add-fix bug[55313]-hpf-2018-5-3
        activity.finish();
    }
