...
public class ContactEditorUtilsEx {
   ...
   public static int getFieldEditorLengthLimit(int inputType) {
    ...
    public static void simTypeSetState(ViewGroup fields, PhoneticNameEditorView phoneticNameView) {
        ...
        for (int i = 0; i < fields.getChildCount(); i++) {
            ...
            if (child instanceof KindSectionView) {
                ...
                Log.i(TAG, "[simTypeSetState] The child :" + child);
        ...
        if (mGroupMetaData != null) {
            ...
            if ((accountType.equals(AccountTypeUtils.ACCOUNT_TYPE_USIM)
                ...
                while (mGroupMetaData.moveToNext()) {
                    Log.d(TAG, "[processGroupMetadataToSim] ACCOUNT_NAME: "
                ...
                Log.d(TAG, "[processGroupMetadataToSim] groupNum : " + groupNum);
    ...
    public static void updateAasView(Context context, RawContactDeltaList state,
        ...
        for (int i = 0; i < numRawContacts; i++) {
            ...
            if (SimAasSneUtils.isUsimOrCsim(accountType)) {
                ...
                GlobalEnv.getAasExtension().updatePhoneType(subId, dataKind);
    ...
    private static void updateEditorViewsLabel(ViewGroup viewGroup) {
        Log.e(TAG, "[updateEditorViewsLabel] Entry");
    ...
    public static void removeAllPopMenu(LinearLayout content, PhotoHandler photoHandler) {
        ...
        if (photoHandler != null) {
            Log.d(TAG, "[removeAllPopMenu] destory pop menu");
