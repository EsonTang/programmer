...
public class MultiDuplicationPickerFragment extends MultiBasePickerFragment {
    ...
    private class CopyRequestConnection implements ServiceConnection {
        ...
        public boolean sendCopyRequest(final List<MultiChoiceRequest> requests) {
            ...
            mService.handleCopyRequest(requests, new MultiChoiceHandlerListener(/*mService*/MultiDuplicationPickerFragment.this.getActivity()
                    /*,mCallingActivityName*/), mAccountSrc, mAccountDst);//prize-change for custom progressbar -hpf-2017-12-27
            return true;
        }
    ...
    void destroyMyself() {
        ...
        if (getActivity() != null) {
            ...
            //getActivity().finish();//prize-remove for custom progressbar -hpf-2017-12-27
        }
    }
    ...
    private class PBHLoadFinishReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.d(TAG, "[onReceive] PBHLoadFinishReceiver action:" + action);
