...
public class RawContactModifierTests extends AndroidTestCase {
    ...
    */
    ...
    public void testMigrateEventFromGoogleToExchange2() {
        ...
        /**
         * M: for Chinese +8 timezone,
         * the 6-1 8:00 will be regarded as UTC 5-31, so the date would be 5-31
         * @{
         *
        if (TimeZone.getDefault().getRawOffset() <= -8) {
            assertEquals("1990-05-31", outputValues.getAsString(Event.START_DATE));
        } else {
