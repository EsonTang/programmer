...
public class RawContactDeltaListTests extends AndroidTestCase {
    ...
    public void testMergeRawContactLocalDeleteRemoteDelete() {
        ...
        assertDiffPattern(first,
                ...
                buildAssertVersion(VER_FIRST),
                /** M: add @ { */
                buildUpdateAggregationKeepSeparate(CONTACT_MARY, CONTACT_BOB),
                /** @ } */
    ...
    /** M: add @ { */
    static ContentProviderOperation buildUpdateAggregationKeepSeparate(long rawContactId,
            long rawContactId2) {
        final ContentValues values = new ContentValues();
        values.put(AggregationExceptions.RAW_CONTACT_ID1, rawContactId);
        values.put(AggregationExceptions.RAW_CONTACT_ID2, rawContactId2);
        values.put(AggregationExceptions.TYPE, AggregationExceptions.TYPE_KEEP_SEPARATE);
