...
public class PhoneNumberListAdapter extends ContactEntryListAdapter {
    ...
    public static class PhoneQuery {
        ...
        static {
            ...
            if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
                ...
                projectionList.add(RawContacts.INDICATE_PHONE_SIM);   //9
                projectionList.add(RawContacts.IS_SDN_CONTACT);       //10
                /// @}
            }
            if (CompatUtils.isMarshmallowCompatible()) {
                projectionList.add(Phone.CARRIER_PRESENCE); // 11
                CARRIER_PRESENCE = projectionList.size() -1;
            }
        ...
        /// @}
        public static /*final*/ int CARRIER_PRESENCE        ;///M:11
    }
    ...
    protected void bindPhoneNumber(ContactListItemView view, Cursor cursor, boolean displayNumber,
        ...
        if (displayNumber &&  !cursor.isNull(PhoneQuery.PHONE_TYPE)) {
            ...
            /// M: [COMMD_FOR_AAS]
            if (ContactsPortableUtils.MTK_PHONE_BOOK_SUPPORT) {
                label = GlobalEnv.getAasExtension().getTypeLabel(
                        type, (CharSequence) customLabel, (String) label,
