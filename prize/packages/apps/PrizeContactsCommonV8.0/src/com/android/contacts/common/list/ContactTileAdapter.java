...
import com.prize.contacts.common.list.PrizeContactTileAdapter;//prize-add-huangliemin-2016-7-7
...
public class ContactTileAdapter extends BaseAdapter {
    private static final String TAG = "ContactsGroup-ContactTileAdapter";
    ...
    public void setContactCursor(Cursor cursor) {
    	Log.d(TAG,"[setContactCursor]  cursor = "+cursor);
    ...
    protected int getDividerPosition(Cursor cursor) {
        ...
        Log.d(TAG, "[getDividerPosition] cursor: " + cursor);
    ...
    public int getCount() {
        ...
        Log.d(TAG,"[getCount]  mDisplayType = "+mDisplayType);
        switch (mDisplayType) {
            case STARRED_ONLY:
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.d(TAG,"[getView]  contactList.size = "+contactList.size());
        if (contactTileRowView == null) {
            // Creating new row if needed
            contactTileRowView = new ContactTileRow(mContext, itemViewType);
        }

        /*prize-change-huangliemin-for-PrizeGroupMemeberAdapter-2016-7-7-start*/
        //contactTileRowView.configureRow(contactList, position == getCount() - 1);
        
        if(this instanceof PrizeContactTileAdapter) {
        	contactTileRowView.PrizeconfigureRow(contactList, position == getCount() - 1);
        } else {
        	contactTileRowView.configureRow(contactList, position == getCount() - 1);
        }
        
        /*prize-change-huangliemin-for-PrizeGroupMemeberAdapter-2016-7-7-end*/
    ...
    private class ContactTileRow extends FrameLayout {
        ...
        //prize-add-huangliemin-for-PrizeGroupMemberAdapter-2016-7-7-start
        public void PrizeconfigureRow(ArrayList<ContactEntry> list, boolean isLastRow) {
            int columnCount = mItemViewType == ViewTypes.FREQUENT ? 1 : mColumnCount;
            int index = 0;
            ...
            if(isLastRow) {
            	android.util.Log.i("logtest", "index: "+index);
            	addContactToRow(index);
            }
            
        }
        //prize-add-huangliemin-for-PrizeGroupMemberAdapter-2016-7-7-end
        
        //prize-add-huangliemin-2016-7-6-start
        public void addContactToRow(int index) {
            ...
            */
            addView(contactTile);
        		...
        		contactTile = (ContactTileView) getChildAt(index);
        	}
            contactTile.setAddContactView();
        ...
        //prize-add-huangliemin-2016-7-6-end

        /*private*/public void addTileFromEntry(ContactEntry entry, int childIndex, boolean isLastRow) {//prize-change-huangliemin-private-to-protected-2016-7-6
            final ContactTileView contactTile;
