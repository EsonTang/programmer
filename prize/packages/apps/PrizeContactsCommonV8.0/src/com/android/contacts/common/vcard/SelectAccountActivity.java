...
public class SelectAccountActivity extends Activity {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        /// M: @{
        List<AccountWithDataSet> myAccountlist = VcardUtils.addNonSimAccount(accountList);
        /// @}
        ...
        new AccountSelectionUtil.AccountSelectedListener(this, myAccountlist, resId) {
         /// @}
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                Log.d(LOG_TAG, "mAccountList.size() : " + mAccountList.size());
...
//                    new CancelListener());
            /// M: @{
            return VcardUtils.getSelectAccountDialog(this, resId, mAccountSelectionListener,
                    new CancelListener());
            /// @}
        }
