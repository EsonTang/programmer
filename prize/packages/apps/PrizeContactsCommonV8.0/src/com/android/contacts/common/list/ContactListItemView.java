...
import com.mediatek.contacts.util.Log;//prize-add-huangpengfei-2016-11-17
...
public class ContactListItemView extends ViewGroup
    ...
    private int mTextOffsetTop = 0;//prize-init value 0 -hpf-2017-10-16
    ...
    /*PRIZE-add listview divider -zhangzhonghao-2015-5-20 -start*/
    private boolean mHorizontalDividerVisible = true;
    private Drawable mHorizontalDividerDrawable;
    private int mHorizontalDividerHeight;
    /*PRIZE-add listview divider -zhangzhonghao-2015-5-20 -end*/
    ...
    private int mHeaderBackgroundHeight = 0;
    private LinearLayout mHeaderLinearLayout;
    private LinearLayout mHeaderLinearLayoutDivider;
    private int mHeaderPaddingLeft = 0;
    private int mHeaderSectionLayoutHight = 0;
    ...
    public ContactListItemView(Context context, AttributeSet attrs) {
        ...
        /*PRIZE-change listviewitemheight -zhangzhonghao-2015-5-20 -start*/
//        mPreferredHeight = a.getDimensionPixelSize(
//                R.styleable.ContactListItemView_list_item_height, mPreferredHeight);
        mPreferredHeight = getContext().getResources().getDimensionPixelOffset(R.dimen.listviewitemheight);
        /*PRIZE-change listviewitemheight -zhangzhonghao-2015-5-20 -start*/
        ...
        /*PRIZE-add listview divider -zhangzhonghao-2015-5-20 -start*/
        mHorizontalDividerDrawable = getContext().getResources().getDrawable(R.drawable.prize_contact_list_item_view_driver, null);
        /*PRIZE-add listview divider -zhangzhonghao-2015-5-20 -end*/
            ...
            mPresenceIconSize = a.getDimensionPixelOffset(
                    ...
                    mPresenceIconSize);
        //prize-change 105 to getResources().getInteger(R.integer.prize_contacts_list_item_view_header_offset_right)-huangpengfei-2016-8-29
        mDefaultPhotoViewSize = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_default_photo_view_size);
        
        /*prize-add-huangpengfei-2016-12-8-start*/
        mHeaderTextSize  = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_header_text_size);
        mHeaderBackgroundHeight  = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_header_background_height);
        mHeaderPaddingLeft  = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_bound_offset);
        mHeaderSectionLayoutHight  = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_header_section_layout_hight);
        mHeaderPaddingTop = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_header_padding_top);
        /*prize-add-huangpengfei-2016-12-8-end*/
        
        /*a.getDimensionPixelOffset(
                R.styleable.ContactListItemView_list_item_photo_size, mDefaultPhotoViewSize);*///prize-change-huangliemin-2016-7-14
        //prize-add-huangliemin-2016-7-13-start
        ...
        //prize-add-huangliemin-2016-7-13-end
            ...
            /*prize-change-hpf-2017-10-16-start*/
            ...
            //mNameTextViewTextSize = (int) getResources().getDimension(R.dimen.contact_browser_list_item_text_size);
            boolean isPrizeFontSize = SystemProperties.getBoolean("persist.sys.prize.fontsize",false);
            if(isPrizeFontSize){
                mNameTextViewTextSize = (int) getResources().getDimension(R.dimen.prize_contact_browser_list_item_text_size);
            }else {
                mNameTextViewTextSize = (int) getResources().getDimension(R.dimen.contact_browser_list_item_text_size);
            }
            /*prize adaptation big-font by zhaojian 20180601 end*/
            /*prize-change-hpf-2017-10-16-end*/
...
//        final int preferredHeight = mPreferredHeight;
        ...
        /*PRIZE-add contactsNameWidth -hpf-2017-11-2 -start*/
        int prizeContactsNameWidth = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_name_text_view_width);
        /*PRIZE-add contactsNameWidth -hpf-2017-11-2 -end*/
        ...
        /*prize-delete-huangliemin-2016-7-13-start*/
        /*
        if (mIsSectionHeaderEnabled) {
            effectiveWidth -= mHeaderWidth + mGapBetweenImageAndText;
        }
        */
        /*prize-delete-huangliemin-2016-7-13-end*/
        ...
        if (isVisible(mNameTextView)) {
        	...
        	/*prize-change-hpg-2017-11-2-start*/
            /*int nameTextWidth = effectiveWidth;
            if (mPhotoPosition != PhotoPosition.LEFT) {
                nameTextWidth -= mTextIndent;
            }*/
            mNameTextView.measure(
                    MeasureSpec.makeMeasureSpec(/*nameTextWidth*/prizeContactsNameWidth, MeasureSpec.EXACTLY),
                    MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
            /*prize-change-hpg-2017-11-2-end*/
        ...
        // remove the padding 8.0 by zhaojian 2017.7.21-start
        height = Math.max(height, mPhotoViewHeight /*+ getPaddingBottom() + getPaddingTop()*/);
        // remove the padding 8.0 by zhaojian 2017.7.21-end
        ...
        if (mHeaderTextView != null && mHeaderTextView.getVisibility() == VISIBLE && mIsSectionHeaderEnabled) {//prize-add-mIsSectionHeaderEnabled-huangliemin-2016-7-14
            /*prize-change-huangliemin-2016-7-13-start*/
            /*
            mHeaderTextView.measure(
                    MeasureSpec.makeMeasureSpec(mHeaderWidth, MeasureSpec.EXACTLY),
                    MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED));
            */
        	mHeaderLinearLayout.measure(
        			MeasureSpec.makeMeasureSpec(mHeaderWidth, MeasureSpec.EXACTLY),
        			MeasureSpec.makeMeasureSpec(mHeaderSectionLayoutHight, MeasureSpec.EXACTLY));
        	mHeaderLinearLayoutDivider.measure(
        			MeasureSpec.makeMeasureSpec(mHeaderWidth, MeasureSpec.EXACTLY),
        			MeasureSpec.makeMeasureSpec(1, MeasureSpec.EXACTLY));
            mHeaderTextView.measure(
                    MeasureSpec.makeMeasureSpec(0, MeasureSpec.UNSPECIFIED),
                    MeasureSpec.makeMeasureSpec(mHeaderSectionLayoutHight, MeasureSpec.EXACTLY));
            height += mHeaderSectionLayoutHight;
            /*prize-change-huangliemin-2016-7-13-end*/
        }
        ///M:
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        //int leftBound = getPaddingLeft();//prize-remove-huangpengfei-2016-12-12
        //int rightBound = width - getPaddingRight(); //prize-remove-huangpengfei-2016-12-8
        int rightBound = width;//prize-add-huangpengfei-2016-12-8
        setPadding(0, 0, 0, 0);//prize-add-huangpengfei-2016-12-8
        int leftBound = 0;//prize-add-huangpengfei-2016-12-12

        final boolean isLayoutRtl = ViewUtil.isViewLayoutRtl(this);
        /*prize-add-huangpengfei-2016-8-29-start*/
        int  prizeDividerOffsetLeft= getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_bound_offset);
        int  prizeDividerOffsetRight= getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_bound_offset);
        /*prize-add-huangpengfei-2016-8-29-end*/

        /*prize add zhaojian 8.0 2017725 start*/
        int prizeCheckBoxOffsetRight = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_checkbox_right);
        ...
        if (mIsSectionHeaderEnabled) {
            ...
            */
            ...
            mHeaderLinearLayout.layout(
            		leftBound,
                    0,
                    rightBound - prizeDividerOffsetRight,//PRIZE-change-huangpengfei-2016-8-29
                    mHeaderSectionLayoutHight
            		);
            mHeaderLinearLayoutDivider.layout(
                    prizeDividerOffsetLeft,//PRIZE-change-huangpengfei-2016-8-29
                    mHeaderSectionLayoutHight,
                    rightBound - prizeDividerOffsetRight,//PRIZE-change-huangpengfei-2016-8-29
                    mHeaderSectionLayoutHight+1
                    );
            
            int prizeHeaderTextViewLeftBound = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_bound_offset);
            mHeaderTextView.layout(
                        isLayoutRtl ? rightBound - prizeHeaderTextViewLeftBound - mHeaderTextView.getMeasuredWidth() : prizeHeaderTextViewLeftBound,
                        0,
                        isLayoutRtl ? rightBound - prizeHeaderTextViewLeftBound : mHeaderTextView.getMeasuredWidth() + prizeHeaderTextViewLeftBound,
                        mHeaderSectionLayoutHight);
            topBound += mHeaderSectionLayoutHight+1;
...
//                    rightBound,
                    height);*/
            int mDialerDividerMargin = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_divider_margin2);
            mHorizontalDividerDrawable.setBounds(
                    mDialerDividerMargin,
                    height - mHorizontalDividerHeight,
                    rightBound - mDialerDividerMargin,
                    height);
        ...
        /*prize-remove-huangpengfei-2016-12-12-start*/
        /*if (mIsSectionHeaderEnabled) {
            if (isLayoutRtl) {
        ...
        /*prize-remove-huangpengfei-2016-12-12-end*/
        ...
        if (isVisible(mCheckBox)) {
            ...
            /*prize-change-for-checkbox-position-huangliemin-2016-7-14-start*/
            /*
            if (mPhotoPosition == PhotoPosition.LEFT) {
            ...
            */
            boolean b = mPhotoPosition == PhotoPosition.LEFT;
            if (mPhotoPosition == PhotoPosition.LEFT) {
            	if(mIsSectionHeaderEnabled) {
                    Log.d(TAG,"left   true ");
            		mCheckBox.layout(rightBound - mCheckBoxWidth-30,
            				photoTop,
            				rightBound-30,
            				photoTop + mCheckBoxHeight);
            	} else {
                    Log.d(TAG,"left   false ");
            		mCheckBox.layout(/*rightBound - mCheckBoxWidth,*/rightBound - mCheckBoxWidth - prizeCheckBoxOffsetRight,//prize modify zhaojian 8.0 2017725
                            photoTop,
                            /*rightBound,*/rightBound - prizeCheckBoxOffsetRight,   //prize modify zhaojian 8.0 2017725
                            photoTop + mCheckBoxHeight);
            	}
            } else {
            	if(mIsSectionHeaderEnabled) {
                    Log.d(TAG,"right   true ");
            		mCheckBox.layout(leftBound + prizeDividerOffsetLeft,
            				photoTop,
            				leftBound + mCheckBoxWidth + prizeDividerOffsetLeft,
            				photoTop + mCheckBoxHeight);
            	} else {
                    Log.d(TAG,"right   false ");
            		mCheckBox.layout(leftBound + prizeDividerOffsetLeft,
                            photoTop,
                            leftBound + mCheckBoxWidth + prizeDividerOffsetLeft,
                            photoTop + mCheckBoxHeight);
            ...
            /*prize-change-for-checkbox-position-huangliemin-2016-7-14-end*/
        }
        ...
        if (mPhotoPosition == PhotoPosition.LEFT) {
            ...
            if (photoView != null) {
            	...
            	/*prize-add-huangpengfei-2016-12-8-start*/
            	leftBound = getContext().getResources().getDimensionPixelOffset(R.dimen.prize_contacts_list_item_view_bound_offset);
            	/*prize-add-huangpengfei-2016-12-8-end*/
            ...
            if (photoView != null) {
                ...
                final int photoTop = topBound + (bottomBound - topBound - mPhotoViewHeight) / 2;
                photoView.layout(
                        rightBound - mPhotoViewWidth - prizeDividerOffsetLeft,
                        photoTop,
                        rightBound - prizeDividerOffsetRight,
                        photoTop + mPhotoViewHeight);
                rightBound -= (mPhotoViewWidth + mGapBetweenImageAndText + prizeDividerOffsetRight);//prize-change-huangpengfei-2016-12-12
            } else if (mKeepHorizontalPaddingForPhotoView) {
                // Draw nothing but keep the padding.
        ...
        if (isVisible(mNameTextView)) {
            ...
            Log.d(TAG,"[onLayout]   distanceFromEnd = "+distanceFromEnd);
            if (mPhotoPosition == PhotoPosition.LEFT) {
        ...
        if (isVisible(mLabelView)) {
            if (!isLayoutRtl) {
                ...
                /* prize-change for dido os8.0-hpf-2017-10-25-start */
                if(mLabelView.getMeasuredWidth() > 0){
                	dataLeftBound += mLabelView.getMeasuredWidth() + mGapBetweenLabelAndData;
                }
                /* prize-change for dido os8.0-hpf-2017-10-25-end */
            } else {
        ...
        if (isVisible(mDataView)) {
            /// M:[Google issue][ALPS03498749]DataView layout overlay with check box.
            /// Modify as mNameTextView @{
            final int distanceFromEnd = workProfileIconWidth
                    + (mCheckBoxWidth > 0 ? mCheckBoxWidth + mGapBetweenImageAndText : 0);
            if (!isLayoutRtl) {
    ...
    public void setSectionHeader(String title) {
        if (!TextUtils.isEmpty(title)) {
            if (mHeaderTextView == null) {
                ...
                mHeaderTextView.setTextColor(getContext().getResources().getColor(R.color.prize_contacts_list_item_view_header_text_color));
                mHeaderTextView.setGravity(Gravity.CENTER_VERTICAL);
                mHeaderTextView.setTextAlignment(View.TEXT_ALIGNMENT_VIEW_START);
                mHeaderLinearLayout = new LinearLayout(getContext());
                mHeaderLinearLayoutDivider = new LinearLayout(getContext());
                mHeaderLinearLayoutDivider.setBackgroundColor(getContext().getResources().getColor(R.color.prize_divider_line_color));//PRIZE-change-yuandailin-2016-8-6
                mHeaderLinearLayout.setBackgroundColor(getContext().getResources().getColor(R.color.prize_contacts_list_item_view_header_bg_color));
               
                mHeaderTextView.setPaddingRelative(0, mHeaderPaddingTop, 0, 0);
                mHeaderLinearLayout.addView(mHeaderTextView);
                //mHeaderTextView.setBackgroundColor(0x11888888);
                
                        /*ViewUtil.isViewLayoutRtl(this) ? Gravity.RIGHT : Gravity.LEFT);*/
                /*prize-change-huangliemin-2016-7-13-end*/
                addView(mHeaderLinearLayout);
                //addView(mHeaderLinearLayoutDivider);//prize-remove-headerDivider-hpf-2017-12-21
            }
            setMarqueeText(mHeaderTextView, title);
            mHeaderTextView.setVisibility(View.VISIBLE);
            mHeaderLinearLayout.setVisibility(View.VISIBLE);
            mHeaderLinearLayoutDivider.setVisibility(View.VISIBLE);
            mHeaderTextView.setAllCaps(true);
        } else if (mHeaderTextView != null) {
            mHeaderTextView.setVisibility(View.GONE);
            mHeaderLinearLayout.setVisibility(View.GONE);
            mHeaderLinearLayoutDivider.setVisibility(View.GONE);
        }
    }
    ...
    public TextView getLabelView() {
        if (mLabelView == null) {
            ...
            ///M: [ALPS03328208] @{
            mLabelView.setTextDirection(View.TEXT_DIRECTION_LTR);
    ...
    private void setMarqueeText(TextView textView, CharSequence text) {
        if (getTextEllipsis() == TruncateAt.MARQUEE) {
            ...
            textView.setText(mBidiFormatter.unicodeWrap(spannable,
                           TextDirectionHeuristics.FIRSTSTRONG_LTR));
        } else {
            textView.setText(mBidiFormatter.unicodeWrap(text,
                           TextDirectionHeuristics.FIRSTSTRONG_LTR));
        }
    }
    ...
    public TextView setDisplayName(CharSequence name) {
    /*PRIZE-Change-DialerV8-wangzhong-2017_7_19-end*/
    ...
    public void setDrawableResource(int drawableId) {
        ...
        if (CompatUtils.isLollipopCompatible()) {
            ...
            /*PRIZE-change-yuandailin-2016-6-1-start*/
            //photo.setImageTintList(ColorStateList.valueOf(iconColor));
            /*PRIZE-change-yuandailin-2016-6-1-end*/
        } else {
