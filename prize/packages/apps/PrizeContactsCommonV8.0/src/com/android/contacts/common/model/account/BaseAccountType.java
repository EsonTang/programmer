...
public abstract class BaseAccountType extends AccountType {
    ...
    protected interface Weight {
        ...
        static final int NICKNAME = /*111*/155;//prize-change for dido os 8.0-hpf-2017-7-19
        static final int EVENT = 120;
        static final int ORGANIZATION = 125;
        static final int NOTE = /*130*/156;//prize-change for dido os 8.0-hpf-2017-7-19
        static final int IM = 140;
        static final int SIP_ADDRESS = 145;
        static final int GROUP_MEMBERSHIP = /*150*/600;//prize-change for dido os 8.0-hpf-2017-7-19
    ...
    protected DataKind addDataKindPhone(Context context) throws DefinitionException {
        ...
        /*prize-delete-huangliemin-2016-7-28-start*/
        //kind.typeList.add(buildPhoneType(Phone.TYPE_FAX_HOME).setSecondary(true));
        //kind.typeList.add(buildPhoneType(Phone.TYPE_PAGER).setSecondary(true));
        /*prize-delete-huangliemin-2016-7-28-end*/
    ...
    protected DataKind addDataKindEmail(Context context) throws DefinitionException {
        ...
        //kind.typeList.add(buildEmailType(Email.TYPE_MOBILE));//prize-delete-huangliemin-2016-7-28
        kind.typeList.add(
    ...
    protected DataKind addDataKindIm(Context context) throws DefinitionException {
        ...
        kind.typeList = Lists.newArrayList();
        kind.typeList.add(buildImType(Im.PROTOCOL_QQ));//prize-add for dido os 8.0-hpf-2017-7-19
        ...
        //kind.typeList.add(buildImType(Im.PROTOCOL_QQ));//prize-remove for dido os 8.0-hpf-2017-7-19
