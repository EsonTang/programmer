...
public class FloatingActionButtonController {
    ...
    public FloatingActionButtonController(Activity activity, View container, ImageButton button) {
		...
		/*PRIZE-remove-yuandailin-2015-5-30-start*/
//        ViewUtil.setupFloatingActionButton(mFloatingActionButtonContainer, resources);
        /*PRIZE-remove-yuandailin-2015-5-30-end*/
    }
    ...
    /*PRIZE-add-yuandailin-2015-5-30-start*/
	/**
    * CallCardFragment  use it to set dialpad button place
    * @param widthDimension/heightDimension/animate
    * @see resize
    */
	public void resize(int widthDimension,int heightDimension, boolean animate) {
        if (animate) {
            AnimUtils.changeDimensions(mFloatingActionButtonContainer, widthDimension, heightDimension);
        } else {
            mFloatingActionButtonContainer.getLayoutParams().width = widthDimension;
            mFloatingActionButtonContainer.getLayoutParams().height = heightDimension;
            mFloatingActionButtonContainer.requestLayout();
        }
    }
    /*PRIZE-add-yuandailin-2015-5-30-end*/
    /**
...
/*PRIZE-remove-yuandailin-2016-7-14-end*/
    ...
    public void resetIn() {
        ...
        mFloatingActionButton.setVisibility(/*View.VISIBLE*/View.GONE);//prize-chaneg-huangliemin-2016-7-15
...
//        AnimUtils.fadeOut(mFloatingActionButton, FAB_ICON_FADE_OUT_DURATION, null);//PRIZE-remove-yuandailin-2016-7-14
    }
