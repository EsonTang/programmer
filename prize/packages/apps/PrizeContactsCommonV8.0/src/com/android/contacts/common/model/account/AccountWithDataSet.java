...
public class AccountWithDataSet extends Account implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        /// M: ALPS03109782. N1 Account(fw) add a new field(accessId).so the write
        /// and read data not match will cause JE. so call super method to write.this
        /// class file should refactor to google default in later review. @{
