...
public class MaterialColorMapUtils {
    ...
    public MaterialColorMapUtils(Resources resources) {
        sPrimaryColors = resources.obtainTypedArray(
                com.android.contacts.common.R.array.prize_letter_tile_colors);//prize-change-hpf-2017-12-21
        sSecondaryColors = resources.obtainTypedArray(
                com.android.contacts.common.R.array.prize_letter_tile_colors_dark);//prize-change-hpf-2017-12-21
    }
