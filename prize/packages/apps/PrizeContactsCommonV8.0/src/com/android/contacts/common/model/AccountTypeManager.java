...
import com.mediatek.contacts.model.RuimAccountType;
...
public abstract class AccountTypeManager {
    ...
    public static AccountTypeManager getInstance(Context context) {
        ///M:[Google issue][ALPS03529202] return EMPTY if no permission @{
        if (!hasRequiredPermissions(context)) {
            ...
            Log.d(TAG, "[getInstance] no permission and return EMPTY!");
            return EMPTY;
        }
        /// @}
    ...
    private static final AccountTypeManager EMPTY = new AccountTypeManager() {
        ...
        public Map<AccountTypeWithDataSet, AccountType> getUsableInvitableAccountTypes() {
            return Collections.unmodifiableMap(new HashMap<AccountTypeWithDataSet, AccountType>());
        }
    };
...
//            }
    ...
    private void addSimAndLocalAccountType(
        ...
        addAccountType(new LocalPhoneAccountType(mContext, null), accountTypesByTypeAndDataSet,
                accountTypesByType);
        //UIM
        addAccountType(new RuimAccountType(mContext, null), accountTypesByTypeAndDataSet,
                accountTypesByType);
