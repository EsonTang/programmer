 ...
 */
public class CustomContactListFilterActivity extends BaseEventHandlerActivity
        ...
        LoaderCallbacks<CustomContactListFilterActivity.AccountSet>
{
        ...
        Log.d(TAG, "[buildDiff] mUngrouped =" + mUngrouped);
            if (isInsert()) {
                ...
                if (mUngrouped) {
                    ...
                    Log.d(TAG, "[buildDiff] selection= " + selection + ",accountName= "
                            + accountName +",accountType= " + accountType + ",dataSet= " + dataSet);
    ...
    public void onReceiveEvent(String eventType, Intent extraData) {
        Log.i(TAG, "[onReceiveEvent] eventType: " + eventType + ", extraData: " + extraData);
