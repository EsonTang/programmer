...
public class Contact {
    ...
    private void initSIMMembers(Contact from) {
        Log.d(TAG, "[initSIMMembers] initSIMMembers begin mIndicatePhoneOrSimContact , mSimIndex ,"
        ...
        Log.d(TAG, "[initSIMMembers] initSIMMembers end mIndicatePhoneOrSimContact , mSimIndex ," +
                " mBlockVideoCall, mIsSdnContact : " + mIndicatePhoneOrSimContact + " , "
                + mSimIndex + " , " + mBlockVideoCall + " , " + mIsSdnContact);
    }
