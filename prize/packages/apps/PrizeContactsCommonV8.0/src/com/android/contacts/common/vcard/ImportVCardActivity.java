...
public class ImportVCardActivity extends BaseEventHandlerActivity
    ...
    private String getDisplayName(Uri sourceUri) {
        ...
        /// @}
        Log.d(LOG_TAG, "[getDisplayName] sourceUri: " + sourceUri + ",displayName : " +
                displayName);
        return displayName;
    }
    ...
    private String readUriToLocalFile(Uri sourceUri) {
        ...
        Log.d(LOG_TAG,"[readUriToLocalFile] sourceUri: " + sourceUri + ",localFilename : "+
                localFilename);
    ...
    protected void onCreate(Bundle bundle) {
        ...
        Log.d(LOG_TAG, "[onCreate] sourceUri: " + sourceUri);
        ...
        if (sourceUri != null) {
            ...
            Log.d(LOG_TAG, "[onCreate] localTmpFileName: " + localTmpFileName +
                    ",sourceDisplayName: " + sourceDisplayName + ",sourceUri: " +
                    sourceUri);
        }
    ...
    private void startImport(Uri uri, String sourceDisplayName) {
        Log.d(LOG_TAG, "[startImport] uri: " + uri + ",sourceDisplayName: " + sourceDisplayName);
        ...
        switch (resId) {
            ...
            case R.id.dialog_cache_vcard: {
                ...
                if (mProgressDialogForCachingVCard == null) {
                    ...
                    mProgressDialogForCachingVCard.setCancelable(false);
    ...
    private boolean isStorageUriEx(Uri uri) {
        Log.d(LOG_TAG, "[isStorageUriEx] uri :" + uri);
        return uri != null && (uri.toString().startsWith(STORAGE_VCARD_URI_PREFIX)||
    ...
    private String getDisplayNameByQueryMediaProvider(Uri sourceUri) {
        Log.d(LOG_TAG, "[getDisplayNameByQueryMediaProvider] sourceUri: " + sourceUri);
        if (sourceUri == null) {
        ...
        Log.i(LOG_TAG, "[getDisplayNameByQueryMediaProvider] displayName:" + displayName);
        return displayName;
    }
    /** @} */
}
