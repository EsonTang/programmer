...
public class PinnedHeaderListView extends AutoScrollListView
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        /*PRIZE-change shadow header textview x -zhangzhonghao-2015-5-20 -start*/
//        mHeaderPaddingStart = getPaddingStart();
        mHeaderPaddingStart = getContext().getResources().getDimensionPixelOffset(com.android.contacts.common.R.dimen.prize_listview_hide_header_left);
        /*PRIZE-change shadow header textview x -zhangzhonghao-2015-5-20 -start*/
    ...
    public void onScroll(AbsListView view, int firstVisibleItem, int visibleItemCount,
        ...
        if (mAdapter != null) {
            ...
            Log.d(TAG, "[onScroll] header count: " + count);
            if (count != mSize) {
                mSize = count;
                if (mHeaders == null) {
    ...
    public void setFadingHeader(int viewIndex, int position, boolean fade) {
        ...
        PinnedHeader header = mHeaders[viewIndex];
		/**prize-M-shiyicheng-20150907-before is true-start*/
        header.visible = false;
		/**prize-M-shiyicheng-20150907-before is true-end*/
        header.state = FADING;
...
//                    drawHeader(canvas, header, currentTime); zhangzhonghao remove 20160305
                }
            }
