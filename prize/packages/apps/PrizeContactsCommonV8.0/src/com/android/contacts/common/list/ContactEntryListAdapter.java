...
public abstract class ContactEntryListAdapter extends IndexerListAdapter {
    ...
    protected void bindView(View itemView, int partition, Cursor cursor, int position) {
    	Log.d(TAG, "[bindView]  itemView="+itemView+"  partition="+partition+"  position="+position);
...
//        }
    ...
    protected void bindHeaderView(View view, int partitionIndex, Cursor cursor) {
        ...
        view.setPaddingRelative(view.getPaddingStart(), /*headerPaddingTop*/20, view.getPaddingEnd(),
                view.getPaddingBottom());
        //prize modify 8.0 by zhaojian 2017721 end
    }
    ...
    public boolean isSdnNumber(int position) {
        ...
        if (isSdnNumber) {
            Log.d(TAG, "[isSdnNumber] isSdnNumber = " + isSdnNumber);
        }
        return isSdnNumber;
    }
    /// @}
