...
public abstract class AccountType {
    ...
    /**
     * M: add for SNE, to remove SNE from list if SIM not support SNE.
     */
    public void removeKind(String mimeType) {
        if (mMimeKinds.get(mimeType) != null) {
            this.mKinds.remove(mMimeKinds.get(mimeType));
            this.mMimeKinds.remove(mimeType);
        }
    }
}
