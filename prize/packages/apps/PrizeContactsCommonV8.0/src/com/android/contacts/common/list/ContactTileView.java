...
public abstract class ContactTileView extends FrameLayout {
    ...
    private Context mContext;//prize-add-huangliemin-2016-7-6
        ...
        if (entry != null) {
            ...
            if (mPhotoManager != null) {
                ...
                if (mPhoto != null) {
                	...
                	request.setScale(1);//prize-add for dido os8.0-hpf-2017-8-7
                    mPhotoManager.loadPhoto(mPhoto, entry.photoUri, -1, isDarkTheme(),
                            isContactPhotoCircular(), request);
    ...
    //prize-add-huangliemin-for-add-contacts-to-group-2016-7-6-start
    public void setAddContactView(){
    	android.util.Log.i("logtest", "setAddContactView");
    	mName.setText(R.string.prize_add_contacts_to_group);
    	mName.setVisibility(View.VISIBLE);
    	mPhoto.setImageDrawable(mContext.getResources().getDrawable(R.drawable.prize_group_ic_person_add));
    	mPhoto.setVisibility(View.VISIBLE);
    	setVisibility(View.VISIBLE);
    }
    //prize-add-huangliemin-for-add-contacts-to-group-2016-7-6-end
