...
public final class AccountsListAdapter extends BaseAdapter {
    ...
    public enum AccountListFilter {
        ...
        /** M: ALPS03621760, add to support get none sim accounts
         * 1/2 @ {
         */
        ACCOUNTS_CONTACT_WRITABLE_NONE_SIM // Only accounts writable and none sim.
        /** ALPS03621760 1/2 @}*/
    }
    ...
    private List<AccountWithDataSet> getAccounts(AccountListFilter accountListFilter) {
        ...
        /** M: ALPS03621760, filter sim account when editing read only contact.
         * 2/2 @ { */
        if (accountListFilter == AccountListFilter.ACCOUNTS_CONTACT_WRITABLE_NONE_SIM) {
            return AccountsListAdapterUtils.getWritableNoneSimAccount(mAccountTypes);
        }
        /** 2/2 @ } */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // name.
        /// M: add for sim name
        AccountsListAdapterUtils.getViewForName(mContext, account, accountType, text2, icon);
