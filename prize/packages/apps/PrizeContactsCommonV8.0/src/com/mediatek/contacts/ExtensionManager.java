...
public final class ExtensionManager {
    ...
    static {
        ...
        sDefaulthPluginMap.put(IContactsPickerExtension.class,
                new DefaultContactsPickerExtension());
    }
    ...
    private static <T> T createPluginObject(Class cls, Object defaultObject) {
        T pluginObject = null;
        if (ContactsPortableUtils.MTK_PLUGIN_SUPPORT) {
            pluginObject = (T) MPlugin.createInstance(cls.getName(), sContext);
        }
   ...
   //-------------------below are getXxxExtension() methonds-----------------//
    ...
    public static IContactsPickerExtension getContactsPickerExtension() {
        IContactsPickerExtension extension =
                (IContactsPickerExtension) getExtension(IContactsPickerExtension.class);
        return extension;
    }
