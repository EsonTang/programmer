...
public class AccountTypeUtils {
    ...
    static {
        for (int slotId : SlotUtils.getAllSlotIds()) {
            ...
            accountNamesForSlot.put(SimCardUtils.SimType.SIM_TYPE_RUIM, "RUIM" + slotId);
    ...
    public static Drawable getDisplayIconBySubId(Context context, int subId, int titleRes,
        ...
        if (titleRes != -1 && syncAdapterPackageName != null) {
             ...
             */
             /*prize-add-huangliemin-2016-6-14-start*/
        	//prize-change-huangliemin-2016-6-30
        	int simindex = SubInfoUtils.getSlotIdUsingSubId(subId)+1;
             if(simindex == 1) {
                return context.getResources().getDrawable(R.drawable.prize_account_sim1);
             } else if (simindex == 2) {
                return context.getResources().getDrawable(R.drawable.prize_account_sim2);
             }
             /*prize-add-huangliemin-2016-6-14-end*/
