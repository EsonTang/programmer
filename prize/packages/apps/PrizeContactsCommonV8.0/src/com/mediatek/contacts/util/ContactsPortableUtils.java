...
public class ContactsPortableUtils {
    ...
    public static final boolean MTK_PLUGIN_SUPPORT = isMtkPluginSupport();
    ...
    private static boolean isMtkPluginSupport() {
        try {
            Class<?> mplugin = Class.forName("com.mediatek.common.MPlugin");
        } catch (ClassNotFoundException e) {
            Log.e(TAG, "MPlugin class not found!");
            return false;
        }
        return true;
    }
    ...
    private static boolean isMtkTelephonySupport() {
        try {
            Class<?> telephonyEx = Class.forName("com.mediatek.internal.telephony.ITelephonyEx");
            Class<?> alphaTag = Class.forName("com.mediatek.internal.telephony.uicc.AlphaTag");
            Class<?> usimGroup = Class.forName("com.mediatek.internal.telephony.uicc.UsimGroup");
    ...
    private static boolean isMtkPhoneBookSupport() {
        try {
            Class<?> iccPhoneBook = Class.forName("com.android.internal.telephony.IIccPhoneBook");
