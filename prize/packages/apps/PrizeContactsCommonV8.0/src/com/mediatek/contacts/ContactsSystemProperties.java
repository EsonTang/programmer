...
public class ContactsSystemProperties {
    ...
    public static final boolean MTK_VVM_SUPPORT = true; // [VVM] vvm is a Google
                                                        // default feature.
    // VOLTE IMS Call feature.
    public static final boolean MTK_VOLTE_SUPPORT = isPropertyEnabled("persist.mtk_volte_support");
    public static final boolean MTK_IMS_SUPPORT = isPropertyEnabled("persist.mtk_ims_support");

    // ALPS02008620, [Performance] APP back key behavior rollback to Google's
    // design.
    public static final boolean MTK_PERF_RESPONSE_TIME =
            isPropertyEnabled("ro.mtk_perf_response_time");
