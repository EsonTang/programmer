...
public class SimCardUtils {
    ...
    public static boolean isSetRadioOn(ContentResolver resolver, int subId) {
        ...
        if (SlotUtils.isGeminiEnabled()) {
            ...
            int dualSimSet = Settings.System.getInt(resolver, Settings.System.MSIM_MODE_SETTING,
                    flagAllSimOn);
    ...
    public static boolean isUsimOrCsimType(int subId) {
        ...
        ///M:[portable] @{
        if (!ContactsPortableUtils.MTK_TELEPHONY_SUPPORT) {
            Log.v(TAG, "[isUsimOrCsimType], can not use ITelephonyEx, return false;");
            return false;
        }
        ///@}
        final ITelephonyEx iTel = ITelephonyEx.Stub.asInterface(ServiceManager
        ...
        protected Void doInBackground(Void... args) {
            ...
            if (!mIsCancelled && (subscriptionInfoList != null)
                ...
                for (SubscriptionInfo subscriptionInfo : subscriptionInfoList) {
                    ...
                    Log.d(TAG, "[ShowSimCardStorageInfoTask] simName = "
                    ...
                    try {
                        ...
                        if (!mIsCancelled && phoneEx != null) {
                            ...
                            SlotUtils.getUsimAnrCount(subscriptionInfo.getSubscriptionId());
                    ...
                    Log.i(TAG, "[ShowSimCardStorageInfoTask]subId:"
                    ...
                    if (storageInfos != null && storageInfos[1] > 0) {
                        sSurplugMap.put(subscriptionInfo.getSubscriptionId(),
