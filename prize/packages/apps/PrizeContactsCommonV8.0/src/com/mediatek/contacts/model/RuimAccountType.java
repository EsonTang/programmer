...
public class RuimAccountType extends BaseAccountType {
    private static final String TAG = "UimAccountType";

    public static final String ACCOUNT_TYPE = AccountTypeUtils.ACCOUNT_TYPE_RUIM;

    public RuimAccountType(Context context, String resPackageName) {
        Log.i(TAG, "[UimAccountType]resPackageName:" + resPackageName);
        this.accountType = ACCOUNT_TYPE;
        this.resourcePackageName = null;
        this.syncAdapterPackageName = resPackageName;
        this.titleRes = R.string.account_uim_only;
        this.iconRes = R.drawable.ic_sim_card_white_36dp;
