...
public class WifiGprsSelector extends WifiSettings
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (KEY_DATA_ENABLER_GEMINI.equals(key)) {
            ...
            AlertDialog dialog = new AlertDialog.Builder(getPrefContext())
            //.setCancelable(false)
    ...
    class SelectionListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                LayoutInflater mFlater = LayoutInflater.from(getPrefContext());
    ...
    static class SimItem {
        ...
        public SimItem(SubscriptionInfo subinfo, WifiGprsSelector wifiGprsSelector) {
            ...
            mWifiGprsSeletor = wifiGprsSelector;
            mSimIconBitmap = subinfo.createIconBitmap(wifiGprsSelector.getPrefContext());
        }
    }
}
