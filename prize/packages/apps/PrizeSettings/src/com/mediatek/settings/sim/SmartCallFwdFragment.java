 ...
 */
public class SmartCallFwdFragment extends PreferenceFragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mSim1num = mTelephonyManagerEx.getLine1Number(SIM1);
        mSim2num = mTelephonyManagerEx.getLine1Number(SIM2);
    ...
    private void startService() {
        // Bind to the service
        Intent eIntent = createExplicitFromImplicitIntent(mContext,
                new Intent("mediatek.settings.SMART_CALL_FWD_SERVICE"));
        if (eIntent != null) {
    ...
    /**
     * Create explicit intent out of implicit intent.
     */
