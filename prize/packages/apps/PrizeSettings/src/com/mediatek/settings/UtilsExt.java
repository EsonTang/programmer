...
public class UtilsExt {
    ...
    /* Changes for getting cusstomized storage setting plugin */
    ...
    /**
     * M: create System memory usage plugin object
     * @param context Context
     * @return IStorageSettingsExt
     */
    public static IStorageSettingsExt getStorageSettingsPlugin(Context context) {
        if(sStorageSettingsExt == null){
            sStorageSettingsExt =
                (IStorageSettingsExt) MPlugin.createInstance(
                        IStorageSettingsExt.class.getName(), context);
            if (sStorageSettingsExt == null) {
    ...
    */
    ...
    public static IAudioProfileExt getAudioProfilePlugin(Context context) {
        ...
        if (ext == null) {
            Log.i(TAG, "IAudioProfileExt = DefaultAudioProfileExt");
            ext = new DefaultAudioProfileExt(context);
        }
        Log.i(TAG, "IAudioProfileExt = " + ext.toString());
        return ext;
    }
