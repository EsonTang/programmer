...
import android.content.ComponentName; //prize add by xiarui 2018-03-28 for bug#53794
...
public class ChooseLockGeneric extends SettingsActivity {
    ...
    public static class ChooseLockGenericFragment extends SettingsPreferenceFragment {
		...
		private boolean mForFaceprint = false;
        ...
        public void onCreate(Bundle savedInstanceState) {
			...
			mForFaceprint = getActivity().getIntent().getBooleanExtra(
                    ChooseLockSettingsHelper.EXTRA_KEY_FOR_FACEPRINT, false);		
          ...
          //  addHeaderView();remove by lijimeng 20180302
        }
        ...
        private void maybeEnableEncryption(int quality, boolean disabled) {
            ...
            if (UserManager.get(getActivity()).isAdminUser()
				...
				intent.putExtra(ChooseLockSettingsHelper.EXTRA_KEY_FOR_FACEPRINT,
                        mForFaceprint);
        ...
        protected void addPreferences() {
            ...
            final RestrictedPreference pref = (RestrictedPreference)findPreference(KEY_UNLOCK_SET_OFF);
            /* prize-add-by-lijimeng-20180303-start*/
            if(pref != null){
                getPreferenceScreen().removePreference(pref);
            }
            /* prize-add-by-lijimeng-20180303-end*/
        }
        ...
        void updateUnlockMethodAndFinish(int quality, boolean disabled) {
            ...
            if (quality == DevicePolicyManager.PASSWORD_QUALITY_UNSPECIFIED) {
                ...
                removeAllFaceId();//prize add by xiarui for bug#53794
        ...
        /*prize add by xiarui for bug#53794 remove all faceid 2018-03-28 start*/
        private void removeAllFaceId() {
            Log.d(TAG, "-----removeAllFaceId----");
        ...
        /*prize add by xiarui for bug#53794 remove all faceid 2018-03-28 end*/
                        ...
                        .setPositiveButton(R.string.unlock_disable_frp_warning_ok,
                                new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int whichButton) {
                                        ...
                                        //SpUtil.saveData(getActivity(), "ListSize", 0);
