...
public class DeviceAdminSettings extends ListFragment {
    ...
    class PolicyListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            bindView(convertView, (DeviceAdminInfo) o,position);
            return convertView;
        }
        ...
        private void bindView(View view, DeviceAdminInfo item,int position) {
            final Activity activity = getActivity();
			...
			if(getCount()>1){
				if(position == 0){
					...
					view.findViewById(R.id.divider_lines).setVisibility(View.VISIBLE);
				}else if(position != getCount()-1){
					view.setBackgroundResource(R.drawable.npreferencecategory_selector);
					view.findViewById(R.id.divider_lines).setVisibility(View.VISIBLE);
				}else{
					view.setBackgroundResource(R.drawable.topmorepreferencecategory_selector);
					view.findViewById(R.id.divider_lines).setVisibility(View.GONE);
				}
			}else{
	...
	public void prizeSetLayoutParams(ListView listview){
		 if(listview.getLayoutParams() instanceof FrameLayout.LayoutParams){
			...
			int top = getActivity().getResources().getDimensionPixelSize(R.dimen.prize_preferencefragment_card_magintop);
			int left = getActivity().getResources().getDimensionPixelSize(R.dimen.prize_preferencefragment_card_maginleft);
