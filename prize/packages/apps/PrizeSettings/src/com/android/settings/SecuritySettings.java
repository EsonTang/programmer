...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    /*-prize-add by lihuangyuan,for applock 2017-10-19-start*/
    private static final String KEY_APPLICATION_LOCK = "application_lock";
    /*-prize-add by lihuangyuan,for applock 2017-10-19-end*/	
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        if (!RestrictedLockUtils.hasBaseUserRestriction(getActivity(),
			...
			//remove
			 PreferenceGroup credentialsManagerPreference = (PreferenceGroup)
                    root.findPreference(KEY_CREDENTIALS_MANAGER);
			credentialsManagerPreference.removePreference(root.findPreference(KEY_CREDENTIAL_STORAGE_TYPE));
			credentialsManagerPreference.removePreference(root.findPreference(KEY_USER_CREDENTIALS));
        } else {
        ...
        if (advancedCategory != null) {
			...
			//remove
			advancedCategory.removePreference(manageAgents);
        }
    ...
    private void maybeAddFingerprintPreference(PreferenceGroup securityCategory, int userId) {
        ...
        if (fingerprintPreference != null) {
			/* prize-modify-by-lijimeng-for remove fingerprintPreference-20171129-start*/
            //securityCategory.addPreference(fingerprintPreference);
			/* prize-modify-by-lijimeng-for remove fingerprintPreference-20171129-end*/
        }
    }
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
	  ...
	  /*-prize-add by lihuangyuan,for applock 2017-10-19-start*/
	 else if(KEY_APPLICATION_LOCK.equals(key))
        {
    ...
    private static class SecuritySearchIndexProvider extends BaseSearchIndexProvider {
        ...
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean enabled) {
            ...
            /* prize-modify-by-lijimeng-for bugid 47073-20180105-start*/
            ...
            /* prize-modify-by-lijimeng-for bugid 47073-20180105-end*/
            final LockPatternUtils lockPatternUtils = new LockPatternUtils(context);
            final int profileUserId = Utils.getManagedProfileId(um, MY_USER_ID);
            if (profileUserId != UserHandle.USER_NULL
                    && lockPatternUtils.isSeparateProfileChallengeAllowed(profileUserId)) {
    ...
    public static class SecuritySubSettings extends SettingsPreferenceFragment
        ...
        private void createPreferenceHierarchy() {
			...
			/* prize-modify-by-lijimeng-for bugid 41265-20171027-start*/
			if(resid > 0){
				addPreferencesFromResource(resid);
			}
			//addPreferencesFromResource(resid);
			/* prize-modify-by-lijimeng-for bugid 41265-20171027-end*/
            // lock after preference
            mLockAfter = (TimeoutListPreference) findPreference(KEY_LOCK_AFTER_TIMEOUT);
            if (mLockAfter != null) {
                setupLockAfterPreference();
                updateLockAfterPreferenceSummary();
                /* prize-add-by-lijimeng-20180208-start*/
                if(getPreferenceScreen() != null){
                    getPreferenceScreen().removePreference(mLockAfter);
                }
                 /* prize-add-by-lijimeng-20180208-start*/
            }
            ...
            mPowerButtonInstantlyLocks = (SwitchPreference) findPreference(
             ...
             /* prize-add-by-lijimeng-20180208-start*/
            if(mPowerButtonInstantlyLocks != null && getPreferenceScreen() != null){
                getPreferenceScreen().removePreference(mPowerButtonInstantlyLocks);
            }
             /* prize-add-by-lijimeng-20180208-end*/
