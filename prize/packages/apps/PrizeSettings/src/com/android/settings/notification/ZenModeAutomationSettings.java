    ...
    private class ZenRulePreference extends Preference {
        ...
        public ZenRulePreference(Context context,
            ...
            try {
				...
				//remove icon liup 20171025 start
                //LoadIconTask task = new LoadIconTask(this);
                //task.execute(info);
				//remove icon liup 20171025 end
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        new BaseSearchIndexProvider() {
            ...
            public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean enabled) {
				...
				final String screenTitle = context.getString(R.string.zen_mode_automation_settings_title);
				indexable.title = context.getString(R.string.zen_mode_automation_settings_title);
