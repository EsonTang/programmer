...
public class PowerUsageSummary extends PowerUsageBase {
    ...
    /* Add for shengdianguanli by zhudaopeng 2016-05-06 Start */
    private static final String PROPERTY_POWER_MODE= "persist.sys.power.mode";
    /* Add for shengdianguanli by zhudaopeng 2016-05-06 End */
    ...
    public void onCreate(Bundle icicle) {
        ...
        /* Modify by zhudaopeng at 2016-11-30 Start */
        getPreferenceScreen().removePreference(mHistPref);
        /* Modify by zhudaopeng at 2016-11-30 End */
    ...
    private void addNotAvailableMessage() {
        ...
        if (notAvailable == null) {
			...
			notAvailable.setWidgetLayoutResource(0);
    ...
    protected void refreshStats() {
        ...
        /*--prize-power usage summary chat-add--liuweiquan-20160219-start--*/
        Bundle data = getArguments();
		if(data!=null&&data.containsKey(SettingsActivity.EXTRA_SHOW_FRAGMENT_ARGUMENTS)
			&&data.getString(SettingsActivity.EXTRA_SHOW_FRAGMENT_ARGUMENTS).equals("*#8809#")){
			/* Modify by zhudaopeng at 2016-11-23 Start */
	        updatePreference(mHistPref);
	        /* Modify by zhudaopeng at 2016-11-23 End */
	        getPreferenceScreen().addPreference(mHistPref);
		}else{
			getPreferenceScreen().removePreference(mHistPref);
		}
		/*--prize-power usage summary chat-add--liuweiquan-20160219-end--*/
        ...
        if (averagePower >= MIN_AVERAGE_POWER_THRESHOLD_MILLI_AMP || USE_FAKE_DATA) {
            ...
            for (int i = 0; i < numSippers; i++) {
                ...
                final CharSequence contentDescription = mUm.getBadgedLabelForUser(entry.getLabel(),
                        userHandle);
                Log.d(TAG, "refreshStats() ---> Label = "+entry.getLabel()+", BadgedIcon = "+badgedIcon);
