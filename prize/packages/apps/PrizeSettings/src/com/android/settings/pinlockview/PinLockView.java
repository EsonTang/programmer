...
public class PinLockView extends RecyclerView {
    ...
    private PinLockAdapter.OnNumberClickListener mOnNumberClickListener = new PinLockAdapter.OnNumberClickListener() {
        ...
        public void onNumberClicked(int position) {
	     ...
	     Log.d("john","onNumberClicked key:"+key+",pinlen:"+mPin.length());
            if (mPin.length() < getPinLength()) {
			   ...
			   Log.d("john","onComplete1 pin:"+mPin);
                ...
                if (!isShowDeleteButton()) {
                    ...
                    /*if (mPinLockListener != null) {
			    Log.d("john","onComplete2 pin:"+mPin);
                        mPinLockListener.onComplete(mPin);
                    }*/
                }
            }
    ...
    private void init(AttributeSet attributeSet, int defStyle) {
        ...
        try {
            ...
            mTextColor = typedArray.getColor(R.styleable.PinLockView_keypadTextColor, ResourceUtils.getColor(getContext(), android.R.color.black));
    ...
    private void initView() {
        ...
        addItemDecoration(new ItemSpaceDecoration(getContext(), mHorizontalSpacing, mVerticalSpacing, 3, false));
    ...
    public void updatePinLockViewError() {
        if (mIndicatorDots != null) {
            mIndicatorDots.updateDotError();
        }
    }
