...
public class OverViewTabAdapter extends BaseExpandableListAdapter {
    ...
    private void getMobileData() {
        ...
        for (SubscriptionInfo subInfo : mSublist) {
            String subscriberId = TelephonyManager.from(mContext).getSubscriberId(
    ...
    private void initData() {
        ...
        if (mSimNum != 0) {
            mGroup.add(mContext.getString(R.string.datausage_overview_mobile_title));
            mMobilePos = 0;
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        if (groupPosition == mWifiPos) {
            ...
            view = inflate.inflate(R.layout.data_usage_exp_child_wifi, null);
			...
			ViewLines = (View) view.findViewById(R.id.data_top_lines);
            getWifiData();
            if (childPosition == 0) {
                textTitle.setText(mContext
                        .getString(R.string.datausage_overview_wifi_today));
                ...
                textTitle.setText(mContext
                        .getString(R.string.datausage_overview_wifi_total));
                    ...
                    if (mLimitBytes[childPosition] > -1) {
                        if (mLimitBytes[childPosition] >= 0
                            ...
                            textUsage.setText(mContext.getString(
                                    R.string.datausage_overview_mobile_usage_warning,
                                    Formatter
                                    .formatFileSize(mContext, mMobileTotal[childPosition]
                                            - mLimitBytes[childPosition])));
                        } else {
                            textUsage.setText(mContext.getString(
                                    R.string.datausage_overview_mobile_usage,
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        /* Modify by zhudaopeng 2016-12-12 Start */
        View view;
        if (null == convertView || !(convertView instanceof TextView)) {
            LayoutInflater factory = LayoutInflater.from(mContext);
            view = factory.inflate(R.layout.list_group_header, null);
        } else {
            view = convertView;
        }
        TextView mHeaderTitle = (TextView) view.findViewById(R.id.header_title);
        mHeaderTitle.setText(mGroup.get(groupPosition));
        return view;
