...
public class IccLockSettings extends SettingsPreferenceFragment
    ...
    /* Add by zhudaoprng 2016-12-16 Start */
    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        getActivity().getActionBar().setDisplayHomeAsUpEnabled(true);
    }
    /* Add by zhudaoprng 2016-12-16 End */
    ...
    private void updatePreferences() {
        /// M: check airplane mode
		/* prize-add-by-lijimeng-for bugid 47218-20170105-start*/
		if(mPinDialog == null){
			return;
		}
		/* prize-add-by-lijimeng-for bugid 47218-20170105-end*/
    ...
    private void tryChangeIccLockState() {
        ...
        if (mPhone != null) {
            Log.d(TAG, "setIccLockEnabled, mToState = " + mToState + " mPin = " + mPin);
    ...
    private void tryChangePin() {
        ...
        if (mPhone != null) {
            Log.d(TAG, "changeIccLockPassword, mOldPin = " + mOldPin + " mNewPin = " + mNewPin);
