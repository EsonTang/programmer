...
public class Settings extends SettingsActivity {
    ...
    */
    ...
    public static class TipAndNotifications extends SettingsActivity { /* empty */ }
    ...
    /**M: Add for shengdianguanli by zhudaopeng 2016-04-26 Start*/
    public static class PowerRankActivity extends SettingsActivity { /*empty */ }
    /**@}*/
    
    // Modify by zhudaopeng at 2016-11-07 Start
    public static class PrizeAirPlaneActivity extends SettingsActivity { /* empty */ }
    
    public static class PrizeAudioProfileSettingsActivity extends SettingsActivity { /* empty */ }
    
    public static class PrizeNoticeStatusBarSettingsActivity extends SettingsActivity { /* empty */ }
    
    public static class PrizeWallpaperLockscreenSettingsActivity extends SettingsActivity { /* empty */ }
    
    public static class PrizeFingerprintOperationActivity extends SettingsActivity { /* empty */ }
    
    public static class PrizeIntelligentSettingsActivity extends SettingsActivity { /* empty */ }
    
    public static class PrizeOtherSettingsActivity extends SettingsActivity { /* empty */ }
    
    public static class PrizeSystemUpdateSettingsActivity extends SettingsActivity { /* empty */ }
    // Modify by zhudaopeng at 2016-11-07 End
	
	/*prize add zhaojian 8.0 2017803 start*/
    public static class PrizeRedPacketAssitActivity extends SettingsActivity { /* empty */ }
    /*prize add zhaojian 8.0 2017803 end*/
	/*prize add lijimeng 8.0 20171121 start*/
    public static class PrizeOldLauncherActivity extends SettingsActivity { /* empty */ }
    public static class PrizeFeedBackActivity extends SettingsActivity { /* empty */ }
    /*prize add lijimeng 8.0 20171121 end*/
    public static class FaceOperationActivity extends SettingsActivity { /*empty */ }
}
