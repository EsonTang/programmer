...
public class ApnEditor extends SettingsPreferenceFragment
    ...
    private static String[] sProjection = new String[] {
            ...
            Telephony.Carriers.SOURCE_TYPE //24, M: [APN Source Type]
    };
    ...
    /// M: [APN Source Type]
    private static final int SOURCE_TYPE_INDEX = 24;
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (action.equals(Intent.ACTION_EDIT)) {
            ...
            if (mFirstTime || icicle.getInt(SAVED_POS) == 0) {
                ...
                /* Check for the Constraint check to prevent emergency APN*/
                String numeric = mTelephonyManager.getSimOperator(mSubId);
                Log.d(TAG, " Insert first check mnc by numeric = " + numeric);
                ...
                if (numeric != null && numeric.length() > 4) {
                    ...
                    /* Add MNC in values to make it unique from Emergency APN */
