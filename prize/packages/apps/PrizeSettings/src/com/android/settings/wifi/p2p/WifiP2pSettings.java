...
public class WifiP2pSettings extends SettingsPreferenceFragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        /* prize-add-by-lijimeng-for bugid 52098-20180312-start*/
        mThisDevicePref.setWidgetLayoutResource(0);
        /* prize-add-by-lijimeng-for bugid 52098-20180312-end*/
    ...
    public Dialog onCreateDialog(int id) {
        if (id == DIALOG_DISCONNECT) {
            ...
            if(filter !=  null){
            	mDeviceNameText.setFilters(new InputFilter[]{filter});
            }else {
            	mDeviceNameText.setFilters(new InputFilter[] {new InputFilter.LengthFilter(24)});
			}
    ...
    /**
     * Limit the length of input characters to 3 characters in Chinese and 1 character in English   add by   mafei
     */
