...
import com.android.settings.pinlockview.PinLockAdapter;
...
import com.android.settings.datausage.OverViewTabAdapter;
...
public class DataUsageSummary extends DataUsageBase implements Indexable {
    ...
    public static final String TEST_SUBSCRIBER_PROP = "test.subscriberid";
    ...
    private LinearLayout mPrizeDataSaver;
   ...
   private BroadcastReceiver mReceiver = new BroadcastReceiver() {
       ...
       public void onReceive(Context context, Intent intent) {
		   ...
		   /* prize-add-bugid 30027 Synchronous Mobile Data-lijimeng-20170309-start*/
			else if(action.equals("android.net.conn.CONNECTIVITY_CHANGE")){
				final TelephonyManager tm =(TelephonyManager) context.getSystemService(Context.TELEPHONY_SERVICE);
				boolean enable = tm.getDataEnabled();
				if(enable){
					if(getSubId(mCurrentTab) == SubscriptionManager.getDefaultDataSubscriptionId()){
						mDataEnabled.setChecked(enable);
						mMobileDataEnabled.put(String.valueOf(getSubId(mCurrentTab)), enable);
					}else{
						mMobileDataEnabled.put(String.valueOf(SubscriptionManager.getDefaultDataSubscriptionId()), enable);
					}
				}else{
					mDataEnabled.setChecked(false);
					if(getSubId(mCurrentTab) == SubscriptionManager.getDefaultDataSubscriptionId()){
						mMobileDataEnabled.put(String.valueOf(getSubId(mCurrentTab)), false);
					}else{
						mMobileDataEnabled.put(String.valueOf(SubscriptionManager.getDefaultDataSubscriptionId()), false);
					}
				}
			}
			/* prize-add-bugid 30027 Synchronous Mobile Data-lijimeng-20170309-end*/
       }
   };
    ...
    public void onCreate(Bundle icicle) {
        ...
        mPolicyEditor = new NetworkPolicyEditor(services.mPolicyManager);
        mPolicyEditor.read();
        ...
        if (hasMobileData) {
            ...
            for (int i = 0; mSubInfoList != null && i < mSubInfoList.size(); i++) {
        ...
        boolean hasEthernet = hasEthernet(getContext());
        if (hasEthernet) {
            
        }

        try {
            if (!services.mNetworkService.isBandwidthControlEnabled()) {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        /* Modify by zhudaopeng at 2016-11-24 Start */
        // if (Utils.isWifiOnly(getActivity())) {
            // menu.removeItem(R.id.data_usage_menu_cellular_networks);
        // }
        /* Modify by zhudaopeng at 2016-11-24 End */
        /// @}
		/* prize-add-by-lijimeng-for remove data control-20171130-start*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /* prize-add-by-lijimeng-for bugid 55343-20180420-start*/
        mPrizeDataSaver = (LinearLayout)view.findViewById(R.id.prizeDataSaver);
        mPrizeDataSaver.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startFragment(DataUsageSummary.this,DataSaverSummary.class.getCanonicalName(),R.string.data_saver_title,0,null);
            }
        });
        /* prize-add-by-lijimeng-for bugid 55343-20180420-end*/
		...
		mListView.setDivider(context.getResources().getDrawable(R.drawable.prize_sleep_gesture_lines,null));
        ...
        mListViewHeader = (ViewGroup) inflater.inflate(R.layout.data_usage_header, mListView, false);
        mListViewHeader.setClickable(true);

        mListView.addHeaderView(new View(context), null, true);
        mListView.addHeaderView(mListViewHeader, null, true);
        ...
        if (mInsetSide > 0) {
            ...
            mListViewHeader.setPaddingRelative(mInsetSide, 0, mInsetSide, 0);
        }

        {
            // bind network switches
            mNetworkSwitchesContainer = (ViewGroup) mListViewHeader.findViewById(
                    R.id.network_switches_container);
            mNetworkSwitches = (LinearLayout) mListViewHeader.findViewById(R.id.network_switches);
            ...
            mCycleView = inflater.inflate(R.layout.data_usage_cycles_summary, mNetworkSwitches, false);
        ...
        mChart = (ChartDataUsageView) mListViewHeader.findViewById(R.id.chart);
        mChart.setListener(mChartListener);
        mChart.bindNetworkPolicy(null);

        {
            // bind app detail controls
            mAppDetail = mListViewHeader.findViewById(R.id.app_detail);
        ...
        mDisclaimer = mListViewHeader.findViewById(R.id.disclaimer);
        mEmpty = (TextView) mListViewHeader.findViewById(android.R.id.empty);
        mStupidPadding = mListViewHeader.findViewById(R.id.stupid_padding);
    ...
    private void showRequestedAppIfNeeded(View rootView) {
        ...
        try {
            ...
            AppHeader.createAppHeader(getActivity(), detail.icon, detail.label, null, uid, pinnedHeader);
    ...
    private void updateTabs() {
        ...
        int simCount = services.mTelephonyManager.getSimCount();

        List<SubscriptionInfo> sirs = services.mSubscriptionManager.getActiveSubscriptionInfoList();
    ...
    public void onResume() {
		...
		if (mSubInfoList != null) {
            for (SubscriptionInfo subInfo : mSubInfoList) {
               getActivity().getContentResolver().registerContentObserver(Settings.Global.getUriFor(Settings.Global.MOBILE_DATA+subInfo.getSubscriptionId()),false, mScreenOffTimeout);
            }
        }
        // updateState();
    ...
    public void onPause() {
		...
		getActivity().getContentResolver().unregisterContentObserver(mScreenOffTimeout);
    }
    ...
    private void createViewForOverviewTab(final Context context, final View view) {
		...
		mOverViewExpList.setDivider(context.getResources().getDrawable(R.drawable.prize_sleep_gesture_lines,null));
		mOverViewExpList.setDividerHeight(1);
    }
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        ...
        if (hasWifiRadio(mContext) && hasReadyMobileRadio(mContext)) {
        ...
        if (hasReadyMobileRadio(mContext) || hasWifiRadio(mContext)) {
    ...
    private void updateScreenEnableState() {
        ...
        if (mDataEnabled != null) {
             mDataEnabled.setEnabled(!mIsAirplaneModeOn && !isCapabilitySwitching
                && mDataUsageSummaryExt.isAllowDataEnable(getSubId(mCurrentTab)));
        }
    ...
    private static View inflatePreference(LayoutInflater inflater, ViewGroup root, View widget) {
    	/* Modify by zhudaopeng at 2016-12-06 Start */
    	// final View view = inflater.inflate(R.layout.preference, root, false);
        final View view = inflater.inflate(R.layout.date_usage_switcher_layout, root, false);
        /* Modify by zhudaopeng at 2016-12-06 End */
    ...
    public static class DataUsageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (getItemViewType(position) == 1) {
				...
				title.setBackgroundResource(R.color.settings_background);

            } else {
                if (convertView == null) {
                    convertView = inflater.inflate(R.layout.data_usage_item_summary, parent, false);
                    inflater.inflate(R.layout.widget_progress_bar_summary,
    ...
    public static class CycleEditorFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            final View view = dialogInflater.inflate(R.layout.data_usage_cycle_editor_cycleeditor, null, false);
    ...
    public static class WarningEditorFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            final View view = dialogInflater.inflate(R.layout.data_usage_bytes_editor_limiteditor, null, false);
    ...
    public static class ConfirmRestrictFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            /// M: for plug-in @{
            String title = getString(R.string.data_usage_restrict_background_title);
           ...
           /// @}
            if (Utils.hasMultipleUsers(context)) {
                ...
                String message = getString(R.string.data_usage_restrict_background);
                builder.setMessage(message);
                /// @}
            }
    ...
    public static class DeniedRestrictFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
             ...
             */
            String deniedRestrictBgDataTitle = getString(R.string.data_usage_app_restrict_background);
            String deniedRestrictBgDataMessage = getString(R.string.data_usage_restrict_denied_dialog);
    ...
    public static class ConfirmAppRestrictFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
             ...
             */
            String dialogTitle = getString(R.string.data_usage_app_restrict_dialog_title);
            String dialogMessage = getString(R.string.data_usage_app_restrict_dialog);
    ...
    public void setRestrictBackground(boolean restrictBackground) {
    	services.mPolicyManager.setRestrictBackground(restrictBackground);
        updateMenuTitles();
    }
    ...
    private boolean isMobileDataEnabled(int subId) {
        ...
        if (mMobileDataEnabled.get(String.valueOf(subId)) != null) {
            ...
            // SUB SELECT
            isEnable = services.mTelephonyManager.getDataEnabled(subId);
            if (LOGD) {
                Log.d(TAG, "isMobileDataEnabled: == null, subId=" + subId
                        + " isEnable=" + isEnable);
            }
    ...
    private void setMobileDataEnabled(int subId, boolean enabled) {
        ...
        services.mTelephonyManager.setDataEnabled(subId, enabled);
    ...
    private void updateBody() {
        ...
        */
            ...
            Log.d(TAG, "updateBody(), update overview tab~~");
             /* prize-add-by-lijimeng-for bugid 55343-20180420-start*/
            if(mPrizeDataSaver != null){
                mPrizeDataSaver.setVisibility(View.VISIBLE);
            }
             /* prize-add-by-lijimeng-for bugid 55343-20180420-end*/
            mListView.setVisibility(View.GONE);
            mOverViewExpList.setVisibility(View.VISIBLE);
            ...
            return;
             ...
             /* prize-add-by-lijimeng-for bugid 55343-20180420-start*/
            if(mPrizeDataSaver != null){
                mPrizeDataSaver.setVisibility(View.GONE);
            }
             /* prize-add-by-lijimeng-for bugid 55343-20180420-end*/
            if (SHOW_OVERVIEW_TAB) {
        ...
        if (policy != null) {
            ...
            try {
                totalBytes = services.mStatsService.getNetworkTotalBytes(policy.template, start, end);
    ...
    private void updateAppDetail() {
        ...
        if (UserHandle.isApp(uid) && !services.mPolicyManager.getRestrictBackground()
            ...
            */
            String appBgDataTitle = getString(R.string.data_usage_app_restrict_background);
            String appBgDataSummary = getString(R.string.data_usage_app_restrict_background_summary);
    ...
    private void handleMultiSimDataDialog() {
        ...
        final SubscriptionInfo nextSir = services.mSubscriptionManager.getDefaultDataSubscriptionInfo();
        ...
        builder.setPositiveButton(R.string.okay, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int id) {
                ...
                /// @}
                services.mSubscriptionManager.setDefaultDataSubId(currentSir.getSubscriptionId());
                setMobileDataEnabled(currentSir.getSubscriptionId(), true);
                disableDataForOtherSubscriptions(currentSir);
                updateBody();
            }
	...
	private ContentObserver mScreenOffTimeout = new ContentObserver(new Handler()) {
       @Override
		  ...
		  if (mSubInfoList != null) {
			for (SubscriptionInfo subInfo : mSubInfoList) {
				if(subInfo.getSubscriptionId() == SubscriptionManager.getDefaultDataSubscriptionId()){
					...
					mMobileDataEnabled.put(String.valueOf(subInfo.getSubscriptionId()), enabled);
					Log.d(TAG, "enabled: " + enabled+ "defaultDataSubId:" + subInfo.getSubscriptionId());
				}else{
					Log.d(TAG, "subInfo.getSubscriptionId() == "+subInfo.getSubscriptionId());
					mMobileDataEnabled.put(String.valueOf(subInfo.getSubscriptionId()), false);
				}
            }
			updatePolicy(false);
        }
