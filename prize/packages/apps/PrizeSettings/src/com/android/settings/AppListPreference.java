...
public class AppListPreference extends CustomListPreference {
    ...
    public class AppArrayAdapter extends ArrayAdapter<CharSequence> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            /// M: Setting different view for the plugin OP03 @{
            if (mExt == null) {
                mExt = UtilsExt.getAppListPlugin(getContext());
            }
            return mExt.addLayoutAppView(view, textView,
                (TextView) view.findViewById(R.id.default_label),
                position, mImageDrawables[position], parent);
            /// @}
    ...
    public void setPackageNames(CharSequence[] packageNames, CharSequence defaultPackageName,
        ...
        for (int i = 0; i < packageNames.length; i++) {
            try {
                ...
                mExt.setAppListItem(appInfo.packageName, i);
                /// @}
