...
public class SwitchBar extends LinearLayout implements CompoundButton.OnCheckedChangeListener,
    ...
    public SwitchBar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        // prize-modify_switch_bar_style-huangdianjun-20150529-start
        // lp.setMarginStart(switchBarMarginStart);
        // prize-modify_switch_bar_style-huangdianjun-20150529-end
    ...
    SwitchBarListener mSwitchBarListener;
    
    public interface SwitchBarListener {
        public void setBottomLineVisibility(int visibility);
    }
    
    public void addListener(SwitchBarListener listener){
    	mSwitchBarListener = listener;
    }
    ...
    //prize tangzhengrong 20180511 Swipe-up Gesture Navigation bar start
	public void setDiableAndGray(){
		super.setEnabled(false);
        mTextView.setEnabled(false);
        mSwitch.setEnabled(false);
        //set gray 
		mTextView.setTextColor(0xFFC8C8C8);
		//mSwitch.setThumbResource(R.drawable.switch_thumb_gray);
		mSwitch.setTrackResource(R.drawable.switch_track_gray);
	}
    //prize tangzhengrong 20180511 Swipe-up Gesture Navigation bar end
    /**
    ...
    public void show() {
        if (!isShowing()) {
        	if(mSwitchBarListener!=null){
        		mSwitchBarListener.setBottomLineVisibility(View.VISIBLE);
        	}
    ...
    public void hide() {
        if (isShowing()) {
        	if(mSwitchBarListener!=null){
        		mSwitchBarListener.setBottomLineVisibility(View.GONE);
        	}
            setVisibility(View.GONE);
