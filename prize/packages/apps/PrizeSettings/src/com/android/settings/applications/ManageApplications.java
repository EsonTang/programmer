...
public class ManageApplications extends InstrumentedFragment
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		/* prize-add-by-lijimeng-for 41330-20171107-start*/
		getActivity().setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
		prizeInitDimens(getContext());
		/* prize-add-by-lijimeng-for 41330-20171107-end*/
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mListContainer != null) {
			...
			// NestedScrollView mNestedScrollView = (NestedScrollView) mRootView.findViewById(R.id.prize_nestedScrollView);
           ...
           // mListView.setFastScrollEnabled(isFastScrollEnabled());
			...
			// mListView.setDivider(getResources().getDrawable(R.drawable.prize_sleep_gesture_lines,null));
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.reset_app_preferences:
                /* prize-add-by-lijimeng-for bugid 53169-20480330-start*/
                if(Utils.isMonkeyRunning()){
                    return true;
                }
                /* prize-add-by-lijimeng-for bugid 53169-20480330-end*/
    ...
    static class ApplicationsAdapter extends BaseAdapter implements Filterable,
        ...
        public void rebuild(boolean eraseold) {
			/* prize-add-by-lijimeng-for bugid 44420-20171205-start */
			if(Utils.isMonkeyRunning()){
				Log.d(TAG, "isMonkeyRunning");
				return;
			}
			/* prize-add-by-lijimeng-for bugid 44420-20171205-end */
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
			...
			if(getCount() > 1){
				if(position == 0){
					...
					convertView.setPadding(left,top,right,0);
					convertView.setBackgroundResource(R.drawable.list_preferencecategory_selector);
				}else if(position == getCount()-1){
					holder.dividerLines.setVisibility(View.GONE);
					convertView.setPadding(left,0,right,bottom);
					convertView.setBackgroundResource(R.drawable.list_topmorepreferencecategory_selector);
				}else{
					holder.dividerLines.setVisibility(View.VISIBLE);
					convertView.setPadding(left,0,right,0);
					convertView.setBackgroundResource(R.drawable.npreferencecategory_selector);
				}
			}else{
				holder.dividerLines.setVisibility(View.GONE);
				convertView.setPadding(left,top,right,0);
				convertView.setBackgroundResource(R.drawable.list_toponelistpreferencecategory_selector);
			}
			/* prize-add-by-lijimeng-20171219-end*/
