...
public class NotificationBackend {
	...
	/* prize-add-by-lijimeng-20180203-start*/
    private static String [] enable_settings_notification_app = {"com.prize.prizethemecenter","com.prize.compass","com.koobee.koobeecenter02","com.android.fmradio"};
    /* prize-add-by-lijimeng-20180203-end*/
    ...
    public AppRow loadAppRow(Context context, PackageManager pm, PackageInfo app) {
        ...
        /* prize-add-by-lijimeng-20180203-start*/
        for(int i= 0; i < enable_settings_notification_app.length; i++){
            if(app != null && app.packageName.equals(enable_settings_notification_app[i])){
                row.cantBlock = false;
            }
        }
        /* prize-add-by-lijimeng-20180203-end*/
