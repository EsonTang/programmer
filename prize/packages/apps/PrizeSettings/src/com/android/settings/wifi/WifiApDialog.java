...
/* prize-add-by-lijimeng-for bugid 43606-start*/
import android.widget.Toast;
/* prize-add-by-lijimeng-for bugid 43606-end*/
...
public class WifiApDialog extends AlertDialog implements View.OnClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChannel.setOnItemSelectedListener(
                new AdapterView.OnItemSelectedListener() {
                    ...
                    public void onItemSelected(AdapterView<?> adapterView, View view, int position,
                                               long id) {
                        if (!mInit) {
                            mExt.setApChannel(position , (mBandIndex != position));
                            mBandIndex = position;
        ...
        mExt.customizeView(context, mView, mWifiConfig);
    ...
    private void validate() {
        ...
        if ((mSsid != null && mSsid.length() == 0)
			...
			/* prize-add-by-lijimeng-for bugid 43606-start*/
			if(Charset.forName("UTF-8").encode(mSsidString).limit() > 32 && isToast){
				mToast = Toast.makeText(mContext,mContext.getString(R.string.wifi_ap_name_prompt),Toast.LENGTH_SHORT);
				mToast.show();
				isToast = false;
			}
			/* prize-add-by-lijimeng-for bugid 43606-end*/
