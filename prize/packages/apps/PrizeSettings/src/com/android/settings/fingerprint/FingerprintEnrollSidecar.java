...
public class FingerprintEnrollSidecar extends InstrumentedFragment {
    ...
    private void startEnrollment() {
        ...
        Log.d("FingerprintEnrollSidecar", "startEnrollment: mToken: " + mToken+",mUserId:"+mUserId);
    ...
    private FingerprintManager.EnrollmentCallback mEnrollmentCallback
        ...
        public void onEnrollmentProgress(int remaining) {
            Log.d("FingerprintEnrollSidecar","mEnrollmentCallback onEnrollmentProgress:"+remaining);
        ...
        public void onEnrollmentHelp(int helpMsgId, CharSequence helpString) {
            Log.d("FingerprintEnrollSidecar","mEnrollmentCallback onEnrollmentHelp:"+helpString);
            if (mListener != null) {
        ...
        public void onEnrollmentError(int errMsgId, CharSequence errString) {
            Log.d("FingerprintEnrollSidecar","mEnrollmentCallback onEnrollmentError:"+errString);
            if (mListener != null) {
