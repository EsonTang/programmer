...
public class AppDataUsage extends DataUsageBase implements Preference.OnPreferenceChangeListener,
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (mAppItem.key > 0) {
            ...
            /// M: Remove these two preferences if the Uid is not in app range,
            ///    ohterwise JE will happen when apply network policy
            ...
            } else if (mAppItem.key == TrafficStats.UID_VILTE) { /// M: ViLTE data usage
                mLabel = getContext().getString(R.string.vilte_data_usage_title);
            } else {
