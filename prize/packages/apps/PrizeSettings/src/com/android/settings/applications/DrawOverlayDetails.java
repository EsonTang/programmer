...
/*-prize-add by lihuangyuan,for floatwindow-2018-01-10-start*/
import android.view.WindowManager;
import android.content.Context;
/*-prize-add by lihuangyuan,for floatwindow-2018-01-10-end*/
public class DrawOverlayDetails extends AppInfoWithHeader implements OnPreferenceChangeListener,
	...
	wm.setFloatEnable(mPackageName, newState);
      /*-prize-add by lihuangyuan,for floatwindow-2018-01-10-end*/
    }
    ...
    protected boolean refreshUi() {
        ...
        if(isAllowed && mPackageInfo.applicationInfo.isSystemApp())
        {
