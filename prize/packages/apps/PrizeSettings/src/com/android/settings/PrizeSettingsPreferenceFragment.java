 ...
 */
public abstract class PrizeSettingsPreferenceFragment extends InstrumentedPreferenceFragment
    ...
    public static class SettingsDialogFragment extends DialogFragment {
        ...
        public void onStart() {
            ...
            if (mParentFragment != null && mParentFragment instanceof PrizeSettingsPreferenceFragment) {
                ((PrizeSettingsPreferenceFragment) mParentFragment).onDialogShowing();
            }
        }
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            if (savedInstanceState != null) {
                ...
                if (mParentFragment instanceof PrizeSettingsPreferenceFragment) {
                    // restore mDialogFragment in mParentFragment
                    ((PrizeSettingsPreferenceFragment) mParentFragment).mDialogFragment = this;
                }
            }
        ...
        public void onDetach() {
            ...
            if (mParentFragment instanceof PrizeSettingsPreferenceFragment) {
                ...
                if (((PrizeSettingsPreferenceFragment) mParentFragment).mDialogFragment == this) {
                    ((PrizeSettingsPreferenceFragment) mParentFragment).mDialogFragment = null;
                }
            }
        }
    }
