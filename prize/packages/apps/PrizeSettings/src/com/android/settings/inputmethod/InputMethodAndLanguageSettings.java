...
public class InputMethodAndLanguageSettings extends SettingsPreferenceFragment
    ...
    public void onResume() {
		...
		/* prize-add-by-lijimeng-for 39874-20171010-start*/
		if(getActivity() != null){
			getActivity().setTitle(getActivity().getResources().getString(R.string.language_settings));
		}
		/* prize-add-by-lijimeng-for 39874-20171010-end*/
    }
    ...
    private static String getLocaleNames(Context context) {
		...
		/* prize-add-by-lijimeng-20171227-start*/
		String defName = LocaleHelper.toSentenceCase(LocaleHelper.getDisplayLocaleList(locales, displayLocale, 2 /* Show up to two locales from the list */),displayLocale);
		if((context.getResources().getString(R.string.prize_def_language_summary).trim()).equals(defName)){
			return context.getResources().getString(R.string.prize_language_summary);
		}
		/* prize-add-by-lijimeng-20171227-start*/
    ...
    public static final Indexable.SearchIndexProvider SEARCH_INDEX_DATA_PROVIDER =
        ...
        public List<SearchIndexableRaw> getRawDataToIndex(Context context, boolean enabled) {
            ...
            if (!ttsEngines.getEngines().isEmpty()) {
                ...
                indexable.screenTitle = screenTitle;
                /* prize-modify-by-lijimeng-for bugid 52090-20180308-start*/
               // indexable.keywords = context.getString(R.string.keywords_text_to_speech_output);
                 /* prize-modify-by-lijimeng-for bugid 52090-20180308-end*/
                indexables.add(indexable);
            }
