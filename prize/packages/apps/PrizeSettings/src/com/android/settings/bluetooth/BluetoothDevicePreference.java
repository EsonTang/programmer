...
public final class BluetoothDevicePreference extends Preference implements
    ...
    private void pair() {
        if (!mCachedDevice.startPairing()) {
            ...
            data.iconResId = R.drawable.ic_settings_bluetooth_prize_v8;
            data.enabled = true;
    ...
    private Pair<Integer, String> getBtClassDrawableWithDescription() {
		...
		/* prize-modify-by-lijimeng-for bugid 40877-20171028-start*/
        //return new Pair<Integer, String>(R.drawable.ic_settings_bluetooth_prize_v8, BLUETOOTH);
        return new Pair<Integer, String>(R.drawable.ic_bt_cellphone, BLUETOOTH);
		/* prize-modify-by-lijimeng-for bugid 40877-20171028-end*/
    }
}
