...
public class SearchViewStyle {
	...
	public SearchViewStyle setTextSize(final float size) {
        final AutoCompleteTextView editText = getView(SEARCH_SRC_TEXT);
        if (editText != null) {
	...
	public SearchViewStyle setHintTextSize(final int size,String hint) {
        final AutoCompleteTextView editText = getView(SEARCH_SRC_TEXT);
        if (editText != null) {
...
//			s.setSpan(textSize, 0, s.length(), Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    /* prize-add-by-lijimeng-20180117-start*/
    public SearchViewStyle setSearchEidtFramePadding(int dimenRight){
        LinearLayout mLinearLayout = getView(SEARCH_EDIT_FRAME);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        if(mLinearLayout != null){
            layoutParams.setMargins(0, 0, dimenRight, 0);
    ...
    public SearchViewStyle resetColseImagePadding() {
        final ImageView imageView = getView(SEARCH_CLOSE_BTN);
        if (imageView != null) {
    ...
    public SearchViewStyle resetTextPadding() {
        final View editText = getView(SEARCH_SRC_TEXT);
        if (editText != null) {
            editText.setPadding(0,0,0,0);
        }
        return this;
    }
    /* prize-add-by-lijimeng-20180117-end*/
