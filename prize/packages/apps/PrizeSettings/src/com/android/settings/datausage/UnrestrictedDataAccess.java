...
public class UnrestrictedDataAccess extends SettingsPreferenceFragment
    ...
    public void onRebuildComplete(ArrayList<AppEntry> apps) {
		...
		/* prize-modify-by-lijimeng-for bugid 39807-20171011-start*/
      ...
      // setLoading(false, true);
		...
		/* prize-modify-by-lijimeng-for bugid 39807-20171011-end*/
    }
    ...
    private class AccessPreference extends SwitchPreference implements DataSaverBackend.Listener {
        ...
        private DataUsageState mState;

        public AccessPreference(final Context context, AppEntry entry) {
            super(context);
            mEntry = entry;
			/* prize-modify-by-lijimeng-for monkey ClassCastException-20171014-start*/
			if(mEntry != null && mEntry.extraInfo instanceof DataUsageState){
				 mState = (DataUsageState) mEntry.extraInfo;
			}
			/* prize-modify-by-lijimeng-for monkey ClassCastException-20171014-end*/
