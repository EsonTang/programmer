...
public class SettingPref {
    ...
    public Preference init(SettingsPreferenceFragment settings) {
		...
		/* prize-modify-by-lijimeng-for bugid 46933-20171228-start*/
		if("charging_sounds".equals(mKey) || "emergency_tone".equals(mKey)){
			settings.getPreferenceScreen().removePreference(p);
			return null;
		}
		/* prize-modify-by-lijimeng-for bugid 46933-20171228-end*/
