...
public abstract class FingerprintEnrollBase extends InstrumentedActivity
    ...
    static final int RESULT_FINISHED = PrizeFingerRelevantSettings.RESULT_FINISHED;
    static final int RESULT_SKIP = PrizeFingerRelevantSettings.RESULT_SKIP;
    static final int RESULT_TIMEOUT = PrizeFingerRelevantSettings.RESULT_TIMEOUT;
    ...
    protected Intent getEnrollingIntent() {
        ...
        intent.setClassName("com.android.settings", PrizeFingerprintEnrollEnrolling.class.getName());
