...
public class PrizeSystemUpdateSuccess extends BroadcastReceiver{
	...
	public void onReceive(Context context, Intent intent) {
		if(intent.getAction().equals("com.fota.custom_update_result")){
			Log.d("PrizeSystemUpdateSuccess","com.fota.custom_update_result");
			sendUnread(context,new ComponentName("com.android.settings", "com.android.settings.Settings"),0,Settings.System.PRIZE_SYSTEM_UPDATE_CHANGE);
		}
	}
