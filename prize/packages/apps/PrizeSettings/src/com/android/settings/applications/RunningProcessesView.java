...
/// M: To obtain Mapped/Buffer memory size@{
        ...
        */
        ...
        synchronized (mState.mLock) {
            ...
            if (!isDefaultCacheFree) {
                ...
                if (anonToCompress > 0) {
                    extraAvailableSize =
                        (long) (anonToCompress * (1.0f - 1.0f / zramCompressRatio));
                }
                else {
                ...
                if (extraAvailableSize > 0) {
                    extraAvailableSize = extraAvailableSize
                                        + mMemInfoReader.getRawInfo()[Debug.MEMINFO_MAPPED] * 1024
                                        - mMemInfoReader.getRawInfo()[Debug.MEMINFO_BUFFERS] * 1024
                                        - FOREGROUND_APP_MEM;
                }
            }
