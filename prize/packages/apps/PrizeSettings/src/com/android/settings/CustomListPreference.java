...
public class CustomListPreference extends ListPreference {
    ...
    public static class CustomListPreferenceDialogFragment extends ListPreferenceDialogFragment {
        ...
        private String getValue() {
			...
			/* prize-modify-by-lijimeng- for bugid 56905 (preference.getEntryValues().length - 1) >= mClickedDialogEntryIndex-20180502-start*/
            if (mClickedDialogEntryIndex >= 0 && preference.getEntryValues() != null && (preference.getEntryValues().length - 1) >= mClickedDialogEntryIndex) {
                return preference.getEntryValues()[mClickedDialogEntryIndex].toString();
            } else {
                return null;
            }
			/* prize-modify-by-lijimeng- for bugid 56905 (preference.getEntryValues().length - 1) >= mClickedDialogEntryIndex-20180502-end*/
        }
