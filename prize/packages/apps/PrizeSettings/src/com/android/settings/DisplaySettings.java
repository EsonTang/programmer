...
public class DisplaySettings extends SettingsPreferenceFragment implements
    ...
    /* PRIZE-Add for BluLight-zhudaopeng-2017-05-04-Start */
    private static final String KEY_BLUE_LIGHT = "prize_blulight_mode_state";
    /* PRIZE-Add for BluLight-zhudaopeng-2017-05-04-End */
    ...
    /* PRIZE-Add for BluLight-zhudaopeng-2017-05-04-Start */
    private PrizeBluLightPreference mBluLightPreference;
    /* PRIZE-Add for BluLight-zhudaopeng-2017-05-04-Start */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /* PRIZE-Add for BluLight-zhudaopeng-2017-05-04-Start */
        mBluLightPreference = (PrizeBluLightPreference) findPreference(KEY_BLUE_LIGHT);
        //mBluLightPreference.setOnPreferenceClickListener(this);
        /* PRIZE-Add for BluLight-zhudaopeng-2017-05-04-End */
        /* PRIZE-Add for BluLight-zhudaopeng-2017-05-04-Start */
        if(!PrizeOption.PRIZE_HUYANMODE) {
            removePreference(KEY_BLUE_LIGHT);
        }	 
        /* PRIZE-Add for BluLight-zhudaopeng-2017-05-04-End */
    ...
    private void updateTimeoutPreferenceDescription(long currentTimeout) {
        ...
        if (preference.isDisabledByAdmin()) {
            ...
            if (entries == null || entries.length == 0) {
				...
				/* prize-modify-Add permanent value-lijimeng-20170421-start*/
			   if(currentTimeout >= Long.parseLong(values[values.length-1].toString())){
				   summary = (String) entries[values.length-1];
			   }
			   /* prize-modify-Add permanent value-lijimeng-20170421-end*/
            }
        }
    ...
    public void onPause() {
		...
		getActivity().getContentResolver().unregisterContentObserver(mAutoBrightnessMode);
    ...
    private void updateFontSizeSummary() {
        ...
        final String[] entries = mDisplaySettingsExt
                .getFontEntries(res.getStringArray(R.array.custom_entries_font_size));
        final String[] strEntryValues = mDisplaySettingsExt
                .getFontEntryValues(res.getStringArray(R.array.custom_entryvalues_font_size));
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if(preference == mBluLightPreference){
            Intent intent = new Intent();
            intent.setAction("android.intent.action.PRIZE_BLULIGHT");
	...
	private ContentObserver mAutoBrightnessMode = new ContentObserver(new Handler()) {
       @Override
       public void onChange(boolean selfChange) {
           final int enabled = Settings.System.getInt(getActivity().getContentResolver(),Settings.System.SCREEN_BRIGHTNESS_MODE, 0);
		   mAutoBrightnessPreference.setChecked(enabled == SCREEN_BRIGHTNESS_MODE_AUTOMATIC);
       }
    };
	private ContentObserver mScreenOffTimeout = new ContentObserver(new Handler()) {
       @Override
       public void onChange(boolean selfChange) {
           final int enabled = Settings.System.getInt(getActivity().getContentResolver(),Settings.System.SCREEN_OFF_TIMEOUT, 0);
		   updateTimeoutPreferenceDescription(enabled);
		   if(mScreenTimeoutPreference != null){
			   mScreenTimeoutPreference.setValue(String.valueOf(enabled));
		   }
       }
    };
}
