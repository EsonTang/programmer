...
public class DevelopmentSettings extends RestrictedSettingsFragment
    ...
    private static final String PRIZE_DEVDELOPMENT_PREFERENCE = "prize_development_preference";
    ...
    public void onCreate(Bundle icicle) {
		...
		mSwitchBar = (SwitchPreference)findPreference(PRIZE_DEVDELOPMENT_PREFERENCE);
    ...
    private void setPrefsEnabledState(boolean enabled) {
        for (int i = 0; i < mAllPrefs.size(); i++) {
			...
			if(PRIZE_DEVDELOPMENT_PREFERENCE.equals(pref.getKey())){
				android.util.Log.d("jiumozhi","jiumozhi");
				continue;
			}
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
		if(PRIZE_DEVDELOPMENT_PREFERENCE.equals(preference.getKey())){
