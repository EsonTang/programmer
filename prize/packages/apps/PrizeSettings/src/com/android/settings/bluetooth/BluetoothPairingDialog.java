...
public final class BluetoothPairingDialog extends AlertActivity implements
        ...
        switch (mType) {
            ...
            case BluetoothDevice.PAIRING_VARIANT_DISPLAY_PIN:
                ...
                if (mType == BluetoothDevice.PAIRING_VARIANT_DISPLAY_PASSKEY) {
                    /// M: Use Locale.US to format key code to avoid RTL language format error
                    mPairingKey = String.format(Locale.US, "%06d", pairingKey);
                } else {
                    /// M: Use Locale.US to format key code to avoid RTL language format error
                    mPairingKey = String.format(Locale.US, "%04d", pairingKey);
                }
    ...
    private View createView() {
        ...
        RadioButton contactSharing = (RadioButton) view.findViewById(
    ...
    protected void onDestroy() {
        super.onDestroy();
        /// M: unnecessary to unregister in case of invalid Confirmation Passkey or PIN @{
