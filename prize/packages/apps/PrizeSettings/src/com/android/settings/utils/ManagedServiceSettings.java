...
public abstract class ManagedServiceSettings extends EmptyTextSettings {
	/* prize-modify-by-lijimeng-for bugid 40831-20171018-start*/
   // private final Config mConfig;
    private static Config mConfig;
	/* prize-modify-by-lijimeng-for bugid 40831-20171018-end*/
    ...
    private void updateList(List<ServiceInfo> services) {
        ...
        for (ServiceInfo service : services) {
			...
			/* prize-modify-by-lijimeng-for remove lpserver-20171208-start*/
			if("com.android.lpserver".equals(cn.getPackageName())){
				continue;
			}
			/* prize-modify-by-lijimeng-for remove lpserver-20171208-end*/
