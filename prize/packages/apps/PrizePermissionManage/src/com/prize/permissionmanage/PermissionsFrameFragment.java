...
public abstract class PermissionsFrameFragment extends PreferenceFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        NestedScrollView mNestedScrollView = (NestedScrollView) view.findViewById(R.id.prize_nestedScrollView);
        mNestedScrollView.setNestedScrollingEnabled(false);
        ListView listView = getListView();
        if(listView != null){
            listView.setDivider(getContext().getResources().getDrawable(R.drawable.list_divider, null));
