...
public class ContinuousShot extends CameraAddition implements ContinuousShotListener {
    ...
    /*prize-xuchunming-20180507-bugid:58336-start*/
    private ISettingRule mFlashRule;
    /*prize-xuchunming-20180507-bugid:58336-end*/
    
    private String[] mFeatureKey = { null, SettingConstants.KEY_SMILE_SHOT,
            SettingConstants.KEY_GESTURE_SHOT, SettingConstants.KEY_HDR, SettingConstants.KEY_ASD, SettingConstants.KEY_WATERMARK };
    private int[] mFeatureResId = { R.string.normal_camera_continuous_not_supported,
            ...
            R.string.pref_camera_capturemode_entry_asd, R.string.prize_accessibility_switch_to_watermark };
    ...
    public boolean isSupport() {
       ...
       if(mICameraDeviceManager.getCurrentCameraId()!=0){
			return false;
		      }
    ...
    private void startContinuousShot() {
        ...
        if (mICameraContext.getFeatureConfig().isLowRamOptSupport()) {
        	...
        	if(mISettingCtrl.getSettingValue(SettingConstants.KEY_CONTINUOUS_NUMBER) == null){
        		mMaxCaptureNum = Integer.valueOf(mActivity.getString(R.string.pref_camera_continuous_number_default)); 
        	}else{
    ...
    private void stopContinuousShot(boolean isPreviewStopped) {
    	if(getCurrentState() == State.STATE_CAPTURING) {
    		...
    		resetoreSettingRule();
        	((CameraActivity)mActivity).notifyContinueShot(false);
        	/*prize-xuchunming-20180508-bugid:54875-end*/
    	}
    	
        State state = getCurrentState();
        Log.i(TAG, "[stopContinuousShot]state = " + state, new Throwable());
    ...
    private boolean takePicture() {
        ...
        /*prize-xuchunming-20180508-bugid:54875-start*/
        deleteSettingRule();
        ((CameraActivity)mActivity).notifyContinueShot(true);
        /*prize-xuchunming-20180508-bugid:54875-end*/
    ...
    private final ShutterCallback mShutterCallback = new ShutterCallback() {
        public void onShutter() {
            ...
            if (getCurrentState() == State.STATE_CAPTURING) {
                ...
                /*prize Continuous shooting mute wanzhijuan 2016-5-30 start*/
                if (isCameraUnMute()) {
                	mCaptureSound.play();
                }
                /*prize Continuous shooting mute wanzhijuan 2016-5-30 end*/
    ...
    private void showSpeedIndicator() {
        ...
        mICameraView.update(0, String.valueOf(mCurrentShotsNum));
    ...
    boolean showContinuousNonsupportInfo(String featureKey, int resId) {
        ...
        if (featureKey == null) {
            if (mIModuleCtrl.isImageCaptureIntent() || !isSupport()) {
                ...
                mICameraAppUi.showInfo(info,3 * 1000,(int)mActivity.getResources().getDimension(R.dimen.info_bottom));
