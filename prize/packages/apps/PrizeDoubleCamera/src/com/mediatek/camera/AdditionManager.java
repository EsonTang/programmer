...
public class AdditionManager {
    ...
    private Vector<ICameraAddition> mWaterMarkAddition = new Vector<ICameraAddition>();
    private Vector<ICameraAddition> mDummyAddtion = new Vector<ICameraAddition>();
    private Vector<ICameraAddition> mGangyunBeautyAddition = new Vector<ICameraAddition>(); //gangyun tech add 
    private Vector<ICameraAddition> mGangyunBokehAddition = new Vector<ICameraAddition>(); //gangyun tech add 
    private Vector<ICameraAddition> mModeAddition;
    /*arc add start*/
    private Vector<ICameraAddition> mPictureZoomAddition = new Vector<ICameraAddition>(); 
    private Vector<ICameraAddition> mLowlightShootAddition = new Vector<ICameraAddition>(); 
    /*arc add end*/
    ...
    public AdditionManager(ICameraContext cameraContext) {
        ...
        mGangyunBeautyAddition.add(mGestureShot); //gangyun tech add 
        mGangyunBokehAddition.add(mGestureShot);//gangyun tech add
        ...
        mWaterMarkAddition.add(mIContinuousShotAddition);
        /*arc add start*/
        mPictureZoomAddition.add(mGestureShot);
        mLowlightShootAddition.add(mGestureShot);
        /*arc add end*/
    }
    ...
    public void setCurrentMode(CameraModeType type) {
        ...
        case EXT_MODE_WATERMARK:
            mModeAddition = mWaterMarkAddition;
            break;
		...
		case EXT_MODE_GY_BEAUTY:
	            mModeAddition = mGangyunBeautyAddition;
	            break;
		...
		case EXT_MODE_PICTURE_ZOOM:
            mModeAddition = mPictureZoomAddition;
            break;
		case EXT_MODE_LOWLIGHT_SHOOT:
            mModeAddition = mLowlightShootAddition;
            break;
        /*arc add end*/
        default:
            mModeAddition = mDummyAddtion;
    ...
    public void onEffectClose() {
    	if (mIEffect != null) {
            mIEffect.execute(AdditionActionType.ACTION_EFFECT_CLOSE);
        }
    }
