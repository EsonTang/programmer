...
public interface ICameraAppUi {
    ...
    public enum ViewState {
		...
		VIEW_STATE_SHOW_WATERMARK_MOREVIEW,
		VIEW_STATE_SHOW_BLUR,
		VIEW_STATE_PANORAMA_CAPTURE,
		VIEW_STATE_MVFOCUSING,
    }
    ...
    public void showInfo(final CharSequence text, int showMs, int topMargin);
