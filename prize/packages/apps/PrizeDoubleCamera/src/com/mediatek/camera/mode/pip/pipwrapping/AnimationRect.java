...
public class AnimationRect {
    ...
    public void scaleTranslate(float scale, float dx, float dy) {
    	mAnimationMatrix.reset();
    	mAnimationMatrix.setScale(scale, scale);
//		mAnimationMatrix.postTranslate(dx, dy);
		mAnimationMatrix.mapRect(mRectF);
		setVetex(mRectF.left, mRectF.top, mRectF.right, mRectF.bottom);
    }
...
//        rotate(rotationRotate);
	...
	public String toString() {
		return "AnimationRect [mCurrentScaleValue=" + mCurrentScaleValue
				+ ", mAnimationMatrix=" + mAnimationMatrix
				+ ", mOriginalDistance=" + mOriginalDistance + ", mRectF="
				+ mRectF + ", mPreviewWidth=" + mPreviewWidth
				+ ", mPreviewHeight=" + mPreviewHeight
				+ ", mCurrentRotationValue=" + mCurrentRotationValue
				+ ", leftTop=" + Arrays.toString(leftTop) + ", rightTop="
				+ Arrays.toString(rightTop) + ", leftBottom="
				+ Arrays.toString(leftBottom) + ", rightBottom="
				+ Arrays.toString(rightBottom) + ", mIsHighlightEnable="
				+ mIsHighlightEnable + "]";
	}
}
