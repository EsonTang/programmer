...
import com.mediatek.camera.mode.watermark.WaterMarkModeView;
...
public class EffectAddition extends CameraAddition {
    ...
    private static final int MSG_ON_CAMERA_OPEN_DONE = 9;
...
//                isShowing = true;
//            }
            /*prize-xuchunming-20171227-bugid:46820-start*/
            //mMainHandler.sendMessage(msg);
            /*prize-xuchunming-20171227-bugid:46820-end*/
            return isShowing;
        ...
        case ACTION_SHOW_INFO:
        	((EffectView)mICameraView).hideCloseTv();
            break;
        case ACTION_HIDE_INFO:
        	((EffectView)mICameraView).showCloseTv();
            break;
        case ACTION_ON_CAMERA_OPEN_DONE:
        	mMainHandler.sendEmptyMessage(MSG_ON_CAMERA_OPEN_DONE);
        	break;
        default:
            break;
        }
    ...
    private class EffectViewListener implements EffectView.Listener {
        ...
        public void onItemClick(String value) {
        	...
        	if(mICameraDevice != null){
        		parameter = mICameraDevice.getParameters();
        	}
...
//            mEffectAddition.hideEffect(true, DELAY_MSG_REMOVE_GRID_MS);
    ...
    private void refreshEffect() {
    	...
    	mICameraView.update(EffectView.ON_CAMERA_OPEN_DONE, mEffectPreference, mirror);
    }
...
//            resetParameters(mICameraDevice);
    ...
    private void closeEffect(boolean animation, int animationTime) {
        Log.i(TAG, "[hideEffect], mShowEffects:" + mShowEffects);
        if (mShowEffects) {
            mShowEffects = false;
            mICameraAppUi.setSwipeEnabled(true);
            mICameraView.update(EffectView.CLOSE_EFFECT, animation, animationTime);
            revertSmileShotAndGetureShot();
        }
    }
