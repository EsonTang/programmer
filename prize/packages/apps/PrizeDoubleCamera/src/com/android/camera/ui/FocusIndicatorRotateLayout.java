...
public class FocusIndicatorRotateLayout extends RotateLayout implements FocusIndicator {
    ...
    private static final int SCALING_DOWN_TIME = 1;
    private static final int DISAPPEAR_TIMEOUT = 1;
    ...
    public void showStart() {
        ...
        if (mState == STATE_IDLE) {
            ...
            animate().withLayer().setDuration(SCALING_UP_TIME).rotation(120);
    ...
    private class Disappear implements Runnable {
        ...
        public void run() {
            ...
            animate().withLayer().setDuration(SCALING_DOWN_TIME).rotation(0);
