...
public class ReviewManager extends ViewManager implements View.OnClickListener {
    ...
    protected View getView() {
        ...
        /*prize-xuchunming-20160808-bugid:19473-start*/
        return adapter43display(view);
        /*prize-xuchunming-20160808-bugid:19473-end*/
    }
    ...
    /*prize-xuchunming-20160808-bugid:19473-start*/
    public View adapter43display(View view){
        FrameLayout.LayoutParams p = (FrameLayout.LayoutParams)view.getLayoutParams();
        if(getContext().getPreviewSurfaceView() != null){
              FrameLayout.LayoutParams mSurfaceview = (FrameLayout.LayoutParams)getContext().getPreviewSurfaceView().getLayoutParams();
              p.bottomMargin = mSurfaceview.bottomMargin;
              p.topMargin = -mSurfaceview.bottomMargin;
