...
public class OrientationManagerImpl implements OrientationManager {
    ...
    public void lockOrientation() {
        Log.i(TAG,"lockOrientation,mOrientationLocked: "+mOrientationLocked+",mRotationLockedSetting: "+mRotationLockedSetting+",ApiHelper.HAS_ORIENTATION_LOCK: "+ApiHelper.HAS_ORIENTATION_LOCK);
