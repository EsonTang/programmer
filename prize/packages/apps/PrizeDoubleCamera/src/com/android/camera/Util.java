...
public class Util {
    ...
    public static final double ASPECT_TOLERANCE_16_9 = 0.5;
    ...
    public static void openCamera(Activity activity, boolean isPIP, int cameraId)
        ...
        // A bad workaround for VT, when video call is enabled
        // do not allow camera app to open camera.
       /* TelecomManager telecomManager = (TelecomManager)
                activity.getSystemService(Context.TELECOM_SERVICE);
        if (telecomManager != null && telecomManager.isInVideoCall()) {
    ...
    public static boolean isWfdEnabled(Context mContext) {
        ...
        Log.d(TAG, "isWfdEnabled() mWfdStatus=" + mWfdStatus + ",activityDisplayState:"+activityDisplayState+", return "
                + mWfdEnabled);
        return mWfdEnabled;
    }
