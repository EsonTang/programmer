...
public class FeatureSwitcher {
    ...
    public static boolean isRearCameraSubAls() {
    	return android.os.SystemProperties.get("ro.prize_rear_camera_sub_als").equals("1");
    }
    
    public static boolean isRearCameraSub() {
    	return android.os.SystemProperties.get("ro.prize_rear_camera_sub").equals("1");
    }
    //added by tangan-begin-for yuv sub camera
    public static boolean isYuvRearCameraSub() {
    		return android.os.SystemProperties.get("ro.prize_rear_camera_sub_yuv").equals("1");
    }
    
  //added by tangan-end-for yuv sub camera
    public static boolean isOpenDoubleCamera() {
    	return android.os.SystemProperties.getBoolean("ro.prize_open_double_camera", false);
    }

    public static boolean isGangyunBokehEnable(){
    	return android.os.SystemProperties.getBoolean("ro.prize_gangyun_bokeh", false);
    }
    ...
    public static boolean isVfbEnable() {
        boolean enable = true;//= SystemProperties.getInt("ro.mtk_cam_vfb", 0) == 1 ? true : false;
    ...
    public static boolean isGyBeautySupported() {
         boolean enable = SystemProperties.getInt("ro.gangyun_camera_beauty", 0) == 1 ? true : false;
         //Log.i(TAG, "isGyBeautySupported() return: " + enable);
         return false;  // enable;  true unused
    }
    public static boolean isGyBokehSupported() {
         boolean enable = SystemProperties.getInt("ro.gangyun_camera_bokeh", 0) == 1 ? true : false;
         //Log.i(TAG, "isGyBokehSupported() return: " + enable);
         return false;  // enable;  true unused
    }
	//gangyun tech add end

    /*prize-add-control Blur function-xiaoping-20170601-start*/
    public static boolean isGyBokehEmptinessShow() {
        boolean enable = SystemProperties.getInt("ro.gangyun_camera_blur_show", 0) == 1 ? true : false;
        //Log.i(TAG, "isGyBokehSupported() return: " + enable);
        return  enable;
   }
    /*prize-add-control Blur function-xiaoping-20170601-end*/
    
    /*prize-xuchunming-20171123-arcsoft switch-start*/
    public static boolean isArcsoftSupperZoomSupported() {
        boolean enabled = SystemProperties.getInt("ro.prize.superzoom.arcsoft", 0) == 1 ? true : false;
        Log.i(TAG, "isArcsoftSupperZoomSupported(), enabled:" + enabled);
        return enabled;
    }
    
    public static boolean isArcsoftNightShotSupported() {
        boolean enabled = SystemProperties.getInt("ro.prize.nightshot.arcsoft", 0) == 1 ? true : false;
        Log.i(TAG, "isArcsoftNightShotSupported(), enabled:" + enabled);
        return enabled;
    }
    
    public static boolean isArcsoftHDRSupported() {
        boolean enabled = SystemProperties.getInt("ro.prize.hdr.arcsoft", 0) == 1 ? true : false;
        Log.i(TAG, "isArcsoftHDRSupported(), enabled:" + enabled);
        return enabled;
    }
    
    public static boolean isArcsoftSelfieSupported() {
        boolean enabled = SystemProperties.getInt("ro.prize.selfie.arcsoft", 0) == 1 ? true : false;
        Log.i(TAG, "isArcsoftSelfieSupported(), enabled:" + enabled);
        return enabled;
    }
    
    /*prize-xuchunming-20171123-brand watermark switch-start*/
    public static boolean isBrandWaterSupported() {
        boolean enabled = SystemProperties.getInt("ro.prize.brand.watermark", 0) == 1 ? true : false;
        Log.i(TAG, "isBrandWaterSupported(), enabled:" + enabled);
        return enabled;
    }
    /*prize-xuchunming-20171123-brand watermark switch-end*/
    
    /*prize-xiaoping-20180413-arc.fcam.superzoom switch-start*/
    public static boolean isArcsoftFcamSuperZoomSupported() {
        boolean enabled = SystemProperties.getInt("ro.prize.arc.fcam.superzoom", 0) == 1 ? true : false;
        Log.i(TAG, "isArcFcamSuperZoomSupported(), enabled:" + enabled);
        return enabled;
    }
    /*prize-xiaoping-20180413-arc.fcam.superzoom switch-end*/
    
    /*prize-xuchunming-201804026-add spotlight-start*/  
    public static boolean isSuperSpotLight() {
        boolean enabled = SystemProperties.getInt("ro.prize.spotlight", 0) == 1 ? true : false;
        Log.i(TAG, "isArcFcamSuperZoomSupported(), enabled:" + enabled);
        return enabled;
    }
    /*prize-xuchunming-201804026-add spotlight-end*/

    public static boolean isShortVideoModeSupported() {
        boolean enabled = SystemProperties.getInt("ro.prize.short.video.mode", 0) == 1 ? true : false;
        Log.i(TAG, "isShortVideoModeSupported(), enabled:" + enabled);
        return enabled;
    }

    public static boolean isPortraitModeSupported() {
        boolean enabled = SystemProperties.getInt("ro.prize.portrait.mode", 0) == 1 ? true : false;
        Log.i(TAG, "isPortraitModeSupported(), enabled:" + enabled);
        return enabled;
    }
}
