...
public class FocusManager implements CameraActivity.OnOrientationListener,
    ...
    /*prize-xuchunming-20180322-bugid:53168-start*/
    private static final int MSG_TOUCH_SHUTTER = 5;
    /*prize-xuchunming-20180322-bugid:53168-end*/
    ...
    /*prize-xuchunming-20171116-bugid 42286-start*/
    private static final int FOCUS_FRAME_DELAY = 1000;
    /*prize-xuchunming-20171116-bugid 42286-end*/
    ...
    private static final int[] MATRIX_FOCUS_MODE_DEFAULT_ARRAY = new int[] {
        ...
        R.array.pref_camera_focusmode_default_array, // doublecamera
		// gangyun tech add begin
	    R.array.pref_camera_focusmode_default_array, // beauty
		R.array.pref_camera_focusmode_default_array, // bokeh
		// gangyun tech add bend
        /*arc add start*/
        R.array.pref_camera_focusmode_default_array,
        R.array.pref_camera_focusmode_default_array,
		/*arc add end*/
		R.array.pref_video_focusmode_default_array,	//short prevideo
		R.array.pref_camera_focusmode_default_array, //portrait
    ...
    private static final String[] MATRIX_FOCUS_MODE_CONTINUOUS = new String[] {
        ...
        Parameters.FOCUS_MODE_CONTINUOUS_PICTURE, // prevideo
        Parameters.FOCUS_MODE_CONTINUOUS_PICTURE, // doublecamera
		// gangyun tech add begin
	    Parameters.FOCUS_MODE_CONTINUOUS_PICTURE, // beauty
		Parameters.FOCUS_MODE_CONTINUOUS_PICTURE, // bokeh
		// gangyun tech add end
       /*arc add start*/      
		Parameters.FOCUS_MODE_CONTINUOUS_PICTURE,
		Parameters.FOCUS_MODE_CONTINUOUS_PICTURE,
		/*arc add end*/
		Parameters.FOCUS_MODE_CONTINUOUS_PICTURE, // short prevideo
		Parameters.FOCUS_MODE_CONTINUOUS_PICTURE, //portrait
};
    ...
    private class MainHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case RESET_FACE_BEAUTY_TOUCH_POSITION:
                ...
                break;
            /*prize-xuchunming-20180322-bugid:53168-start*/
            case MSG_TOUCH_SHUTTER:
            	SettingTool.checkTouchShutter(mContext);
                break;
            /*prize-xuchunming-20180322-bugid:53168-end*/
            default:
                break;
    ...
    public void onAutoFocus(boolean focused) {
        ...
        if (mState == STATE_FOCUSING_SNAP_ON_FINISH) {
            ...
            /*prize-xuchunming-20180322-bugid:53168-start*/  
            mHandler.sendEmptyMessage(MSG_TOUCH_SHUTTER);
            /*prize-xuchunming-20180322-bugid:53168-end*/  
            
            // If this is triggered by touch focus, cancel focus after a
            // while.
            /*prize-xuchunming-20171207-bugid:44246-start*/
            mHandler.sendEmptyMessage(RESET_TOUCH_FOCUS);
            /*prize-xuchunming-20171207-bugid:44246-end*/
        } else if (mState == STATE_IDLE) {
        	/*prize-xuchunming-20171116-bugid 42286-start*/
            //mHandler.sendEmptyMessage(RESET_TOUCH_FOCUS);
        	/*prize-xuchunming-20171116-bugid 42286-end*/
    ...
    public void onAutoFocusMoving(boolean moving) {
        ...
        /*prize-xuchunming-20180227-bugid:50919-start*/
        /*if(moving == true && mContext.getCameraAppUI() != null && mContext.getCameraAppUI().getViewState() == ViewState.VIEW_STATE_NORMAL) {
        	if(mContext.getCurrentMode() != ModePicker.MODE_PREVIDEO) {
        		mContext.getCameraAppUI().setViewState(ViewState.VIEW_STATE_MVFOCUSING);
        	}
        }else if(moving == false && mContext.getCameraAppUI() != null && mContext.getCameraAppUI().getViewState() == ViewState.VIEW_STATE_MVFOCUSING){
        	mContext.getCameraAppUI().setViewState(ViewState.VIEW_STATE_NORMAL);
        }*/
        /*prize-xuchunming-20180227-bugid:50919-end*/
        ...
        if (moving) {
            ...
            mContext.getCameraActor().onMvFocusing();
        } else {
            mFocusIndicatorRotateLayout.showSuccess(true);
            mContext.getCameraActor().onMvFocused();
        }
    }
    ...
    public void onSingleTapUp(int x, int y) {
        ...
        if(NavigationBarUtils.isShowNavigationBar(mContext.getApplicationContext())){
        	nvaTop = (int)mContext.getResources().getDimension(R.dimen.center_item_height);
        }
      
        if(mContext.getPreviewSurfaceView() != null && Math.abs((mContext.getPreviewSurfaceView().getAspectRatio() - SettingUtils.getFullScreenRatio())) <= Util.ASPECT_TOLERANCE){//full screen
        	int bottomGray = (int)mContext.getResources().getDimension(R.dimen.shutter_group_height);		
    		int nvaHeight = 0;
            if(NavigationBarUtils.isShowNavigationBar(mContext.getApplicationContext())){
            	nvaHeight = NavigationBarUtils.getNavigationBarHeight(mContext.getApplicationContext());
            }
            int maxY = previewHeight - (bottomGray - nvaHeight);
        	left = Util.clamp(x - focusWidth / 2, 0, previewWidth - focusWidth);
            top =  Util.clamp(y - focusHeight / 2, 0, maxY - focusHeight);
        }else{
        	left = Util.clamp(x - focusWidth / 2, 0, previewWidth - focusWidth);
    ...
    public void updateFocusUI() {
        ...
        if (mState == STATE_IDLE || mState == STATE_UNKNOWN) {
            ...
            focusIndicator.showStart();
            mContext.getCameraActor().onAutoFocusing();
        } else {
            ...
            /*prize-xuchunming-20171116-bugid 42286-end*/
            mContext.getCameraActor().onAutoFocused();
        }
    }
	...
	//prize fengshangdong modify at 20171018 for camera video's continus AF function
    private String getModeContinousFocusMode(int mode) {
       ...
       /* if ((mode == ModePicker.MODE_VIDEO && !isPdafSupported())
         ...
         Log.i(TAG, "[getModeContinousFocusMode] mode = " + mode);
