...
public class CameraManager {
    ...
    private static final int SET_PREVIEW_CALLBACK = 132;
    ...
    public class CameraProxy {
        ...
        public void setParameters(Parameters params) {
        	/*prize-xuchunming-20180307-bugid:51969-start*/
            if (params == null || mCamera == null) {
            /*prize-xuchunming-20180307-bugid:51969-end*/
            ...
            CameraPerformanceTracker.onEvent(TAG,
                    ...
                    CameraPerformanceTracker.ISBEGIN);
            mParametersIsDirty = true;
            mParamsToSet.unflatten((String) params.flatten());
            mCamera.setParameters(mParamsToSet);
            CameraPerformanceTracker.onEvent(TAG,
                    CameraPerformanceTracker.NAME_SET_PARAMETERS,
                    CameraPerformanceTracker.ISEND);
