...
public class CameraAppUI implements SurfaceCallback {
    ...
    public void showReviewManager(byte[] jpagData, int orientation,int height) {
        DecodeTask decodeTask = new DecodeTask(jpagData, orientation, false,height);
        decodeTask.execute();
    }
    ...
    private class DecodeTask extends AsyncTask<Void, Void, Bitmap> {
        ...
        public DecodeTask(byte[] data, int orientation, boolean mirror,int height) {
            mData = data;
