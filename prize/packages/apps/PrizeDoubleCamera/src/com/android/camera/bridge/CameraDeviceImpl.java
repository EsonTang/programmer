...
public class CameraDeviceImpl implements ICameraDevice {
    ...
    /*prize-add-blur function-xiaoping-20170601-start*/
    @Override
    public void addRawImageCallbackBuffer(byte[] data) {
        mCameraDevice.addRawImageCallbackBuffer(data);
    }
    /*prize-add-blur function-xiaoping-20170601-end*/
    ...
    public void setPictureSize(int width, int height) {
        mMyCameraDevice.getParametersExt().setPictureSize(width, height);
    }
    ...
    public void takePicture(ShutterCallback shutterCallback, PictureCallback rawPictureCallback,
    	...
    	/*prize-xuchunming-20180417-bugid:55716-start*/
    	if(postViewPictureCallback != null) {
    		Settings.System.putInt(mActivity.getContentResolver(), "camera_capturing", 1); //for key tasklist
    	}else {
    		Settings.System.putInt(mActivity.getContentResolver(), "camera_capturing", 0); //for key tasklist
    	}
    	/*prize-xuchunming-20180417-bugid:55716-end*/
    ...
    /**
     * 
     * Camera mute settings
     * @param enable true un-mute false mute
     * @return 
     * @see 
     */
    public boolean enableShutterSound(boolean enable) {
    	return mCameraDevice.getCamera().enableShutterSound(enable);
    }
