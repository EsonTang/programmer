 ...
 */
public class PrizeSurfaceTextureWrapper {
    private static final String TAG = PrizeSurfaceTextureWrapper.class.getSimpleName();
    ...
    public PrizeSurfaceTextureWrapper() {
    }

    public PrizeSurfaceTextureWrapper(int surfaceTexId) {
