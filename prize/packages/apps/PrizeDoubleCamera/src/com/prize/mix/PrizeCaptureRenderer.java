...
public class PrizeCaptureRenderer extends Renderer {
    private static final String TAG = PrizeCaptureRenderer.class.getSimpleName();
    ...
    public PrizeCaptureRenderer(Activity activity) {
        super(activity);
    }
