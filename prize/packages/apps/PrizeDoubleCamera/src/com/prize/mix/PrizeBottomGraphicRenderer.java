...
import com.mediatek.camera.mode.pip.pipwrapping.BottomGraphicRenderer;
import com.mediatek.camera.mode.pip.pipwrapping.GLUtil;
import com.mediatek.camera.mode.pip.pipwrapping.Renderer;
import com.mediatek.camera.mode.pip.pipwrapping.ResourceRenderer;

public class PrizeBottomGraphicRenderer extends Renderer {
	private static final String TAG = PrizeBottomGraphicRenderer.class.getSimpleName();
    ...
    public PrizeBottomGraphicRenderer(Activity activity) {
        super(activity);
        initProgram();
    }
