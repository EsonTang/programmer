...
public class ScaleGestureDetector {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (inAnchoredScaleMode()) {
            span = spanY;
            Log.d(TAG, "xuchunming spanY:"+spanY);
        } else {
            span = (float) Math.hypot(spanX, spanY);
            Log.d(TAG, "xuchunming spanX:"+spanX+",spanY:"+spanY+",span:"+span);
        }
        ...
        Log.d(TAG, "xuchunming mSpanSlop:"+mSpanSlop+",mMinSpan:"+mMinSpan+",minSpan:"+minSpan+",span:"+span+",mInitialSpan:"+mInitialSpan+",mInProgress:"+mInProgress+",wasInProgress:"+wasInProgress+",action:"+action+",MotionEvent.ACTION_MOVE:"+MotionEvent.ACTION_MOVE);
