...
import com.android.gallery3d.filtershow.ui.StickerView;
...
public class FilterShowActivity extends FragmentActivity implements OnItemClickListener,
    ...
    private CategoryAdapter mCategoryStickersAdapter = null;
...
//        	mLocationManager = new StickerLocationManager(this);
        }
...
*/
        ///M:aviod flash when launch filter show
        getWindow().setBackgroundDrawable(new ColorDrawable(0));
/// @}
    ...
    private void loadXML() {
        ...
        actionBar.setBackgroundDrawable(new ColorDrawable(
                getResources().getColor(R.color.bg_screen)));
        ...
        if (OptionConfig.SHOW_WATERMARK) {
            ...
            mStickerView.init(this);
//            StickerManager.getStickerManager().setLocationManager(mLocationManager);
        }
		/** PRIZE-watermark-wanzhijuan-2016-1-21-end **/
	...
	/** PRIZE-watermark-wanzhijuan-2016-1-21-start **/
    private String mWatermarkType = StickerTool.TYPE_WATERMARK_INTEREST;
    private void fillStickers() {
    	ArrayList<WatermarkBean> watermarkBeans = StickerManager.getStickerManager().getWatermarkBeans(mWatermarkType);
    	ArrayList<FilterRepresentation> stickers = StickerTool.buildStickerFilterRepresentations(watermarkBeans);

        if (mCategoryStickersAdapter != null) {
        	mCategoryStickersAdapter.clear();
        }
        mCategoryStickersAdapter = new CategoryAdapter(this);
        for (FilterRepresentation representation : stickers) {
        	representation.setName("");
            mCategoryStickersAdapter.add(new Action(this, representation, Action.STICKER));
        }
    }
	/** PRIZE-watermark-wanzhijuan-2016-1-21-end **/
	...
	/** PRIZE-watermark-wanzhijuan-2016-1-21-start **/
    public CategoryAdapter getCategoryStickersAdapter() {
    	fillStickers();
		return mCategoryStickersAdapter;
	}
	/** PRIZE-watermark-wanzhijuan-2016-1-21-end **/
	...
	/** PRIZE-watermark-wanzhijuan-2016-1-21-start **/
    public void useStickerFilterRepresentation(WatermarkBean watermarkBean) {
    	// TODO
        ...
        if (panel != null && panel instanceof MainPanel) {
            ...
            mainPanel.loadCategorySticker();
        }
        mWatermarkType = watermarkBean.getType();
        StickerManager.getStickerManager().addWatermark(watermarkBean);
    }
    
    public void useStickerFilterRepresentation() {
    	// TODO
    	Fragment panel = getSupportFragmentManager().findFragmentByTag(MainPanel.FRAGMENT_TAG);
        if (panel != null && panel instanceof MainPanel) {
            MainPanel mainPanel = (MainPanel) panel;
    ...
    private void updateAddr(String name) {
    	StickerManager.getStickerManager().updateAddress(name);
    }
	/** PRIZE-watermark-wanzhijuan-2016-1-21-end **/
	...
	/** PRIZE-watermark-wanzhijuan-2016-1-21-start **/
    public static final int PICK_STICKER_REQUEST_CODE = 2;
    public static final int PICK_ADDRESS_REQUEST_CODE = 3;
    public static final String KEY_STICKER_RER = "key_sticker";
    public static final String KEY_ADDR_LONGITUDE = "key_longitude";
    public static final String KEY_ADDR_LATITUDE = "key_latitude";
    public static final String KEY_ADDR = "key_addr";
    public void gotoPickSticker() {
        Intent it = new Intent(this, PickStickerActivity.class);
        it.putExtra(LAUNCH_FULLSCREEN,
                isFullscreen());
        startActivityForResult(it, PICK_STICKER_REQUEST_CODE);
        overrideTransition();
    }
    ...
    public void showRepresentation(FilterRepresentation representation) {
        ...
        if (representation instanceof FilterImageStickerRepresentation) {
        	FilterImageStickerRepresentation stickerRepresentation = (FilterImageStickerRepresentation) representation;
        	StickerManager.getStickerManager().addWatermark(stickerRepresentation.getWatermarkBean());        	
            return;
        }
		/** PRIZE-watermark-wanzhijuan-2016-1-21-end **/
        /// M: [BUG.ADD] @{
    ...
    private class LoadBitmapTask extends AsyncTask<Uri, Boolean, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
			...
			/** PRIZE-watermark-wanzhijuan-2016-1-21-start **/
            if (mCategoryStickersAdapter != null) {
            	mCategoryStickersAdapter.imageLoaded();
            }
			/** PRIZE-watermark-wanzhijuan-2016-1-21-end **/
    ...
    private void showSavingProgress(String albumName) {
        ...
        Log.i(TAG, "showSavingProgress progressText=" + progressText + " albumName=" + albumName);
...
/// M: [BEHAVIOR.ADD] @{
    ...
    void resetHistory() {
        ...
        /** PRIZE-Reset clear watermark bug14237-wanzhijuan-2016-4-7-start **/
        StickerManager.getStickerManager().reset();
		/** PRIZE-Reset clear watermark-wanzhijuan-2016-4-7-end **/
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == RESULT_OK) {
			...
			/** PRIZE-watermark-wanzhijuan-2016-1-21-start **/
                ...
                WatermarkBean watermarkBean = data.getParcelableExtra(PickStickerActivity.KEY_STICKER_RER);
                useStickerFilterRepresentation(watermarkBean);
            } else if (requestCode == PICK_ADDRESS_REQUEST_CODE) {
            	String name = data.getStringExtra(KEY_ADDR);
            	updateAddr(name);
            }
        } else {
        	if (requestCode == PICK_STICKER_REQUEST_CODE) {
                useStickerFilterRepresentation();
        	}
        }
		/** PRIZE-watermark-wanzhijuan-2016-1-21-end **/
    }
    ...
    private boolean finishAndReturnIfNotExists() {
        if (!new File(mSourcePath).exists()) {
