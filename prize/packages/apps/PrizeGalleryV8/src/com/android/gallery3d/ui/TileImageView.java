...
public class TileImageView extends GLView {
    ...
    public int mImageWidth = SIZE_UNKNOWN;
    public int mImageHeight = SIZE_UNKNOWN;
    ...
    private void layoutTiles(float centerX, float centerY, float scale, int rotation) {
        ...
        Log.i(TAG, "************************layoutTiles centerX=" + centerX + " centerY=" + centerY + " scale=" + scale + " rotation=" + rotation + " mLevel=" + mLevel + " mLevelCount=" + mLevelCount + " mOffsetX=" + mOffsetX + " mOffsetY=" + mOffsetY);
