...
public class SlideshowView extends GLView {
    ...
    private class SlideshowAnimation extends CanvasAnimation {
        ...
        private MediaItem mMediaItem;//add prize liup 20180322 cmcc
        /// @}
        ...
        /// M: [BUG.ADD] @{
        public SlideshowAnimation(int width, int height, Random random, MediaItem mediaItem) {//add prize liup 20180322 cmcc
        ...
        public void apply(GLCanvas canvas) {
			...
			//add prize liup 20180322 cmcc
			//initScale = GalleryPluginUtils.getImageOptionsPlugin().
             //       getImageDisplayScale(initScale);
            initScale = GalleryPluginUtils.getImageOptionsPlugin().
                    getImageDisplayScale(initScale, mMediaItem);
			//end
            /// @}
