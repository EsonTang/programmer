...
public class Wallpaper extends Activity {
    ...
    private String mPickedItemFilePath;
    ...
    protected void onCreate(Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            mPickedItemFilePath = bundle.getString(KEY_PICKED_ITEM_FILE_PATH);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle saveState) {
        ...
        if (mPickedItem != null) {
            ...
            saveState.putString(KEY_PICKED_ITEM_FILE_PATH, mPickedItemFilePath);
        }
    }
    ...
    protected void onResume() {
        ...
        switch (mState) {
            case STATE_INIT: {
                ...
                mPickedItemFilePath = intent.getStringExtra(KEY_PICKED_ITEM_FILE_PATH);
                if (mPickedItemFilePath == null) {
            ...
            case STATE_PHOTO_PICKED: {
                ...
                /// M: [DEBUG.ADD] @{
                Log.d(TAG, "<onResume> start CropActivity, intent " + cropAndSetWallpaperIntent);
                /// @}
                startActivity(cropAndSetWallpaperIntent);*/
                startWallpaper();
                finish();
    ...
    private void startWallpaper() {
        try {
            Intent it = new Intent("android.intent.action.PreviewActivity");
            it.putExtra("wallType", "3");
            it.putExtra("localWallPath", mPickedItemFilePath);
            it.putExtra("activityType", 1);
            startActivity(it);
        } catch (ActivityNotFoundException anfe) {
            Log.e(TAG, "<startWallpaper> ActivityNotFoundException", anfe);
        } catch (IllegalArgumentException iae) {
            Log.e(TAG, "<startWallpaper> IllegalArgumentException", iae);
        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (mState == STATE_PHOTO_PICKED) {
            ...
            mPickedItemFilePath = data.getStringExtra(KEY_PICKED_ITEM_FILE_PATH);
        }
