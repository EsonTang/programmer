...
public abstract class BaseFiltersManager implements FiltersManagerInterface {
    ...
    protected void addFilterClasses(Vector<Class> filters) {
        ...
        filters.add(ImageFilterSticker.class);
    ...
    public void setFilterResources(Resources resources) {
		...
		/** PRIZE-watermark-wanzhijuan-2016-1-21-start **/
        ImageFilterSticker filterSticker = (ImageFilterSticker) getFilter(ImageFilterSticker.class);
        ImageFilterSticker.setStickerSampleSize(sBorderSampleSize);
        filterSticker.setResources(resources);
		/** PRIZE-watermark-wanzhijuan-2016-1-21-end **/
    }
