...
public class MenuExecutor {
	...
	public static void updateMenuSelectIon(Menu menu){
    	 setMenuItemVisible(menu, R.id.action_select_all, true);
    }
    ...
    public static void updateMenuOperation(Menu menu, int supported) {
        ...
        //boolean supportslideshow = (supported & MediaObject.SUPPORT_SLIDESHOW) != 0;
        ...
        /* PRIZE-1985 [Baidu maps] when the camera to take pictures on the map, Baidu map can not display the map -fuqiang-2015-6-25-start */
        //setMenuItemVisible(menu, R.id.action_show_on_map, supportShowOnMap);
        /* PRIZE-1985 [Baidu maps] when the camera to take pictures on the map, Baidu map can not display the map --fuqiang-2015-6-25-end */
		...
		/* PRIZE-Gallery update PhotoPage layout UI-wanzhijuan-2015-6-8-start*/
        //setMenuItemVisible(menu, R.id.action_slideshow, supportSlideshow);
		/* PRIZE-Gallery update PhotoPage layout UI-wanzhijuan-2015-6-8-end*/
        /// @}
    ...
    /*PRIZE-Gallery update PhotoPage layout UI-wanzhijuan-2015-6-4-start*/
    /**
     * 
     * method:Shooting photos, MenuItem display, the other is hidden
     * @param The parameter name isConshot resource type is not continuous shooting photos, true display, false hides
     * @return back type, detials
     * @see class/complete class/complete class#method
     */
    public static void updateMenuForConshot(Menu menu, boolean isConshot) {
        setMenuItemVisible(menu, R.id.action_conshot, isConshot);
    }
    
    public static void updateMenuForImageRefocus(Menu menu, boolean isImageRefocus) {
    	setMenuItemVisible(menu, R.id.action_imagerefocus, isImageRefocus);
    }
    
    public static void updateMenuForPanorama(Menu menu, boolean isPanorama) {
    	setMenuItemVisible(menu, R.id.action_panorama, isPanorama);
    }
    
    public static void updateMenuForTinyPlanet(Menu menu, boolean isTinyPlanet) {
    	setMenuItemVisible(menu, R.id.action_tiny_planet, isTinyPlanet);
    }
    /*PRIZE-Gallery update PhotoPage layout UI-wanzhijuan-2015-6-4-end*/
    ...
    private Intent getIntentBySingleSelectedPath(String action) {
        ...
        Intent it = new Intent(action).setDataAndType(manager.getContentUri(path), mimeType);
        String filePath = manager.getFilePath(path);
        if (Intent.ACTION_ATTACH_DATA.equals(action) && !TextUtils.isEmpty(filePath)) {
            it.putExtra(KEY_PICKED_ITEM_FILE_PATH, filePath);
        }
        return it;
    }
    ...
    /**PRIZE-gallery modify PhotoPage layout UI-liudong-2015-7-2-start*/
    public void setOnMenuClicked(int action,final ProgressListener listener){
    	 onMenuClicked(action, listener);
    }
    /** gallery modify PhotoPage layout UI-liudong-2015-7-2-end*/
    ...
    public void startAction(int action, int title, ProgressListener listener,
        ...
        if (showDialog) {
        	if(action == R.id.action_delete){
        		 mDialog = createProgressDialog(activity, title, mSelectionManager.getSelectedCount());
        	}else{
