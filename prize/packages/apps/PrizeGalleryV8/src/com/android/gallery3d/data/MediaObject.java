...
public abstract class MediaObject {
    ...
    /// @}
	/* PRIZE-gallery modefiy PhotoPage layout UI-wanzhijuan-2015-6-8-start*/
    public static final int SUPPORT_SLIDESHOW = 1 << 31;
	/* PRIZE-gallery modefiy PhotoPage layout UI-wanzhijuan-2015-6-8-end*/
