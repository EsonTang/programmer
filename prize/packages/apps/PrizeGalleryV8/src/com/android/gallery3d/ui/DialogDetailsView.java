...
public class DialogDetailsView implements DetailsViewContainer {
    ...
    private class DetailsAdapter extends BaseAdapter
        ...
        private void setDetails(Context context, MediaDetails details) {
            ...
            for (Entry<Integer, Object> detail : details) {
                ...
                switch (detail.getKey()) {
                    ...
                    /** PRIZE-add geographical position-xuchunming-2015-6-12-start*/
                    case MediaDetails.INDEX_ADDR: {
                        mLocationIndex = mItems.size();
                        value = (String) detail.getValue();
                        //PRIZE-modify optimization -pengcancan-2017-02-14-start
                        if(value==null || value.trim().equals("") || value.trim().equals("null")){
                        	value = context.getString(R.string.pref_camera_scenemode_label_auto);
                        }
                        //PRIZE-modify optimization -pengcancan-2017-02-14-end
                        break;
                    }
                    /** PRIZEadd geographical position-xuchunming-2015-6-12-end*/
                ...
                /** PRIZE-Filter GPS latitude and longitude - Xu Chunming-2015-6-12-start*/
                if(detail.getKey() != MediaDetails.INDEX_LOCATION){
                	mItems.add(value);
                }
                /** Filter GPS latitude and longitude - Xu Chunming-2015-6-12-end*/
            }
        ...
        public void onAddressAvailable(String address) {
            /** PRIZE- Modify bug:24587 -xiaoping-2016-11-14-start*/
//            mItems.set(mLocationIndex, address);
//            notifyDataSetChanged();
            /** PRIZE- Modify bug:24587 -xiaoping-2015-11-14-end*/
        }
