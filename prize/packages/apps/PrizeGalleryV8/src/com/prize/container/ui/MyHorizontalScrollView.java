...
public class MyHorizontalScrollView extends FrameLayout {
    ...
    private void initScrollView() {
        mScroller = new Scroller(getContext(), null, false/*, new DecelerateInterpolator()*/);
        setFocusable(true);
    ...
    public CharSequence getAccessibilityClassName() {
        return MyHorizontalScrollView.class.getName();
    }
    ...
    public final void smoothScrollBy(int dx, int dy) {
        ...
        LogUtil.i(TAG, "smoothScrollBy duration=" + duration + " ANIMATED_SCROLL_GAP=" + ANIMATED_SCROLL_GAP);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        super.onLayout(forceLeftGravity, l, t, r, b);
