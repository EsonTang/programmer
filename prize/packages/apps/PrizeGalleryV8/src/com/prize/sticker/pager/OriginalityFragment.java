...
public class OriginalityFragment extends Fragment {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
		...
		mStickerRecycler.setAdapter(mAdapter = new StickerAdapter(getActivity(), StickerManager.getStickerManager().getWatermarkBeans(StickerTool.TYPE_WATERMARK_ORIGINALITY)));
