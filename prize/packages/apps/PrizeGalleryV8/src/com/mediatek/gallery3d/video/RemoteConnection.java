...
public abstract class RemoteConnection {
    private static final String TAG = "Gallery2/VideoPlayer/RemoteConnection";
    ...
    protected void dismissPresentation() {
        ...
        if (mPresentation != null) {
            ...
            mPresentation = null;
            ((ViewGroup) mRootView).addView((View) mMovieView, 0);
        }
    }
    ...
    protected final Runnable mSelectMediaRouteRunnable = new Runnable() {
        ...
        public void run() {
            ...
            Display presentationDisplay = routeInfo != null ? routeInfo
    ...
    public void updatePresentation(){
        ...
        if (mPresentation == null && presentationDisplay != null) {
            ...
            if (((View) mMovieView).getParent() != null) {
                ((ViewGroup) ((View) mMovieView).getParent())
                        .removeView((View) mMovieView);
            }
