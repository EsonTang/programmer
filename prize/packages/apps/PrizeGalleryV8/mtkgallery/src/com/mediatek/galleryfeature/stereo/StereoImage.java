...
public class StereoImage {
     ...
     * Segment will generate mask based on this sample size and later save
     * the mask to jpeg header. Fancy color can use the same sample size
     * to decode image, and use the saved segment mask directly.
     *
     * @param width
