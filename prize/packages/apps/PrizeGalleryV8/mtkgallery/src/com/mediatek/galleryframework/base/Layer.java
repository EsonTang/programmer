...
public abstract class Layer implements PlayListener {
    ...
    /**
     * LayerNotifier is a interface which allows layer to send message out.
     * Layer can notice some information which will impact on other layers.
     */
    public static interface LayerNotifier {
        /**
         * Send message.
         * @param layer The Layer who sends this message
     ...
     * @param hasAnimation if has animation, while the visibility change.
    ...
    /**
     *  Fresh layer the visibility.
     * @param visible the visibility for the layer.
     * @param hasAnimation if has animation, while the visibility change.
     * @return whether has do fresh.
     */
