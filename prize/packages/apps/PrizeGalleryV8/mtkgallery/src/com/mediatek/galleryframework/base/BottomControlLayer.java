...
public class BottomControlLayer extends Layer {
    ...
    public void onClickEvent(View v) {
        ...
        case R.id.m_stereo_dynamic_preview_menu:
     ...
     */
    public boolean onStereoDynamicPreviewView() {
        return mPhotopageBottomViewControls.onStereoDynamicPreviewView();
    }
    ...
    public boolean getVisibility(int id, boolean visiable) {
        ...
        case R.id.m_stereo_dynamic_preview_menu:
            return supportDynamicPreview() && visiable;
        case R.id.m_stereo_start_menu:
            return visiable;
    ...
    /**
     * Whether support dynamic view. Subclass should override this
     * method.
     * @return false for this layer.
     */
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (onStereoView() || onStereoDynamicPreviewView()) {
            menu.clear();
        }
        return true;
    }
