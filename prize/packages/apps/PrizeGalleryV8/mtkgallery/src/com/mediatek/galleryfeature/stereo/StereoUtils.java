...
public class StereoUtils {
     ...
     */
    public static int[] getCoordinateSensorToImage(double width, double height, double x,
            double y) {
        int[] coord = new int[2];
     ...
     */
    public static int[] getCoordinateImageToSensor(double width, double height, double x,
            double y) {
        int[] coord = new int[2];
