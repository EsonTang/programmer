...
public class ContainerLayer extends Layer {
    ...
    public void onCreate(Activity activity, ViewGroup root) {
        ...
        mActivity = activity;
		mPaddingBottom = mActivity.getResources().getDimensionPixelSize(R.dimen.container_detail_padding_bottom);
		mPaddingRight = mActivity.getResources().getDimensionPixelSize(R.dimen.container_detail_padding_right);
        ...
        mConShotIcon.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                PlatformHelper.enterContainerSavePage(mActivity, mMediaData, false, null);
            }
    ...
    public void onResume(boolean isFilmMode) {
        ...
        mActionBarVisibility =  true;//mActivity.getActionBar().isShowing();
	...
	public void onNavigationBarChange(boolean isShow, boolean isLandsape, int navigationBarHeight) {
		if (isShow) {
			if (isLandsape) {
				mContainer.setPadding(0, 0, mPaddingRight + navigationBarHeight, mPaddingBottom);
			} else {
				mContainer.setPadding(0, 0, mPaddingRight, mPaddingBottom + navigationBarHeight);
			}
		} else {
			mContainer.setPadding(0, 0, mPaddingRight, mPaddingBottom);
		}
	}
