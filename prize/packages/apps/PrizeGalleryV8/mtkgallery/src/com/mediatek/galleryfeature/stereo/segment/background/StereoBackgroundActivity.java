...
public class StereoBackgroundActivity extends FragmentActivity {
    ...
    private static ForegroundSegmenterParameter sForegroundSegmenterParameter;
    ...
    private class LoadBitmapTask extends AsyncTask<Uri, Boolean, Boolean> {
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (sForegroundSegmenterParameter == null) {
                sForegroundSegmenterParameter = new ForegroundSegmenterParameter(mMasterImage
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PICK_FROM_GALLERY) {
            ...
            mMaskSimulator = getSegmentWrapper();
            if (mMaskSimulator != null) {
    ...
    public void finish() {
        ...
        sForegroundSegmenterParameter = null;
        super.finish();
    }

    private StereoSegmentWrapper getSegmentWrapper() {
        if (sForegroundSegmenterParameter != null && mMaskSimulator == null) {
            mMaskSimulator = new StereoSegmentWrapper(sForegroundSegmenterParameter.mOriginalWidth,
                    sForegroundSegmenterParameter.mOriginalHeight,
                    sForegroundSegmenterParameter.mBitmap.getWidth(),
                    sForegroundSegmenterParameter.mBitmap.getHeight());
            boolean isSegmentValid = mMaskSimulator.initSegment(
                    sForegroundSegmenterParameter.mFilePath, sForegroundSegmenterParameter.mBitmap);
            if (!isSegmentValid) {
