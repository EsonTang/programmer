...
public class XmpOperator {
    ...
    static {
        ...
        Log.d(TAG, "Stereo Namespace: " + MEDIATEK_IMAGE_REFOCUS_NAMESPACE);
    }
    ...
    public byte[] writeStereoCaptureInfoToJpg(String fileName, byte[] jpgBuffer, byte[] jpsData,
        ...
        writeStereoCaptureInfo(is, os, jpsData, jsonBuffer, jpsMask, clearImage, encodedDepth, ldc);
    ...
    private byte[] extractExtendXmpData(String filePath) {
        ...
        try {
            ...
            if (extXmpTotalLen == 0) {
                Log.d(TAG, "<extractExtendXmpData> extXmpTotalLen = 0, return null!!");
                return null;
            }
