...
#define IMAGE_SAMPLE_SIZE 2
#define JPS_SAMPLE_SIZE 1
...
private:
    ...
    void initRefocusIMGSource(const char *sourceFilePath, int outImgWidth, int outImgHeight, int sampleSize);
    bool initRefocusIMGSource(uint8_t* jpegBuf, int bufSize, int outImgWidth, int outImgHeight, int sampleSize);
