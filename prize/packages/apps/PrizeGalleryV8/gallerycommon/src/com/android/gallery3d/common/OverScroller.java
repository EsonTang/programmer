...
//    }
    ...
    public void fling(int startX, int startY, int velocityX, int velocityY,
        ...
        if (mFlywheel && !isFinished()) {
			...
			Log.i("OverScroller", "fling oldVelocityY=" + oldVelocityY + " velocityY=" + velocityY);
        }
    ...
    static class SplineOverScroller {
        ...
        private void onEdgeReached() {
            ...
            */
            mState = BALLISTIC;
            mFinal = mVelocity > 0 ? mMaxScrollLength : mMinScrollLength;
            mOver = Math.abs(mStart - mFinal);
            /// @}
    ...
    /// M: [FEATURE.ADD] fancy layout @{
    public void setMaxScrollLength(int max) {
        mScrollerX.mMaxScrollLength = max;
    }
    public void setMinScrollLength(int min) {
        mScrollerX.mMinScrollLength = min;
    }
    /// @}
	  /// @prize chenyao 2015-05-29 {
    public void setMaxScrollLengthY(int max) {
        mScrollerY.mMaxScrollLength = max;
    }
    public void setMinScrollLengthY(int min) {
        mScrollerY.mMinScrollLength = min;
    }
    /// @prize }
}
