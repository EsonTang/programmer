...
import com.prize.factorytest.FingerKeyCheck.FingerKeyCheck;
import com.prize.factorytest.Efuses.Efuses;
...
public class PrizeFactoryTestListActivity extends Activity implements
	...
	public void FactoryTestList(String TestListName) {
		...
		if (TestListName.equals(getResources().getString(R.string.sub_microphone))) {
			Intent intent = new Intent().setClass(this, MICSubRe.class);
			startActivityForResult(intent, 0);
		}
		...
		if (TestListName.equals(getResources().getString(R.string.front_camera_sub))) {
			Intent intent = new Intent().setClass(this, CameraFrontYuvSub.class);
			startActivityForResult(intent, 0);
		}
		...
		if (TestListName.equals(getResources().getString(R.string.fingerprivatekey))) {
			Intent intent = new Intent().setClass(this, FingerKeyCheck.class);
			startActivityForResult(intent, 0);
		}
		if (TestListName.equals(getResources().getString(R.string.efuse_name))) {
			Intent intent = new Intent().setClass(this, Efuses.class);
			startActivityForResult(intent, 0);
		}
	}
