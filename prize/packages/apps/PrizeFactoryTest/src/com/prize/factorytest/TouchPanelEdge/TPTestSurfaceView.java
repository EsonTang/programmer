...
public class TPTestSurfaceView extends SurfaceView implements Callback {
	...
	private void drawFree(Canvas canvas) {
		//prize-add-taoyingyou-bugid-57991-liuhai screen adapter-start
		if(SystemProperties.get("ro.prize_notch_screen").equals("1")) {
			canvas.drawText(mCoordinate, 30, 120, mWhitePaint);
			canvas.drawLine(0, 130, getWidth(), 130, mWhitePaint);
		}else{
		//prize-add-taoyingyou-bugid-57991-liuhai screen adapter-end
