...
public class PrizeSnInfo extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(SystemProperties.get("ro.prize_notch_screen").equals("1")) {
			mVersion.setPadding(0, 50, 48, 0);
		}
		mContext=this;
	...
	private void koobeeTestInfo(String temp){
        ...
        koobeeInfo = new HashMap<String, String>();
        koobeeInfo.put("key", "人工测试: ");
        if(null != temp&&temp.length()>=42){
            if(temp.substring(37, 38).equals("P") || manual.equals("P"))
                koobeeInfo.put("value", getString(R.string.pass));
            else if(temp.substring(37, 38).equals("F") || manual.equals("F"))
                koobeeInfo.put("value", getString(R.string.fail));
            else 
                koobeeInfo.put("value", getString(R.string.no_test));
        }else{
        ...
        autotestList.add(koobeeInfo);

        koobeeInfo = new HashMap<String, String>();
        koobeeInfo.put("key", "MMI自动化测试: ");
        if(null != temp&&temp.length()>=42){
            if(temp.substring(38, 39).equals("P") || autommi.equals("P"))
                koobeeInfo.put("value", getString(R.string.pass));
            else if(temp.substring(38, 39).equals("F") || autommi.equals("F"))
                koobeeInfo.put("value", getString(R.string.fail));
            else
                koobeeInfo.put("value", getString(R.string.no_test));
        }else{
        ...
        koobeeInfo = new HashMap<String, String>();
        koobeeInfo.put("key", "camera自动化测试: ");
        if(null != temp&&temp.length()>=42){
            if(temp.substring(39, 40).equals("P") || autocamera.equals("P"))
                koobeeInfo.put("value", getString(R.string.pass));
            else if(temp.substring(39, 40).equals("F") || autocamera.equals("F"))
                koobeeInfo.put("value", getString(R.string.fail));
            else
                koobeeInfo.put("value", getString(R.string.no_test));
        }else{
        ...
        koobeeInfo = new HashMap<String, String>();
        koobeeInfo.put("key", "音频自动化测试: ");
        if(null != temp&&temp.length()>=42){
            if(temp.substring(40, 41).equals("P") || autoaudio.equals("P"))
                koobeeInfo.put("value", getString(R.string.pass));
            else if(temp.substring(40, 41).equals("F") || autoaudio.equals("F"))
                koobeeInfo.put("value", getString(R.string.fail));
            else
                koobeeInfo.put("value", getString(R.string.no_test));
        }else{
        ...
        koobeeInfo = new HashMap<String, String>();
        koobeeInfo.put("key", "DDR测试: ");
        if(null != temp&&temp.length()>=42){
            if(temp.substring(36, 37).equals("P") || readProInfo(36).equals("P"))
                koobeeInfo.put("value", getString(R.string.pass));
            else if(temp.substring(36, 37).equals("F") || readProInfo(36).equals("F"))
                koobeeInfo.put("value", getString(R.string.fail));
            else
                koobeeInfo.put("value", getString(R.string.no_test));
        }else{
	...
	private String getVersionInfo() {
		...
		wbg = readProInfo(41);
        manual = readProInfo(37);
        autommi = readProInfo(38);
        autocamera = readProInfo(39);
        autoaudio = readProInfo(40);
	...
	private void snInfoDisplay(){
        ...
        autotestAdapter = new SnInfoAdapter(getBaseContext(),autotestList);
		//pcbaListView.setEnabled(false);
		//phoneListView.setEnabled(false);
        //autotestListView.setEnabled(false);
