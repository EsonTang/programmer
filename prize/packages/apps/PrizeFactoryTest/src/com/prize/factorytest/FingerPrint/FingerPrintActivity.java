...
public class FingerPrintActivity extends BaseActivity{  
    ...
    protected void onStart() {  
		...
		if(SystemProperties.get("soter.teei.thh.init").equals("ACTIVE")){
			 mTitleNoticeTxt.setText(getResources().getString(R.string.finger_active_disc));  		
		}else{
		    mTitleNoticeTxt.setText(getResources().getString(R.string.finger_unactive_disc));  
		}		
