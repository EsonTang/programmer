...
public class PrizeFactoryTestActivity extends Activity {
	...
	public void FactoryTestList(String TestListName) {
		...
		}else if (TestListName.equals(getResources().getString(R.string.fingerprivatekey))) {
      		intent.setClass(this, FingerKeyCheck.class);
    	}else if (TestListName.equals(getResources().getString(R.string.efuse_name))) {
      		intent.setClass(this, Efuses.class);
    	}
		if(null != intent){
			startActivityForResult(intent, 0);
		}
