...
public class MediaFile {
    ...
    public static String IMAGE_FORMAT_HEADER = "<Image>";
    public static final String IMAGE_FORMAT_PATTERN = "(?=<Image>).*?\\.(([J|j]+[P|p]+[G|g])|([J|j]+[P|p]+[E|e]+[G|g])|([G|g]+[I|i]+[F|f])"
    		+ "|([B|b]+[M|m]+[P|p])|([W|w]+[B|b]+[M|m]+[P|p])|([P|p]+[N|n]+[G|g]))";	
    public static final String IMAGE_PATH_PATTERN = "/.+?\\.(([J|j]+[P|p]+[G|g])|([J|j]+[P|p]+[E|e]+[G|g])|([G|g]+[I|i]+[F|f])"
    		+ "|([B|b]+[M|m]+[P|p])|([W|w]+[B|b]+[M|m]+[P|p])|([P|p]+[N|n]+[G|g]))";	
