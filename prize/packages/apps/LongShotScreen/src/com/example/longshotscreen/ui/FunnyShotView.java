...
public class FunnyShotView {
	...
	private int mRectShotPopupHeight;
	...
	public FunnyShotView(Context context) {
		...
		/*prize-add-huangpengfei-2017-11-13-start*/
		mRectShotPopupHeight = (int) mRes.getDimension(R.dimen.prize_rect_shot_popup_height);
		/*prize-add-huangpengfei-2017-11-13-end*/
			...
			public boolean onKey(View view, int keyCode, KeyEvent keyEvent) {
				...
				if (keyEvent.getAction() == 1)
					...
					case KeyEvent.KEYCODE_HOME:
						exitLassoScreenShot();
						//returnToLauncher();//prize-remove-hpf-2017-12-6
						return true;					
					}
				return true;
			}
...
//		}
		...
		this.mCutRectEditLayout.setOnKeyListener(new View.OnKeyListener() {
			public boolean onKey(View view, int keyCode, KeyEvent keyEvent) {
				if (keyEvent.getAction() == 1)
					...
					case KeyEvent.KEYCODE_HOME:
						FunnyShotView.this.exitCutRectEditLayout();
						//FunnyShotView.this.returnToLauncher();//prize-remove-hpf-2017-12-6
						return true;
					}
				return true;
			}
	...
	public void exitFunnyShot() {
            /*-prize add by lihuangyuan,for notchscreen -2018-04-24-start*/ 	
            Log.d("screenshot","FunnyShotView exitFunnyShot");
...
//		}
	...
	/*prize-add-huangpengfei-2017-11-13-start*/
	private PopupWindow mRectShotHintPop;
	private void initRectShotHintPopup(){
		RelativeLayout localLinearLayout = (RelativeLayout) LayoutInflater.from(
				this.mContext).inflate(R.layout.rectshot_popup_window_hint, null);
		this.mRectShotHintPop = new PopupWindow(localLinearLayout, 600,
				mRectShotPopupHeight, false);
		this.mRectShotHintPop.setAnimationStyle(R.style.funnyshot_anim);
		
	}
	/*prize-add-huangpengfei-2017-11-13-end*/
	
	protected void readyToRectShot() {
		initRectShotHintPopup();//prize-add-huangpengfei-2017-11-13
        ...
        //this.mRect = new Rect();
		this.mRect = new Rect(this.mScreenWidth/4,this.mScreenHeight/4,
                this.mScreenWidth * 3 / 4,this.mScreenHeight * 3 / 4);
		...
		/*prize-remove-hpf-2017-11-25-start*/
		/*getScreenShotImage();
		this.mCutRectView.setBackground(new BitmapDrawable(this.mRes,
				this.mScreenBitmap));*/
		/*prize-remove-hpf-2017-11-25-end*/
		...
		this.mHandler.postDelayed(new Runnable() {
			public void run() {
				/*prize-remove-hpf-2017-11-25-start*/
				getScreenShotImage();
				FunnyShotView.this.mCutRectView.setBackground(new BitmapDrawable(FunnyShotView.this.mRes,
				FunnyShotView.this.mScreenBitmap));
				/*prize-remove-hpf-2017-11-25-end*/
	...
	class FunnyShotHandler extends Handler {
		...
		public void handleMessage(Message msg) {
			...
			case 0x11: {
				...
				/* prize-add-huangpengfei-2017-11-13-start */
				if ((mRectShotHintPop != null) && (mRectShotHintPop.isShowing())) {
					mRectShotHintPop.dismiss();
				}
				/* prize-add-huangpengfei-2017-11-13-end */
				break;
			}
			case 0x12: {
				...
				/* prize-add-huangpengfei-2017-11-13-start */
				if ((mRectShotHintPop != null) && (!mRectShotHintPop.isShowing()) && (mCutRectView != null)) {
					mRectShotHintPop.showAtLocation(mCutRectView, Gravity.CENTER, 0, 220);
				}
				/* prize-add-huangpengfei-2017-11-13-end */
				break;
			}
