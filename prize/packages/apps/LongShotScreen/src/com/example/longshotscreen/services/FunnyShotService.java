...
import android.view.inputmethod.InputMethodManager;//prize-add-hpf-2017-11-24
...
public class FunnyShotService extends Service {
	...
	public void onCreate() {
		super.onCreate();
            Log.d("screenshot","FunnyShotService onCreate");
		...
		/*prize-add hide SofrInput-hpf-2017-11-24-start-*/
		InputMethodManager inputmgr = (InputMethodManager)getSystemService(Context.INPUT_METHOD_SERVICE);
		inputmgr.prizeHideSoftInput(InputMethodManager.HIDE_NOT_ALWAYS, null);
		/*prize-add hide SofrInput-hpf-2017-11-24-end-*/
	}
 ...
 */
	...
	public void onDestroy() {
            Log.d("screenshot","FunnyShotService onDestroy");
	...
	public class GlobalReceiver extends BroadcastReceiver
	{
		...
		public void register()
		{
			...
			/*PRIZE-add-Stop-FunnyShot-hpf-2017-11-22-start*/
			localIntentFilter.addAction("android.intent.action.PHONE_STATE");
			localIntentFilter.addAction("android.provider.Telephony.SMS_RECEIVED");
			localIntentFilter.addAction("com.android.deskclock.ALARM_ALERT");
			/*PRIZE-add-Stop-FunnyShot-hpf-2017-11-22-end*/
