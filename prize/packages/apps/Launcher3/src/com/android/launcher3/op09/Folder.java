...
import com.android.launcher3.FolderPluginEx;
...
public class Folder extends LinearLayout implements DragSource, View.OnClickListener,
    ...
    public Folder(Context context, AttributeSet attrs) {
        ...
        // reliable behavior when clicking the
        // text field (since it will always gain focus on click).
    ...
    public boolean onLongClick(View v) {
        ...
        if (v instanceof BubbleTextView &&
                /// M: Add for OP customization. @{
                !(mSupportEditAndHideApps && Launcher.isInEditMode())) {
                /// @}
    ...
    public boolean startDrag(View v, DragOptions options) {
        ...
        if (tag instanceof ShortcutInfo) {
            ...
            // then call onDragStart() from DragListener
    ...
    // folderIcon.mOnOpenListener.alarm() call it
    ...
    public void onDropCompleted(final View target, final DragObject d,
        ...
        if (mDeferDropAfterUninstall) {
            ...
            mDeferredAction = new Runnable() {
                    // call it by onDragObjectRemoved()
                    public void run() {
