...
public class BaseRecyclerViewFastScrollBar {
    ...
    public BaseRecyclerViewFastScrollBar(BaseRecyclerView rv, Resources res) {
        ...
        mThumbWidth = mThumbMinWidth = res.getDimensionPixelSize(
                R.dimen.container_fastscroll_thumb_min_width);
    ...
    public void handleTouchEvent(MotionEvent ev, int downX, int downY, int lastY) {
        ...
        int y = (int) ev.getY();
        Log.d("OP09Launcher-BaseRecyclerViewFastScrollBar.handleTouchEvent", "action: " + action +
                ",downX: " + downX + ",downY: " + downY + ",lastY: " + lastY + ",mIsDragging: " +
                mIsDragging);
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mIsDragging) {
                    ...
                    String sectionName = mRv.scrollToPositionAtProgress((boundedY - top) /
                            (bottom - top));
                    // high light scrollbar, show section name
