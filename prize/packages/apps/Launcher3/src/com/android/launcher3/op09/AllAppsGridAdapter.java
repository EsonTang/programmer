...
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
    ...
    public static final int VIEW_TYPE_SECTION_BREAK = 1 << 0; // onBindViewHolder, positon: 1
    // A normal icon
    public static final int VIEW_TYPE_ICON = 1 << 1; // onBindViewHolder, positon: 2,3...
    // A prediction icon
    ...
    public static final int VIEW_TYPE_SEARCH_DIVIDER = 1 << 6; // onBindViewHolder, positon: 0
    ...
    public class GridSpanSizer extends GridLayoutManager.SpanSizeLookup {
        ...
        public int getSpanSize(int position) {
            /// M: Add for OP customization. @{
            if (mApps.getAdapterItems().get(position).viewType ==
                    AllAppsGridAdapter.FOLDER_VIEW_TYPE) {
                return 1;
            }
            /// @}
    ...
    private BindViewCallback mBindViewCallback;  // AllAppsFastScrollHelper
