...
public class LauncherProvider extends ContentProvider {
        ...
        switch (method) {
            case LauncherSettings.Settings.METHOD_SET_EXTRACTED_COLORS_AND_WALLPAPER_ID: {
                ...
                Utilities.getPrefs(getContext()).edit()
                        ...
                        .apply();
                mListenerHandler.sendEmptyMessage(
            ...
            case LauncherSettings.Settings.METHOD_NEW_ITEM_ID: {
                Bundle result = new Bundle();
                result.putLong(
                        LauncherSettings.Settings.EXTRA_VALUE, mOpenHelper.generateNewItemId());
                return result;
            }
            case LauncherSettings.Settings.METHOD_NEW_SCREEN_ID: {
                Bundle result = new Bundle();
                result.putLong(
                        LauncherSettings.Settings.EXTRA_VALUE, mOpenHelper.generateNewScreenId());
                return result;
            }
    ...
    synchronized private void loadDefaultFavoritesIfNecessary() {
        ...
        if (sp.getBoolean(EMPTY_DATABASE_CREATED, false)) {
            ...
            // M:ALPS03115292 Don't empty DB for it will clear widgetinfo, leads to GTS fail.
            String isGms = Utilities.getSysProperty("ro.com.google.gmsversion", null);
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                ...
                case 16: {
                    ...
                    // is very destructive (wipes out workspaces),
                    // we want to prevent this from showing
                ...
                case 18: {
                    ...
                    // which no longer exist. Since this can cause other problems,
                    // and since the user will never see these items anyway,
                    // we use database upgrade as an opportunity to clean things up.
