...
public final class LauncherLog {
    ...
    static {
        if (android.os.SystemProperties.getBoolean(PROP_DEBUG_ALL, false)) {
            ...
            if (isUserLoad()) {
                DEBUG_KEY = android.os.SystemProperties.getBoolean(PROP_DEBUG_KEY, false);
            } else {
            ...
            DEBUG_MOTION = android.os.SystemProperties.getBoolean(PROP_DEBUG_MOTION, true);
    ...
    /**
     * The method gets whether is user load or not.
     */
    public static final boolean isUserLoad() {
        return android.os.SystemProperties.get("ro.build.type").equals("user") ||
                android.os.SystemProperties.get("ro.build.type").equals("userdebug");
    }
}
