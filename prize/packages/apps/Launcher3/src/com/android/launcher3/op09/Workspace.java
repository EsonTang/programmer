...
public class Workspace extends PagedView
    ...
    @Override
    // DragController.addDragListener   DragController.startDeferredDrag -> listener.onDragStart()
    public void onDragStart(DropTarget.DragObject dragObject, DragOptions options) {
        ...
        if (!(mSupportEditApps && LauncherPluginEx.sIsInEditMode)) {
    ...
    public void onDragEnd() {
        ...
        Log.d("OP09Launcher-Workspace.onDragEnd", "called");
    ...
    void addInScreen(View child, long container, long screenId, int x, int y, int spanX, int spanY,
        ...
        if (!layout.addViewToCellLayout(child, insert ? 0 : -1, childId, lp, markCellsAsOccupied)) {
            ...
            Log.e(TAG, "Failed to add to item at (" + lp.cellX + "," + lp.cellY +
                    ") to CellLayout");
        }
     ...
     * @param alpha the alpha for the workspace page
     */
    private void setWorkspaceTranslationAndAlpha(Direction direction, float translation,
            float alpha) {
    ...
    /// M:ALPS02363312 [Performance] Set HW layer on down event to improve response time.
    ...
    int getOverviewModeTranslationY() {
        ...
        int workspaceOffsetTopEdge = workspaceTop +
                ((workspaceBottom - workspaceTop) - scaledHeight) / 2;
    ...
    public void onDragEnter(DragObject d) {
        Log.d("OP09Launcher-Workspace.onDragEnter", "dragObject: " + d);
        if (ENFORCE_DRAG_EVENT_ORDER) {
    ...
    void setCurrentDropOverCell(int x, int y) {
        Log.d("OP09Launcher-Workspace.setCurrentDropOverCell", "x: " + x + "y: " + y +
                "mDragOverX: " + mDragOverX + ",mDragOverY: " + mDragOverY);
    ...
    void setDragMode(int dragMode) {
        Log.d("OP09Launcher-Workspace.setDragMode", "dragMode: " + dragMode);
   ...
   static private float squaredDistance(float[] point1, float[] point2) {
    ...
    public void onDragOver(DragObject d) {
        ...
        if (mDragTargetLayout != null) {
            ...
            // create folder or drop in exists folder
    ...
    private void manageFolderFeedback(CellLayout targetLayout,
        ...
        if (willAddToFolder && mDragMode == DRAG_MODE_NONE) {
            /// M: ALPS02014125. Three folders can be opened at the same time and some
    ...
    private void onDropExternal(final int[] touchXY, final ItemInfo dragInfo,
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            boolean isWidget = pendingInfo.itemType ==
