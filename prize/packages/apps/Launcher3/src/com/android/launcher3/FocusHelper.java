...
public class FocusHelper {
    ...
    static boolean handleHotseatButtonKeyEvent(View v, int keyCode, KeyEvent e) {
        ...
        switch (newIconIndex) {
            ...
            case FocusLogic.PREVIOUS_PAGE_RIGHT_COLUMN:
                ...
                ///M: ALPS02868574. {@
                if (checkIsNull(prevPage)) return consume;
                /// @}
            ...
            case FocusLogic.NEXT_PAGE_RIGHT_COLUMN:
                ...
                ///M: ALPS02868574. {@
                if (checkIsNull(nextPage)) return consume;
                /// @}
    ...
    ///M: ALPS02868574. Fix MTBF seldom crash. {@
    private static boolean checkIsNull(CellLayout page) {
        return (page == null) ||
           (page.getShortcutsAndWidgets() == null) ||
           (page.getShortcutsAndWidgets().getChildAt(0) == null) ||
           (page.getShortcutsAndWidgets().getChildAt(0).getLayoutParams() == null);
    }
    /// @}
}
