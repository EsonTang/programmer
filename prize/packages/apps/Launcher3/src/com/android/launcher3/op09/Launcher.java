...
public class Launcher extends Activity
    ...
    private View mAllAppsButton; /// layout/page_indicator.xml id : all_apps_handle
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.launcher);   // res/layout-land/launcher.xml LauncherRootView
    ...
    private void handleActivityResult(
        ...
        LauncherLog.d(TAG, "handleActivityResult,requestArgs: " + requestArgs);
    ...
    @Thunk void completeTwoStageWidgetDrop(
        ...
        ///M. ALPS02202279.
        if (mWorkspace == null) {
            Log.d(TAG, "completeTwoStageWidgetDrop: mWorkspace = " + mWorkspace);
            return;
        }
    ...
    private void setupOverviewPanel() {
        ...
        // in res/layout/overview_panel.xml
     ...
     */
    /// call from PageIndicatorLineCaret.onFinishInflate()
    ...
    public void closeSystemDialogs() {
      ...
      ///M: ALPS03154215 : wait for activity result before making paramenters null.
    //    setWaitingForResult(null);
    }
    ...
    public void closeFolder(Folder folder, boolean animate) {
       ...
       //M:ALPS03156218 need not to check power saver mode for folder close
       // if (animate) {
            ...
            if (item.hasRestoreFlag(LauncherAppWidgetInfo.FLAG_ID_NOT_VALID)) {
                if (!item.hasRestoreFlag(LauncherAppWidgetInfo.FLAG_ID_ALLOCATED)) {
                    ...
                    PendingAddWidgetInfo pendingInfo =
                            new PendingAddWidgetInfo(this, appWidgetInfo);
