...
public class DragController implements DragDriver.EventListener, TouchController {
    ...
    public DragView startDrag(Bitmap b, int dragLayerX, int dragLayerY,
        ...
        if (mOptions.isAccessibleDrag) {
            ...
            //(mMotionDownX,mMotionDownY) location of down click
        ...
        if (!mIsDragDeferred) {
            // by default, DragController#startDrag() -> DragListener#onDragStart() is called
            startDeferredDrag();
        } else {
    ...
    public void onDriverDragMove(float x, float y) {
        ...
        LauncherLog.d(TAG, "x= " + x + ",y= " + y +
                ",dragLayerPos[0]= " + dragLayerPos[0] + ",dragLayerPos[1]= " + dragLayerPos[1]);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        LauncherLog.d(TAG, " ev.getAction(): " + ev.getAction());
    ...
    private void handleMoveEvent(int x, int y) {
        ...
        // DropTarget: workspace, ButtonDropTarget, AnotherWindowDropTarget, Folder
       ...
       if (LauncherLog.DEBUG_DRAG) {
        ...
        // mLastDropTarget.onDragExit() -> dropTarget.onDragEnter()-> dropTarget.onDragOver()
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        LauncherLog.d(TAG, "ev.getAction(): " +
                ev.getAction());
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                if ((dragLayerX < mScrollZone) || (dragLayerX > mScrollView.getWidth() -
                        mScrollZone)) {
                    mScrollState = SCROLL_WAITING_IN_ZONE;
