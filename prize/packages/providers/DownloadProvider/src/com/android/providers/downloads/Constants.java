...
public class Constants {
     ...
     */
    public static final boolean MTK_DRM_ENABLED = OmaDrmUtils.isOmaDrmEnabled();
...
//      "com.android.providers.downloads.ui.OMADLOpenDownloadReceiver";
    ...
    /// M: add to fix 811498. @{
    public static final String SCAN_REQUEST_CALLED = "scanRequestCalled";
    /// @}

    /// M: add to fix 821679. @{
    public static final String DD_FILE_MIMETYPE = "application/vnd.oma.dd+xml";
    /// @}

    /// M: add to support oma dl dialog. @{
    public static final String ACTION_OMA_DL_DIALOG = "com.mtk.ACTION_OMA_DL_DIALOG";
    /// @}
}
