            ...
            if ("application/vnd.android.package-archive".equals(mimeType)) {
                ...
                if (Constants.MTK_DRM_ENABLED
                        ...
                        && (mimeType.equalsIgnoreCase(
                                OmaDrmStore.DrmObjectMimeType.MIME_TYPE_DRM_MESSAGE) || mimeType
                                .equalsIgnoreCase(
                                        OmaDrmStore.DrmObjectMimeType.MIME_TYPE_DRM_CONTENT))) {
                    Log.i(Constants.DL_DRM, " will send DRM intent");
                    mimeType = DownloadDrmHelper.getOriginalMimeType(context, file, mimeType);

                 if (Constants.DEBUG) Log.d(Constants.DL_DRM, "Open DRM documentUri:" +
                            documentUri + " MimeType is"
                            + mimeType);
                }
                /// @}
            }
