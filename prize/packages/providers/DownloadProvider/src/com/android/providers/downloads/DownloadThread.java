...
public class DownloadThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            if (Downloads.Impl.OMA_DOWNLOAD_SUPPORT
                ...
                try {
                    ...
                    Log.e(Constants.LOG_OMA_DL, "DownloadThread: New notify url failed" + mInfoDelta.mOmaDownloadInsNotifyUrl);
                }
            ...
            /// M: Add for fix GMS low memory issue 332710. @{
            if (Constants.DEBUG) Log.d(Constants.DL_ENHANCE, "after notifyDownloadCompleted"
        ...
        if (Downloads.Impl.isStatusCompleted(mInfoDelta.mStatus)) {
            /// M: The mInfo is out of date and it can not call media scanner
            /// correctly. So, we need to query from DB to make sure the scanner
            /// can work properly. @{
            DownloadInfo tempInfo = DownloadInfo.queryDownloadInfo(mContext, mId);
            if (null != tempInfo && tempInfo.shouldScanFile(mInfoDelta.mStatus)) {
                    ...
                    case HTTP_UNAUTHORIZED:
                        if ((mInfo.mUsername != null || mInfo.mPassword != null)
                            ...
                            if (headerAuthString != null) {
                                Log.d(Constants.DL_ENHANCE, "response.getFirstHeader WWW-Authenticate is: "
                                        + headerAuthString);
                                ...
                                if (innerState.mAuthHeader != null) {
                                   ...
                                   Log.d(Constants.DL_ENHANCE, "Auth scheme and mAuthHeader.scheme is  "
                            ...
                            Log.w(Constants.DL_ENHANCE, "DownloadThread: handleExceptionalStatus:" +
    ...
    private void addRequestHeaders(HttpURLConnection conn, boolean resuming) {
        for (Pair<String, String> header : mInfo.getHeaders()) {
            ...
            if (header.first.equalsIgnoreCase("Referer") &&
                 ...
                 Log.d(Constants.TAG, "header.first: referer "  +
    ...
    private void notifyOMADownloadWebServerErrorStatus(URL notifyUrl, int notifyCode) {
        if (notifyUrl != null) {
            Log.i(Constants.LOG_OMA_DL, "DownloadThread: catch StopRequest and need to notify web server: " +
            ...
            if (state.mMimeType.equals("application/vnd.oma.dd+xml")) {
                ...
                if (ddFile != null && ddUrl != null) {
                    ...
                    if (omaDescription != null && parseStatus == OmaStatusHandler.SUCCESS) {
                        ...
                        Log.d(Constants.LOG_OMA_DL, "DownloadThread: handleOmaDownloadDescriptorFile(): " +
                        ...
                        Log.w(Constants.LOG_OMA_DL, "DownloadThread: handleOmaDownloadDescriptorFile(): " +
