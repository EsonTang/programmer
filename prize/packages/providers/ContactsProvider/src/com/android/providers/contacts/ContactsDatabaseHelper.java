...
/// M: ALPS03484826 @{
/// add dump code for database locked issue analysis
...
public class ContactsDatabaseHelper extends SQLiteOpenHelper {
    ...
    public interface Tables {
        ...
        public static final String RAW_CONTACTS_JOIN_SETTINGS_DATA_GROUPS = Tables.RAW_CONTACTS
                ...
                + "LEFT OUTER JOIN " + Tables.SETTINGS + " ON ("
                    ...
                    + " ("
                        ...
                        + AccountUtils.ACCOUNT_NAME_LOCAL_PHONE + "' OR "
                        ...
                        + AccountUtils.ACCOUNT_TYPE_LOCAL_PHONE + "'"
                    + " ) OR "
                    /** @} */
        ...
        // TODO For legacy code, need refactor
    ...
    public SQLiteDatabase getWritableDatabase() {
        try {
            ...
            e.printStackTrace();
            Log.e(TAG, "Dump database process usage info:");
            String filename = "/data/data/com.android.providers.contacts/databases/contacts2.db";
            String cmd = "/system/bin/lsof " + filename;
            ...
            try {
                ...
                if (process.exitValue() != 0) {
                    Log.d(TAG, "Dump failed: " + process.exitValue());
                }
...
//        ");");
    ...
    private void createContactsTriggers(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TRIGGER " + Tables.RAW_CONTACTS + "_deleted "
                ...
                + "            WHERE " + RawContacts.CONTACT_ID + "=OLD." + RawContacts.CONTACT_ID
                + "           )=1;"
                /// M: clean search index data if all raw_contacts have been deleted
                + "   DELETE FROM " + Tables.SEARCH_INDEX
                + "     WHERE " + SearchIndexColumns.CONTACT_ID + "=OLD." + RawContacts.CONTACT_ID
                + "       AND (SELECT COUNT(*) FROM " + Tables.RAW_CONTACTS
                + "            WHERE " + RawContacts.CONTACT_ID + "=OLD." + RawContacts.CONTACT_ID
                + "           )=1;"
                /// @}
    ...
    public void createSimSettingInTransaction(AccountWithDataSet accountWithDataSet) {
        ...
        if (AccountUtils.isSimAccount(accountType)) {
    ...
    public boolean updateContactVisible(
        ...
        boolean newVisibility = DatabaseUtils.longForQuery(db,
                ...
                ") OR EXISTS (" +
                    ...
                    " FROM " + Tables.RAW_CONTACTS +
                    " WHERE " + RawContacts.CONTACT_ID + "=?1" +
                    "   AND " + RawContactsColumns.CONCRETE_ACCOUNT_ID + " IN " +
    ...
    public String[] buildSipContactQuery(StringBuilder sb, String sipAddress) {
        ...
        /// M: when query sip number also query ims and phone type number @{
        sb.append(" IN ('" + Long.toString(getMimeTypeIdForSip()) + "', '"
                + Long.toString(getMimeTypeIdForImsCall()) + "', '"
                + Long.toString(getMimeTypeIdForPhone()) + "')");
        /// @}
    ...
    public void updateRawContactDisplayName(SQLiteDatabase db, long rawContactId) {
        ...
        if (sortKeyPrimary != null) {
        	// prize - remove- huangpengfei-2016-8-31-Start
            ...
            // prize - remove- huangpengfei-2016-8-31-end
        	// prize - add- huangpengfei-2016-8-31-Start 
        	String sortKeyPinYin = HanziToPinyin.getInstance().getPinyin(sortKeyPrimary.charAt(0));
        	if (sortKeyPinYin != null && sortKeyPinYin != "") {
        		phonebookBucketPrimary = localeUtils.getBucketIndex(sortKeyPinYin);
        	} else {
        		phonebookBucketPrimary = localeUtils.getBucketIndex(sortKeyPrimary); // Original
        	}
        	phonebookLabelPrimary = localeUtils.getBucketLabel(phonebookBucketPrimary);
