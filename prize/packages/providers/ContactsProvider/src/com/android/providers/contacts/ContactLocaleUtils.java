...
public class ContactLocaleUtils {
    ...
    private static class ContactLocaleUtilsBase {
        ...
        public int getBucketIndex(String name) {
            ...
            /*prize - add - huangpengfei -2016-9-5 - start*/
            if (bucket == 0) {
            return mNumberBucketIndex; // return mNumberBucketIndex which in the "#" type. If want to stay behind the "#"，return mNumberBucketIndex+1
            }
            /*prize - add - huangpengfei -2016-9-5 - end*/
