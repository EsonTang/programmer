...
public class CalendarProvider2 extends SQLiteContentProvider implements OnAccountsUpdateListener {
    ...
    public boolean onCreate() {
        super.onCreate();
        // M: MoMS for controlling database access ability
        // setMoMSPermission(SubPermissions.QUERY_CALENDAR, SubPermissions.MODIFY_CALENDAR);
    ...
    private void sendUpdateNotification(long eventId,
        ...
        /** M: add some log to record dalaly time @{*/
        if (callerIsSyncAdapter) {
            Log.i(CalendarProvider2.TAG, "sendUpdateNotification, delay="
                    + delay);
        }
        /** @}*/
    }
    ...
    private void constructSearchSuggesions(MatrixCursor target, Cursor source) {
        ...
        while (source.moveToNext()) {
            ...
            Log.v(TAG, "constructSearchSuggesions");
