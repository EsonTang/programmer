...
import com.mediatek.phone.ApInfoCollectService;
...
public class PhoneGlobals extends ContextWrapper {
            ...
            switch (msg.what) {
                ...
                case EVENT_SIM_NETWORK_LOCKED:
                    if (getCarrierConfig().getBoolean(
                        ...
                        /** M: Using key guard to replace IccNetworkDepersonalizationPanel,
                         * Exception: msg.obj is not a Phone object but an AsyncResult object.
                         * Original Code:
    ...
    public void onCreate() {
        ...
        if (mCM == null) {
            ...
            Thread phoneGlobalThread = new Thread() {
                public void run() {
                    try {
                        // Start TelephonyDebugService After the default phone is created.
                        Intent intent = new Intent(sMe, TelephonyDebugService.class);
                        startService(intent);
                    } catch (Exception e) {
                        Log.e(LOG_TAG, "System not allowing to start Debug Service");
                    }
                }
            };
            phoneGlobalThread.start();

            // Start ApInfoCollectService After the default phone is created.
            if (ApInfoCollectService.getApInfoToMonitor() > 0) {
                Intent serviceIntent = new Intent(this,
                        com.mediatek.phone.ApInfoCollectService.class);
       ...
       /// M: CC: Check ECC state according to TeleService state
       mTelEx = ITelephonyEx.Stub.asInterface(
    ...
    private void maybeTurnCellOff(Context context, boolean isAirplaneNewlyOn) {
        if (isAirplaneNewlyOn) {
            ...
            if (mTelEx != null) {
                try {
                    isInEcc = mTelEx.isEccInProgress();
                } catch (RemoteException e) {
                    Log.e(LOG_TAG, "Exception of isEccInProgress");
                }
            } else {
                Log.e(LOG_TAG, "ITelephonyManagerEx is null");
            }
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_AIRPLANE_MODE_CHANGED)) {
                ...
                */
                ...
                int airplaneMode = enabled? AIRPLANE_ON: AIRPLANE_OFF;
                ...
                /// M: Google issue, getPhone using subId @{
                ...
                Log.d(LOG_TAG, "call notifier to update notification icon when IPO");
    ...
    ///M: Listen sim hot swap related change. {@
