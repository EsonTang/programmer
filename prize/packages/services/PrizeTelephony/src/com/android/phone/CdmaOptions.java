...
public class CdmaOptions {
    ...
    protected void create() {
        ...
        ///  M: Some CDMA carriers want the APN settings.
        /* TODO: Temple solution for CDMA remove APN
        ...
        */
        /// M: for 03032561, remove APN entry as it also shows in GsmUmtsOptions in worldMode @{
        if (isWorldMode() && mButtonAPNExpand != null) {
            mPrefScreen.removePreference(mButtonAPNExpand);
            removedAPNExpand = true;
        }
        /// @}
    ...
    private boolean isWorldMode() {
        ...
        final TelephonyManager tm = (TelephonyManager) mPrefActivity
                .getSystemService(Context.TELEPHONY_SERVICE);
        final String configString = mPrefActivity.getResources().getString(
