...
public class OutgoingCallBroadcaster extends Activity
    ...
    public class OutgoingCallReceiver extends BroadcastReceiver {
        ...
        public boolean doReceive(Context context, Intent intent) {
            ...
            if (TelephonyCapabilities.supportsOtasp(app.getPhone())) {
            ...
            if (number == null) {
                ...
                return false;
            } else if (TelephonyCapabilities.supportsOtasp(app.getPhone())
                    && (app.getPhone().getState() != PhoneConstants.State.IDLE)
                    && (app.getPhone().isOtaSpNumber(number))) {
