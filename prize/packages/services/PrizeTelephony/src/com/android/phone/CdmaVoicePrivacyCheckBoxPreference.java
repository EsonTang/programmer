...
public class CdmaVoicePrivacyCheckBoxPreference extends CheckBoxPreference {
    ...
    public void setPhone(Phone phone) {
        mPhone = phone;
        mPhone.getEnhancedVoicePrivacy(mHandler
                               .obtainMessage(MyHandler.MESSAGE_GET_VP));
    }
    ...
    protected void onClick() {
        ...
        mPhone.enableEnhancedVoicePrivacy(isChecked(),
    ...
    private class MyHandler extends Handler {
        ...
        private void handleGetVPResponse(Message msg) {
            ...
            if (ar.exception != null) {
                ...
                Log.d(LOG_TAG, "Voice privacy value returned:" + enable);
                setChecked(enable != 0);
        ...
        private void handleSetVPResponse(Message msg) {
            ...
            mPhone.getEnhancedVoicePrivacy(obtainMessage(MESSAGE_GET_VP));
        }
    }
}
