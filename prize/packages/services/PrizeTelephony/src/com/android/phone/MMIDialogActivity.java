...
public class MMIDialogActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /// M: fix CR:ALPS02786033,add IMSPhone register about MMIDialogActivity.(CallManager
        /// register include IMSPhone and GSMPhone) @{
        CallManager.getInstance().registerForMmiComplete(mHandler, PhoneGlobals.MMI_COMPLETE, null);
        /// @}
