...
public class PhoneAccountSettingsFragment extends PreferenceFragment
    ...
    private static final String ALL_CALLING_ACCOUNTS_KEY = "all_calling_accounts";
    ...
    public void onCreate(Bundle icicle) {
        ...
        /// M: update the phone account preference when receive the phone account change message @{
        registerPhoneAccountChangeReceiver();
        /// @}
    }

    /*PRIZE-set the padding of left and right-yuandailin-2016-8-2-start*/
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        /*PRIZE-Add-DialerV8-wangzhong-2017_7_19-start*/
        mView = view;
        view.setBackgroundColor(inflater.getContext().getResources().getColor(R.color.prize_preferences_lowest_bg));
        /*PRIZE-Add-DialerV8-wangzhong-2017_7_19-end*/
        return view;
    }
    /*PRIZE-set the padding of left and right-yuandailin-2016-8-2-end*/
    ...
    public void onResume() {
        ...
        addPreferencesFromResource(R.xml.prize_phone_account_settings);
        View listView = mView.findViewById(android.R.id.list);
        if (null != listView && listView instanceof android.widget.ListView) {
            /*listView.setPadding(40, listView.getPaddingTop(), 40, listView.getPaddingBottom());*/
    ...
    private void initAccountList(List<PhoneAccountHandle> enabledAccounts) {
        ...
        for (PhoneAccount account : accounts) {
            ...
            /*PRIZE-Add-DialerV8-wangzhong-2017_7_19-start*/
            accountPreference.setLayoutResource(R.layout.prize_preference_mid_item);
            /*PRIZE-Add-DialerV8-wangzhong-2017_7_19-end*/
    ...
    public static Intent buildPhoneAccountConfigureIntent(
        ...
        Log.d(LOG_TAG, "get intent: " + intent);
        return intent;
    }
    ...
    // ----------------------------------- mtk -----------------------------------------
    private final String TAG = "PhoneAccountSettingsFragment";
    ...
    private BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            Log.d(TAG, "--- update phone account preference ---");
            updatePhoneAccountPreference();
        }
    };

    private void updatePhoneAccountPreference() {
        List<PhoneAccountHandle> enabledAccounts =
            getCallingAccounts(true, false);
        initAccountList(enabledAccounts);
    }
