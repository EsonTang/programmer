    ...
    /* package */ void updateCfi(int subId, boolean visible) {
        ...
        if (visible) {
            ...
            Notification.Builder builder = new Notification.Builder(mContext)
                    ...
                    .setSmallIcon(R.drawable.prize_callforward_notification)
            ...
            for (int i = 0; i < users.size(); i++) {
                ...
                Notification notificationForward = builder.build();
                notificationForward.flags |= Notification.FLAG_KEEP_NOTIFICATION_ICON;
