...
public class SimErrorDialog extends AlertDialog implements OnClickListener {
    ...
    public SimErrorDialog(Context context, ArrayList<String> dialogInformation) {
		...
		/*PRIZE-change-yuandailin-2016-6-3-start*/
//        getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_ALERT);
		getWindow().setType(WindowManager.LayoutParams.TYPE_SYSTEM_DIALOG);
		/*PRIZE-change-yuandailin-2016-6-3-end*/
        ...
        setOnDismissListener(new DialogInterface.OnDismissListener() {
            public void onDismiss(DialogInterface dialog) {
                ...
                Log.d(SimErrorDialog.this, "SimErrorDialog dismissed: " + SimErrorDialog.this);
            }
        });
    ...
    public void onClick(DialogInterface dialog, int which) {
        switch (which) {
            case DialogInterface.BUTTON_POSITIVE:
                if (TelephonyConnectionServiceUtil.getInstance().isCellConnMgrAlive()) {
