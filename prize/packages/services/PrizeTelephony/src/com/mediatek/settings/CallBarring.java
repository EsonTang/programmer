...
public class CallBarring extends TimeConsumingPreferenceActivity implements
    ...
    protected void onCreate(Bundle icicle) {
        ...
        addPreferencesFromResource(R.xml.prize_mtk_call_barring_options);
        ...
        if (carrierConfig.getBoolean(CarrierConfigManager.KEY_SUPPORT_VT_SS_BOOL)) {
            ...
            GsmUmtsVTUtils.setCBServiceClass(prefSet, serviceClass);
            int resId = GsmUmtsVTUtils.getActionBarResId(serviceClass, GsmUmtsVTUtils.CB_TYPE);
