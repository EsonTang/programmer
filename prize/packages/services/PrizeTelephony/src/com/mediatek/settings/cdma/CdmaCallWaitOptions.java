...
public class CdmaCallWaitOptions {
    ...
    public Dialog createDialog() {
        ...
        return dialog;*/
        View contentView = android.view.LayoutInflater.from(mContext).inflate(R.layout.prize_mtk_cdma_cf_dialog, null);
        final RadioGroup radioGroup = (RadioGroup) contentView.findViewById(R.id.group);
        final TextView textView = (TextView) contentView.findViewById(R.id.dialog_sum);
        if (textView != null) {
            textView.setVisibility(View.GONE);
        }
        EditText editText = (EditText) contentView.findViewById(R.id.EditNumber);
        if (editText != null) {
            editText.setVisibility(View.GONE);
        }
