...
public class CallBarringBasePreference extends CheckBoxPreference implements
    ...
    public static final int EXCEPTION_ERROR = TimeConsumingPreferenceActivity.EXCEPTION_ERROR;
    ...
    protected void onClick() {
        // do not set check flag until get successful result form fwk.
        // super.onClick();
    ...
    private void doPreferenceClick(final String title) {
        ...
        final View textEntryView = inflater.inflate(R.layout.prize_mtk_callbarring_option, null);
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if (!validatePassword(password)) {
                            ...
                            if (TelephonyUtils.shouldShowOpenMobileDataDialog(
                                ...
                                TelephonyUtils.showOpenMobileDataDialog(getContext(),
                                        mPhone.getSubId());
                                return;
                            }
                            /// @}
    ...
    private void getCallState(String facility, String password, boolean reason) {
        ...
        if (carrierConfig.getBoolean(CarrierConfigManager.KEY_SUPPORT_VT_SS_BOOL)) {
            mPhone.getFacilityLockForServiceClass(facility, password, mServiceClass, m);
        } else {
    ...
    private void setCallState(String facility, boolean enable, String password) {
        ...
        if (carrierConfig.getBoolean(CarrierConfigManager.KEY_SUPPORT_VT_SS_BOOL)) {
            mPhone.setFacilityLockForServiceClass(facility, enable, password, mServiceClass, m);
        } else {
        ...
        private void handleSetCallBarringResponse(Message msg) {
            ...
            if (ar.exception != null) {
                ...
                if (ar.exception instanceof CommandException) {
                    if (mTcpListener != null) {
                        /// M: for plug-in to handle UT_XCAP_404_NOT_FOUND or UT_XCAP_409_CONFLICT
                        if (!ExtensionManager.getCallFeaturesSettingExt().handleErrorDialog(
                                mContext, ar, CallBarringBasePreference.this)) {
                            mTcpListener.onException(CallBarringBasePreference.this,
            ...
            if (ar.exception != null) {
                ...
                if (ar.exception instanceof CommandException) {
                    ...
                    if (ce.getCommandError()
                        ...
                        /// @}
                        if (mTcpListener != null) {
                            mTcpListener.onException(CallBarringBasePreference.this, ce);
                        }
                    }
                } else {
    ...
    public void setServiceClass(int serviceClass) {
        Log.d(LOG_TAG, "set service class: " + serviceClass);
