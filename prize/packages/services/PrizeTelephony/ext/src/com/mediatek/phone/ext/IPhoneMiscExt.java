...
public interface IPhoneMiscExt {
     ...
     * @internal
     */
    String[] addCurrentNetworkToSelectionListIndex(String[] entryValues);
     ...
     * @internal
     */
    CharSequence[] addCurrentNetworkToSelectionListValue(CharSequence[] entries);
     ...
     * @internal
     */
    boolean onPreferenceChange(int index);
     ...
     * @internal
     */
   int getCurrentNetworkIndex(int index);
