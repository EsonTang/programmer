...
public interface ICallForwardExt {
    ...
    public void updateCfiIcon(int subId, Context context, ICfiAction cfiAction);
     ...
     /**
     * update time slot cfu icon with visible
     * @param visible
     * @param subId
     * @param context
     * @param cfiAction
     * @param visible
     */
    public void updateCfiIconEx(int subId, Context context, ICfiAction cfiAction, boolean visible);
    ...
    /**
     * if enable CFUInTimeSlot, do not call common notificationMgr.updateCfi
     * @param subId
     * @return true when enable CFUInTimeSlot
     */
    public boolean isEnableCFUInTimeSlot(int subId);
}
