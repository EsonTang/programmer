...
public class PhoneRecorder extends Recorder {
    ...
    private static final String TAG = PhoneRecorder.class.getSimpleName();
    ...
    /**
     * PhoneRecorder is a singleton, not allowed multiply object to start record
     * @param context
     * @return
     */
    public synchronized static PhoneRecorder getInstance(Context context) {
    ...
    /**
     * PhoneRecorder is a singleton, and its method are called in a single thread
    ...
    public void stopRecord() {
        ...
        if (isStorageAvailable) {
            ...
            fireRecordFinished(Recorder.SUCCESS, path);
        } else {
            deleteSampleFile();
            fireRecordFinished(Recorder.STORAGE_UNMOUNTED, null);
        }
    }
