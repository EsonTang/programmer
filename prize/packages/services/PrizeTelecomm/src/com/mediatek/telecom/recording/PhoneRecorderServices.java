...
public class PhoneRecorderServices extends Service {
    ...
    private PhoneRecorder.OnStateChangedListener
            mPhoneRecorderStateListener = new PhoneRecorder.OnStateChangedListener() {
    ...
    private final IPhoneRecorder.Stub mBinder = new IPhoneRecorder.Stub() {
        ...
        /**
         * No place will call this method again, should be removed on android N
         * @return isRecording
         */
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            if (mPhoneRecorder != null && (Intent.ACTION_MEDIA_EJECT.equals(intent.getAction())
                ...
                if (mPhoneRecorder.isRecording()) {
                    mRecordHandler.removeCallbacks(mRecordDiskCheck);
                    log("Current used sd card is ejected, stop voice record");
                    mRecordHandler.sendMessage(
                            mRecordHandler.obtainMessage(REQUEST_STOP_RECORDING));
                }
            }
        }
    };
    ...
    private void checkRecordDisk() {
        if (mPhoneRecorder != null && mPhoneRecorder.isRecording()
