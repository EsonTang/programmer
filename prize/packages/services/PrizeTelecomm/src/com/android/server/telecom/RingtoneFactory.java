...
public class RingtoneFactory {
    ...
    public Ringtone getRingtone(Call incomingCall) {
        ...
        if(ringtone == null) {
            ...
            /* -- modify by liangchagnwei for dualcard ringtone setting-----*/
			if((incomingCall.getSubId()== SubscriptionManager.getSubId(1)[0])&&(SubscriptionManager.from(hasDefaultRingtoneForUser(userContext)? userContext : mContext).getActiveSubscriptionInfoList().size() == 2)){
			    ringtone = RingtoneManager.getRingtone(
					 hasDefaultRingtoneForUser(userContext)? userContext : mContext,
