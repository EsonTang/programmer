...
public abstract class Runnable {
    ...
    /**
     * FIXME: Deprecated, the loggedRun no longer synchronized, no need such handling.
     * M: This method is prepared to clean up the active session, but to avoid deadlock, this
     * method is asynchronous, which may lead to disorder of the session logs when Runnable
     * is already running in handler. So farthest avoid to use this method in normal case. @{
     */
    @Deprecated
    public void cancelAllowingSynchronizedError() {
        Log.cancelSubsession(mSubsession);
        mSubsession = null;
    }
    /** @} */
