    ...
    public void onReceive(Context context, Intent intent) {
        if (SECRET_CODE_ACTION.equals(intent.getAction()) && intent.getData() != null &&
            ...
            if (intent.getData().getHost().equals(TELECOM_SECRET_CODE_DEBUG_ON)) {
                ...
                /// M: [log optimize] @{
                TelecomUtils.showToast("Telecom debug log on.");
                TelecomUtils.setUpgradeLoggingEnabled(true);
                /// @}
                ...
                /// M: [log optimize] @{
                TelecomUtils.showToast("Telecom debug log off.");
                TelecomUtils.setUpgradeLoggingEnabled(false);
                /// M: @}
                ...
                /// M: [log optimize]
                TelecomUtils.showToast("Telecom log current call.");
            }
        }
    }
}
