...
public final class TelephonyUtil {
    ...
    public static boolean shouldProcessAsEmergency(Context context, Uri handle) {
        return handle != null && PhoneNumberUtils.isLocalEmergencyNumber(
                context, handle.getSchemeSpecificPart() != null ?
                    handle.getSchemeSpecificPart().replaceAll("\\s", "") : "");
    }
    ...
    public static boolean isPstnComponentNameEx(ComponentName componentName) {
        return isPstnComponentName(componentName);
    }
    /// @}
