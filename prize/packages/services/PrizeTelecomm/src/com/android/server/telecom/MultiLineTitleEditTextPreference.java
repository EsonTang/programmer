    ...
    protected void onDialogClosed(boolean positiveResult) {
        if (positiveResult) {
            ...
            if (value.trim().equals("")) {
                android.widget.Toast.makeText(getContext(), R.string.prize_quick_reply_message_warning,
                        android.widget.Toast.LENGTH_LONG).show();
            } else if (value.trim().length() > 50) {
                android.widget.Toast.makeText(getContext(), R.string.prize_quick_reply_message_warning2,
                        android.widget.Toast.LENGTH_LONG).show();
            } else {
