...
public class TelecomSystemTest extends TelecomTestCase {
    ...
    public void setUp() throws Exception {
        ...
        log("[setUp]exit TelecomSystemTest.setUp()");
    }
    ...
    ///M: @{
    /**
     * copy from startAndMakeActiveIncomingCall()
     * the only difference is that delay 200ms to set call as active
     */
    protected IdPair startAndMakeActiveIncomingVideoCall(
            String number,
            PhoneAccountHandle phoneAccountHandle,
            ConnectionServiceFixture connectionServiceFixture,
            int videoState) throws Exception {
