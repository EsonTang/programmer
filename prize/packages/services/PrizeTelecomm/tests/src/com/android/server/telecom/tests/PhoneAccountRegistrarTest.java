...
public class PhoneAccountRegistrarTest extends TelecomTestCase {
    ...
    public void testPhoneAccountHandle() throws Exception {
        PhoneAccountHandle input = new PhoneAccountHandle(new
                         ComponentName("pkg0", "cls0.class"), "id0");
        ...
        PhoneAccountHandle inputN = new PhoneAccountHandle(new
                            ComponentName("pkg0", "cls0.class"), null);
