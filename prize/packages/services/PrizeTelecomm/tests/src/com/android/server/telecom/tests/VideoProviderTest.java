...
public class VideoProviderTest extends TelecomSystemTest {
    ...
    private Answer mVerification = new Answer() {
        ...
        public Object answer(InvocationOnMock i) {
            log("[answer]" + i + " invoked, countDown the lock: " + mVerificationLock);
            mVerificationLock.countDown();
            Log.d(VideoProviderTest.this, "Verification finish count down");
            return null;
        }
    };
    ...
    public void setUp() throws Exception {
        ...
        Log.d(VideoProviderTest.this, "set up mock object of mVideoCallCallback");
        ...
        log("[setUp]add mock mVideoCallCallback: " + mVideoCallCallback
                + " to mVideoCall: " + mVideoCall);
    ...
    public void testSessionEvent() throws Exception {
        ...
        Log.d(VideoProviderTest.this, "finish to send SESSION_EVENT_CAMERA_READY");

        mVerificationLock.await(TEST_TIMEOUT, TimeUnit.MILLISECONDS);
        Log.d(VideoProviderTest.this, "VerificationLock finish await due to timeout");
    ...
    public void testPeerDimensionChange() throws Exception {
        ...
        /// M: Waiting for call back registered.
        Thread.sleep(1000);
        log("[testPeerDimensionChange]sending peer dimensions");
        ...
        log("[testPeerDimensionChange]verify mVideoCallCallback: " + mVideoCallCallback);
        verify(mVideoCallCallback, timeout(TEST_TIMEOUT))
