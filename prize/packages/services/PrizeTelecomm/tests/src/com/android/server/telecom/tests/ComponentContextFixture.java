...
public class ComponentContextFixture implements TestFixture<Context> {
        ...
        public Object getSystemService(String name) {
            switch (name) {
                ...
                case Context.LAYOUT_INFLATER_SERVICE:
                    Log.d("LayoutInflater", "inflater service ...");
                    return mAppContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                default:
                    return null;
            }
        }
        ...
        public ContentResolver getContentResolver() {
            return new ContentResolver(mApplicationContextSpy) {
                ...
                private IContentProvider getOrCreateProvider(String name) {
                    /// M: Add synchronized to avoid multi-thread problem. @{
                    synchronized (mIContentProviderByUri) {
    ...
    private final SharedPreferences mSharedPreference = mock(SharedPreferences.class);
    ...
    public ComponentContextFixture() {
        ...
        }).when(mAppOpsManager).noteOp(anyInt());
        ...
        when(mEditor.putBoolean(any(String.class), anyBoolean())).thenReturn(mEditor);
    }
    ...
    public void addConnectionService(
        ...
        serviceInfo.permission = android.Manifest.permission.BIND_TELECOM_CONNECTION_SERVICE;
    ...
    private List<ResolveInfo> doQueryIntentServices(Intent intent, int flags) {
        ...
        Log.d("queryIntentService", "intent = %s", intent.getAction());
        for (ComponentName componentName : mComponentNamesByAction.get(intent.getAction())) {
            ...
            Log.d("queryIntentService", "permission = %s", resolveInfo.serviceInfo.permission);
        }
        return result;
    }
}
