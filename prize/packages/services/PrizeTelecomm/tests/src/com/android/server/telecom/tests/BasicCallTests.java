...
public class BasicCallTests extends TelecomSystemTest {
    ...
    public void testIncomingCallFromContactWithSendToVoicemailIsRejected() throws Exception {
        ...
        /**
         * M: After the 1st query, the CallScreening feature need the additional query
         * for DirectToVoicemailCallFilter. We have to make CallerInfo returned as expected.
         * google default :
        ...
        CallerInfo sendToVoicemailCallerInfo = new CallerInfo();
        sendToVoicemailCallerInfo.shouldSendToVoicemail = true;
        Log.d(BasicCallTests.this, "Rui     : replyWithCallerInfo");
        mCallerInfoAsyncQueryFactoryFixture.setAutoReplyCallerInfo(sendToVoicemailCallerInfo);
        /** @} */
        ...
        verify(mInCallServiceFixtureY.getTestDouble(), never())
                .setInCallAdapter(any(IInCallAdapter.class));
        /// M: restore the previous state after this test case done
        mCallerInfoAsyncQueryFactoryFixture.clearAutoReplyCallerInfo();
    }
