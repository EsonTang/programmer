...
public class AudioManager {
    ...
    public void setSpeakerphoneOn(boolean on){
        ...
        //M:chenteng-20180508-add callingPackage name for debug
        Log.d(TAG, "setSpeakerphoneOn callingPackage is " + mApplicationContext.getOpPackageName());
        try {
    ...
    */
     ...
     * @hide
     *
     * SysResMonitor apk: monitor audio player processes.  prize-linkh-20181204 @{
     * @return the pids of processes that are playing audio, or return 
     *   NULL if not found.
     */
    public static int[] getActiveAudioPids() {
        final String pidsString = AudioSystem.getParameters("getActiveAudioPids");
        if (pidsString == null || pidsString.isEmpty()) {
            return null;
        }

        ArrayList<Integer> list = null;
        String[] pidsArray = pidsString.split(":");
