...
public class RingtoneManager {
     ...
     * Type that refers to sounds that are used for notifications.
     */
    public static final int TYPE_NOTIFICATION2 = 64;
    ...
    private void setFilterColumnsList(int type) {
        ...
        columns.clear();
        if (((type & TYPE_RINGTONE) != 0) || ((type & TYPE_RINGTONE2) != 0)) {
            columns.add(MediaStore.Audio.AudioColumns.IS_RINGTONE);
        }
        
        if (((type & TYPE_NOTIFICATION) != 0) || ((type & TYPE_NOTIFICATION2) != 0)) {
...
*/
    ...
    private static String getSettingForType(int type) {
        ...
        } else if ((type & TYPE_NOTIFICATION2) != 0) {
            return Settings.System.NOTIFICATION2_SOUND;
        }{
            return null;
        }
    }
    ...
    public static Uri getCacheForType(int type) {
        if ((type & TYPE_RINGTONE) != 0) {
            ...
            return Settings.System.RINGTONE2_CACHE_URI;
        } else if ((type & TYPE_NOTIFICATION2) != 0) {
            return Settings.System.NOTIFICATION2_SOUND_CACHE_URI;
        }{
            return null;
        }
    }
    ...
    public static int getDefaultType(Uri defaultRingtoneUri) {
        if (defaultRingtoneUri == null) {
            ...
            return TYPE_ALARM;
		} else if (defaultRingtoneUri.equals(Settings.System.DEFAULT_RINGTONE2_URI)) {
			return TYPE_RINGTONE2;
		} else if (defaultRingtoneUri.equals(Settings.System.DEFAULT_NOTIFICATION2_URI)) {
			return TYPE_NOTIFICATION2;
        } else {
            return -1;
        }
    }
