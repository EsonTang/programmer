...
//prize add by xiarui 2018-06-06 start @{
                         ...
                         implements SubtitleController.Listener
{
    ...
    public void setDataSource(@NonNull Context context, @NonNull Uri uri,
        ...
        if (scheme == null) {
            ...
            //prize add by xiarui for intercept com.tencent.mm notification ringtone 2018-06-06 @{
            if (PrizeOption.PRIZE_VIBRATE_CONTROL) {
                Log.i(TAG, "setDataSource type = " + type + " , packageName = " + resolver.getPackageName());
                if (shouldIntercept(context, resolver.getPackageName(), type)) {
                    Log.i(TAG, "Intercept notification ringtone from com.tencent.mm in zen mode !");
                    return;
                }
            }
            //@}
    ...
    private boolean shouldIntercept(Context context, String packageName, int type) {
        NotificationManager notificationManager =
                context.getSystemService(NotificationManager.class);
        int zen = notificationManager.getZenMode();
        ...
        if (zenModeEnabled
                ...
                && packageName != null && "com.tencent.mm".equals(packageName)) {
            return true;
        }
        return false;
    }
    ...
    private class EventHandler extends Handler
    {
        ...
        public void handleMessage(Message msg) {
            ...
            case MEDIA_PLAYBACK_COMPLETE:
                ...
                if(msg.arg1 == 1122 && msg.arg2 == 3344)
                {
                   if (mAudioManager == null) {
				   	   Context context = ActivityThread.currentApplication();
                       mAudioManager = (AudioManager) context.getSystemService(Context.AUDIO_SERVICE);
                   }
				   Log.d(TAG, "qihoo360 completed call setMode to 0");
            ...
            case MEDIA_STOPPED:
                ...
                if(msg.arg1 == 1122 && msg.arg2 == 3344)
                {
                   ...
                   Log.d(TAG, "qihoo360 stopped call setMode to 0");
                   mAudioManager.setMode(0);
                }
                break;
