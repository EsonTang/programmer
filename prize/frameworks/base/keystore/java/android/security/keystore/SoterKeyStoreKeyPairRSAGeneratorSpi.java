...
public class SoterKeyStoreKeyPairRSAGeneratorSpi extends KeyPairGeneratorSpi {
    ...
    private X509Certificate generateSelfSignedCertificate(
		...
		//Log.d("Soter", "generateSelfSignedCertificate");  //Microtrust-Delete wechat Sensitive Information;
															  
        String signatureAlgorithm =
        getCertificateSignatureAlgorithm(mKeymasterAlgorithm, mKeySizeBits, mSpec);
        if (signatureAlgorithm == null) {
			//Log.d("Soter", "generateSelfSignedCertificateWithFakeSignature1"); //Microtrust-Delete wechat Sensitive Information;
            ...
            try {
				//Log.d("Soter", "generateSelfSignedCertificateWithValidSignature");  //Microtrust-Delete wechat Sensitive Information;
                ...
                // generation failing.
				//Log.d("Soter", "generateSelfSignedCertificateWithFakeSignature2");  //Microtrust-Delete wechat Sensitive Information;
                return generateSelfSignedCertificateWithFakeSignature(publicKey);
            }
        }
    }
    ...
    private byte[] getRealKeyBlobByKeyName(String keyName) {
        //Log.d("Soter", "start retrieve key blob by key name: " + keyName);  //Microtrust-Delete wechat Sensitive Information;
