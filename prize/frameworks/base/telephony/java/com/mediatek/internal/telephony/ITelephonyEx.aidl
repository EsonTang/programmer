...
interface ITelephonyEx {
  ...
  /**
   ...
   /**
     ...
     * @hide
     */
    String getUimImsiBySubId(int subId);
   ...
   /**
     ...
     * @hide
     */
    boolean isPhoneTypeGsm(int slotId);

    /**
     * Check wheter phone type is CDMA.
     * @param slotId
     * @return
     * @hide
     */
    boolean isPhoneTypeCdma(int slotId);

    /**
     * Check wheter phone type is CDMA+LTE.
     * @param slotId
     * @return
     * @hide
     */
    boolean isPhoneTypeCdmaLte(int slotId);
     ...
     * @hide
     */
    boolean isMccMncMarkedAsRoaming(int slotId, String mccMnc);
     ...
     * @hide
     */
    boolean isMccMncMarkedAsNonRoaming(int slotId, String mccMnc);

   /**
     * Set the Pseudo Bs feature on.
      * @param slotId.
     * @param reportOn true for URC report on and false for URC report off
     * @param reportRateInSeconds times in seconds for report rate, must in 1 - 65535
     */
   void enablePseudoBSMonitor(int slotId, boolean reportOn, int reportRateInSeconds);
     ...
     */
    void setAntiPseudoCellMode(int slotId, int apcMode, boolean reportOn,
     ...
     * @hide
     */
    String getFullIccSerialNumber(int slotId);

    /*
    * Enable/ disable game modem enhancement
    * param onOff: turn on enhancement if true.
    */
    void requestGameModeEnhancement(boolean onOff);

    /**
     * Get aggregated video call data usage since boot.
     * Permissions android.Manifest.permission.READ_NETWORK_USAGE_HISTORY is required.
     * @param subId The target sub id
     * @return total data usage in bytes
     * @hide
     */
    long getVtDataUsage(int subId);
     ...
     */
    List<CellInfo> getAllCellInfo(int slotId, String callingPackage);
}
