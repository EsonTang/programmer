...
interface IImsConfig {
     ...
     */
    int[] setImsCfg(in String[] keys, in String[] values, int phoneId);
     ...
     * @return value in int array format (success is 0, fail is -1)
     */
    int[] setImsWoCfg(in String[] keys, in String[] values, int phoneId);
     ...
     * @return value in int array format (success is 0, fail is -1)
     */
    int[] setImsIwlanCfg(in String[] keys, in String[] values, int phoneId);
}
