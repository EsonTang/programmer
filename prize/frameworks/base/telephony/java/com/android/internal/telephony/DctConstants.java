...
public class DctConstants {
    ...
    public static final int EVENT_PCO_STATUS = MTK_BASE + 15;

    // M: IA- change attach APN
    public static final int EVENT_ATTACH_APN_CHANGED = MTK_BASE + 16;

    // M: Multi-PS Attach Start
    public static final int EVENT_DATA_ALLOWED = MTK_BASE + 17;
    // M: Multi-PS Attach End

    // M: Roaming type changed
    public static final int EVENT_ROAMING_TYPE_CHANGED = MTK_BASE + 18;
    /** M: end */

    // M: Data Retry
    public static final int EVENT_MD_DATA_RETRY_COUNT_RESET = MTK_BASE + 19;

    // M: Data Enabled Settings
    public static final int EVENT_DATA_ENABLED_SETTINGS = MTK_BASE + 20;
