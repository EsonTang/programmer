    ...
    public static int getRafFromNetworkType(int type) {
        ...
        // / M: @{
            case RILConstants.NETWORK_MODE_LTE_GSM:
                raf = RAF_LTE | GSM;
                break;
            case RILConstants.NETWORK_MODE_CDMA_GSM:
                raf = CDMA | GSM;
                break;
            case RILConstants.NETWORK_MODE_CDMA_EVDO_GSM:
                raf = CDMA | EVDO | GSM;
                break;
            case RILConstants.NETWORK_MODE_LTE_CDMA_EVDO_GSM:
                raf = RAF_LTE | CDMA | EVDO | GSM;
                break;
        // / @}
            default:
                raf = RAF_UNKNOWN;
...
/// @}
        // /M: @{
            case (LTE | GSM):
                ...
                break;
            case (CDMA | GSM):
                type = RILConstants.NETWORK_MODE_CDMA_GSM;
                break;
            case (CDMA | EVDO | GSM):
                type = RILConstants.NETWORK_MODE_CDMA_EVDO_GSM;
                break;
            case (LTE | CDMA | EVDO | GSM):
                type = RILConstants.NETWORK_MODE_LTE_CDMA_EVDO_GSM;
                break;
        // / @}
            default:
