...
public class WifiManager {
    ...
    private static final int MIN_RSSI = -95;   // prize-modify-by-yanghao-20160805

    /** Anything better than or equal to this will show the max bars. */
    private static final int MAX_RSSI = -67;  // prize-modify-by-yanghao-20160805
    ...
    */
    ...
    public static int calculateSignalLevel(int rssi, int numLevels) {
		...
		// prize-add-by-yanghao-20160805-start 
		if (numLevels == 5)
		{	
			if (rssi >= -78 && rssi <= -68)
			{
		...
		Log.d(TAG, "calculateSignalLevel , other numLevels");	
		// prize-add-by-yanghao-20160805-end 
