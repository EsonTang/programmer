...
public class WifiScanner {
    ...
    /**
     * M: Enable Verbose Logging for WifiScanningService
     * @param verbose enable verbose log in WifiScanningService
     * @hide
     */
    public void enableVerboseLogging(int verbose) {
        Log.d(TAG, "enableVerboseLogging, pid:" + Process.myPid() + ", tid:" + Process.myTid() +
            ", uid:" + Process.myUid());

        validateChannel();
        mAsyncChannel.sendMessage(CMD_ENABLE_VERBOSE_LOGGING, verbose);
    }
    ...
    /** @hide */
    ///M: Enable Verbose Log in WifiScanningService
    public static final int CMD_ENABLE_VERBOSE_LOGGING      = BASE + 29;
