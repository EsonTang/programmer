...
struct ANDROID_API Typeface {
    ...
    unsigned long fLovelyFontHash;
    unsigned long fEmojiHash;
    bool fCanReplace;
    bool fUseLovelyfont;
    bool fUseLovelyfontEmoji;
#endif
// ================lovelyfonts end  =====================
    ...
    // ================lovelyfonts start=====================
#ifdef MTK_YIQI_FONTS_FRAMEWORK_SUPPORT
    static void updateLovelyfonts();
    static void updateEmojiFonts(char const** fnArray);
    static void clearEmojiFonts();
