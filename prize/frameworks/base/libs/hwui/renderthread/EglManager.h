...
public:
    ...
    /// M: Notify whether current EGL surface is valid or not.
    EGLBoolean isSurfaceValid() const { return mIsSurfaceValid; }
...
private:
    ...
    /// M: Indicate whether current EGL surface is valid or not.
    EGLBoolean mIsSurfaceValid;
