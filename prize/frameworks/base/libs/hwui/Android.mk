...
#================lovelyfonts add start=====================
ifeq ($(strip $(MTK_YIQI_FONTS_FRAMEWORK_SUPPORT)),yes)
include $(CLEAR_VARS)
LOCAL_MODULE := libyiqiTypeface

ifeq ($(findstring 7.,$(PLATFORM_VERSION)),7.)
LOCAL_SRC_FILES_32 := hwui/70/libyiqiTypeface.a
LOCAL_SRC_FILES_64 := hwui/70/lib64yiqiTypeface.a
endif
LOCAL_MULTILIB := both
...
#================lovelyfonts start=====================
ifneq ($(strip $(MTK_YIQI_FONTS_FRAMEWORK_SUPPORT)),yes)
    hwui_src_files += \
       hwui/Typeface.cpp
endif
#================lovelyfonts end=======================
...
ifeq ($(strip $(MTK_PERFSERVICE_SUPPORT)), yes)
    hwui_src_files += mediatek/MTKFrameBudgetIndicator.cpp
    LOCAL_SHARED_LIBRARIES += libdl
    hwui_cflags += -DMTK_PERFSERVICE_SUPPORT
endif
...
#======================lovelyfonts start=================================
ifeq ($(strip $(MTK_YIQI_FONTS_FRAMEWORK_SUPPORT)),yes)
hwui_cflags  += -DMTK_YIQI_FONTS_FRAMEWORK_SUPPORT
endif
#======================lovelyfonts end  =================================
