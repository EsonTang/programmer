...
#define LOG_TAG "GnssLocationProvider-JNI"
...
#ifndef MTK_GPS_MT3337_SUPPORT_JNI
...
static void android_location_GnssLocationProvider_class_init_native(JNIEnv* env, jclass clazz) {
    ...
    #else
        ALOGE("MTK 3337 GPS SUPPORT has been set!!!");
    #endif
    }
}
...
#ifndef MTK_GPS_MT3337_SUPPORT_JNI
    ALOGE("MT3337_GPS_SUPPORT has not been set");
    if (sVzwDebugInterface)
        sVzwDebugInterface->init(&sVzwDebugCallbacks);
#else
    ALOGE("MT3337_GPS_SUPPORT has been set");
#endif
