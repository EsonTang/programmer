...
public class KeyguardServiceDelegate {
	...
	//2018-04-09 add for faceid.
    public void nofityPowerKeyPower(boolean interactive) {
        if (mKeyguardService != null) {
            mKeyguardService.nofityPowerKeyPower(interactive);
        }
    }
    ...
    /*PRIZE-return show virtual key state-liufan-2015-12-14-start*/
    public boolean isAllowShowVirtualKey() {
        if (mKeyguardService != null) {
            mKeyguardState.showing = mKeyguardService.isAllowShowVirtualKey();
        }
        return mKeyguardState.showing;
    }
    /*PRIZE-return show virtual key state-liufan-2015-12-14-end*/
