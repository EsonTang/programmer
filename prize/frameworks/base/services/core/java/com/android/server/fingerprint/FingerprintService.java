...
/*-prize-removed by lihuangyuan,for fingerprint quick unlock-2018-04-08-start*/
import com.mediatek.perfservice.PerfServiceWrapper;
/*-prize-removed by lihuangyuan,for fingerprint quick unlock-2018-04-08-end*/
...
public class FingerprintService extends SystemService implements IBinder.DeathRecipient {
    ...
    public void perfBoost(){
        ...
        if (mPerfService != null) {
            ...
            Slog.e(TAG, "FingerprintService Increase cpu!");
            ...
            Slog.e(TAG, "FingerprintService PerfService is not ready!");
        }
    }
    /*-prize-removed by lihuangyuan,for fingerprint quick unlock-2018-04-08-end*/
    private IFingerprintDaemonCallback mDaemonCallback = new IFingerprintDaemonCallback.Stub() {
        ...
        public void onAcquired(final long deviceId, final int acquiredInfo) {
            ...
            /*-prize-removed by lihuangyuan,for fingerprint quick unlock-2018-04-08-start*/
            if(acquiredInfo == FingerprintManager.FINGERPRINT_ERROR_VENDOR_BASE + 2)
            {
                perfBoost();
            }
            /*-prize-removed by lihuangyuan,for fingerprint quick unlock-2018-04-08-end*/
