...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
 ...
 /*prize-OS8.0_Shutdown-add-yangming-2017_8_12-start*/
    ...
    private void handleShow() {
		...
		if(null != screenShot()){
			//Bitmap mBitmap = big(blurScale(screenShot()));
			Bitmap mBitmap = changeBitmapBrightness(big(blurScale(screenShot())));
		    Drawable mDrawable = new BitmapDrawable(mContext.getResources(), mBitmap);
...
private final class RestartAction extends SinglePressAction implements LongPressAction {
 ...
 /*prize-OS8.0_Shutdown-add-yangming-2017_8_12-start*/
	private static Bitmap changeBitmapBrightness(Bitmap bitmap){
		...
		colorMatrix.setScale(0.3f, 0.3f, 0.3f, 1);
