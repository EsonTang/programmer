        ...
        for (int i = windows.size() - 1; i >= 0; i--) {
            ...
            if (winAnimator.hasSurface()) {
                ...
                if (mPolicy.isForceHiding(win.mAttrs)) {
                    ...
                    if ((DEBUG_KEYGUARD || DEBUG_VISIBILITY) && !IS_USER_BUILD) Slog.v(TAG,
                ...
                for (int i=unForceHiding.size()-1; i>=0; i--) {
                    ...
                    if (a != null) {
                        ...
                        if (first) {
                            ...
                            /* PRIZE-for lockscreen speed-liyongli-2018-04-02 -start*/
                            if(PrizeOption.PRIZE_KEYGUARD_UNLOCK_FAST) {
                                mPostKeyguardExitAnimation.setDuration(10);
                            }/* PRIZE-for lockscreen speed-liyongli-2018-04-02 -end*/                             
    ...
    private void animateLocked(long frameTimeNs) {
        ...
        try {
            ...
            for (int i = 0; i < numDisplays; i++) {
                ...
                if(!PrizeOption.PRIZE_SPLIT_SCREEN_IME_NOTRESIZE) {
