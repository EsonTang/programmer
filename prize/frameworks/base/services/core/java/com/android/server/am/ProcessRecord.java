...
final class ProcessRecord {
    ...
    int appInstanceIndex; // 0 represents this activity is original.
    ...
    ProcessRecord(BatteryStatsImpl _batteryStats, ApplicationInfo _info,
        ...
        /* app multi instances feature. prize-linkh-20151029 */
        if(info != null) {
            appInstanceIndex = info.appInstanceIndex;
        } //end..
    ...
    void toShortString(StringBuilder sb) {
        ...
        /* app multi instances feature. prize-linkh-20151030 */        
        if(ActivityManagerService.DUMP_APP_INST && appInstanceIndex != 0) {
            sb.append(" aii=");
