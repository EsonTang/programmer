...
public class LockSettingsService extends ILockSettings.Stub {
    ...
    /*PRIZE-save mPassword- liufan-2016-06-16-start*/
    private String mPassword;
    /*PRIZE-save mPassword- liufan-2016-06-16-end*/
    // This method should be called by LockPatternUtil only, all internal methods in this class
    ...
    private void setLockPasswordInternal(String password, String savedCredential, int userId)
        ...
        /*PRIZE-save mPassword - liufan-2016-06-16-start*/
        mPassword = password;
        setString("password_check",password,0);//save to database
        /*PRIZE-save mPassword - liufan-2016-06-16-end*/
        if (password == null) {
            clearUserKeyProtection(userId);
            getGateKeeperService().clearSecureUserId(userId);
    ...
    /*PRIZE-add isAnswerRight- liufan-2016-06-16-start*/
    @Override
    public VerifyCredentialResponse isAnswerRight(String password, int userId, int errorTime)
            throws RemoteException {
            String pwd = mPassword;
            if(pwd == null){
                pwd = getString("password_check", null, 0);
                Log.d("xxyy","getString--->Key: password_check-->" + pwd);
            }
    ...
    /*PRIZE-add isAnswerRight- liufan-2016-06-16-end*/
