...
final class LocalDisplayAdapter extends DisplayAdapter {
    ...
    private final class LocalDisplayDevice extends DisplayDevice {
	 ...
	 @Override
	 public void setDisplayOn(int state)
        {
            mState = state;
	     setDisplayState(state);
        }
	 @Override
	 public void setDisplayStateLock(int state,int brightness)
        {
            // Assume that the brightness is off if the display is being turned off.
            assert state != Display.STATE_OFF || brightness == PowerManager.BRIGHTNESS_OFF;

	    boolean stateChanged = (mState != state);
	    boolean brightnessChanged = (mBrightness != brightness) && mBacklight != null;
	                    ...
	                    || oldState == Display.STATE_UNKNOWN) 
	        {
	                if (!Display.isSuspendedState(state)) 
			  {
			      ...
			      currentState = Display.STATE_DOZE;
	                ...
	                {
	                    Slog.d(TAG,"do nothing oldState:"+oldState+",state:"+state);
        ...
        private void setDisplayBrightness(int brightness) 
	 {
            if (DEBUG) {
                Slog.d(TAG, "setDisplayBrightness("
                        + "id=" + mBuiltInDisplayId + ", brightness=" + brightness + ")");
            }
