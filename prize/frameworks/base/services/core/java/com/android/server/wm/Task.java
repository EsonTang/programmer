...
class Task implements DimLayer.DimLayerUser {
    ...
    public void MM2setBounds(Rect bounds) {
        mBounds.set(bounds);
    }
    
    public String prizeGetTaskName() {
        AppWindowToken wtoken = mAppTokens.get(0);
        String str = ""+wtoken;
        String out = null;
        if( str.indexOf("com.tencent.mm") >0 ){ ///.ui.LauncherUI
            Slog.i(TAG, "com.tencent.mm -- pop keyboard" );
            out = "MM";
        }else if( str.indexOf("com.tencent.mobileqq") >0 ){
            Slog.i(TAG, "com.tencent.mobileqq -- pop keyboard" );
            out = "QQ";
        }
        
        return out;
    }
    /* prize-add-split screen-liyongli-20170812-end */
