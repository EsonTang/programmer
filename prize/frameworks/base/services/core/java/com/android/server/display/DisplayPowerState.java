...
final class DisplayPowerState {
	...
	/*-prize-add by chenrui,for debug 2018-05-17-start*/
    private boolean getDebugPowerScreen(){
        return "1".equals(SystemProperties.get("debug.power.screen"));
	}
	/*-prize-add by chenrui,for debug 2018-05-17-end*/
    ...
    private final Runnable mScreenUpdateRunnable = new Runnable() {
        ...
        public void run() {
            ...
            if (mPhotonicModulator.setState(mScreenState, brightness)) {
                if ((false && DEBUG)||getDebugPowerScreen()) {
