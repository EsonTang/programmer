...
public class JobServiceContext extends IJobCallback.Stub implements ServiceConnection {
    ...
    //modify by lihuangyuan,for qq MSFAliveJobService hold wakelock,2018-07-27-start
    private boolean mWakeLockLocked;
    //modify by lihuangyuan,for qq MSFAliveJobService hold wakelock,2018-07-27-end
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        ...
        //modify by lihuangyuan,for qq MSFAliveJobService hold wakelock,2018-07-27-start
        if(!name.getClassName().equals("com.tencent.mobileqq.msf.service.MSFAliveJobService"))
        {
            mWakeLockLocked = true;
            wl.acquire();
            Slog.d(TAG,"onServiceConnected acquire PARTIAL_WAKE_LOCK,name:"+name);
        }
        //modify by lihuangyuan,for qq MSFAliveJobService hold wakelock,2018-07-27-end        
        synchronized (mLock) {
    ...
    private class JobServiceHandler extends Handler {
        ...
        private void closeAndCleanupJobH(boolean reschedule) {
            ...
            synchronized (mLock) {
                ...
                //modify by lihuangyuan,for qq MSFAliveJobService hold wakelock,2018-07-27-start
                if (mWakeLock != null&& mWakeLockLocked/* add by lihuangyuan */) {
                    mWakeLock.release();
                }
                //modify by lihuangyuan,for qq MSFAliveJobService hold wakelock,2018-07-27-end
