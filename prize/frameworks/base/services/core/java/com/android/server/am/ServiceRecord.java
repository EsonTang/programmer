                ...
                public void run() {
                    ...
                    try {
                        ...
                        nm.enqueueNotification(localPackageName, localPackageName,
                                ...
                                outId, userId, appInstanceIndex/* app multi instances feature. prize-linkh-20151208 */);
        ...
        ams.mHandler.post(new Runnable() {
            public void run() {
                ...
                try {
                        ...
                        if(com.mediatek.common.prizeoption.PrizeOption.PRIZE_APP_MULTI_INSTANCES) {
                            inm.cancelNotificationWithTagForAppInst(localPackageName, null,
                                    localForegroundId, userId, appInstanceIndex);
                        } else { //end....
        ...
        ams.mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                nmi.removeForegroundServiceFlagFromNotification(localPackageName, localForegroundId,
                        localUserId, appInstanceIndex/* app multi instances feature. prize-linkh-20151208 */);
            }
        });
    }
    ...
    public String toString() {
        ...
        if(ActivityManagerService.DUMP_APP_INST && appInstanceIndex != 0) {
            sb.append("ServiceRecord{")
                ...
                .append(" aii-").append(appInstanceIndex)
