 ...
 */
final public class ActivityRecord {
    ...
    /*prize-modify by lihuangyuan,for fingerapplock-2018-04-13-start*/
    //final int requestCode;  // code given by requester (resultTo)
    int requestCode;  // code given by requester (resultTo)
    /*prize-modify by lihuangyuan,for fingerapplock-2018-04-13-end*/
    ...
    /* app multi instances feature. prize-linkh-20151022 */
    ...
    void dump(PrintWriter pw, String prefix) {
        ...
        if(ActivityManagerService.DUMP_APP_INST && appInstanceIndex != 0) {
            pw.print(prefix); pw.print("aii="); pw.println(appInstanceIndex);
        } //end...
            ...
            switch (animationType) {
                ...
                case ActivityOptions.ANIM_SCALE_UP:
                   ...
                   /* service.mWindowManager.overridePendingAppTransitionScaleUp(
                            pendingOptions.getStartX(), pendingOptions.getStartY(),
                            pendingOptions.getWidth(), pendingOptions.getHeight());*/
                    service.mWindowManager.overridePendingAppTransitionScaleUpbyDuration(
                            pendingOptions.getStartX(), pendingOptions.getStartY(),
                            pendingOptions.getWidth(), pendingOptions.getHeight(),pendingOptions.getDuration());
                    /* PRIZE- add launch anim - zhouerlong - 20160310 -start */
                    if (intent.getSourceBounds() == null) {
                        intent.setSourceBounds(new Rect(pendingOptions.getStartX(),
                                pendingOptions.getStartY(),
...
/* PRIZE- add launch anim - zhouerlong - 20160310 -start */
        if (processName.toString().equals("com.android.launcher3")&&shortComponentName!=null&&shortComponentName.contains("com.android.launcher3/.Launcher")) {
        	service.mWindowManager.overridePendingAppTransitionScaleDownWithLauncher();
        }
/* PRIZE- add launch anim - zhouerlong - 20160310 -end */
    ...
    static ActivityRecord restoreFromXml(XmlPullParser in,
        ...
        /* app multi instances feature. prize-linkh-20151111 */
        intent.setAppInstanceIndex(appInsIdx);
        //end...
    ...
    public String toString() {
        if (stringName != null) {
            ...
            if(ActivityManagerService.DUMP_APP_INST && appInstanceIndex != 0) {
                return stringName + " t" + (task == null ? INVALID_TASK_ID : task.taskId) + " aii=" + appInstanceIndex + 
                        (finishing ? " f}" : "}");
            }//end...
