...
public class KeyguardStateMonitor extends IKeyguardStateCallback.Stub {
    ...
    /*PRIZE-get virtual key state changed-liufan-2015-12-14-start*/
    private boolean isAllowShowVirtualKey = true;

    public boolean isAllowShowVirtualKey(){
        return isAllowShowVirtualKey;
    }

    @Override // Binder interface
    public void onAllowShowStateChanged(boolean isAllowShow) {
        isAllowShowVirtualKey = isAllowShow;
    }
    /*PRIZE-get virtual key state changed-liufan-2015-12-14-end*/
