...
public final class BroadcastQueue {
    ...
    private final void processCurBroadcastLocked(BroadcastRecord r,
        ...
        if(PrizeOption.PRIZE_APP_MULTI_INSTANCES) {
            if(ActivityManagerService.ENABLE_LOG_BROADCAST) {
                mService.logAppInstancesInfo(ActivityManagerService.LOG_BROADCAST_TAG, "processCurBroadcastLocked(). app=" +  app + ", r=" + r);
            }
        } //end...
    ...
    public boolean finishReceiverLocked(BroadcastRecord r, int resultCode,
        ...
        int appInst = (r.curApp != null) ? r.curApp.appInstanceIndex : 0;
        if(ActivityManagerService.ENABLE_LOG_BROADCAST) {
            mService.logAppInstancesInfo(ActivityManagerService.LOG_BROADCAST_TAG, 
                "finishReceiverLocked(): appInst-" + appInst + ", br=" + r);
        }
        //end...
        ...
        if (waitForServices && r.curComponent != null && r.queue.mDelayBehindServices
            ...
            if (receiver == null || nextReceiver == null
                ...
                if (mService.mServices.hasBackgroundServices(r.userId, appInst/* app multi instances feature. prize-linkh-20151117 */)) {
                    /// M: broadcast log enhancement @{
                    ActiveServices.ServiceMap smap = mService.mServices.mServiceMap.get(r.userId);
                     /* app multi instances feature. prize-linkh-20151117 */
                    if(appInst > 0) {
                        smap = null;
                        if(mService.mServices.mServiceMapForAppInst.get(r.userId) != null) {
                            smap = mService.mServices.mServiceMapForAppInst.get(r.userId).get(appInst);
                        }
                    }
                    //end...
                    if (smap != null) {
    ...
    void performReceiveLocked(ProcessRecord app, IIntentReceiver receiver,
        ...
        if(PrizeOption.PRIZE_APP_MULTI_INSTANCES) {
            if(ActivityManagerService.ENABLE_LOG_BROADCAST) {
                ActivityManagerService.logAppInstancesInfo(ActivityManagerService.LOG_BROADCAST_TAG, 
                    "performReceiveLocked(). app=" +  app + ", receiver=" + receiver + ", intent=" + intent);
            }            
        } //end...
    ...
    private void deliverToRegisteredReceiverLocked(BroadcastRecord r,
        ...
        /*prize modify for feature: frozen app 2018-05-02 begin */
        //if (!mService.mIntentFirewall.checkBroadcast(r.intent, r.callingUid,
        if (!mService.mIntentFirewall.checkBroadcast(r.intent, r.targetComp,r.callingUid,
                r.callingPid, r.resolvedType, filter.receiverList.uid)) {
            skip = true;
        }
        /*prize modify for feature: frozen app 2018-05-02 end */
        ...
        if (filter.receiverList.app != null &&
                (filter.receiverList.app.pid != filter.receiverList.pid)) {
            Slog.e(TAG, "Process " + filter.receiverList.app +
                    " has been restarted , so skip the broadcast " + r);
            skip = true;
        }
        ...
        if (callerForeground && receiverRecord.intent.getComponent() != null) {
            IIntentSender target = mService.getIntentSenderLocked(
                    ...
                    PendingIntent.FLAG_CANCEL_CURRENT | PendingIntent.FLAG_ONE_SHOT
                            | PendingIntent.FLAG_IMMUTABLE, null, receiverRecord.appInstanceIndex/* app multi instances feature. prize-linkh-20161101 */);
    ...
    final void processNextBroadcast(boolean fromMsg) {
        synchronized(mService) {
            ...
            if (!skip) {
                ...
                skip = !mService.mIntentFirewall.checkBroadcast(r.intent,r.targetComp, r.callingUid,
            ...
            /* app multi instances feature. prize-linkh-20151112 */
            if(PrizeOption.PRIZE_APP_MULTI_INSTANCES) {
                //set for starting new process.
                if(ActivityManagerService.ENABLE_LOG_BROADCAST) {
                    mService.logAppInstancesInfo(ActivityManagerService.LOG_BROADCAST_TAG, 
                        "BroadcastQueue, update ApplicationInfo. appInst=" +  info.appInstanceIndex);
                }                  
                info.activityInfo.applicationInfo.appInstanceIndex = info.appInstanceIndex;
            } //end...
	
            ProcessRecord app = mService.getProcessRecordLocked(targetProcess,
                    info.activityInfo.applicationInfo.uid, false, info.appInstanceIndex/* app multi instances feature. prize-linkh-20151027 */);
    ...
    boolean cleanupDisabledPackageReceiversLocked(
            String packageName, Set<String> filterByClasses, int userId, boolean doit, int appInst/* app multi instances feature. prize-linkh-20160412 */) {
        boolean didSomething = false;
        for (int i = mParallelBroadcasts.size() - 1; i >= 0; i--) {
            didSomething |= mParallelBroadcasts.get(i).cleanupDisabledPackageReceiversLocked(
                    packageName, filterByClasses, userId, doit, appInst/* app multi instances feature. prize-linkh-20160412 */);
