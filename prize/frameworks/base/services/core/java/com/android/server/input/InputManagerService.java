...
public class InputManagerService extends IInputManager.Stub
    ...
    /* Dynamically hiding nav bar feature. prize-linkh-20150805 */
    // Native callback.
    private int interceptMotionBeforeQueueingInteractive(MotionEvent event, int policyFlags) {
        return mWindowManagerCallbacks.interceptMotionBeforeQueueingInteractive(
                event, policyFlags);
    }
