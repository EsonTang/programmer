...
public class ConnectivityService extends IConnectivityManager.Stub
    ...
    /// M: Support auto USB tethering function
    /**
     * used to enable mobile data when boot_completed intent is received.
     */
    ...
    private static boolean sIsAutoTethering =
                SystemProperties.getBoolean("persist.net.auto.tethering", false);
    /** @} */
    ...
    protected ConnectivityService(Context context, INetworkManagementService netManager,
        ...
        // M: Support auto USB tethering function @{
        if (sIsAutoTethering) {
            filterC.addAction(Intent.ACTION_BOOT_COMPLETED);
    ...
    public NetworkInfo getActiveNetworkInfo() {
        ...
        if (VDBG) log("getActiveNetworkInfo uid = " + uid);
    ...
    private void handlePromptUnvalidated(Network network) {
        ...
        // Modify by zenghui for bug 59356 Prize-linkh-20180530 start
        /*
    ...
    private class InternalHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case EVENT_ENABLE_MOBILE_DATA_FOR_TETHERING: {
                    // Enable mobile data setting
                    handleRegisterNetworkRequest(new NetworkRequestInfo(
    ...
    private void updateLinkProperties(NetworkAgentInfo networkAgent, LinkProperties oldLp) {
        ...
        if (SDBG) log("LinkProperties:" + newLp);
...
//        }
    ...
    private void updateDnses(LinkProperties newLp, LinkProperties oldLp, int netId) {
        ...
        if (mDefaultDns != null && !dnses.contains(mDefaultDns)) {
            ...
            if (SDBG) log("add default dns: " + mDefaultDns.getHostAddress());
        }
        /** @}*/
        /** M: ipv6 only network, but provide ipv4+ipv6 dnses
         **    giving ipv6 dns higher query priority @{*/
/* begin, prize-lifenfen-20180705, resolve DNS ipv6 query issue, refer to ALPS03983350 */
/*
...
*/
            ...
            dnses = sortedDnses;
/* end, prize-lifenfen-20180705, resolve DNS ipv6 query issue, refer to ALPS03983350 */
        // @}
    ...
    private void teardownUnneededNetwork(NetworkAgentInfo nai) {
        ...
        if (nai.networkInfo.getDetailedState() == NetworkInfo.DetailedState.VERIFYING_POOR_LINK) {
            Log.d(TAG, "don't tear down poor link wifi!");
            return;
        }
            ...
            synchronized (mSynchronizedObject) {
                if (Intent.ACTION_TETHERING_CHANGE.equals(action)) {
                    ...
                    if (sIsAutoTethering) {
                        ...
                        // Wait for 3 seconds
                        mHandler.sendMessageDelayed(mHandler.obtainMessage(
                                    EVENT_ENABLE_MOBILE_DATA_FOR_TETHERING), 3000);
                    }
                }
            }
        }
