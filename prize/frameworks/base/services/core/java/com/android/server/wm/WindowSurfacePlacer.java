...
/**prize-add-by-liup-20150415-start*/
import com.mediatek.common.prizeoption.PrizeOption;
/**prize-add-by-liup-20150415-end*/
...
class WindowSurfacePlacer {
    ...
    final void performLayoutLockedInner(final DisplayContent displayContent,
        ...
        if (mService.mSupportFullscreenSwitch) {
            ...
            if (focusedApp != null && focusedApp.appWindowToken != null
                    && !focusedApp.isFullscreenOn) {
                // Use the effective "visual" dimensions based on current rotation
                final boolean rotated = (mService.mRotation == Surface.ROTATION_90
                        || mService.mRotation == Surface.ROTATION_270);
                int realdw = rotated ?
    ...
    private void handleNotObscuredLocked(final WindowState w, final DisplayInfo dispInfo) {
        ...
        if (w.mHasSurface && canBeSeen) {
			...
			if(PrizeOption.PRIZE_READING_MODE){
				final boolean bPrizeReadingMode = Settings.System.getInt(mService.mContext.getContentResolver(),Settings.System.PRIZE_READING_MODE,0) == 1;
