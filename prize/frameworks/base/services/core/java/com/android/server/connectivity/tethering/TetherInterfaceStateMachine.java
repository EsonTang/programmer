...
public class TetherInterfaceStateMachine extends StateMachine {
    ...
    public TetherInterfaceStateMachine(String ifaceName, Looper looper, int interfaceType,
                    INetworkManagementService nMService, INetworkStatsService statsService,
                    IControlsTethering tetherController, MdDirectTethering mdDirectTethering) {
        this(ifaceName, looper, interfaceType, nMService,
                                    statsService, tetherController);
        mMdDirectTethering = mdDirectTethering;
    }
    /// @}
        ...
        try {
            ...
            if (ifcg != null) {
                ...
                if (mMdDirectTethering != null &&
                        mMdDirectTethering.isMdtEnable(mInterfaceType)) {
                    mMdDirectTethering.configureMdtIface(mIfaceName, enabled);
                }
            }
        } catch (Exception e) {
    ...
    class TetheredState extends State {
        ...
        public void exit() {
            ...
            if (mMdDirectTethering != null &&
                mMdDirectTethering.isMdtEnable(mInterfaceType)) {
                mMdDirectTethering.resetMdtInterface();
            }
        }
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                ...
                case CMD_TETHER_CONNECTION_CHANGED:
                    ...
                    if (mMdDirectTethering != null &&
                        mMdDirectTethering.isMdtEnable(mInterfaceType)) {
                        mMdDirectTethering.clearBridgeMac(mIfaceName);
                    }
