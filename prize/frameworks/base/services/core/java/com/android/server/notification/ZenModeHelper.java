...
public class ZenModeHelper {
        ...
        switch (mZenMode) {
            ...
            case Global.ZEN_MODE_ALARMS:
                if (ringerModeInternal != AudioManager.RINGER_MODE_SILENT) {
                    ...
                    //prize modify by xiarui keep internal ringer mode 2018-06-06 @{
                    if (PrizeOption.PRIZE_VIBRATE_CONTROL) {
                        newRingerModeInternal = ringerModeInternal;
                    } else {
            ...
            case Global.ZEN_MODE_OFF:
                /**
                 * if open ZenMode first, then open SilentMode, will exit SilentMode also when close zenMode
                 * if open silent mode, will exit silent mode when reboot device
                 */
                //prize modify by xiarui 2018-06-06 @{
                if (!PrizeOption.PRIZE_VIBRATE_CONTROL) {
                    if (ringerModeInternal == AudioManager.RINGER_MODE_SILENT) {
    ...
    private final class RingerModeDelegate implements AudioManagerInternal.RingerModeDelegate {
        ...
        public int onSetRingerModeInternal(int ringerModeOld, int ringerModeNew, String caller,
			...
			//remove liup 20171215 volume_key set ZEN_MODE
            //if (newZen != -1) {
        ...
        public int onSetRingerModeExternal(int ringerModeOld, int ringerModeNew, String caller,
            ...
            //prize remove by xiarui 2018-05-31 @{
            if (!PrizeOption.PRIZE_VIBRATE_CONTROL) {
                if (newZen != -1) {
