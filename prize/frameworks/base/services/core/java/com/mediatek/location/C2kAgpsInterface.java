...
class C2kAgpsInterface {
    ...
    private static final String SOCKET_ADDRESS = "c2kagpsd"; //reply to mtk_agpsd
    ...
    void setFlightMode(boolean enabled) {
        ...
        try {
             connect();
             C2kAgpsInterface.putInt(mOut, EVENT_AGPS_FLIGHT_MODE);
             C2kAgpsInterface.putInt(mOut, data);
             mOut.flush();
         } catch (IOException e) {
