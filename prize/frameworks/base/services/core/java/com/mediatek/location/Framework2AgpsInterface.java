...
public class Framework2AgpsInterface {
    ...
    public final static int MAX_BUFF_SIZE = 40;
    ...
    public static class Framework2AgpsInterfaceSender {
        ...
        public boolean DnsQueryResult2(UdpClient client, boolean isSuccess, boolean hasIpv4,
                int ipv4, boolean hasIpv6, byte[] ipv6, boolean hasNetId, int netId) {
            synchronized(client) {
                if(!client.connect()) {
                    return false;
                }
...
/*
    public static abstract class Framework2AgpsInterfaceReceiver implements ProtocolHandler {
        ...
        public abstract void DnsQueryResult2(boolean isSuccess, boolean hasIpv4, int ipv4,
                boolean hasIpv6, byte[] ipv6, boolean hasNetId, int netId);
