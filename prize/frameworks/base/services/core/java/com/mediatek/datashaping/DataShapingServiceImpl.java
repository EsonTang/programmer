...
public class DataShapingServiceImpl extends IDataShapingManager.Stub {
        ...
        public void onUninstalled() {
            ...
            synchronized (mLock) {
                ...
                if (mCurrentState instanceof GateCloseState) {
                    mDataShapingHandler.obtainMessage(MSG_INPUTFILTER_STATE_CHANGED,
                            mRegisterInput).sendToTarget();
    ...
    public void setDeviceIdleMode(boolean enabled) {
        if(!mDataShapingEnabled) {
            Slog.d(TAG, "[setDeviceIdleMode] Data Shaping isn't enable.");
            return;
        }
    ...
    private class DataShapingHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            case MSG_APPSTANDBY_CHANGED:
                ...
                break;
            /// integrate Doze and App Standby @}
            case MSG_INPUTFILTER_STATE_CHANGED:
                mCurrentState.onInputFilterStateChanged((Boolean)msg.obj);
                break;
            default:
                break;
            }
