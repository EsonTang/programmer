...
public final class AMEventHook {
    ...
    private void showLogForAfterActivityResumed(AMEventHookData.AfterActivityResumed data) {
        ...
        int processUid = data.getInt(AMEventHookData.AfterActivityResumed.Index.processUid);
        int callerUid = data.getInt(AMEventHookData.AfterActivityResumed.Index.callerUid);

        Slog.v(TAG, "onAfterActivityResumed, Activity:(" + pid + ", " + pkgName +
                "," + activityName + ", " + activityType +
                ", processUid=" + processUid + ", callerUid=" + callerUid + ")");
    }
