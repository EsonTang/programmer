...
public class DataShapingUtils {
    ...
    public void setLteAsReport() {
        ...
        if (isLteDataOn) {
            if (isLteDataOn != mIsMobileConnection) {
        ...
        mIsMobileConnection = isLteDataOn;
    }
    ...
    public boolean isAppIdleParoleOn() {
        ...
        if (mAppStandbyEnable) {
            Slog.d(TAG, "[isAppIdleParoleOn] App Standby is enable");
            return mUsageStats.isAppIdleParoleOn();
        } else {
    ...
    public boolean canTurnFromLockedToOpen() {
        ...
        Slog.d(TAG, "[canTurnFromLockedToOpen] isNetworkTypeLte|" + isNetworkTypeLte
                ...
                + " isAppIdleParoleOn|" + isAppIdleParoleOn
                + " isDeviceIdleEnable|" + mDeviceIdleState
                + " isLteDataOn|" + isLteDataOn);
        /// M: integrate Doze and App Standby
        boolean isReady = isNetworkTypeLte && !isScreenOn && !isSharedDefaultApnEstablished
                && !isUsbConnected && !isWifiTetheringEnabled && !isAppIdleParoleOn
                && !mDeviceIdleState && isLteDataOn;
    ...
    public boolean getLteDataOnState() {
        ...
        if (networkInfo != null && networkInfo.isConnectedOrConnecting()) {
            ...
            isDataOn = true;
            Slog.d(TAG, "[setLteAsReport] networkType = " + networkType +
                    " networkSubType = " + networkSubType +
                    " isMobile = " + isMobile +
                    " isLte = " + isLte +
                    " isDataOn = " + isDataOn);
        }
        return isMobile && isLte && isDataOn;
    }
}
