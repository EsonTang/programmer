...
/* MD Direct Tethering */
/*prize-adb manager-wangxianzhen-2016-06-08-start*/
import com.mediatek.common.prizeoption.PrizeOption;
/*prize-adb manager-wangxianzhen-2016-06-08-end*/
...
public class UsbDeviceManager {
    ...
    private static int br0State = IFACE_BR_MAIN_NONE;
    /* MD Direct Tethering */
    ...
    private boolean mIsUsbSimSecurityCheck = false;
    ...
    private class AdbSettingsObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
            ...
            /*prize-adb manager-modify by wangxianzhen-2016-06-08-start*/
            if(PrizeOption.PRIZE_ADB_MANAGER) {
                prize_adb_value = Settings.System.getInt(mContentResolver, "prize.adb.enable", 0);
                Slog.d("prizeadb", "onChange prize_adb_value=" + prize_adb_value + ", enable=" + enable);
                if(1 == prize_adb_value) {
                    Slog.d("prizeadb", "sendMessage");
                    mHandler.sendMessage(MSG_ENABLE_ADB, enable);
                } else {
                    Slog.d("prizeadb", "not sendMessage");
                }
            } else {
                mHandler.sendMessage(MSG_ENABLE_ADB, enable);
            }
            /*prize-adb manager-modify by wangxianzhen-2016-06-08-end*/
        }
    }
    ...
    private final class UsbHandler extends Handler {
        ...
        public UsbCheck() {
            IntentFilter intent = new IntentFilter(INTENT_USB_ACTIVATION);
            mContext.registerReceiver(mUsbCheckReceiver, intent);
        }
        ...
        public UsbHandler(Looper looper) {
            ...
            try {
                ...
                if (value != null && !value.isEmpty() && validPortNum(value) > 0) {
                    ...
                    usbFunctions = UsbManager.addFunction(mCurrentFunctions, "acm");
                    SystemProperties.set("sys.usb.config", usbFunctions);
                }
		...
		/*usb-liuweiquan-20160624-start*/
		public boolean isUsbDataUnlocked(){
            return mUsbDataUnlocked;
        }
		/*usb-liuweiquan-20160624-end*/
        ...
        private void setEnabledFunctions(String functions, boolean forceRestart) {
            ...
            if (SystemProperties.get("ro.mtk_md_direct_tethering").equals("1") &&
                br0Name != null && !br0Name.isEmpty()) {
                if (functions != null &&
                    UsbManager.containsFunction(functions, UsbManager.USB_FUNCTION_RNDIS) &&
                    UsbManager.containsFunction(mCurrentFunctions, UsbManager.USB_FUNCTION_RNDIS)
                        == false) {
                    Slog.i(TAG, "addBridge");
                    br0State = IFACE_BR_MAIN_ADDED;
                    try {
                        mNwService.addBridge(br0Name);
                    } catch (RemoteException e) {
                        Slog.e(TAG, "Error addBridge: ", e);
                    }
                } else if ((functions == null ||
                           UsbManager.containsFunction(functions,
                                                       UsbManager.USB_FUNCTION_RNDIS) == false) &&
                           UsbManager.containsFunction(mCurrentFunctions,
                                                       UsbManager.USB_FUNCTION_RNDIS)) {
                        Slog.i(TAG, "deleteBridge");
                    try {
                        mNwService.deleteBridge(br0Name);
                    } catch (RemoteException e) {
                        Slog.e(TAG, "Error deleteBridge: ", e);
                    }
                    br0State = IFACE_BR_MAIN_NONE;
                }
            }
            /* MD Direct Tethering */
        ...
        private boolean trySetEnabledFunctions(String functions, boolean forceRestart) {
            ...
            if (!mCurrentFunctions.equals(functions) || !mCurrentFunctionsApplied
                ...
                if (!setUsbConfig(functions)) {
                    ...
                    /* MD Direct Tethering */
                    String br0Name = SystemProperties.get("ro.tethering.bridge.interface");
                    if (br0State == IFACE_BR_MAIN_ADDED) {
                        try {
                            Slog.e(TAG, "deleteBridge");
                            mNwService.deleteBridge(br0Name);
                        } catch (RemoteException e) {
                            Slog.e(TAG, "Error deleteBridge: ", e);
                        }
	...
	/*usb-liuweiquan-20160624-start*/
	public boolean isUsbDataUnlocked(){
        return mHandler.isUsbDataUnlocked();
    }
	/*usb-liuweiquan-20160624-end*/
