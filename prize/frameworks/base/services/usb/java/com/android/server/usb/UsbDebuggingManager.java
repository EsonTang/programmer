...
/*prize-adb manager-wangxianzhen-2016-06-27-start*/
import android.provider.Settings;
import com.mediatek.common.prizeoption.PrizeOption;
/*prize-adb manager-wangxianzhen-2016-06-27-end*/
public class UsbDebuggingManager {
    ...
    private void startConfirmation(String key, String fingerprints) {
        ...
        /*prize-adb manager-modify by wangxianzhen-2016-06-27-start*/
        if(PrizeOption.PRIZE_ADB_MANAGER) {
            if(mContext != null) {
                prize_adb_value = Settings.System.getInt(mContext.getContentResolver(), "prize.adb.enable", 0);
            }
            Slog.d("prizeadb", "UsbDebuggingManager prize_adb_value=" + prize_adb_value);
            if(1 == prize_adb_value) {
                Slog.d("prizeadb", "UsbDebuggingManager startConfirmation key=" + key + ", fingerprints=" + fingerprints);
                ...
                Slog.d("prizeadb", "UsbDebuggingManager not startConfirmation");
            }
        } else {
            ComponentName componentName = ComponentName.unflattenFromString(componentString);
            if (startConfirmationActivity(componentName, userInfo.getUserHandle(), key, fingerprints)
        ...
        /*prize-adb manager-modify by wangxianzhen-2016-06-27-end*/
    }
