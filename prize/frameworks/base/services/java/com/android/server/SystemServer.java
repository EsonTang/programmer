...
/*-prize add by lihuangyuan,for whitelistservice -2017-05-05-start-*/
import com.android.server.WhiteListService;
/*-prize add by lihuangyuan,for whitelistservice -2017-05-05-end-*/
...
/// @}
/*prize-add for purebackground-wangxianzhen-2016-04-11-start*/
import com.mediatek.common.prizeoption.PrizeOption;
/*prize-add for purebackground-wangxianzhen-2016-04-11-end*/
...
public final class SystemServer {
    ...
    private void startOtherServices() {
	 ...
	 /*-prize add by lihuangyuan,for whitelist -2017-05-06-end-*/
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (!disableNetwork) {
                ...
                if(PrizeOption.PRIZE_CONTROL_APP_NETWORK_FOR_SLEEPING) {
                    Slog.i(TAG, "Prize App Network Manager Service");
                    mSystemServiceManager.startService(PrizeAppNetworkManagerService.class);
                } //END....

                /// M: Start LWX Service @{
                if ("1".equals(SystemProperties.get("ro.mtk_lwa_support")) ||
                    "1".equals(SystemProperties.get("ro.mtk_lwi_support"))) {
                    traceBeginAndSlog("StartLwxService");
                    try {
                        mSystemServiceManager.startService(LWX_SERVICE_CLASS);
                    } catch (Throwable e) {
                        reportWtf("starting LwxService", e);
                    }
                    Trace.traceEnd(Trace.TRACE_TAG_SYSTEM_SERVER);
                }
                /// @}
            ...
            if ("1".equals(SystemProperties.get("ro.mtk_fullscreen_switch"))) {
                try {
                    Slog.i(TAG, "addService FullscreenSwitchService");
                    Class rModeService = Class.forName("com.mediatek.fullscreenswitch.FullscreenSwitchService");
                    ...
                    Slog.e(TAG, "FullscreenSwitchService ClassNotFoundException" + e);
                } catch (NoSuchMethodException e) {
                    Slog.e(TAG, "FullscreenSwitchService NoSuchMethodException" + e);
                } catch (InstantiationException e) {
                    Slog.e(TAG, "FullscreenSwitchService InstantiationException" + e);
                } catch (IllegalAccessException e) {
                    Slog.e(TAG, "FullscreenSwitchService IllegalAccessException" + e);
                } catch (InvocationTargetException e) {
                    Slog.e(TAG, "FullscreenSwitchService InvocationTargetException" + e);
                } catch (Throwable e) {
                    Slog.e(TAG, "Failure starting FullscreenSwitchService", e);
                }
            }
            /// @}
	     ...
	     /*-prize add by lihuangyuan,for whitelist -2017-05-06-start-*/
	     whitelistservice = new WhiteListService(context);
	     ServiceManager.addService("whitelist",whitelistservice);
	     /*-prize add by lihuangyuan,for whitelist -2017-05-06-end-*/
            /*prize-add service for purebackground-wangxianzhen-2016-04-11-start*/
            //if(PrizeOption.PRIZE_PURE_BACKGROUND)
	     {
                try {
                    Slog.i(TAG,"PureBackground Clear Service");
                    ServiceManager.addService("pureback", new ClearBkgroundService(context));
                } catch (Throwable e) {
                    reportWtf("starting PureBackground Clear Service", e);
                }
            }
            /*prize-add service for purebackground-wangxianzhen-2016-04-11-end*/
	 ...
	 /*-prize add by lihuangyuan,for whitelist -2017-05-06-start-*/
	 try{
	 	whitelistservice .systemReady();
	 }
	 catch (Throwable e) {
            reportWtf("making WhiteListService ready", e);
        }
	 /*-prize add by lihuangyuan,for whitelist -2017-05-06-end-*/
