...
public class IpManager extends StateMachine {
    ...
    private void recordMetric(final int type) {
        if (mStartTimeMillis <= 0) { Log.e(mTag, "Start time undefined!"); }
    ...
    private ProvisioningChange setLinkProperties(LinkProperties newLp) {
        if (SDBG) Log.d(mTag, "setLinkProperties newLp = " + newLp);
        if (mApfFilter != null) {
    ...
    class RunningState extends State {
        ...
        public void exit() {
            ...
            // M: Check IMS PDN over Wi-Fi firstly
            checkActiveImsPdn();
    ...
    private void checkActiveImsPdn() {
        ...
        for (Network network : allNetworks) {
            ...
            if (nc != null && nc.hasCapability(NetworkCapabilities.NET_CAPABILITY_IMS)) {
                ...
                if (networkInfo != null
                        && "IWLAN".equals(networkInfo.getSubtypeName())) {
