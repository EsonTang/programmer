            ...
            for (int i=0; i<apps.size(); i++) {
                ...
                if (entry != null && (filter == null || filter.filterApp(entry))) {
                    synchronized (mEntriesMap) {
						...
						if(!entry.info.packageName.contains("com.prize.factorytest") && !entry.info.packageName.contains("com.android.music") && !entry.info.packageName.contains("com.android.documentsui")){//add liup 20171208
