...
public class AccessPoint implements Comparable<AccessPoint>, Cloneable {
    ...
    private String getSettingsSummary(WifiConfiguration config) {
        ...
        if (isActive() && config != null && config.isPasspoint()) {
            ...
            /* prize-modify-by-zenghui-for bugid 44380-20180611-start*/
            String msg = mContext.getString(messageID);
            summary.append(msg.substring(0, msg.length() - 1));
            /* prize-modify-by-zenghui-for bugid 44380-20180611-end*/
            ...
            switch (networkStatus.getNetworkSelectionDisableReason()) {
                ...
                case WifiConfiguration.NetworkSelectionStatus.DISABLED_ASSOCIATION_REJECTION:
                    ...
                    break;
                /* prize-modify-by-zenghui -20180607-start*/
                case WifiConfiguration.NetworkSelectionStatus.DISABLED_NO_INTERNET:
                    String msg = mContext.getString(R.string.wifi_no_internet);
                    summary.append(msg.substring(0, msg.length() - 1));
                    break;
                /* prize-modify-by-zenghui -20180607-end*/
            }
