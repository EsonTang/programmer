...
public class SettingsDrawerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(item != null && isTile && tileHasTitle(item.tile)){
            if(TileUtils.isAirPlaneTile(mActivity, item.tile)){
            	((Switch) convertView.findViewById(R.id.dashboard_switch)).setVisibility(View.VISIBLE);
            	((Switch) convertView.findViewById(R.id.dashboard_switch)).setChecked(WirelessUtils.isAirplaneModeOn(mActivity));
            	((ImageView) convertView.findViewById(R.id.im_arrow_reminders)).setVisibility(View.GONE);
            } else {
            	((Switch) convertView.findViewById(R.id.dashboard_switch)).setVisibility(View.GONE);
            	((ImageView) convertView.findViewById(R.id.im_arrow_reminders)).setVisibility(View.VISIBLE);
            }
        } else if(item == null && isTile){
        	((Switch) convertView.findViewById(R.id.dashboard_switch)).setVisibility(View.GONE);
        	((ImageView) convertView.findViewById(R.id.im_arrow_reminders)).setVisibility(View.GONE);
        }
    ...
    private boolean tileHasTitle(Tile tile){
    	return tile != null;
    }
