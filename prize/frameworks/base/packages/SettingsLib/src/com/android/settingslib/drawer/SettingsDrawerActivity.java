...
public class SettingsDrawerActivity extends Activity {
    ...
    private final AirPlaneModeReceiver mAirPlaneModeReceiver = new AirPlaneModeReceiver();
...
//        	Log.d(TAG, "onCreate() theme.getBoolean = " + false);
...
//        }
    ...
    protected void onResume() {
        ...
        if (mDrawerLayout != null) {
            ...
            registerReceiver(mAirPlaneModeReceiver, airPlaneModeFilter);
    ...
    public boolean openTile(Tile tile) {
        ...
        try {
            ...
            Context mContext = SettingsDrawerActivity.this;
            if(TileUtils.isAirPlaneTile(SettingsDrawerActivity.this, tile)){
            	boolean isChecked = WirelessUtils.isAirplaneModeOn(mContext);
