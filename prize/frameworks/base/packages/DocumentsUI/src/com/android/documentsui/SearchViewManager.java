...
final class SearchViewManager implements
    ...
    public void install(DocumentsToolbar actionBar, boolean isFullBarSearch) {
        ...
        SearchViewStyle.on(mSearchView).setTextColor(Color.BLACK)
                .setTextSize(actionBar.getContext().getResources().getDimension(R.dimen.prize_searchview_text_size))//prize-public-bug:20601 set text size-pengcancan-20160822
