...
public class DocumentStack extends LinkedList<DocumentInfo> implements Durable, Parcelable {
    ...
    @Override
    public synchronized void push(DocumentInfo doc) {
        super.push(doc);
    }

    @Override
    public synchronized DocumentInfo pop() {
        return super.pop();
    }

    @Override
    public synchronized DocumentInfo get(int index) {
        if (size() > 0)
    ...
    @Override
    public synchronized boolean add(DocumentInfo doc) {
