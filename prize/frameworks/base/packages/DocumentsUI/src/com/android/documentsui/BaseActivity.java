...
public abstract class BaseActivity extends Activity
    ...
    public void onCreate(Bundle icicle) {
        ...
        //prize-public-standard: remove float action-bar effect-pengcancan-20161208-start
        getActionBar().setElevation(0f);
        getActionBar().setBackgroundDrawable(getDrawable(R.drawable.actionbar_background));
        //prize-public-standard: remove float action-bar effect-pengcancan-20161208-end
    ...
    void onRootPicked(RootInfo root) {
        ...
        mState.derivedMode = LocalPreferences.getViewMode(this, root, MODE_LIST);//default Mode-pengcancan-20161027
