...
import com.android.providers.settings.NvRAMAgent;
import android.os.ServiceManager;
...
class DatabaseHelper extends SQLiteOpenHelper {
        ...
        if (upgradeVersion < 116) {
            if (mUserHandle == UserHandle.USER_SYSTEM) {
                ...
                try {
                    ...
                    loadSetting(stmt, Settings.Global.ENHANCED_4G_MODE_ENABLED_SIM2,
                            ImsConfig.FeatureValueConstants.ON);
                    loadSetting(stmt, Settings.Global.ENHANCED_4G_MODE_ENABLED_SIM3,
                            ImsConfig.FeatureValueConstants.ON);
    ...
    private void loadVibrateWhenRingingSetting(SQLiteDatabase db) {
        ...
        //prize modify by xiarui 2018-06-25 @{
        int vibrateSetting = getIntValueFromSystem(db, Settings.System.VIBRATE_ON,
                PrizeOption.PRIZE_VIBRATE_CONTROL ? AudioManager.VIBRATE_SETTING_ON : AudioManager.VIBRATE_SETTING_OFF);
        //end@}
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            //priz-wuliang-20180411 auto brightness		
            loadIntegerSetting(stmt, Settings.System.SCREEN_AUTO_MODE_BRIGHTNESS,
                    R.integer.def_screen_brightness);
			...
			loadBooleanSetting(stmt, Settings.System.PRIZE_SALES_STATIS_NET,R.bool.def_prize_sales_statis_net);
            int channel = 0;
            try{
               channel = Integer.valueOf(SystemProperties.get("ro.prize.project.ver"));
            }catch(Exception e){
                e.printStackTrace();
            }
            if (SystemProperties.get("ro.prize_customer").equals("odm")|| channel % 2 == 0) {
                loadBooleanSetting(stmt, Settings.System.PRIZE_SALES_STATIS_MMS,R.bool.def_prize_sales_statis_mms_close);
            }else{
                loadBooleanSetting(stmt, Settings.System.PRIZE_SALES_STATIS_MMS,R.bool.def_prize_sales_statis_mms);
            }
            if(SystemProperties.get("ro.prize_flip_silent").equals("1")){
                loadBooleanSetting(stmt, Settings.System.PRIZE_FLIP_SILENT,R.bool.def_prize_flip_slent);
            }
            if(SystemProperties.get("ro.prize_smart_answer_call").equals("1")){
                loadBooleanSetting(stmt, Settings.System.PRIZE_SMART_ANSWER_CALL,R.bool.def_prize_smart_answer_call);
            }
            if(SystemProperties.get("ro.prize_smart_dialing").equals("1")){
                loadBooleanSetting(stmt, Settings.System.PRIZE_SMART_DIALING,R.bool.def_prize_smart_dialing);
            }
            if(SystemProperties.get("ro.prize_pocket_mode").equals("1")){
                loadBooleanSetting(stmt, Settings.System.PRIZE_POCKET_MODE,R.bool.def_prize_pocket_mode);
            }
            if(SystemProperties.get("ro.prize_non_touch_operation").equals("1")){
                loadBooleanSetting(stmt, Settings.System.PRIZE_NON_TOUCH_OPERATION,R.bool.def_prize_non_touch_operation);
                loadBooleanSetting(stmt, Settings.System.PRIZE_NON_TOUCH_OPERATION_UNLOCK,R.bool.def_prize_non_touch_peration_nulock);
                loadBooleanSetting(stmt, Settings.System.PRIZE_NON_TOUCH_OPERATION_GALLERY,R.bool.def_prize_non_touch_peration_gallery);
                loadBooleanSetting(stmt, Settings.System.PRIZE_NON_TOUCH_OPERATION_LAUNCHER,R.bool.def_prize_non_touch_peration_launcher);
                loadBooleanSetting(stmt, Settings.System.PRIZE_NON_TOUCH_OPERATION_VIDEO,R.bool.def_prize_non_touch_peration_video);
                loadBooleanSetting(stmt, Settings.System.PRIZE_NON_TOUCH_OPERATION_MUSIC,R.bool.def_prize_non_touch_peration_music);
            }
            if(SystemProperties.get("persist.lucky.money.helper").equals("1")){
                String notice_default = mContext.getResources().getString(R.string.def_prize_lucky_money_notice_sound);
                Log.v("prize_zwl","loadSetting-----> notice_default = " + notice_default);
                loadSetting(stmt, Settings.System.PRIZE_LUCKY_MONEY_NOTICE_SOUND_DEFAULT, notice_default);
                loadSetting(stmt, Settings.System.PRIZE_LUCKY_MONEY_NOTICE_SOUNDS, 0);
                loadBooleanSetting(stmt, Settings.System.PRIZE_LUCKY_MONEY_HELPER_ENABLE,R.bool.def_prize_lucky_money_helper_enable);
            }
			loadIntegerSetting(stmt, Settings.System.PRIZE_FLASH_STATUS,R.integer.def_prize_flash_status);
            if(SystemProperties.get("ro.prize_antifake_touch").equals("1")){
                loadBooleanSetting(stmt, Settings.System.PRIZE_ANTIFAKE_TOUCH,R.bool.def_prize_antifake_touch);
            }
/**prize-add-by-zhongweilin-end*/
			loadBooleanSetting(stmt, Settings.System.PRIZE_SLIDE_SCREENSHOT,R.bool.def_prize_slide_screenshot_enabled);
			loadBooleanSetting(stmt, Settings.System.PRIZE_SLIDE_SPLIT_SCREEN,R.bool.def_prize_slide_split_screen_enabled);
			loadBooleanSetting(stmt, Settings.System.PRIZE_DBLCLICK_SLEEP,
                    R.bool.def_prize_dblclick_sleep);
					
			loadBooleanSetting(stmt, Settings.System.PRIZE_LOCKSCREEN_OPEN_TORCH,
                    R.bool.def_prize_lockscreen_open_torch);

			
			/**prize-add-game-reading-mode-liup-20150420-start*/	
			loadBooleanSetting(stmt, Settings.System.PRIZE_GAME_MODE,R.bool.def_prize_game_mode);
			loadBooleanSetting(stmt, Settings.System.PRIZE_READING_MODE,R.bool.def_prize_reading_mode);
			/**prize-add-game-reading-mode-liup-20150420-end*/
			/**prize-add-floatwindow-liup-20150427-start*/
			loadBooleanSetting(stmt, Settings.System.PRIZE_FLOAT_WINDOW,R.bool.def_prize_float_window);
			/**prize-add-floatwindow-liup-20150427-end*/
			/**prize-notification-custom-liup-20150515-start*/
			loadBooleanSetting(stmt, Settings.System.PRIZE_NOTIFICATION_CUSTOM,R.bool.def_prize_notification_custom);
			/**prize-notification-custom-liup-20150515-end*/
			
			/**prize-sleep-gesture-liup-20150523-start*/
			loadBooleanSetting(stmt, Settings.System.PRIZE_SLEEP_GESTURE,R.bool.def_prize_sleep_gesture);	
			/**prize-sleep-gesture-liup-20150523-end*/

            loadStringSetting(stmt, Settings.System.TIME_12_24,R.string.time_12_24);
			/* prize-add-by-lijimeng-20180110-start*/
            loadStringSetting(stmt, Settings.System.PRIZE_RINGTONE_NAME,R.string.prize_ringtone_name);
			loadBooleanSetting(stmt, Settings.System.PRIZE_FACEID_SWITCH,R.bool.prize_faceid_switch);	
			loadBooleanSetting(stmt, Settings.System.PRIZE_VIBRATE_IN_SILENT,R.bool.prize_def_virate_in_silent);	
			/* prize-add-by-lijimeng-20180110-end*/
			loadBooleanSetting(stmt, Settings.System.PRIZE_NEW_FLOAT_WINDOW,R.bool.def_prize_new_float_window);
			/*prize-public-standard:magazine lock screen-liuweiquan-20161018-start*/
			loadBooleanSetting(stmt, Settings.System.PRIZE_MAGAZINE_KGWALLPAPER_SWITCH,R.bool.def_prize__magazine_kgwallpaper_switch);	
			/*prize-public-standard:magazine lock screen-liuweiquan-20161018-end*/
			/*PRIZE-prize-public-standard:Changed lock screen-liuweiquan-20151210-start*/
			loadBooleanSetting(stmt, Settings.System.PRIZE_KGWALLPAPER_SWITCH,R.bool.def_prize_kgwallpaper_switch);	
			...
			loadBooleanSetting(stmt, Settings.System.PRIZE_ALLOW_DROPDOWN_NOTIFICATIONBAR_SWITCH,R.bool.def_prize_allow_dropdown_notificationbar_switch);	
			...
			loadBooleanSetting(stmt, Settings.System.PRIZE_SCREEN_ON_FOR_NOTIFICATION_SWITCH,R.bool.def_prize_screen_on_for_notification_switch);	
			/*PRIZE-prize-public-standard:screen on when comes notification-liuweiquan-20160803-end*/
			loadBooleanSetting(stmt, Settings.System.PRIZE_REAL_TIME_NETWORK_SPEED_SWITCH,R.bool.def_prize_real_time_network_speed_switch);	
			/**prize-old-launcher-liup-20170223-start*/	
			loadBooleanSetting(stmt, Settings.System.PRIZE_OLD_LAUNCHER,R.bool.def_prize_old_launcher);
			loadBooleanSetting(stmt, Settings.System.PRIZE_VOICE_KEY,R.bool.def_prize_voice_key);
			loadBooleanSetting(stmt, Settings.System.PRIZE_VOICE_DIALER_KEY,R.bool.def_prize_voice_dialer_key);
			loadBooleanSetting(stmt, Settings.System.PRIZE_VOICE_CALL_KEY,R.bool.def_prize_voice_call_key);
			loadBooleanSetting(stmt, Settings.System.PRIZE_VOICE_MMS_KEY,R.bool.def_prize_voice_mms_key);
			loadBooleanSetting(stmt, Settings.System.PRIZE_VOICE_LAUNCHER_KEY,R.bool.def_prize_voice_launcher_key);
			/*yang-add-setting_magazine_lockscreen-2017_10_10-start*/
			loadBooleanSetting(stmt, Settings.System.PRIZE_SETTING_UPDATE_NETWORK_DATA, R.bool.default_lock_screen_network_data);
            /*yang-add-setting_magazine_lockscreen-2017_10_10-end*/
			/* prize-add-fota notifycation from settings-lijimeng-20170427-start*/
			loadBooleanSetting(stmt, Settings.System.PRIZE_SYSTEM_UPDATE_CHANGE,R.bool.def_prize_system_update_change);
            ...
            if (PrizeOption.PRIZE_DYNAMICALLY_HIDE_NAVBAR || PrizeOption.PRIZE_REPOSITION_BACK_KEY) {
                loadIntegerSetting(stmt, Settings.System.PRIZE_NAVIGATION_BAR_STYLE, com.prize.internal.R.integer.default_nav_bar_style);
            }
            //END...

            /* Dynamically changing Recents function feature. prize-linkh-20161114 */
            if (PrizeOption.PRIZE_TREAT_RECENTS_AS_MENU) {
                loadBooleanSetting(stmt, Settings.System.PRIZE_TREAT_RECENTS_AS_MENU, com.prize.internal.R.bool.default_treat_recents_as_menu);
            }//END...

            /* app multi instances feature. prize-linkh-20160119 */
            if(PrizeOption.PRIZE_APP_MULTI_INSTANCES) {
                String[] list = mContext.getResources().getStringArray(com.prize.internal.R.array.disabled_app_list_for_multi_instances);
                StringBuilder sb = new StringBuilder();
                for(int i = 0; i < list.length; ++i) {
                    sb.append(list[i]);
                    if(i != list.length) {
                        sb.append(PrizeAppInstanceUtils.SEPARATOR_CHAR);
                    }
                }
                loadSetting(stmt, Settings.System.PRIZE_DISABLE_PACKAGES_FOR_APP_INST, sb.toString());
            }//end...
        } finally {
            if (stmt != null) stmt.close();
        }
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            loadIntegerSetting(stmt, Settings.Secure.SLEEP_TIMEOUT,
                    R.integer.def_sleep_timeout);
			/* prize-add-by-lijimeng-20180228-start*/
			loadIntegerSetting(stmt, Settings.Secure.LOCK_SCREEN_LOCK_AFTER_TIMEOUT,
                    R.integer.def_lockscreen_after_timeout);
			/* prize-add-by-lijimeng-20180228-end*/
            /// M: Add for AOD @{
            ...
            /* Prize pre-defined IME. prize-linkh-20161122 */
            final String predefinedIME = SystemProperties.get("ro.prize_default_ime");
            if (predefinedIME != null) {
                loadSetting(stmt, Settings.Secure.DEFAULT_INPUT_METHOD, predefinedIME);

                // we must put this latinIME to enabled list even though it's actually
                // uninstalled. En, It should be always installed.
                final String latinIME = "com.android.inputmethod.latin/.LatinIME";
                loadSetting(stmt, Settings.Secure.ENABLED_INPUT_METHODS, latinIME + ":" + predefinedIME);
            } //END...
    ...
    private void loadGlobalSettings(SQLiteDatabase db) {
        ...
        try {
			...
			if(audios == null || cameras == null || mmi == null){
				Log.e(TAG, "readProInfo() aaaaa ret = " + "11111");
				loadSetting(stmt, Settings.Global.ADB_ENABLED, 1);	
			}else if(!audios.equals("P") || !cameras.equals("P") || !mmi.equals("P")){
				Log.e(TAG, "readProInfo() aaaaa ret = " + "22222");
				loadSetting(stmt, Settings.Global.ADB_ENABLED, 1);	
			}
			...
			/*PRIZE-prize-public-standard:Changed lock screen-liuweiquan-20151210-start*/
			//modify liuweiquan 20160318
			if(PrizeOption.PRIZE_CUSTOMER_NAME.equals("coosea")){
				loadStringSetting(stmt, Settings.Global.PRIZE_KGWALLPAPER_PATH,R.string.def_prize_coosea_kgkeyguard_path);
			}else{
				loadStringSetting(stmt, Settings.Global.PRIZE_KGWALLPAPER_PATH,R.string.def_prize_kgkeyguard_path);
			}
			/*PRIZE-prize-public-standard:Changed lock screen-liuweiquan-20151210-end*/
