...
public class EmergencyButton extends Button {
    ...
    private void updateEmergencyCallButton() {
        ...
        //if (mIsVoiceCapable) {
            ...
            /**prize add by xiarui show emergency button when airplane mode Bug#43621 2017-12-06 start**/
            boolean isAirplaneMode = KeyguardUtils.isAirplaneModeOn(mContext);
            /**prize add by xiarui show emergency button when airplane mode Bug#43621 2017-12-06 end**/
            ...
            if (mLocateAtNonSecureView && !mEmergencyButtonExt.showEccInNonSecureUnlock()) {
                ...
                show = ((visible || antiTheftLocked
                        ...
                        && eccShouldShow) || isAirplaneMode;    /***prize add by xiarui show emergency button when airplane mode Bug#43621 2017-12-06**/
