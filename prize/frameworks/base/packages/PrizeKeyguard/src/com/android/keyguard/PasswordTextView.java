...
public class PasswordTextView extends View {
    ...
    /*PRIZE-add KeyguardPinBasedInputView obj-liufan-2015-07-22-start*/
    private KeyguardPinBasedInputView mKeyguardPinBasedInputView;
    public void setKeyguardPinBasedInputView(KeyguardPinBasedInputView keyguardPinBasedInputView){
        this.mKeyguardPinBasedInputView = keyguardPinBasedInputView;
    }
    public KeyguardPinBasedInputView getKeyguardPinBasedInputView(){
        return this.mKeyguardPinBasedInputView;
    }
    /*PRIZE-add KeyguardPinBasedInputView obj-liufan-2015-07-22-end*/
