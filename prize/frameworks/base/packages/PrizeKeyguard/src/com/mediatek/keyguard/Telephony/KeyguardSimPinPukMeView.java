...
public class KeyguardSimPinPukMeView extends KeyguardPinBasedInputView {
    ...
    public void resetState(boolean forceReload) {
        ...
        /*PRIZE-sim lock-zhudaopeng-2017-03-23-Start*/
        ...
        mSimImageView.setImageTintList(ColorStateList.valueOf(rez.getColor(R.color.ic_sim_lock_tint_color)));
        /*PRIZE-sim lock-zhudaopeng-2017-03-23-End*/
    ...
    private abstract class CheckSimPinPuk extends Thread {
        ...
        public void run() {
            try {
                ...
                // M: ALPS03310669, fix phoneId change when SIM PIN unlocking.
                int rememberPhoneId = mPhoneId;
                ...
                if (mResult != null) {
                    // M: ALPS03310669, fix phoneId change when SIM PIN unlocking.
                    if (rememberPhoneId != mPhoneId) {
                        if (mResult[0] == PhoneConstants.PIN_RESULT_SUCCESS) {
                            Log.e(TAG, "mPhoneId changed, ingore pin result");
                            return;
                        }
                    }
    ...
    private Dialog getSimUnlockProgressDialog() {
        if (mSimUnlockProgressDialog == null) {
        	//prize-huangdianjun-20150915-start
            //mSimUnlockProgressDialog = new ProgressDialog(mContext);
            mSimUnlockProgressDialog = new ProgressDialog(mContext,com.android.internal.R.style.Theme_Material_Light_Dialog_Alert);
          //prize-huangdianjun-20150915-end
    ...
    /*prize-judge for puk-zhangjialong-20150917-start*/
    public boolean isPukInput(){
        boolean result = false;
        if (mUpdateMonitor.getSimStateOfPhoneId(mPhoneId) ==
                         IccCardConstants.State.PUK_REQUIRED) {
            /*String mHint = mSb.toString();
            String mNewPin = mContext.getText(R.string.keyguard_password_enter_new_pin_code).toString();
            String mConfirmPin = mContext.getText(R.string.keyguard_password_Confirm_pin_code).toString();

            if(mHint.equals(mNewPin)||mHint.equals(mConfirmPin))
            {
               Log.e("zhangjialong","isPukInput PUK NEW"); 
               result =false;
            }else{
                result = true;
            }*/
        ...
        android.util.Log.d(TAG,"isPukInput result = " + result);
        return result;
    } 
    /*prize-judge for puk-zhangjialong-20150917-start*/
    ...
    public boolean isPinInput(){
        ...
        if (mUpdateMonitor.getSimStateOfPhoneId(mPhoneId) == IccCardConstants.State.PIN_REQUIRED) {
            ...
            if(mHint.equals(mNewPin)||mHint.equals(mConfirmPin))
            {
                Log.e("zhangjialong","isPinInput PIN NEW");
                result =false;
            }else{
                result = true;
            }*/
        ...
        android.util.Log.d(TAG,"isPinInput result = " + result);
        return result;
    }
    ...
    private Dialog getSimRemainingAttemptsDialog(int remaining) {
        ...
        if (mRemainingAttemptsDialog == null) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(mContext,com.android.internal.R.style.Theme_Material_Light_Dialog_Alert);
        	//prize-huangdianjun-20150915-end
