...
public class ExternalStorageProvider extends DocumentsProvider {
    ...
    public String renameDocument(String docId, String displayName) throws FileNotFoundException {
        ...
        if (isSamePathAndVisiblePath(docId)) {
            ...
            if (before_visible != null) {
                ...
                Log.d(TAG, "renameDocument diff path and visiblePath rows_updated = " +
                        rows_updated);
            }
        }
    ...
    private boolean isSamePathAndVisiblePath(String docId) {
        ...
        if (root.visiblePath != null && root.visiblePath.toString().equals(root.path.toString()))
            return true;
        return false;
    }
