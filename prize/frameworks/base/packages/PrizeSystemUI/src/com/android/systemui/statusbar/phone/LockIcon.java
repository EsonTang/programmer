...
public class LockIcon extends KeyguardAffordanceView {
    ...
    public void update(boolean force) {
        ...
        if(PrizeOption.PRIZE_LOCKSCREEN_INVERSE){
            if(textColor == 0){
                setImageTintList(ColorStateList.valueOf(PhoneStatusBar.LOCK_DARK_COLOR));
            }else{
                setImageTintList(ColorStateList.valueOf(PhoneStatusBar.LOCK_LIGHT_COLOR));
            }
        } else {
            /*PRIZE-finger unlock error color-liufan-2016-09-09-start*/
            setImageTintList(ColorStateList.valueOf(0x80FFFFFF));
            /*PRIZE-finger unlock error color-liufan-2016-09-09-end*/
        }
