...
public class BatteryTile extends QSTile<QSTile.State> implements BatteryController.BatteryStateChangeCallback {
    ...
    public Intent getLongClickIntent() {
        /*PRIZE-update for bugid:45276-2017-12-12-start*/
        return null;//new Intent(Intent.ACTION_POWER_USAGE_SUMMARY);
        /*PRIZE-update for bugid:45276-2017-12-12-end*/
    }
    ...
    protected void handleUpdateState(State state, Object arg) {
        ...
        /**PRIZE-get battery drawable- 2015-05-15 start */
		int resId = obtainBatteryResId(mLevel);
        state.icon = ResourceIcon.get(resId);
        /*state.icon = new Icon() {
            @Override
        ...
        /**PRIZE-get battery drawable- 2015-05-15 end */
    ...
    /**PRIZE-get battery res id- 2015-05-15 start */
    private int obtainBatteryResId(int battery){
        int resId = R.drawable.ic_qs_power_on_0;
        /**PRIZE-don't show charge when the power is full- 2015-05-15 start */
        if(mCharging && battery != 100){
        /**PRIZE-don't show charge when the power is full- 2015-05-15 end */
            resId = R.drawable.ic_qs_power_on_charge;
        }else if(battery >= 0 && battery <= 5){
            resId = R.drawable.ic_qs_power_on_0;
        }else if(battery > 5 && battery < 30){
            resId = R.drawable.ic_qs_power_on_20;
        }else if(battery >= 30 && battery < 45){
            resId = R.drawable.ic_qs_power_on_40;
        }else if(battery >= 45 && battery < 55){
            resId = R.drawable.ic_qs_power_on_50;
        }else if(battery >= 55 && battery < 70){
            resId = R.drawable.ic_qs_power_on_60;
        }else if(battery >= 70 && battery < 90){
            resId = R.drawable.ic_qs_power_on_80;
        }else if(battery >= 90 && battery <= 100){
            resId = R.drawable.ic_qs_power_on;
        }
        return resId;
    }
    /**PRIZE-get battery res id- 2015-05-15 end */
