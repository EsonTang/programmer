...
/*prize-import pkg-liufan-2016-01-28-start*/
import android.app.ActivityManager;
import android.app.ActivityManager.RunningAppProcessInfo;
/*prize-import pkg-liufan-2016-01-28-end*/
...
/*prize add by xiarui 2018-03-17 start*/
import com.android.systemui.recents.events.activity.HideRecentsEvent;
/*prize add by xiarui 2018-03-17 end*/
...
public class RecentsView extends FrameLayout {
    ...
    public RecentsView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        /*prize add by xiarui for Bug#43237 2017-11-24 start*/
        if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
            mEmptyView = (TextView) inflater.inflate(R.layout.prize_recents_empty, this, false);
        } else {
            mEmptyView = (TextView) inflater.inflate(R.layout.recents_empty, this, false);
        }
        /*prize add by xiarui for Bug#43237 2017-11-24 end*/
        addView(mEmptyView);
    }
    ...
    /*prize-startHideClearRecentsButtonAnimation-liufan-2015-12-01-start*/
     public void startHideClearRecentsButtonAnimation() {
        if (mClearRecents != null) {
            mClearRecents.animate()
                ...
                .setDuration(1000)//mConfig.taskViewRemoveAnimDuration
    ...
    private View mClearRecents = null;
    /*prize-startHideClearRecentsButtonAnimation-liufan-2015-12-01-end*/
    ...
    protected void onAttachedToWindow() {
        ...
        /*prize-get prompt text obj-liufan-2015-12-01-start*/
        mClearRecents = ((View)getParent()).findViewById(R.id.clear_recents);
        /*prize-get prompt text obj-liufan-2015-12-01-end*/
    }
    ...
    /*prize-dismiss all task-liufan-2016-11-17-start*/
    public void dismissAllTasksAnimated(Runnable r) {
        mTaskStackView.dismissAllTasks(r);
    }
    public void shouldFinishActivity() {
        mTaskStackView.shouldFinishActivity();
    }
    /*prize-dismiss all task-liufan-2016-11-17-end*/
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        //prize add by xiarui for demand bug#52019 2018-03-17 @{
        if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
            if (mTaskStackView != null && mTaskStackView.getTaskViews().size() == 0){
	...
	public boolean isAppLockByFingerprint(String packageName)
      {
	  ...
	  try
	  {
	  	int mFunctStatus = 0;
		int mAppLock = 0;
	  	functionCursor = getContext().getContentResolver().query(FP_FUNCTION_DATA, new String[]{"function_status"}, "function_name=?", new String[]{"app_lock_fc"},null);
		if(functionCursor != null && functionCursor.getCount() > 0 && functionCursor.moveToNext())
		{
			mFunctStatus = functionCursor.getInt(0);			
		}
		...
		dataCursor = getContext().getContentResolver().query(LOCK_APP_DATA, new String[]{"lock_status"}, "pkg_name=?", new String[]{packageName},null);
		if(dataCursor != null && dataCursor.getCount() > 0 && dataCursor.moveToNext())
		{
			mAppLock = dataCursor.getInt(0);			
		}
		if(dataCursor != null)
		{
			dataCursor.close();
      ...
      private boolean startAppLock(String packagename)
      {
      	    if(isAppLockByFingerprint(packagename))
      	    {
      	       Intent intent = new Intent();
		intent.setClassName("com.prize.applock.fingerprintapplock","com.prize.applock.fingerprintapplock.LockUI");
		intent.putExtra("block_pkgname",packagename);
		intent.putExtra("block_resultcode",10001);
		Activity ac = (Activity)getContext();
		ac.startActivityForResult(intent, 10001);
      	    	return true;
      	    }
      	    return false;
      }
	public static class AppLockParam{
		public TaskStack stack;
		public Task task;
		public TaskStackView stackView ;
		public TaskView taskView;
		public boolean screenPinningRequested;
		public Rect targetTaskBounds;
		public int targetTaskStack;
		public boolean lockToTask;
      }
      public static AppLockParam s_AppLockParam = new AppLockParam();
      public void doLaunchRecentTasksByAppLock()
      {
          mTransitionHelper.launchTaskFromRecents(s_AppLockParam.stack, s_AppLockParam.task, s_AppLockParam.stackView, s_AppLockParam.taskView,
                s_AppLockParam.screenPinningRequested, s_AppLockParam.targetTaskBounds, s_AppLockParam.targetTaskStack);
      }
      /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-end*/
    public final void onBusEvent(LaunchTaskEvent event) {
        mLastTaskLaunchedWasFreeform = event.task.isFreeformTask();
	 /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-start*/
	if(PrizeOption.PRIZE_FINGERPRINT_APPLOCK && startAppLock(event.task.key.baseIntent.getComponent().getPackageName()))
	{
	       s_AppLockParam.stack = mStack;
		s_AppLockParam.task = event.task;
		s_AppLockParam.stackView = mTaskStackView;
		s_AppLockParam.taskView = event.taskView;
		s_AppLockParam.screenPinningRequested = event.screenPinningRequested;
              s_AppLockParam.targetTaskBounds = event.targetTaskBounds;
		s_AppLockParam.targetTaskStack = event.targetTaskStack;
		s_AppLockParam.lockToTask = true;
		return ;
	}
	/*prize-add by lihuangyuan,for fingerapplock-2017-07-04-end*/
