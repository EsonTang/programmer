...
import com.mediatek.common.prizeoption.PrizeOption; //prize add by xiarui 2017-12-01
...
public class RecentsTransitionHelper {
    ...
    private static Bitmap composeHeaderBitmap(TaskView taskView,
        ...
        if (RecentsDebugFlags.Static.EnableTransitionThumbnailDebugMode) {
            ...
            /*prize modify by xiarui { hide app icon when launchTaskFromRecents } 2017-12-01 start*/
            ...
            /*prize modify by xiarui { hide app icon when launchTaskFromRecents } 2017-12-01 end*/
        }
        return b.createAshmemBitmap();
    }
