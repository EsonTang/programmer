...
public class BluetoothTile extends QSTile<QSTile.BooleanState>  {
    ...
    /*prize add by xiarui for Bug#43910 Bug#45306 2017-12-01 start*/
    private boolean mCanBeClicked = true;
    /*prize add by xiarui for Bug#43910 Bug#45306 2017-12-01 end*/
    ...
    protected void handleSecondaryClick() {
        Log.d("yh", "yuhao BluetoothTile handleSecondaryClick ");
        /*PRIZE-PowerExtendMode-yuhao-2016-12-10-start*/
        if (PrizeOption.PRIZE_POWER_EXTEND_MODE && PowerManager.isSuperSaverMode()) {
            Log.d("yh", "yuhao BluetoothTile handleSecondaryClick enter SuperSaverMode ");
            return;
        }
        /*PRIZE-PowerExtendMode-yuhao-2016-12-10-end*/
        Log.d(TAG, "xiar ---- handleSecondaryClick   mCanBeClicked : " + mCanBeClicked);
        if (mCanBeClicked) {
            mCanBeClicked = false;
    ...
    protected void handleClick() {
        ...
        showDetail(true);*/
        Log.d(TAG, "xiar ---- handleClick   mCanBeClicked : " + mCanBeClicked);
        if (mCanBeClicked) {
            mCanBeClicked = false;
            final boolean isEnabled = (Boolean) mState.value;
            MetricsLogger.action(mContext, getMetricsCategory(), !isEnabled);
    ...
    protected void handleUpdateState(BooleanState state, Object arg) {
        ...
        /**PRIZE-change drawable- 2015-05-15 start */
        if (enabled) {
            state.label = null;
            if (connected) {
                state.icon = ResourceIcon.get(R.drawable.ic_qs_bt_on);
                state.colorId = 1;
            ...
            state.icon = ResourceIcon.get(R.drawable.ic_qs_bt_off);
            state.colorId = 0;
            state.label = mContext.getString(R.string.quick_settings_bluetooth_label);
            state.contentDescription = mContext.getString(
                    R.string.accessibility_quick_settings_bluetooth_off);
        }
        /**PRIZE-change drawable- 2015-05-15 end */

		/*PRIZE-PowerExtendMode-yuhao-2016-12-10-start*/
//        if (PrizeOption.PRIZE_POWER_EXTEND_MODE && PowerManager.isSuperSaverMode()){
//			Log.d("yh","yuhao  BluetoothTile handleUpdateState set state.icon = null ");
//			state.icon = null;
//        }
		/*PRIZE-PowerExtendMode-yuhao-2016-12-10-end*/
    ...
    private final BluetoothController.Callback mCallback = new BluetoothController.Callback() {
        ...
        public void onBluetoothStateChange(boolean enabled) {
            mCanBeClicked = true;
            Log.d(TAG, "xiar ---- onBluetoothStateChange   mCanBeClicked : " + mCanBeClicked);
            refreshState();
        }
    ...
    private final class BluetoothDetailAdapter implements DetailAdapter, QSDetailItems.Callback {
        ...
        public View createDetailView(Context context, View convertView, ViewGroup parent) {
            ...
            mItems.setEmptyState(R.drawable.ic_qs_bt_on,//prize-change drawable-liufan-2015-05-15
        ...
        private void updateItems() {
            ...
            if (devices != null) {
                for (CachedBluetoothDevice device : devices) {
                    ...
                    item.icon = R.drawable.ic_qs_bt_on;//prize-change drawable-liufan-2015-05-15
