...
public class KeyguardAffordanceHelper {
    ...
    private void updateIcon(KeyguardAffordanceView view, float circleRadius, float alpha,
        ...
        /*PRIZE-ignore the rightIcon-liufan-2017-01-04-start*/
        if (view.getVisibility() != View.VISIBLE && !force && (view != mRightIcon || !isReset)) {
        /*PRIZE-ignore the rightIcon-liufan-2017-01-04-end*/
            return;
        }
