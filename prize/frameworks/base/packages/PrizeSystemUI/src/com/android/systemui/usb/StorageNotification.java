        ...
        for (VolumeRecord rec : recs) {
            ...
            if ((info != null && info.isMountedWritable()) || rec.isSnoozed()) {
                ...
                Notification.Builder builder = new Notification.Builder(mContext)
                        /*PRIZE-change sd card notification icon- liufan-2016-07-15-start*/
                        .setSmallIcon(com.android.systemui.R.drawable.ic_sd_card_48dp_prize)
                        /*PRIZE-change sd card notification icon- liufan-2016-07-15-end*/
                ...
                /*PRIZE-retain power notification icon- liufan-2016-07-15-start*/
				Notification notif = builder.build();
                notif.flags |= Notification.FLAG_KEEP_NOTIFICATION_ICON;
                mNotificationManager.notifyAsUser(fsUuid, PRIVATE_ID, notif, UserHandle.ALL);
                /*PRIZE-retain power notification icon- liufan-2016-07-15-end*/
            }
        }
    }
    ...
    private int getSmallIcon(DiskInfo disk, int state) {
        ...
        if (disk.isSd()) {
            switch (state) {
                case VolumeInfo.STATE_CHECKING:
                case VolumeInfo.STATE_EJECTING:
                    return com.android.systemui.R.drawable.ic_sd_card_48dp_prize;
                default:
                    return com.android.systemui.R.drawable.ic_sd_card_48dp_prize;
            }
        } else if (disk.isUsb()) {
            return com.android.systemui.R.drawable.stat_sys_data_usb_prize;
        } else {
            return com.android.systemui.R.drawable.ic_sd_card_48dp_prize;
        }
        /*PRIZE-change sd card notification icon- liufan-2016-07-15-end*/
