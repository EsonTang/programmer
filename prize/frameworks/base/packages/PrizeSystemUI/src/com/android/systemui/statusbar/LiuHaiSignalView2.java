...
import com.android.systemui.statusbar.phone.LiuHaiStatusBarIconController2;
import com.android.systemui.statusbar.phone.LiuHaiStatusBarIconController2.ShowOnLeftListener;
...
public class LiuHaiSignalView2
    ...
    public LiuHaiSignalView2(Context context) {
        this(context, null);
    }

    public LiuHaiSignalView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public LiuHaiSignalView2(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onAttachedToWindow() {
        ...
        for (PhoneState state : mPhoneStates) {
            ...
            /*PRIZE-add for liuhai screen-liufan-2018-06-25-start*/
            if(mLiuHaiStatusBarIconController != null && rightIconController != null){
                PhoneStatusBar.debugLiuHai2("LiuHaiSignalView2.onAttachedToWindow addItem");
                LiuHaiStatusBarIconData data = mLiuHaiStatusBarIconController.new LiuHaiStatusBarIconData();
                data.slot = SIM_SLOT;
                data.index = Integer.MAX_VALUE - sum;
                sum--;
                data.view = state.mMobileGroup;
                state.data = data;
                rightIconController.addItem(data);
            }
            /*PRIZE-add for liuhai screen-liufan-2018-06-25-end*/
        }
    ...
    protected void onDetachedFromWindow() {
        ...
        /*PRIZE-add for liuhai screen-liufan-2018-06-25-start*/
        if(rightIconController != null){
            rightIconController.deleteItem(SIM_SLOT);
        }
        /*PRIZE-add for liuhai screen-liufan-2018-06-25-end*/
    ...
    public void setSubs(List<SubscriptionInfo> subs) {
        ...
        if(PhoneStatusBar.OPEN_LIUHAI_SCREEN2){
            if(showOnLeftListener != null) {
                showOnLeftListener.hideAllVolteIcon();
            }
        }
        /*PRIZE-add for liuhai screen-liufan-2018-04-09-end*/
    ...
    private PhoneState inflatePhoneState(int subId) {
        ...
        if (mMobileSignalGroup != null) {
            ...
            if(mLiuHaiStatusBarIconController != null && rightIconController != null){
                ...
                LiuHaiStatusBarIconData data = mLiuHaiStatusBarIconController.new LiuHaiStatusBarIconData();
                data.slot = SIM_SLOT;
                data.index = Integer.MAX_VALUE - (2 - mPhoneStates.size());
                data.view = state.mMobileGroup;
                state.data = data;
                rightIconController.addItem(data);
            }
    ...
    public void onRtlPropertiesChanged(int layoutDirection) {
        ...
        if(PluginManager.isDefaultSystemUIStatusBarExt() && mNoSimsPrize != null){
            ...
            mNoSimsPrize.setImageResource(R.drawable.liuhai2_no_sims);
        }
    ...
    private void apply() {
        ...
        if (mWifiVisible) {
            if (mWifiStrengthId != mLastWifiStrengthId) {
                ...
                /*PRIZE-add for liuhai screen-liufan-2018-06-25-start*/
                if(PhoneStatusBar.OPEN_LIUHAI_SCREEN2 && showOnLeftListener != null){
                    showOnLeftListener.setWifiIcon(mWifiStrengthId, 1);
                }
                /*PRIZE-add for liuhai screen-liufan-2018-06-25-end*/
            }
            ...
            if(PhoneStatusBar.OPEN_LIUHAI_SCREEN2 && showOnLeftListener != null){
                showOnLeftListener.setWifiInOutIcon(mWifiActivityId, 1);

                showOnLeftListener.setWifiIconVisible(View.VISIBLE);
            ...
            /*PRIZE-add for liuhai screen-liufan-2018-06-25-start*/
            if(PhoneStatusBar.OPEN_LIUHAI_SCREEN2 && showOnLeftListener != null){
                showOnLeftListener.setWifiIconVisible(View.GONE);
            }
            /*PRIZE-add for liuhai screen-liufan-2018-06-25-end*/
        }
        ...
        if (mIsAirplaneMode) {
            ...
            //if (mLastAirplaneIconId != mAirplaneIconId) {
	            ...
	            if(PrizeOption.PRIZE_STATUSBAR_INVERSE_COLOR && !mIgnoreStatusBarStyleChanged) {
	                icon = TelephonyIcons.getFlightModeIcon(mCurStatusBarStyle);
                    /*PRIZE-add for liuhai screen-liufan-2018-06-25-start*/
                    if(PhoneStatusBar.OPEN_LIUHAI_SCREEN2){
                ...
                /*PRIZE-add for liuhai screen-liufan-2018-06-25-start*/
                if(PhoneStatusBar.OPEN_LIUHAI_SCREEN2 && showOnLeftListener != null){
                    showOnLeftListener.setAirplaneIcon(icon,1);
                }
                /*PRIZE-add for liuhai screen-liufan-2018-06-25-end*/
            ...
            if(PhoneStatusBar.OPEN_LIUHAI_SCREEN2 && showOnLeftListener != null){
                showOnLeftListener.setAirplaneIconVisible(View.VISIBLE);
            ...
            /*PRIZE-add for liuhai screen-liufan-2018-06-25-start*/
            if(PhoneStatusBar.OPEN_LIUHAI_SCREEN2 && showOnLeftListener != null){
                showOnLeftListener.setAirplaneIconVisible(View.GONE);
            }
            /*PRIZE-add for liuhai screen-liufan-2018-06-25-end*/
        }
        ...
        if(PrizeOption.PRIZE_STATUSBAR_INVERSE_COLOR && !mIgnoreStatusBarStyleChanged) {
            ...
            if(PluginManager.isDefaultSystemUIStatusBarExt() && mCurStatusBarStyle == StatusBarManager.STATUS_BAR_INVERSE_GRAY) {
                mNoSimsPrize.setImageResource(R.drawable.liuhai2_no_sims_gray);
            }
        ...
        /*PRIZE-add for liuhai screen-liufan-2018-06-25-start*/
        if(mLiuHaiStatusBarIconController != null && rightIconController != null){
            boolean show = mNoSimsPrize.getVisibility() == View.VISIBLE;
            if(show){
                if(nosimData == null){
                    nosimData = mLiuHaiStatusBarIconController.new LiuHaiStatusBarIconData();
                    nosimData.slot = NO_SIM_SLOT;
                    nosimData.index = Integer.MAX_VALUE - 5;
                    nosimData.view = mNoSimsPrize;
                }
                rightIconController.addItem(nosimData);
            } else {
                rightIconController.deleteItem(NO_SIM_SLOT);
            }
        }
        /*PRIZE-add for liuhai screen-liufan-2018-06-25-end*/
    ...
    private class PhoneState {
        ...
        public LiuHaiStatusBarIconData data;
        ...
        public PhoneState(int subId, Context context) {
            ...
            if(PhoneStatusBar.OPEN_LIUHAI_SCREEN2){
                root = (ViewGroup) LayoutInflater.from(context)
                            .inflate(R.layout.liuhai_mobile_signal_group_ext2, null);
            } else
            /*PRIZE-add for liuhai screen-liufan-2018-06-25-end*/
            if(PluginManager.isDefaultSystemUIStatusBarExt()){
                root = (ViewGroup) LayoutInflater.from(context)
        ...
        public boolean apply(boolean isSecondaryIcon) {
            ...
            if(!FeatureOption.PRIZE_QS_SORT){
                ...
                if(PluginManager.isDefaultSystemUIStatusBarExt()){
                    ...
                    mNoService.setImageResource(R.drawable.liuhai2_no_service);
	                if(PrizeOption.PRIZE_STATUSBAR_INVERSE_COLOR && !mIgnoreStatusBarStyleChanged) {
                        ...
                        if(mCurStatusBarStyle == StatusBarManager.STATUS_BAR_INVERSE_GRAY){
                            mNoService.setImageResource(R.drawable.liuhai2_no_service_gray);
                        }
	                } //end...                
        ...
        private void setVolteIcon() {
            ...
            if(PhoneStatusBar.OPEN_LIUHAI_SCREEN2){
                ...
                if(showOnLeftListener == null) {
                    PhoneStatusBar.debugLiuHai2("LiuHaiStatusBarIconController.showOnLeftListener is null");
                    return ;
                }
                if (mVolteIcon == 0) {
                    showOnLeftListener.hideVolteIcon(mSubId, mPhoneStates.size());
                } else {
                    showOnLeftListener.showVolteIcon(mSubId, mVolteIcon, mPhoneStates.size());
                }
                return ;
            }
            /*PRIZE-add for liuhai screen-liufan-2018-06-25-end*/
    ...
    public static final String SIM_SLOT = "sim_card";
    public static final String NO_SIM_SLOT = "nosim_card";
    private LiuHaiStatusBarIconData nosimData;
    LiuHaiStatusBarIconController2.ShowOnLeftListener showOnLeftListener = null;
    LiuHaiStatusBarIconController2.RightIconController rightIconController = null;
    LiuHaiStatusBarIconController2 mLiuHaiStatusBarIconController = null;
    public void setShowOnLeftListener(LiuHaiStatusBarIconController2.ShowOnLeftListener listener){
        showOnLeftListener = listener;
    }
    public void setLiuHaiStatusBarIconListener(LiuHaiStatusBarIconController2 controller){
        mLiuHaiStatusBarIconController = controller;
        showOnLeftListener = controller.getShowOnLeftListenerImpI();
        rightIconController = controller.getRightIconController();
    }
    ...
    public int exchangeAirplaneIconForLiuHai(int iconid){
        ...
        case R.drawable.stat_sys_airplane_mode:
            result = R.drawable.liuhai2_stat_sys_airplane_mode;
            break;
        case R.drawable.stat_sys_airplane_mode_gray_prize:
            result = R.drawable.liuhai2_stat_sys_airplane_mode_gray_prize;
            break;
        }
        return result;
    }
    ...
    public int exchangeIconForLiuHai(int iconid, int statusBarStyle){
        ...
        case R.drawable.stat_sys_network_type_3g:
            if(isNeedGrayIcon){
                result = R.drawable.liuhai2_stat_sys_network_type_3g_gray_prize;
            } else {
                result = R.drawable.liuhai2_stat_sys_network_type_3g;
            }
            break;
        case R.drawable.stat_sys_network_type_1x:
            if(isNeedGrayIcon){
                result = R.drawable.liuhai2_stat_sys_network_type_1x_gray_prize;
            } else {
                result = R.drawable.liuhai2_stat_sys_network_type_1x;
            }
            break;
        case R.drawable.stat_sys_network_type_e:
            if(isNeedGrayIcon){
                result = R.drawable.liuhai2_stat_sys_network_type_e_gray_prize;
            } else {
                result = R.drawable.liuhai2_stat_sys_network_type_e;
            }
            break;
        case R.drawable.stat_sys_network_type_4g:
            if(isNeedGrayIcon){
                result = R.drawable.liuhai2_stat_sys_network_type_4g_gray_prize;
            } else {
                result = R.drawable.liuhai2_stat_sys_network_type_4g;
            }
            break;
        case R.drawable.stat_sys_network_type_2g:
            if(isNeedGrayIcon){
                result = R.drawable.liuhai2_stat_sys_network_type_2g_gray_prize;
            } else {
                result = R.drawable.liuhai2_stat_sys_network_type_2g;
            }
            break;
        case R.drawable.stat_sys_network_type_g:
            if(isNeedGrayIcon){
                result = R.drawable.liuhai2_stat_sys_network_type_g_gray_prize;
            } else {
                result = R.drawable.liuhai2_stat_sys_network_type_g;
            }
            break;
        case R.drawable.stat_sys_network_type_4g_plus:
            if(isNeedGrayIcon){
                result = R.drawable.liuhai2_stat_sys_network_type_4g_plus_gray_prize;
            } else {
                result = R.drawable.liuhai2_stat_sys_network_type_4g_plus;
            }
            break;
        }
        return result;
    ...
    public int exchangeMobileInOutIconForLiuHai(int iconid){
        ...
        case R.drawable.stat_sys_signal_data_not_inout:
            result = R.drawable.liuhai2_stat_sys_signal_data_not_inout;
            break;
        case R.drawable.stat_sys_signal_data_in:
            result = R.drawable.liuhai2_stat_sys_signal_data_in;
            break;
        case R.drawable.stat_sys_signal_data_out:
            result = R.drawable.liuhai2_stat_sys_signal_data_out;
            break;
        case R.drawable.stat_sys_signal_data_inout:
            result = R.drawable.liuhai2_stat_sys_signal_data_inout;
            break;

        case R.drawable.stat_sys_signal_data_not_inout_gray_prize:
            result = R.drawable.liuhai2_stat_sys_signal_data_not_inout_gray_prize;
            break;
        case R.drawable.stat_sys_signal_data_in_gray_prize:
            result = R.drawable.liuhai2_stat_sys_signal_data_in_gray_prize;
            break;
        case R.drawable.stat_sys_signal_data_out_gray_prize:
            result = R.drawable.liuhai2_stat_sys_signal_data_out_gray_prize;
            break;
        case R.drawable.stat_sys_signal_data_inout_gray_prize:
            result = R.drawable.liuhai2_stat_sys_signal_data_inout_gray_prize;
            break;
        }
        return result;
    }
