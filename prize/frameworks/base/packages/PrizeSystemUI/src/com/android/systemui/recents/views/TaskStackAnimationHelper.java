...
public class TaskStackAnimationHelper {
    ...
    /*PRIZE-to public-liufan-2016-11-18-start*/
    public static final int DOUBLE_FRAME_OFFSET_MS = 33;
    /*PRIZE-to public-liufan-2016-11-18-end*/
    ...
    public void prepareForEnterAnimation() {
        ...
        if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
            LogUtils.d("xx", "prepareForEnterAnimation  mNeedSendAnimationCompletedEvent" + RecentsActivity.mNeedSendAnimationCompletedEvent);
            if (RecentsActivity.mNeedSendAnimationCompletedEvent) {
    ...
    public void startEnterAnimation(final ReferenceCountedTrigger postAnimationTrigger) {
        ...
        LogUtils.d("xx", "startEnterAnimation");
            ...
            if (launchState.launchedFromApp && !launchState.launchedViaDockGesture) {
                if (task.isLaunchTarget) {
                    ...
                    if (currentTaskOccludesLaunchTarget) {
                        ...
                        /*prize modify by xiarui for Bug#44285 2017-12-09 start*/
                        if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
                            mStackView.updateTaskViewToTransform(true, postAnimationTrigger, tv, mTmpTransform, taskAnimation);
                        } else {
                            postAnimationTrigger.increment();
                            mStackView.updateTaskViewToTransform(tv, mTmpTransform, taskAnimation);
                        }
                        /*prize modify by xiarui for Bug#44285 2017-12-09 end*/
                    }
                }
    ...
    public void startExitToHomeAnimation(boolean animated,
        ...
        for (int i = 0; i < taskViewCount; i++) {
            ...
            /*prize modify by xiarui for Bug#44285 2017-12-09 start*/
            if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
                mStackView.updateTaskViewToTransform(animated, postAnimationTrigger, tv, mTmpTransform, taskAnimation);
            } else {
                mStackView.updateTaskViewToTransform(tv, mTmpTransform, taskAnimation);
            }
            /*prize modify by xiarui for Bug#44285 2017-12-09 end*/
    ...
    public void startLaunchTaskAnimation(TaskView launchingTaskView, boolean screenPinningRequested,
        ...
        for (int i = 0; i < taskViewCount; i++) {
            ...
            if (tv == launchingTaskView) {
                ...
                /*prize modify by xiarui 2017-12-09 end*/
                mTmpTransform.fillIn(tv);
                mTmpTransform.alpha = 0f;
                mTmpTransform.rect.offset(0, taskViewAffiliateGroupEnterOffset);
                /*prize modify by xiarui for Bug#44285 2017-12-09 start*/
    ...
    public void startDeleteTaskAnimation(final TaskView deleteTaskView,
        ...
        animator.addUpdateListener((animation) -> {
            ...
            /*prize modify delete task animation by xiarui 2017-11-15 start*/
			if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
            	deleteTaskView.setTranslationY(-(progress * dismissSize));
			} else {
				deleteTaskView.setTranslationX(progress * dismissSize);
			}
            /*prize modify delete task animation by xiarui 2017-11-15 end*/
    ...
    public void startDeleteAllTasksAnimation(final List<TaskView> taskViews,
        ...
        if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
            mStackView.isDeleteAllTasksAnimation = true;
        }
        //@}
        ...
        for (int i = count; i >= 0; i--) {
            ...
            if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
                boolean isLock = tv.getTask().isLock(mStackView.getContext());
                if (isLock) {
                    continue;
                }
            }
            ...
            mTmpTransform.fillIn(tv);
            /*prize add by xiarui 2017-12-02 start*/
            if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
                int offscreenYOffset  = tv.getBottom();
                mTmpTransform.rect.offset(0, -offscreenYOffset);
            } else {
                mTmpTransform.rect.offset(offscreenXOffset, 0);
            }
            /*prize add by xiarui 2017-12-02 end*/
