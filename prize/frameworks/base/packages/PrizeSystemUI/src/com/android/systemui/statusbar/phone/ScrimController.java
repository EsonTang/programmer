...
/*PRIZE-import package- liufan-2015-06-09-start*/
import android.widget.LinearLayout;
import android.util.Log;
/*PRIZE-import package- liufan-2015-06-09-end*/
...
public class ScrimController implements ViewTreeObserver.OnPreDrawListener,
    ...
    public static final long ANIMATION_DURATION = 0;//update for magazine-liufan-2018-1-29
    ...
    public void setPanelExpansion(float fraction) {
        if (mFraction != fraction) {
            ...
            /*PRIZE-change the alpha of the blur layout- liufan-2015-06-09-start*/
            if (VersionControl.CUR_VERSION == VersionControl.BLUR_BG_VER) {
                if(this.mNotificationLayout!=null){
                    this.mNotificationLayout.setAlpha(mFraction);
                }
            }
            /*PRIZE-change the alpha of the blur layout- liufan-2015-06-09-end*/
            /*PRIZE-change the alpha of the blur layout- liufan-2015-06-09-start*/
            if(this.mLockscreenBlurLayout!=null){
                this.mLockscreenBlurLayout.setAlpha(mFraction);
            }
            /*PRIZE-change the alpha of the blur layout- liufan-2015-06-09-end*/
    ...
    /*PRIZE-the blur layout obj- liufan-2015-06-09-start*/
    private LinearLayout mNotificationLayout;
    private LinearLayout mLockscreenBlurLayout;
    public void setNotificationBackgroundLayout(LinearLayout linearLayout){
    ...
    /*PRIZE-the blur layout obj- liufan-2015-06-09-end*/
    ...
    public static boolean isDismissScrim = false;
    public static boolean haveNotification = false;
    protected void updateScrims() {
    /*PRIZE-cancel the dark scrimview when lockscreen- liufan-2015-08-14-start*/
        if (mAnimateKeyguardFadingOut || mForceHideScrims) {
            if (VersionControl.isDismissScrimView || isDismissScrim) {
                mScrimBehind.setVisibility(View.VISIBLE);
                mScrimInFront.setVisibility(View.VISIBLE);
            }
            setScrimInFrontColor(0f);
            /*PRIZE-update for bugid:44387- liufan-2017-12-08-start*/
            setScrimBehindColor(0.001f);
            /*PRIZE-update for bugid:44387- liufan-2017-12-08-end*/
            ...
            boolean dismiss = PhoneStatusBar.BLUR_BG_CONTROL ? 
                VersionControl.isDismissScrimView && !mBouncerShowing :
                VersionControl.isDismissScrimView && !mBouncerShowing && !haveNotification;
            if (dismiss) {
                setScrimInFrontColor(0f);
                /*PRIZE-update for bugid:44387- liufan-2017-12-08-start*/
                setScrimBehindColor(0.001f);
    ...
    /*PRIZE-cancel the dark scrimview when lockscreen- liufan-2015-08-14-end*/
        mAnimateChange = false;
    }
    ...
    public void setBouncerColor(float alpha) {
	setScrimInFrontColor(alpha);
        setScrimBehindColor(alpha);
    }
