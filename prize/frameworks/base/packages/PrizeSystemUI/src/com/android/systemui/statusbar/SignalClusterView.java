...
public class SignalClusterView
    ...
    protected void onFinishInflate() {
        ...
        mNoSimsPrize = (TextView) findViewById(R.id.no_sims_prize);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        /*PRIZE-add for liuhai screen-liufan-2018-04-09-start*/
        if(!PhoneStatusBar.OPEN_LIUHAI_SCREEN && !PhoneStatusBar.OPEN_LIUHAI_SCREEN2) applyIconTint();
        /*PRIZE-add for liuhai screen-liufan-2018-04-09-end*/
    }
    ...
    private void apply() {
        ...
        /*PRIZE-add for bugid:55556-liufan-2018-04-21-start*/
        else {
            if(!PluginManager.isDefaultSystemUIStatusBarExt()){
                int color = PrizeStatusBarStyle.getInstance(getContext()).getColor(0);
                for (PhoneState state : mPhoneStates) {
                    state.setViewColorFilter(color);
                }
            }
        }//end...
        /*PRIZE-add for bugid:55556-liufan-2018-04-21-end*/
    ...
    private class PhoneState {
        ...
        public void setViews(ViewGroup root) {
            ...
            if(PluginManager.isDefaultSystemUIStatusBarExt()){
                ...
                /*PRIZE-data activity, up and down arrow-liyao-2015-05-25 end*/
                /**PRIZE-No Service exchange String from icon-liyao-20150707-start*/
                mNoService = (TextView) root.findViewById(R.id.no_service_prize);
                /**PRIZE-No Service exchange String from icon-liyao-20150707-end*/
            }
