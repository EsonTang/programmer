...
public class ZenModePanel extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        /*PRIZE-update the dialog background color- liufan-2015-05-19-start*/
        if(FeatureOption.PRIZE_QS_SORT){
            /*PRIZE update the radian liyao 20150708 start  */
            mZenIntroduction.setBackgroundResource(com.android.systemui.R.drawable.zen_mode_panel_dialog_radius_top);
            mZenConditions.setBackgroundResource(com.android.systemui.R.drawable.zen_mode_panel_dialog_radius_bottom);
            /*PRIZE update the radian liyao 20150708 end */
        }
        /*PRIZE-update the dialog background color- liufan-2015-05-19-end*/
    }
    ...
    private void updateWidgets() {
        ...
        if(!zenOff && expanded){
            ...
            mZenIntroduction.setBackgroundResource(com.android.systemui.R.drawable.zen_mode_panel_dialog_radius);
        }
        /*PRIZE update the radian liyao 20150708 end */
    }
    ...
    private void bind(final Condition condition, final View row, final int rowId) {
        ...
        if (tag.line2 == null) {
            ...
            /*PRIZE-update the textview's color- liufan-2015-05-19-start*/
            if(FeatureOption.PRIZE_QS_SORT){
                tag.line2.setTextAppearance(mContext, R.style.TextAppearance_QS_DetailItemSecondary_define);
            }
            /*PRIZE-update the textview's color- liufan-2015-05-19-end*/
        }
