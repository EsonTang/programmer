...
public class MLand extends FrameLayout {
    ...
    public Player getPlayer(int i) {
        /*PRIZE-update for bugid:46358-liufan-2017-12-27-start*/
        //return i < mPlayers.size() ? mPlayers.get(i) : null;
        return i > 0 && i < mPlayers.size() ? mPlayers.get(i) : null;
        /*PRIZE-update for bugid:46358-liufan-2017-12-27-end*/
    }
    ...
    public void start(boolean startPlaying) {
        ...
        /*PRIZE-update for bugid:46357-liufan-2017-12-27-start*/
        if(mAnim == null || mAnim.isRunning()){
            android.util.Log.d("MLand","mAnim is null or isRunning");
            return ;
        }
        /*PRIZE-update for bugid:46357-liufan-2017-12-27-end*/
