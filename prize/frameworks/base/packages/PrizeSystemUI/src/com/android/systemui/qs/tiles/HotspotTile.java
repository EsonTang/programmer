...
public class HotspotTile extends QSTile<QSTile.AirplaneBooleanState> {
    ...
    protected void handleUpdateState(AirplaneBooleanState state, Object arg) {
        ...
        state.icon = ResourceIcon.get(state.value ? R.drawable.ic_qs_hotspot_on 
                : R.drawable.ic_qs_hotspot_off);//state.value ? mEnable : mDisable;
        ...
        if (state.isAirplaneMode) {
            ...
            state.icon = ResourceIcon.get(R.drawable.ic_qs_hotspot_off);//mUnavailable;
            state.colorId = 0;
        } else if (wasAirplane) {
            state.icon = ResourceIcon.get(R.drawable.ic_qs_hotspot_off);//mDisableNoAnimation;
            state.colorId = 0;
        }
