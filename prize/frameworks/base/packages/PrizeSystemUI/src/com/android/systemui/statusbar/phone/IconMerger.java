...
/*prize-import package-liufan-2016-02-18-start*/
import com.mediatek.common.prizeoption.PrizeOption;
/*prize-import package-liufan-2016-02-18-end*/
...
public class IconMerger extends LinearLayout {
    ...
    private void reloadDimens() {
        ...
        /*prize-To avoid being cut notification icon-liufan-2016-02-18-start*/
        if(PrizeOption.PRIZE_STATUSBAR_INVERSE_COLOR){
            mIconSize = mContext.getResources().getDimensionPixelSize(
                R.dimen.notification_icon_w_in_sb);
        }
        /*prize-To avoid being cut notification icon-liufan-2016-02-18-end*/
    }
