...
public class RecentsConfiguration {
    ...
    //prize add by xiarui 2018-05-07 @{
    public static float taskViewScalePortrait = 0.6f;
    public static float taskViewScaleLand = 0.0f;
    //@}
    ...
    public RecentsConfiguration(Context context) {
        ...
        //prize add by xiarui 2018-05-07 @{
        taskViewScaleLand = context.getResources().getFraction(
