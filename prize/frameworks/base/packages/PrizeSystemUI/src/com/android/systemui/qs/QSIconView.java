...
public class QSIconView extends ViewGroup {
    ...
    public QSIconView(Context context) {
        ...
        /*PRIZE-change size- liufan-2016-11-03-start*/
        mIconSizePx = res.getDimensionPixelSize(R.dimen.qs_tile_icon_size_config);
        /*PRIZE-change size- liufan-2016-11-03-end*/
    ...
    public void setIcon(QSTile.State state) {
        /*PRIZE-show the drawable priority- liufan-2015-04-29-start*/
        ImageView iv = (ImageView) mIcon;
        if(state.drawable!=null){
            iv.setImageDrawable(state.drawable);
        }else{
            setIcon(iv, state);
        }
        /*PRIZE-show the drawable priority- liufan-2015-04-29-end*/
    }
