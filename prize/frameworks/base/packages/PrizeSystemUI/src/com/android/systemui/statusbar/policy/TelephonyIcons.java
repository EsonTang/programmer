...
public class TelephonyIcons {
    ...
    /**PRIZE change no service to text liyao 20150707 start*/
    ...
    static final int TELEPHONY_NO_NETWORK = 0;//R.drawable.stat_sys_signal_null;
	static final int QS_TELEPHONY_NO_NETWORK = R.drawable.ic_qs_signal_no_signal;
     /**PRIZE change no service to text liyao 20150707 end*/
    ...
    static final MobileIconGroup DATA_DISABLED = new MobileIconGroup(
            ...
            0,//TelephonyIcons.ICON_DATA_DISABLED,--delete for bugid:51155
            false,
            0//TelephonyIcons.QS_ICON_DATA_DISABLED--delete for bugid:51155
            );

	
    /*PRIZE*使用移动数据业务,信号图标不显示上下行箭头(bug 699) 2015-05-25 start*/
    static final int[] DATA_ACTIVITY = {
            R.drawable.stat_sys_signal_data_not_inout,
            R.drawable.stat_sys_signal_data_in,
            R.drawable.stat_sys_signal_data_out,
            R.drawable.stat_sys_signal_data_inout
    };
    /*PRIZE*使用移动数据业务,信号图标不显示上下行箭头(bug 699) 2015-05-25 end*/

    //add for statusbar inverse. prize-linkh-20150903
    static final int FLIGHT_MODE_ICON_GRAY_PRIZE = R.drawable.stat_sys_airplane_mode_gray_prize;
    static final int[] DATA_ACTIVITY_GRAY_PRIZE = {
        R.drawable.stat_sys_signal_data_not_inout_gray_prize,
        R.drawable.stat_sys_signal_data_in_gray_prize,
        R.drawable.stat_sys_signal_data_out_gray_prize,
        R.drawable.stat_sys_signal_data_inout_gray_prize

    };
    static final int[] TELEPHONY_SIGNAL_STRENGTH_FULL_PRIZE = {
        R.drawable.stat_sys_signal_0_fully_gray_prize,
        R.drawable.stat_sys_signal_1_fully_gray_prize,
        R.drawable.stat_sys_signal_2_fully_gray_prize,
        R.drawable.stat_sys_signal_3_fully_gray_prize,
        R.drawable.stat_sys_signal_4_fully_gray_prize,
    };
    
    static public int getDataActivityIcon(int style, int activity) {
        int icon = 0;
        if(style == StatusBarManager.STATUS_BAR_INVERSE_WHITE) {
            icon = DATA_ACTIVITY[activity];
        } else if(style == StatusBarManager.STATUS_BAR_INVERSE_GRAY) {
            icon = DATA_ACTIVITY_GRAY_PRIZE[activity];
        }
    ...
    static public int getFlightModeIcon(int style) {
        int icon = FLIGHT_MODE_ICON;
        if(style == StatusBarManager.STATUS_BAR_INVERSE_WHITE) {
            icon = FLIGHT_MODE_ICON;
        } else if(style == StatusBarManager.STATUS_BAR_INVERSE_GRAY) {
            icon = FLIGHT_MODE_ICON_GRAY_PRIZE;
        }
        return icon;
    }

    static final int getSignalStrengthIcon(int style, int level) {
        int icon = 0;
        if(style == StatusBarManager.STATUS_BAR_INVERSE_WHITE) {
            icon = TELEPHONY_SIGNAL_STRENGTH_FULL[level];
        } else if(style == StatusBarManager.STATUS_BAR_INVERSE_GRAY) {
            icon = TELEPHONY_SIGNAL_STRENGTH_FULL_PRIZE[level];
        }
        return icon;
    }
    //end...
