...
public class StackScrollAlgorithm {
    ...
    public void getStackScrollState(AmbientState ambientState, StackScrollState resultState) {
        ...
        /*prize-don't fix headsup notification,for bugid：43654-liufan-2017-12-09-start*/
        //updateHeadsUpStates(resultState, algorithmState, ambientState);
        /*prize-don't fix headsup notification,for bugid：43654-liufan-2017-12-09-end*/
    ...
    private void updateHeadsUpStates(StackScrollState resultState,
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            /*prize-the heads up is not always visible even when scrolled off,bugid：25272-liufan-2016-12-15-start*/
            /*if (mIsExpanded) {
                // Ensure that the heads up is always visible even when scrolled off
                clampHunToTop(ambientState, row, childState);
                clampHunToMaxTranslation(ambientState, row, childState);
            }*/
            /*prize-the heads up is not always visible even when scrolled off,bugid：25272-liufan-2016-12-15-end*/
            if (row.isPinned()) {
