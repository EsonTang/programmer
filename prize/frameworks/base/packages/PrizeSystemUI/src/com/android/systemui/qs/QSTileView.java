...
public class QSTileView extends QSTileBaseView {
    ...
    private void updateTopPadding() {
        ...
        mTilePaddingTopPx = 0;// Math.round((1 - largeFactor) * padding + largeFactor * largePadding);   //liyao
    ...
    protected void onConfigurationChanged(Configuration newConfig) {
        ...
        updateTopPadding();
        //update for bugid:50674-liufan-2018-3-3
    ...
    protected void handleStateChanged(QSTile.State state) {
        ...
        /*PRIZE-update the qs text color- liufan-2015-05-19-start*/
        if(FeatureOption.PRIZE_QS_SORT){
            final Resources res = mContext.getResources();
            if(state.colorId == 0){
                mLabel.setTextColor(res.getColor(R.color.notification_qs_text_offcolor_define));
            }else{
                mLabel.setTextColor(res.getColor(R.color.notification_qs_text_oncolor_define));
            }
        }
        /*PRIZE-update the qs text color- liufan-2015-05-19-end*/
