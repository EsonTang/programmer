...
public abstract class PanelBar extends FrameLayout {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_DOWN) {
            ...
            if (VersionControl.CUR_VERSION == VersionControl.BLUR_BG_VER) {
                if(mPanel != null){
                    mPanel.expandImmediateSetting();
                }
            }
            /*PRIZE-pull to quick setting when there is no notification-liufan-2015-06-10-end*/
            
            /*PRIZE-show the blur background - liufan-2015-06-10-start
            if (VersionControl.CUR_VERSION == VersionControl.BLUR_BG_VER) {
		Log.e("liufan","PanleBar-------onTouchEvent------cancelNotificationBackground--->");
                mPanel.cancelNotificationBackground();
                //mPanel.showBlurBackground();
            }
            /*PRIZE-show the blur background - liufan-2015-06-10-end*/
        }
    ...
    public void panelExpansionChanged(float frac, boolean expanded) {
        Log.d("Notification","panelExpansionChanged() expanded = "+expanded);
