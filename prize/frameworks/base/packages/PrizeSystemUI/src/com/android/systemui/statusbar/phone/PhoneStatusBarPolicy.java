    ...
    private final void updateVolumeZen() {
        ...
        if (DndTile.isVisible(mContext) || DndTile.isCombinedIcon(mContext)) {
            ...
            zenIconId = mZen == Global.ZEN_MODE_NO_INTERRUPTIONS
                    /*PRIZE-update stat_sys_dnd to stat_sys_zen_none- liufan-2016-06-17-start*/
                    ? R.drawable.stat_sys_dnd_total_silence : R.drawable.stat_sys_zen_none;
                    /*PRIZE-update stat_sys_dnd to stat_sys_zen_none- liufan-2016-06-17-end*/
        ...
        //prize modify by xiarui for statusbar icon show 2018-06-01 @{
        boolean silentVisible = DndTile.isVisible(mContext) && !DndTile.isCombinedIcon(mContext)
                && audioManager.getRingerModeInternal() == AudioManager.RINGER_MODE_SILENT;
        boolean vibrateVisible = mZen != Global.ZEN_MODE_NO_INTERRUPTIONS && mZen != Global.ZEN_MODE_ALARMS &&
                audioManager.getRingerModeInternal() == AudioManager.RINGER_MODE_VIBRATE;
        if (PrizeOption.PRIZE_VIBRATE_CONTROL) {
            silentVisible = audioManager.getRingerModeInternal() == AudioManager.RINGER_MODE_SILENT;
            vibrateVisible = audioManager.getRingerModeInternal() == AudioManager.RINGER_MODE_VIBRATE;
        }
        if (silentVisible) {
            volumeVisible = true;
            volumeIconId = R.drawable.stat_sys_ringer_silent;
            volumeDescription = mContext.getString(R.string.accessibility_ringer_silent);
        } else if (vibrateVisible) {
            volumeVisible = true;
            volumeIconId = R.drawable.stat_sys_ringer_vibrate;
            volumeDescription = mContext.getString(R.string.accessibility_ringer_vibrate);
        }
        //end by xiarui 2018-06-06@}
