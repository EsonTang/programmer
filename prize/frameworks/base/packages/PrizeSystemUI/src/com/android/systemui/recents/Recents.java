...
public class Recents extends SystemUI
    ...
    private int prizeRecentsOpenNum = 0; // prize-modify-split screen-liyongli-20170803
	...
	if(PrizeOption.PRIZE_CHANGESIM_RESET_DIALOG)
	{
		...
		if(prizeresetmode == 1)
		{
			Log.d(TAG, "showRecents prizeresetmode:"+prizeresetmode);
			return ;
		}
	}
	/*PRIZE-add for changesimcard reset dialog-lihuangyuan-2017-06-15-end*/
        ...
        /* prize-modify-split screen-liyongli-20170803-start */
        if( prizeRecentsOpenNum==0){
            prizeRecentsOpenNum++;
        }
        /* prize-modify-split screen-liyongli-20170803-end */
    ...
    public static boolean isClearRecentsActivity = false;
    public static boolean isStackTaskRemoved = false;
	...
	if(PrizeOption.PRIZE_CHANGESIM_RESET_DIALOG)
	{
		...
		if(prizeresetmode == 1)
		{
			Log.d(TAG, "toggleRecents prizeresetmode:"+prizeresetmode);
			return ;
		}
	}
	/*PRIZE-add for changesimcard reset dialog-lihuangyuan-2017-06-15-end*/
        ...
        if (sSystemServicesProxy.isSystemUser(currentUser)) {
            /*prize-don't allow to enter RecentsActivity when is cleaning,bugid:18562-liufan-2016-07-20-start*/
            //if(isClearRecentsActivity || isStackTaskRemoved) return;
            /*prize-don't allow to enter RecentsActivity when is cleaning,bugid:18562-liufan-2016-07-20-end*/
    ...
    public final void onBusEvent(final DockedTopTaskEvent event) {
        ...
        if( prizeRecentsOpenNum==0){
            prizeRecentsOpenNum++;
            EventBus.getDefault().post(new RecentsDrawnEvent());//liyongli add fix, burn first entry Splite, only one screen
        }
        /* prize-modify-split screen-liyongli-20170803-end */
