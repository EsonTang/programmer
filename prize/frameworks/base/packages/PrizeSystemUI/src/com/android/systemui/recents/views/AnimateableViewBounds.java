...
public class AnimateableViewBounds extends ViewOutlineProvider {
    ...
    private static final float MAX_ALPHA = 0.4f; //0.8f //prize modify by xiarui 2017-11-25
    ...
    public void getOutline(View view, Outline outline) {
        ...
        if (mCornerRadius > 0) {
			/*prize modify by xiarui 2017-11-13 start */
			if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
	            outline.setRoundRect(mClipRect.left, mClipRect.top + ((TaskView)mSourceView).getHeaderView().getMeasuredHeight(),
			...
			/*prize modify by xiarui 2017-11-13 end */
        } else {
