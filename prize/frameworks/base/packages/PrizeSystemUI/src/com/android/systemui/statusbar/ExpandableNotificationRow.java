...
/*PRIZE-change text color,bugid:43613-liufan-2017-12-08-start*/
import com.android.systemui.statusbar.phone.PhoneStatusBar;
/*PRIZE-change text color,bugid:43613-liufan-2017-12-08-end*/
...
public class ExpandableNotificationRow extends ActivatableNotificationView {
    ...
    /*PRIZE-add for bugid:51812-liufan-2018-03-05-start*/
    private OnClickListener mExpandClickListener = null;
    ...
    /*PRIZE-add for bugid:51812-liufan-2018-03-05-end*/
    ...
    public void onNotificationUpdated(NotificationData.Entry entry) {
        ...
        updateLimits();
        /*PRIZE-change text color,bugid:43613-liufan-2017-12-08-start*/
        PhoneStatusBar.makeViewAlpha(this);
        /*PRIZE-change text color,bugid:43613-liufan-2017-12-08-end*/
    }

    /*PRIZE-change group notification icon,bugid:44276-liufan-2017-12-26-start*/
    public NotificationGroupManager getGroupManager(){
        return mGroupManager;
    }
    /*PRIZE-change group notification icon,bugid:44276-liufan-2017-12-26-end*/
    ...
    //prize add by xiarui 2018-04-23 start @{
    public boolean isCustomView() {
        View contractedChild = mPrivateLayout.getContractedChild();
        boolean isCustomView = (contractedChild != null && contractedChild.getId() != com.android.internal.R.id.status_bar_latest_event_content);
        Log.d(PhoneStatusBar.TICKER_TAG, "isCustomView = " + isCustomView);
        return isCustomView;
    }
    //@}
}
