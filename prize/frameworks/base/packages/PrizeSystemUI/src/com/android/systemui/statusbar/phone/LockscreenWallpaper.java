...
public class LockscreenWallpaper extends IWallpaperManagerCallback.Stub implements Runnable {
        ...
        mLoader = new AsyncTask<Void, Void, LoaderResult>() {
            ...
            protected void onPostExecute(LoaderResult result) {
                ...
                if (result.success) {
                    ...
                    mCache = result.bitmap;
                    mUpdateMonitor.setHasLockscreenWallpaper(result.bitmap != null);
					// prize-delete for 3rd wallpaper app sets wallpaper will close the switch of magazine wallpaper-xiekui-20180827
                    //mBar.closeLockScreenWallpaperSwitch();//add for bug: 25866-liufan-2016-12-13
    ...
    public static class WallpaperDrawable extends DrawableWrapper {
        ...
        static class ConstantState extends Drawable.ConstantState {
            ...
            /*PRIZE-add for bug: 25866-liufan-2016-12-13-start*/
            public Bitmap getBackground(){
                return mBackground;
            }
            /*PRIZE-add for bug: 25866-liufan-2016-12-13-end*/
