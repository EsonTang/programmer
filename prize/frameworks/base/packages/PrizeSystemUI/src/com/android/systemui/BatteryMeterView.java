...
public class BatteryMeterView extends ImageView implements
    ...
    public void onTuningChanged(String key, String newValue) {
        if (StatusBarIconController.ICON_BLACKLIST.equals(key)) {
            ...
            /**PRIZE-add PRIZE_SYSTEMUI_BATTERY_METER-liufan-2016-11-07-start */
            if(PrizeOption.PRIZE_SYSTEMUI_BATTERY_METER){
                setVisibility(View.GONE);
            }else{
                setVisibility(icons.contains(mSlotBattery) ? View.GONE : View.VISIBLE);
            }
            /**PRIZE-add PRIZE_SYSTEMUI_BATTERY_METER-liufan-2016-11-07-end */
        }
    }
    ...
    public void onAttachedToWindow() {
        ...
        /*PRIZE-add judgement-liufan-20151030-start*/
		if(mBatteryController != null){
        	mBatteryController.addStateChangedCallback(this);
		}
        /*PRIZE-add judgement-liufan-20151030-end*/
