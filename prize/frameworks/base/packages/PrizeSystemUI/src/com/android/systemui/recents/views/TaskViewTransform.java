...
public class TaskViewTransform {
    ...
    public float titleAlpha = 1f; //prize add by xiarui 2017-11-09
    ...
    public void applyToTaskView(TaskView v, ArrayList<Animator> animators,
		...
		/*prize add by xiarui 2017-11-09 start*/
		if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
        	v.setHeaderAlpha(this.titleAlpha);
		}
		/*prize add by xiarui 2017-11-09 end*/
    }
