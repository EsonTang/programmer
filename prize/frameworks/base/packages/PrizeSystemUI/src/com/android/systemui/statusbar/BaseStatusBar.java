...
import java.util.regex.Matcher;//add by zhouerlong
import java.util.regex.Pattern;//add by zhouerlong

/*PRIZE-PowerExtendMode-wangxianzhen-2015-07-21-start*/
import com.mediatek.common.prizeoption.PrizeOption;
/*PRIZE-PowerExtendMode-wangxianzhen-2015-07-21-end*/
import com.android.systemui.statusbar.phone.NotificationPanelView;
import static android.service.notification.NotificationListenerService.Ranking.IMPORTANCE_HIGH;
/*PRIZE-liyu-fingerprint application lock-20160830-start*/
import android.net.Uri;
import android.database.Cursor;
/*PRIZE-liyu-fingerprint application lock-20160830-end*/

import com.android.systemui.PrizeFloatQQService; //prize-add-split screen-liyongli-20170610
import com.android.systemui.recents.events.component.PrizeOpenPendingIntentEvent;
import com.mediatek.common.prizeoption.PrizeOption;
import com.android.systemui.statusbar.phone.PrizeTickerViewPanel; //prize add by xiarui 2018-04-13
...
public abstract class BaseStatusBar extends SystemUI implements
    ...
    public static final boolean PRIZE_HEADS_UP_STYLE = PrizeOption.PRIZE_NOTCH_SCREEN;
    //@}
	...
	/*PRIZE-for supershot-shiyicheng-20160831-start*/
	protected static final int MSG_CLOSE_SEARCH_PANEL = 1127;
	/*PRIZE-for supershot-shiyicheng-20160831-end*/
	
	/* prize-add-split screen-liyongli-20170610-start */
	protected static final int MSG_OPEN_QQFLOAT_ICON = 1128;
    ...
    /*private*/public KeyguardManager mKeyguardManager;//prize modify by xiarui 2018-04-13
    ...
    private ExpandableNotificationRow qqrow, mmrow;
    private int  qqMsgNum=0, mmMsgNum=0;
    ...
    private final IVrStateCallbacks mVrStateCallbacks = new IVrStateCallbacks.Stub() {
        ...
        public void onVrStateChanged(boolean enabled) {
            mVrMode = enabled;
            Log.d(TAG, "onVrStateChanged mVrMode = " + mVrMode);
        }
    };
    ...
    private RemoteViews.OnClickHandler mOnClickHandler = new RemoteViews.OnClickHandler() {
        ...
        public boolean onClickHandler(
            ...
            /*prize-add for bugid:47555-liufan-2018-01-22-start*/
            ...
            if(intent != null){
                ...
                if(component != null){
                    ...
                    Log.d(TAG,"action = " + action + ", pkg = " + pkg + ", cls = " + cls);
                    if("com.android.dialer.calllog.CallLogNotificationsService".equals(cls)){//miss call notification
                        if("com.android.dialer.calllog.CALL_BACK_FROM_MISSED_CALL_NOTIFICATION".equals(action)//call back
                            || "com.android.dialer.calllog.SEND_SMS_FROM_MISSED_CALL_NOTIFICATION".equals(action)//send sms
                        ){
                            isActivity = true;
                        }
                    }
            ...
            Log.d(TAG,"isActivity = " + isActivity);
            /*prize-add for bugid:47555-liufan-2018-01-22-end*/
            if (isActivity) {
    ...
    private final NotificationListenerService mNotificationListener =
        ...
        public void onListenerConnected() {
            ...
            if (notifications != null) { //prize add by xiarui 2018-05-28
    ...
    //add by zhouerlong 20160414
            ...
            if(entry!=null) {
                    View contentViewLocal = entry.getContentView();
                    if(contentViewLocal!=null) {
                            sendLauncherUnreadNotification(contentViewLocal,sbn);
                    }
				} 
            }catch (Exception e) {
				e.printStackTrace();
    ...
    protected View.OnTouchListener mRecentsPreloadOnTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (PrizeOption.PRIZE_POWER_EXTEND_MODE && PowerManager.isSuperSaverMode()){
                Log.i(TAG,"PowerExtendMode mRecentsPreloadOnTouchListener");
                return false;
            }
    ...
    protected class H extends Handler {
        public void handleMessage(Message m) {
            switch (m.what) {
             ...
             /* prize-add-split screen-liyongli-20170610-start */
             case MSG_OPEN_QQFLOAT_ICON:
             if( PrizeOption.PRIZE_SYSTEMUI_QQPOP_ICON ){
                 String strPkg = "com.android.systemui";
                 //String strCls = "com.android.systemui.stackdivider.PrizeFloatQQService";
                 String strCls = "com.android.systemui.PrizeFloatQQService";
                  Intent intent = new Intent("action.com.prize.floatqqservice");
                  String strHost;// = (String) m.obj;
                  int type = m.arg1;
                  int num = 0;//m.arg2;
                  strHost = PrizeFloatQQService.HOST_QQ;
                  if(type==PrizeOpenPendingIntentEvent.QQ_TYPE){
                  	strHost = PrizeFloatQQService.HOST_QQ;
                  	qqrow = (ExpandableNotificationRow)m.obj;
                  	qqMsgNum++;
                  	num = qqMsgNum;
                  }else if(type==PrizeOpenPendingIntentEvent.MM_TYPE){
                  	strHost = PrizeFloatQQService.HOST_MM;
                  	mmrow = (ExpandableNotificationRow)m.obj;
                  	mmMsgNum++;
                  	num = mmMsgNum;
                  }

                  intent.setClassName(strPkg, strCls);
                  intent.putExtra(PrizeFloatQQService.KEY_MSG_NUM, num);
                  intent.putExtra(PrizeFloatQQService.KEY_MSG_HOST,  strHost);
    ...
    protected boolean inflateViews(Entry entry, ViewGroup parent) {
        ...
        try {
            //add for statusbar inverse. prize-linkh-20150914
            // we don't want any color filter.
            if(PrizeOption.PRIZE_STATUSBAR_INVERSE_COLOR) {
                PrizeNotificaionIconUtil.clearNotificationIconColorFilter(sbn, contentView);
                PrizeNotificaionIconUtil.clearNotificationIconColorFilter(sbn, bigContentView);
                PrizeNotificaionIconUtil.clearNotificationIconColorFilter(sbn, headsUpContentView);
                PrizeNotificaionIconUtil.clearNotificationIconColorFilter(sbn, publicContentView);
                /*if(publicNotification != null) {
                    PrizeNotificaionIconUtil.clearNotificationIconColorFilter(sbn, publicNotification.contentView);
                }*/
            }//end...
        ...
        //add for statusbar inverse. prize-linkh-20150914        
        if(PrizeOption.PRIZE_STATUSBAR_INVERSE_COLOR && !PrizeNotificaionIconUtil.shouldIgnoreReplacing(sbn.getNotification())) {
            int iconId = 0;
            View v = null;
            iconId = com.android.internal.R.id.icon;
            v = contentViewLocal.findViewById(iconId);
            if(v!=null)
			    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, contentViewLocal, iconId, false);
            iconId = com.android.internal.R.id.right_icon;
            v = contentViewLocal.findViewById(iconId);
            if(v!=null)
                PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, contentViewLocal, iconId, false);
            ...
            if(bigContentViewLocal != null) {
                iconId = com.android.internal.R.id.icon;
                v = bigContentViewLocal.findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, bigContentViewLocal, iconId, false);
                iconId = com.android.internal.R.id.right_icon;
                v = bigContentViewLocal.findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, bigContentViewLocal, iconId, false);
            ...
            if(headsUpContentViewLocal != null) {
                iconId = com.android.internal.R.id.icon;
                v = headsUpContentViewLocal.findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, headsUpContentViewLocal, iconId, true);
                iconId = com.android.internal.R.id.right_icon;
                v = headsUpContentViewLocal.findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, headsUpContentViewLocal, iconId, true);
            ...
            if(publicViewLocal != null) {
                iconId = com.android.internal.R.id.icon;
                v = publicViewLocal.findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, publicViewLocal, iconId, false);
                iconId = com.android.internal.R.id.right_icon;
                v = publicViewLocal.findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, publicViewLocal, iconId, false);
            ...
            /*if(publicNotification != null && publicNotification.largeIcon != null) {
                iconId = com.android.internal.R.id.right_icon;
            } else {
                iconId = com.android.internal.R.id.icon;
            }
    ...
    private final class NotificationClicker implements View.OnClickListener {
        ...
        //prize add by xiarui 2018-04-12 @{
        private PendingIntent mIntent;
        private final String mNotificationKey;

        public NotificationClicker() {
            mIntent = null;
            mNotificationKey = null;
        }
        ...
        public void TickerDragHandlerOnClick(View v) {
            ...
            if (mIntent != null) {
                intent = mIntent;
                notificationKey = mNotificationKey;
                sbn = ((PrizeTickerViewPanel) v).getNotification();
            }
            if (sbn == null) {
            ...
            if (intent != null) {
                try {
                    Log.i(BaseStatusBar.TAG, "Sending contentIntent success");
                    intent.send(-1);//modify by lihuangyuan,for applock-2018-05-05
                } catch (PendingIntent.CanceledException e) {
                    Log.w(BaseStatusBar.TAG, "Sending contentIntent failed: " + e);
                }
            }
            try {
                if (BaseStatusBar.this.mBarService != null) {
                    BaseStatusBar.this.mBarService.onNotificationClick(notificationKey);
                }
            } catch (RemoteException ex) {
                Log.e(BaseStatusBar.TAG, "notification onclick error : " + ex);
            }
            BaseStatusBar.this.animateCollapsePanels(0, true);
        ...
        public void onClick(final View v) {
            ...
            if (PRIZE_HEADS_UP_STYLE) {
                if (v instanceof PrizeTickerViewPanel) {
                    TickerDragHandlerOnClick(v);
                    return;
                }
            }
            //---end@}
            ...
            Log.e(TAG, "NotificationClicker onClick notification.contentIntent = " + notification.contentIntent
                + ", notification.fullScreenIntent = " + notification.fullScreenIntent);
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            if (intent != null) {
                                ...
                                try {
                                    intent.send(null, -1, null, null, null, null,
                                            getActivityOptions());//modify by lihuangyuan,for fingerapplock,2017-07-04
                                } catch (PendingIntent.CanceledException e) {
                                    // the stack trace isn't very helpful here.
                                    // Just log the exception message.
        ...
        public void register(ExpandableNotificationRow row, StatusBarNotification sbn) {
            ...
            if (notification.contentIntent != null || notification.fullScreenIntent != null) {
                ...
                Log.e(TAG, "NotificationClicker notification("+notification+") register clicklistener is null");
    ...
    protected NotificationData.Entry createNotificationViews(StatusBarNotification sbn) {
        ...
        //add for statusbar inverse. prize-linkh-20150909
        if(PrizeOption.PRIZE_STATUSBAR_INVERSE_COLOR && !PrizeNotificaionIconUtil.shouldIgnoreReplacing(sbn.getNotification())) {
            Drawable specialDrawable = PrizeNotificaionIconUtil.getSpecialNotificationDrawable(mContext, sbn);
            if(specialDrawable != null) {
                iconView.mPriorDrawable = specialDrawable;
            } else {
                PrizeNotificaionIconUtil.useLaunchIconIfNecessary(mContext, sbn.getPackageName(), iconView);
            }
    ...
    protected void updateRowStates() {
        ...
        for (int i = 0; i < N; i++) {
            ...
            showOnKeyguard = (isUseHaoKan() && mState == StatusBarState.KEYGUARD) ?
                    showOnKeyguard && NotificationPanelView.IS_ShowNotification_WhenShowHaoKan
                    : showOnKeyguard;//add by vlife-2016-07-30
    ...
    /* prize-get lockscreen notification nums,bugid:45830-liufan-2017-12-16-start */
    public int showNotificationOnKeyguardNums() {
        ArrayList<Entry> activeNotifications = mNotificationData.getActiveNotifications();
        final int N = activeNotifications.size();

        int visibleNotifications = 0;
        boolean onKeyguard = true;//mState == StatusBarState.KEYGUARD;
        int maxNotifications = 0;
        if (onKeyguard) {
            maxNotifications = getMaxKeyguardNotifications(true /* recompute */);
        }
    ...
    /* prize-get lockscreen notification nums,bugid:45830-liufan-2017-12-16-end */
        ...
        if (applyInPlace) {
            ...
            try {
                if (entry.icon != null) {
                    ...
                    //add for statusbar inverse. prize-linkh-20150909
                    if(PrizeOption.PRIZE_STATUSBAR_INVERSE_COLOR && !PrizeNotificaionIconUtil.shouldIgnoreReplacing(notification.getNotification())) {
                        Drawable specialDrawable = PrizeNotificaionIconUtil.getSpecialNotificationDrawable(mContext, notification);
                        if(specialDrawable != null) {
                            entry.icon.mPriorDrawable = specialDrawable;
                        } else {
                            PrizeNotificaionIconUtil.useLaunchIconIfNecessary(mContext, notification.getPackageName(), entry.icon);
                        }                        
                        entry.icon.updateDrawable();
                    } //end...
                }
   ...
   //add by zhouerlong
    ...
    private void sendLauncherUnreadNotification(View expanded ,StatusBarNotification notification) {

        if(expanded instanceof ViewGroup&&notification.getPackageName()!=null) {
			if (notification.getPackageName().equals("com.tencent.mm")
					|| notification.getPackageName().equals(
							"com.tencent.mobileqq")) {
				ViewGroup wechat = (ViewGroup) expanded;

				ComponentName c = null;
				TextView t = null;
				if (notification.getPackageName().equals("com.tencent.mm")) {
					c = new ComponentName("com.tencent.mm",
							"com.tencent.mm.ui.LauncherUI");
					t = (TextView) expanded
							.findViewById(com.android.internal.R.id.text);
				} else if (notification.getPackageName().equals(
						"com.tencent.mobileqq")) {
					c = new ComponentName("com.tencent.mobileqq",
							"com.tencent.mobileqq.activity.SplashActivity");
					t = (TextView) expanded
							.findViewById(com.android.internal.R.id.title);
					if(t!=null && t instanceof TextView) {

						String title = ((TextView) t).getText().toString();
						if(title !=null) {
							if(!hasDigit(title)) {
								t = (TextView) expanded
										.findViewById(com.android.internal.R.id.text);
				...
				if (t != null && t instanceof TextView) {
					...
					if (title != null) {
						...
						intent.putExtra(Intent.EXTRA_UNREAD_COMPONENT, c);

						intent.putExtra(Intent.EXTRA_SHORTCUT_ICON,
								notification.getNotification().largeIcon);
						...
						intent.putExtra(Intent.EXTRA_UNREAD_NUMBER, 1);
						Log.i("zhouerlong", "sssstitle::::" + title);
    ...
    private void updateNotificationViews(Entry entry, StatusBarNotification sbn) {
        ...
        if(PrizeOption.PRIZE_STATUSBAR_INVERSE_COLOR && !PrizeNotificaionIconUtil.shouldIgnoreReplacing(sbn.getNotification())) {
            ...
            View v = null;
            iconId = com.android.internal.R.id.icon;
            v = entry.getContentView().findViewById(iconId);
            if(v!=null)
                PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, entry.getContentView(), iconId, false);
            iconId = com.android.internal.R.id.right_icon;
            v = entry.getContentView().findViewById(iconId);
            if(v!=null)
                PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, entry.getContentView(), iconId, false);
            ...
            if(entry.getExpandedContentView() != null) {
                iconId = com.android.internal.R.id.icon;
                v = entry.getExpandedContentView().findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, entry.getExpandedContentView(), iconId, false);
                iconId = com.android.internal.R.id.right_icon;
                v = entry.getExpandedContentView().findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, entry.getExpandedContentView(), iconId, false);
            ...
            if(entry.getHeadsUpContentView() != null) {
                iconId = com.android.internal.R.id.icon;
                v = entry.getHeadsUpContentView().findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, entry.getHeadsUpContentView(), iconId, true);
                iconId = com.android.internal.R.id.right_icon;  
                v = entry.getHeadsUpContentView().findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, entry.getHeadsUpContentView(), iconId, true);
            ...
            if(publicContentView != null && entry.getPublicContentView() != null) {
                iconId = com.android.internal.R.id.icon;
                v = entry.getPublicContentView().findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, entry.getPublicContentView(), iconId, false);
                iconId = com.android.internal.R.id.right_icon;
                v = entry.getPublicContentView().findViewById(iconId);
                if(v!=null)
                    PrizeNotificaionIconUtil.replaceNotificationIcon(mContext,  entry, entry.getPublicContentView(), iconId, false); 
    ...
    protected boolean shouldPeek(Entry entry, StatusBarNotification sbn) {
        if (!mUseHeadsUp || isDeviceInVrMode()) {
            Log.d(TAG, "shouldPeek : !mUseHeadsUp =  " + !mUseHeadsUp + ", isDeviceInVrMode() = " + isDeviceInVrMode());
            return false;
        }
        ...
        // DESCRIPTION : Hide head up notification
        // AUTHOR : yueliu
        //if (mNotificationData.getImportance(sbn.getKey()) < IMPORTANCE_HIGH) {
        if (mNotificationData.getImportance(sbn.getKey()) < IMPORTANCE_HIGH
                || (mWindowManager.isFullScreenMode() && Settings.System.getInt(mContext.getContentResolver(), Settings.System.PRIZE_BARRAGE_WINDOW,0) == 1)) {
        // PRIZE END
            /// M: Enable this log for debug.
        ...
        if (sbn.getNotification().fullScreenIntent != null) {
            if (mAccessibilityManager.isTouchExplorationEnabled()) {
                ...
                Log.d(TAG, "No peeking: mAccessibilityManager shouldPeek return true");
                return true;
            }
        }
    ...
    // add for statubar inverse style. prize-linkh-20150907
   @Override
   public void onStatusBarInverseChanged(int style) {}   
   
   
/* prize-add-split screen-liyongli-20170612-start */ 
    //for PhoneStatusBar.java  onBusEvent(final PrizeOpenPendingIntentEvent event) called
       public final  void openQQPendingIntent(final PrizeOpenPendingIntentEvent event) {
       	int type=event.type;
       	Log.d(TAG, "lylnotify   onBusEvent  PrizeOpenPendingIntentEvent "+type);
       	if( type==PrizeOpenPendingIntentEvent.QQ_TYPE && qqrow!=null ){
       		mNotificationClicker.onClick( (View) qqrow);
       	}else if( type==PrizeOpenPendingIntentEvent.MM_TYPE && mmrow!=null ){
       		mNotificationClicker.onClick( (View) mmrow);
       	}
    }
/* prize-add-split screen-liyongli-20170612-end */
    ...
    // add for statubar background color. prize-liufan-20170828
   @Override
