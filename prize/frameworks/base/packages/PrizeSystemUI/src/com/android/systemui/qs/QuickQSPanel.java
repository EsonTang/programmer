...
public class QuickQSPanel extends QSPanel {
    ...
    /*PRIZE-PowerExtendMode-lihuangyuan-2017-11-16-start*/
    public View getHeaderTileLayout()
    {
    	return (View)mTileLayout;
    }
    /*PRIZE-PowerExtendMode-lihuangyuan-2017-11-16-end*/
