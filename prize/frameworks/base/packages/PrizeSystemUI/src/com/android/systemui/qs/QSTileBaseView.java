...
public class QSTileBaseView extends LinearLayout {
    ...
    public QSTileBaseView(Context context, QSIconView icon, boolean collapsedView) {
        ...
        /*PRIZE-change RippleBackground- liufan-2016-11-03-start*/
        mIcon.getIconView().setBackground(mTileBackground);
        /*PRIZE-change RippleBackground- liufan-2016-11-03-end*/
    ...
    private void setRipple(RippleDrawable tileBackground) {
        ...
        /*PRIZE-change to IconView- liufan-2016-11-03-start*/
        if (mIcon.getIconView().getWidth() != 0) {
            updateRippleSize(mIcon.getIconView().getWidth(), mIcon.getIconView().getHeight());
        }
        /*PRIZE-change to IconView- liufan-2016-11-03-end*/
    }
    ...
    private void updateRippleSize(int width, int height) {
        ...
        /*PRIZE-change Ripple Size- liufan-2016-11-03-start*/
        final int rad = (int)(mIcon.getIconView().getHeight() * .55f);
        /*PRIZE-change Ripple Size- liufan-2016-11-03-end*/
        mRipple.setHotspotBounds(cx - rad, cy - rad, cx + rad, cy + rad);
    }

    public void init(OnClickListener click, OnLongClickListener longClick) {
        mIcon.getIconView().setClickable(true);
        mIcon.getIconView().setOnClickListener(click);
        mIcon.getIconView().setOnLongClickListener(longClick);
    }
