...
public class NotificationHeaderViewWrapper extends NotificationViewWrapper {
    ...
    public void setDark(boolean dark, boolean fade, long delay) {
        ...
        /*PRIZE-cancel dark notification progressbar color-liufan-2016-12-06-start*/
        /*if (fade) {
        ...
        /*PRIZE-cancel dark notification progressbar color-liufan-2016-12-06-end*/
    }
    ...
    private void updateIconColorFilter(ImageView target, float intensity) {
		/*PRIZE-cancel the colorTint-liufan-2016-11-11-start*/
		...
		/*PRIZE-cancel the colorTint-liufan-2016-11-11-end*/
    }
