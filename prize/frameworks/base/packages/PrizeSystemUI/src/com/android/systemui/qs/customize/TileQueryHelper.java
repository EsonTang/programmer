...
/*PRIZE-add for bugid:48042- liufan-2018-01-16-start*/
import com.mediatek.systemui.qs.tiles.DataConnectionTileDefined;
/*PRIZE-add for bugid:48042- liufan-2018-01-16-end*/
...
public class TileQueryHelper {
    ...
    private void addSystemTiles(final QSTileHost host) {
        /*PRIZE-update system qs tile- liufan-2016-12-03-start*/
        String possible = mContext.getString(R.string.quick_settings_tiles_default)
                + ",hotspot,saver,work,night";//",hotspot,inversion,saver,work,cast,night"
        ...
        possible = quickSettingsPlugin.customizeQuickSettingsTileOrder(possible)
                + ",hotspot,saver,work,night";//",hotspot,inversion,saver,work,cast,night"
        /// M: Customize the quick settings tile order for operator. @}
        /*PRIZE-update system qs tile- liufan-2016-12-03-end*/
        ...
        for (int i = 0; i < possibleTiles.length; i++) {
            ...
            tile.clearState();
            /*PRIZE-add for bugid:48042- liufan-2018-01-16-start*/
            if(tile instanceof DataConnectionTileDefined){
                DataConnectionTileDefined dct = (DataConnectionTileDefined)tile;
                dct.getDataConnectionState();
            }
            /*PRIZE-add for bugid:48042- liufan-2018-01-16-end*/
            tile.refreshState();
        ...
        /*PRIZE-cancel third app qs- liufan-2016-12-03-start*/
        /*qsHandler.post(new Runnable() {
            @Override
            public void run() {
                mainHandler.post(new Runnable() {
        ...
        /*PRIZE-cancel third app qs- liufan-2016-12-03-end*/
    }
