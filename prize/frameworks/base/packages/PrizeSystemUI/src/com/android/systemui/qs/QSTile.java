...
public abstract class QSTile<TState extends State> {
    ...
    /*PRIZE-qstile click listener- liufan-2015-04-14-start*/
    public OnTileClickListener onTileClickListener;
    
    public interface OnTileClickListener{
        public void onTileClick(boolean newState,String label);
    }
    /*PRIZE-qstile click listener- liufan-2015-04-14-end*/
    ...
    protected void handleLongClick() {
        /*PRIZE-add judgement nullpoint- liufan-2016-11-04-start*/
        Intent intent = getLongClickIntent();
        if(intent == null){
            Log.d(TAG,"LongClickIntent is null");
            return ;
        }
        MetricsLogger.action(mContext, MetricsEvent.ACTION_QS_LONG_PRESS, getTileSpec());
        mHost.startActivityDismissingKeyguard(intent);
        /*PRIZE-add judgement nullpoint- liufan-2016-11-04-end*/
    }
    ...
    /*PRIZE-add UserBoolean- liufan-2016-11-05-start*/
    ...
    /*PRIZE-add UserBoolean- liufan-2016-11-05-end*/

    public static class State {
        public Icon icon;
        /*PRIZE-add State Attributes- liufan-2015-04-29-start*/
        public Drawable drawable;
        public int colorId = 1;//0 means dark color，1 means light color;
        /*PRIZE-add State Attributes- liufan-2015-04-29-end*/
        ...
        public boolean copyTo(State other) {
            ...
            final boolean changed = !Objects.equals(other.icon, icon)
                    ...
                    /*PRIZE-copy new Attributes- liufan-2015-04-29-start*/
                    || !Objects.equals(other.drawable, drawable)
                    || !Objects.equals(other.colorId, colorId)
                    /*PRIZE-copy new Attributes- liufan-2015-04-29-end*/
        ...
        protected StringBuilder toStringBuilder() {
            ...
            /*PRIZE-append new Attributes- liufan-2015-04-29-start*/
            sb.append(",drawable=").append(drawable);
            sb.append(",colorId=").append(colorId);
            /*PRIZE-append new Attributes- liufan-2015-04-29-end*/
