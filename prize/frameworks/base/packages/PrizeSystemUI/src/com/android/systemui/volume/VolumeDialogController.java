...
public class VolumeDialogController {
    ...
    /*PRIZE-delete final for bugid:49676- liufan-2018-02-02-start*/
    private String[] mStreamTitles;
    /*PRIZE-delete final for bugid:49676- liufan-2018-02-02-end*/
    ...
    public void refreshStreamTitles(){
        mStreamTitles = mContext.getResources().getStringArray(R.array.volume_stream_titles);
        onGetStateW();
    }
    ...
    public boolean isVibrateInSilentOpen() {
        if (PrizeOption.PRIZE_VIBRATE_CONTROL) {
            return Settings.System.getInt(
                    mContext.getContentResolver(), Settings.System.PRIZE_VIBRATE_IN_SILENT, 0) != 0;
        }
        return false;
    }
    //@}
    ...
    /*prize-public-bug:16731 set silent to vibrate vibrate liuweiquan-20160622-start*/
    private String ringMode = "";
    /*prize-public-bug:16731 set silent to vibrate vibrate liuweiquan-20160622-end*/
        public void init() {
        /*prize-public-bug:16731 set silent to vibrate vibrate liuweiquan-20160622-start*/
        ringMode = Util.ringerModeToString(mAudio.getRingerMode());
        /*prize-public-bug:16731 set silent to vibrate vibrate liuweiquan-20160622-end*/
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(AudioManager.VOLUME_CHANGED_ACTION)) {
                ...
                /*prize-public-bug:16731 set silent to vibrate vibrate liuweiquan-20160622-start*/
                if(ringMode.equals("RINGER_MODE_SILENT")&&Util.ringerModeToString(rm).equals("RINGER_MODE_VIBRATE")){
                    vibrate();
                }
                ringMode = Util.ringerModeToString(rm);
                /*prize-public-bug:16731 set silent to vibrate vibrate liuweiquan-20160622-end*/
