   ...
   /* M : Override onDestroy method to unregister configuration changed
    ...
    class DrawableEngine extends Engine {
        ...
        public void onDestroy() {
            ...
            /*prize-solve exchange wallpaper quickly, SystemUI throw OOM-liufan-2016-03-09-start*/
            if(mBackground != null){
                mBackground.recycle();
                mBackground = null;
                mWallpaperManager.forgetLoadedWallpaper();
            }
            /*prize-solve exchange wallpaper quickly, SystemUI throw OOM-liufan-2016-03-09-end*/
        ...
        /**prize add by xiarui 2017-12-19 for Bug#45320 ,see e-service Id: ALPS03667854 start**/
        ...
        protected void updateWallpaper(Bitmap b) {
            mBackground = null;
            mBackgroundWidth = -1;
            mBackgroundHeight = -1;
        ...
        /**prize add by xiarui 2017-12-19 for Bug#45320 ,see e-service Id: ALPS03667854 end**/
...
/**prize modify by xiarui 2017-12-19 for Bug#45320 ,see e-service Id: ALPS03667854 start**/
            updateWallpaper(getWallpaperBitmap());
...
/**prize modify by xiarui 2017-12-19 for Bug#45320 ,see e-service Id: ALPS03667854 end**/
        }
