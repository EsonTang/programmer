...
import com.mediatek.common.prizeoption.PrizeOption; // prize-add-split screen-liyongli-20171122 add
...
public class RecentsViewTouchHandler {
    ...
    public final void onBusEvent(DragStartEvent event) {
        ...
        if (ActivityManager.supportsMultiWindow() && !ssp.hasDockedTask()
            ...
            /* prize-add-split screen, applock task not Drag to split screen -liyongli-20171122-start */
            if(PrizeOption.PRIZE_FINGERPRINT_APPLOCK && event.task.isEncryption){
                EventBus.getDefault().send(new ShowIncompatibleAppOverlayEvent());
            }else/* prize-add-split screen-liyongli-20171122-end */            
    ...
    public final void onBusEvent(DragEndEvent event) {
        ...
        if(PrizeOption.PRIZE_FINGERPRINT_APPLOCK && event.task.isEncryption){
            EventBus.getDefault().send(new HideIncompatibleAppOverlayEvent());
        }/* prize-add-split screen-liyongli-20171122-end */     
