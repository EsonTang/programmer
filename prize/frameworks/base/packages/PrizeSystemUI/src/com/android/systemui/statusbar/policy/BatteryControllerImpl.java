...
//add liup 20160612 电量百分比修改 start
import com.android.systemui.R;
import android.view.View;
import android.widget.TextView;
import android.provider.Settings;
//add liup 20160612 电量百分比修改 end
...
//add liup 20160612 电量百分比修改 end
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (action.equals(Intent.ACTION_BATTERY_CHANGED)) {
            ...
            /**PRIZE 电量百分比修改 liyao 2015-06-25 start */
            if (mLevelView != null) {
                    CharSequence levelText = mContext.getResources().getString(
                            R.string.battery_percent, mLevel);
                    mLevelView.setText(levelText);
                    updateLevelView();
            }
            /**PRIZE 电量百分比修改 liyao 2015-06-25 end */
    ...
    void updateLevelView() {
        ...
        Log.d("BatteryController", "mIsShowLevel = " + mIsShowLevel);
        if (mLevelView != null) {
            if (mIsShowLevel) {
    ...
    /**PRIZE 电量图标及百分比修改 liyao 2015-06-25 end */
}
