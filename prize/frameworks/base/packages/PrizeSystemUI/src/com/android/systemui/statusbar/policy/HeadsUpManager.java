...
import com.android.systemui.statusbar.BaseStatusBar; //prize add by xiarui 2018-05-10
...
public class HeadsUpManager implements ViewTreeObserver.OnComputeInternalInsetsListener {
    ...
    public void updateNotification(NotificationData.Entry headsUp, boolean alert) {
        ...
        if (alert) {
            ...
            //prize add by xiarui 2018-05-10 @{
            if (!BaseStatusBar.PRIZE_HEADS_UP_STYLE) {
    ...
    public boolean removeNotification(String key, boolean ignoreEarliestRemovalTime) {
        ...
        if (wasShownLongEnough(key) || ignoreEarliestRemovalTime) {
            ...
            if (BaseStatusBar.PRIZE_HEADS_UP_STYLE) {
                mBar.removeHeadsUpIfNeeded(key);
            }
            //@}
            return true;
        } else {
    ...
    public class HeadsUpEntry implements Comparable<HeadsUpEntry> {
            ...
            mRemoveHeadsUpRunnable = new Runnable() {
                ...
                public void run() {
                    if (!mTrackingHeadsUp) {
                        //prize add by xiarui for bug63242\bug65189 2018-08-11 @{
                        if (BaseStatusBar.PRIZE_HEADS_UP_STYLE) {
                            mBar.removeHeadsUpIfNeeded(entry.key);
                        }
                        //@}
                        removeHeadsUpEntry(entry);
                    } else {
        ...
        public void updateEntry(boolean updatePostTime) {
            ...
            /*PRIZE-auto dismiss top notification-liufan-2016-08-27-start*/
            String pkg = entry.notification.getPackageName();
            boolean noNeedDismiss = pkg.equals("com.android.dialer") 
                || pkg.equals("com.android.deskclock")|| pkg.equals("com.android.calendar");
            if (!isSticky()|| !noNeedDismiss || pkg.equals("com.android.mms") || pkg.equals("com.prize.appcenter")
                 || pkg.equals("com.example.longshotscreen")) {
            /*PRIZE-auto dismiss top notification-liufan-2016-08-27-end*/
                long finishTime = postTime + mHeadsUpNotificationDecay;
                long removeDelay = Math.max(finishTime - currentTime, mMinimumDisplayTime);
                if(pkg.equals("com.android.mms")){
                    removeDelay = 5500;//add for bugid:53868-liufan-2018-3-29
                }
