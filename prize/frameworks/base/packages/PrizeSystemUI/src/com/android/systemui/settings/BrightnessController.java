...
/**PRIZE import package liyao 2015-07-02 start */
import android.util.Log;
import android.view.View;
import android.animation.ValueAnimator;
import android.animation.AnimatorListenerAdapter;
import android.animation.Animator;
/**PRIZE import package liyao 2015-07-02 end */

public class BrightnessController implements ToggleSlider.Listener {
    private static final String TAG = "StatusBar.BrightnessController";
    /**PRIZE show prompt icon falg liyao 2015-07-02 start */
    private static final boolean SHOW_AUTOMATIC_ICON = true;//false;
    /**PRIZE show prompt icon falg liyao 2015-07-02 end */
    ...
    private class BrightnessObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri) {
            ...
            if (BRIGHTNESS_MODE_URI.equals(uri)) {
                ...
                mBackgroundHandler.post(mUpdateSliderRunnable);
            //prize-wuliang 20180227 auto brightness
            } else if (AUTO_MODE_BRIGHTNESS_URI.equals(uri) && mAutomatic) {
                mBackgroundHandler.post(mUpdateSliderRunnable);
            }
        ...
        public void run() {
            if (mAutomatic) {
                ...
                value = Settings.System.getIntForUser(mContext.getContentResolver(),
                        Settings.System.SCREEN_AUTO_MODE_BRIGHTNESS, mMaximumBacklight,
                        UserHandle.USER_CURRENT);
    ...
    public void onChanged(ToggleSlider view, boolean tracking, boolean automatic, int value,
        ...
        Log.e("wuliang", "value = " + val + " fromUser:"+ fromUser + " mAutomatic: "+ mAutomatic + " mExternalChange: " + mExternalChange + " tracking: " + tracking + " stopTracking:" + stopTracking);
...
//            setBrightnessAdj(adj);
            if (fromUser) {
                AsyncTask.execute(new Runnable() {
                    public void run() {
                        Settings.System.putIntForUser(mContext.getContentResolver(),
                                Settings.System.SCREEN_AUTO_MODE_TEMP_BRIGHTNESS, val,
                                UserHandle.USER_CURRENT);
                    }
                });
            }
    ...
    private void updateIcon(boolean automatic) {
        if (mIcon != null) {
            /**PRIZE show prompt icon liyao 2015-07-02 start */
            mIcon.setImageResource(automatic && SHOW_AUTOMATIC_ICON ?
                    com.android.systemui.R.drawable.ic_qs_brightness_auto_on :
                    com.android.systemui.R.drawable.ic_qs_brightness_auto_off);
            mIcon.setVisibility(View.GONE);
            /**PRIZE show prompt icon liyao 2015-07-02 end */
        }
    }
}
