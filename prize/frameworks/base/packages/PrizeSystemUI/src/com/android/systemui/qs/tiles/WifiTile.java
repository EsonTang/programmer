...
public class WifiTile extends QSTile<QSTile.SignalState> {
    ...
    protected void handleUpdateState(SignalState state, Object arg) {
        ...
        /*prize modify by xiarui for Bug#44283 2017-12-05 start*/
        /** see {@link SignalTileView} ,you can get the in and out icon **/
        state.activityIn = false;//cb.enabled && cb.activityIn;
        state.activityOut = false;//cb.enabled && cb.activityOut;
        /*prize modify by xiarui for Bug#44283 2017-12-05 end*/
        state.filter = true;
        ...
        if (!state.value) {
            ...
            state.icon = ResourceIcon.get(R.drawable.ic_qs_wifi_on);
            state.colorId = 1;
		...
		/*PRIZE-PowerExtendMode-yuhao-2016-12-10-start*/
//        if (PrizeOption.PRIZE_POWER_EXTEND_MODE && PowerManager.isSuperSaverMode()){
//			Log.d("yh","yuhao  WifiTile handleUpdateState set state.icon = null ");
//			state.icon = null;
//        }
		/*PRIZE-PowerExtendMode-yuhao-2016-12-10-end*/
    ...
    protected final class WifiSignalCallback extends SignalCallbackAdapter {
        ...
        /*PRIZE-use the new callback method-liufan-2016-06-13-start*/
        @Override
        ...
        /*PRIZE-use the new callback method-liufan-2016-06-13-end*/
    };
    ...
    private final class WifiDetailAdapter implements DetailAdapter,
        ...
        public View createDetailView(Context context, View convertView, ViewGroup parent) {
            ...
            /*PRIZE update the wifi icon liyao 20150615  start*/
            mItems.setEmptyState(R.drawable.ic_qs_wifi_detail_prize,
            /*PRIZE update the wifi icon liyao 20150615  end*/
            ...
            if (mAccessPoints != null) {
                ...
                for (int i = 0; i < mAccessPoints.length; i++) {
                    ...
                    item.overlay = ap.getSecurity() != AccessPoint.SECURITY_NONE
                            /**PRIZE add safe lock icon to wifi 2015-05-19 start */
                            ? mContext.getDrawable(R.drawable.qs_ic_wifi_lock_prize)
                            /**PRIZE add safe lock icon to wifi 2015-05-19 end */
                            : null;
                    items[i] = item;
                }
            }
