...
import com.mediatek.common.prizeoption.PrizeOption; //prize add by xiarui 2017-11-07
...
public class TaskViewHeader extends FrameLayout
    ...
    @ViewDebug.ExportedProperty(category="recents")
    float mDimAlpha;
    float mHeaderAlpha = 1f;//set 1f for bug#53702 //prize add by xiarui 2017-11-09
    ...
    /*prize-lockview-liufan-2016-11-17-start*/
	ImageView mLockView;
	Drawable mLightLockDrawable;
	Drawable mLightUnLockDrawable;
	Drawable mDarkLockDrawable;
	Drawable mDarkUnLockDrawable;
    /*prize-lockview-liufan-2016-11-17-end*/
    ...
    public TaskViewHeader(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        /*prize-lockview icon-liufan-2016-11-17-start*/
		mLightLockDrawable = context.getDrawable(R.drawable.recents_lock_light_prize);
		mLightUnLockDrawable = context.getDrawable(R.drawable.recents_unlock_light_prize);
		mDarkLockDrawable = context.getDrawable(R.drawable.recents_lock_dark_prize);
		mDarkUnLockDrawable = context.getDrawable(R.drawable.recents_unlock_dark_prize);
        /*prize-lockview icon-liufan-2016-11-17-end*/
        ...
        /*prize modify for header bg-xiarui 2017-11-07 start*/
        if (!PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
            setBackground(mBackground);
        }
        /*prize modify for header bg-xiarui 2017-11-07 end*/
    ...
    protected void onFinishInflate() {
        ...
        /*prize-lock view-liufan-2016-11-17-start*/
        mLockView = (ImageView) findViewById(R.id.lock_task);
        mLockView.setOnClickListener(this);
        /*prize-lock view-liufan-2016-11-17-end*/
        //prize modify by xiarui for disable long click 2018-06-05 @{
        if (!PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
    ...
    private void updateLayoutParams(View icon, View title, View secondaryButton, View button) {
        ...
        setLayoutParams(lp);
        /*prize modify by xiarui 2017-11-09 start*/
        if (!PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
            lp = new FrameLayout.LayoutParams(mHeaderBarHeight, mHeaderBarHeight, Gravity.CENTER_VERTICAL|Gravity.START);
        ...
        /*prize modify by xiarui 2017-11-09 end*/
        ...
        /*prize-set lockview lp-liufan-2016-11-17-start*/
        if(button == mDismissButton){
            lp = new FrameLayout.LayoutParams(mHeaderBarHeight, mHeaderBarHeight, Gravity.END);
            lp.setMarginEnd(mHeaderBarHeight - mHeaderButtonPadding);
            mLockView.setLayoutParams(lp);
        }
        /*prize-set lockview lp-liufan-2016-11-17-end*/
    }
    ...
    public void onTaskViewSizeChanged(int width, int height) {
        ...
        /**prize-show dismiss icon-liufan-2016-11-17-start*/
        /*mDismissButton.setVisibility(showDismissIcon ? View.VISIBLE : View.INVISIBLE);*/
        /**prize-show dismiss icon-liufan-2016-11-17-end*/
     ...
     * @param headerAlhpa
     */
    public void setHeaderAlhpa(float headerAlhpa) {
        if (Float.compare(mHeaderAlpha, headerAlhpa) != 0) {
            mHeaderAlpha = headerAlhpa;
            mTitleView.setAlpha(headerAlhpa);
            //mIconView.setAlpha(headerAlhpa);
        }
    }
    ...
    public void bindToTask(Task t, boolean touchExplorationEnabled, boolean disabledInSafeMode) {
        ...
        /*prize modify by xiarui set light TextColor 2017-11-07 start*/
        if (PrizeOption.PRIZE_SYSTEMUI_RECENTS) {
            mTitleView.setTextColor(mTaskBarViewLightTextColor);
        } else {
            mTitleView.setTextColor(t.useLightOnPrimaryColor ?
                    mTaskBarViewLightTextColor : mTaskBarViewDarkTextColor);
        }
        /*prize modify by xiarui set light TextColor 2017-11-07 end*/
        mDismissButton.setImageDrawable(t.useLightOnPrimaryColor ?
                mLightDismissDrawable : mDarkDismissDrawable);
        mDismissButton.setContentDescription(t.dismissDescription);
        mDismissButton.setOnClickListener(this);
        /**prize-set mDismissButton can click-liufan-2016-11-25-start*/
        mDismissButton.setClickable(true);
        /**prize-set mDismissButton can click-liufan-2016-11-25-end*/
        ((RippleDrawable) mDismissButton.getBackground()).setForceSoftware(true);
		
        /**prize-set lock icon drawable-liufan-2016-11-17-start*/
		setLockViewDrawable(t);
        /**prize-set lock icon drawable-liufan-2016-11-17-end*/
    ...
    /**prize-set lock icon drawable-liufan-2016-11-17-start*/
    public void setLockViewDrawable(Task t){
        if(t.useLightOnPrimaryColor){
            if(t.isLock){
                mLockView.setImageDrawable(mLightLockDrawable);
            } else {
                mLockView.setImageDrawable(mLightUnLockDrawable);
            }
        } else {
            if(t.isLock){
                mLockView.setImageDrawable(mDarkLockDrawable);
            } else {
                mLockView.setImageDrawable(mDarkUnLockDrawable);
            }
        }
	}
    /**prize-set lock icon drawable-liufan-2016-11-17-end*/
    ...
    public void onTaskDataLoaded() {
		...
		Log.d("xxyy","setlauncherIcon--------->");
            mIconView.setImageDrawable(mTask.launcherIcon);
        } else
        if (mTask.icon != null) {
    ...
    public void onClick(View v) {
        ...
        /**prize-click lockview-liufan-2016-11-17-start*/
        else if(v == mLockView){
            if(mTask != null){
                if (mTask.isLock) {
                    mTask.setLock(getContext(), false);
                } else {
                    mTask.setLock(getContext(), true);
                }
				setLockViewDrawable(mTask);
            }
        }
        /**prize-click lockview-liufan-2016-11-17-end*/
    }
