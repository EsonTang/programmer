...
public class NetworkTypeUtils {
    ...
    public static final int VOLTE_ICON = R.drawable.stat_sys_hd_prize;//R.drawable.stat_sys_volte;
    /*PRIZE-add gray volte icon,bugid:43538-liufan-2017-12-02-start*/
    public static final int VOLTE_ICON_GRAY = R.drawable.stat_sys_hd_gray_prize;//R.drawable.stat_sys_volte_gray_prize;
    /*PRIZE-add gray volte icon,bugid:43538-liufan-2017-12-02-end*/
