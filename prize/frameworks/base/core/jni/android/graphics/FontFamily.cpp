...
static void FontFamily_setCanBeReplaced(JNIEnv* env, jobject clazz, jlong familyPtr,jboolean can) {
    FontFamily* fontFamily = reinterpret_cast<FontFamily*>(familyPtr);
    if (NULL == fontFamily) {
        return ;
    }
    fontFamily->setCanBeReplaced(can);
}
#endif
// ========================lovelyfonts end========================
...
static const JNINativeMethod gFontFamilyMethods[] = {
 ...
 // ========================lovelyfonts start========================
 #ifdef MTK_YIQI_FONTS_FRAMEWORK_SUPPORT
    { "nSetCanBeReplaced",     "(JZ)V",
                                           (void*)FontFamily_setCanBeReplaced },
#endif
// ========================lovelyfonts end==========================
};
