...
//========================lovelyfonts start========================
# ifdef MTK_YIQI_FONTS_FRAMEWORK_SUPPORT
static void Typeface_updateLovelyfonts(JNIEnv* env, jobject) {
    Typeface::updateLovelyfonts();
}


static jlong Typeface_updateEmojiFonts(JNIEnv *env,  jobject, jobjectArray familyArray) {
    Typeface::updateEmojiFonts((char const**)familyArray);
    return 0;
}

static void Typeface_clearEmojiFonts(JNIEnv* env, jobject) {
    return Typeface::clearEmojiFonts();
}
static void Typeface_setCanReplace(JNIEnv* env,jobject, jlong faceHandle, jboolean can) {
    Typeface* face = reinterpret_cast<Typeface*>(faceHandle);
    face->setCanReplace(can);
}
static jboolean Typeface_getCanReplace(JNIEnv* env, jobject, jlong faceHandle) {
    Typeface* face = reinterpret_cast<Typeface*>(faceHandle);
    return face->getCanReplace();
}
...
static const JNINativeMethod gTypefaceMethods[] = {
    ...
    // ========================lovelyfonts start========================
#ifdef MTK_YIQI_FONTS_FRAMEWORK_SUPPORT
    { "nativeUpdateLovelyfonts", "()V",   (void*)Typeface_updateLovelyfonts },
    { "nativeUpdateEmojiFonts",    "([Ljava/lang/String;)J",
                                           (void*)Typeface_updateEmojiFonts },
    { "nativeClearEmojiFonts", "()V",   (void*)Typeface_clearEmojiFonts },
    { "nativeSetCanReplace", "(JZ)V",   (void*)Typeface_setCanReplace },
    { "nativeGetCanReplace", "(J)Z",   (void*)Typeface_getCanReplace },
#endif
// ========================lovelyfonts end  ========================
};
