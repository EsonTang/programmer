    ...
    jint pid, jstring fileName)
{
    ...
    /// M: Add O_APPEND option because it has the risk of being overwritten during dump backtrace.
    int fd = open(fileName8.string(), O_CREAT | O_WRONLY | O_NOFOLLOW | O_APPEND, 0666);  /* -rw-rw-rw- */
