...
public class NafSessionKey implements Parcelable {
    ...
    public String toString() {
        synchronized (this) {
            ...
            builder.append(" btid: " + mBtid);
            builder.append(" keylifetime: " + mKeylifetime);
            builder.append(" nafkeyname: " + mNafKeyName);
            builder.append(" authheader: " + mAuthHeader);
