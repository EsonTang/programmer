...
public class AlertController {
    ...
    protected void setupButtons(ViewGroup buttonPanel) {
		...
		/*PRIZE-delete by liyu-for system dialog-20160614-start*/
      ...
      /*  if (TextUtils.isEmpty(mButtonNegativeText)) {
		...
		/*PRIZE-delete by liyu-for system dialog-20160614-end*/
        mButtonNeutral = (Button) buttonPanel.findViewById(R.id.button3);
        mButtonNeutral.setOnClickListener(mButtonHandler);
		
		/*--Prize--add by liyu--for dialog style--2015-12-05--start*/
		if(!TextUtils.isEmpty(mButtonPositiveText)){
			if(mButtonPositiveText.length() > 7){
				mButtonPositiveText = mButtonPositiveText.subSequence(0, 6);
			}
		}
		
		if(!TextUtils.isEmpty(mButtonNegativeText)){
			if(mButtonNegativeText.length() > 7){
				mButtonNegativeText = mButtonNegativeText.subSequence(0, 6);
			}
		}
		
		if(!TextUtils.isEmpty(mButtonNeutralText)){
			if(mButtonNeutralText.length() > 7){
				mButtonNeutralText = mButtonNeutralText.subSequence(0, 6);
			}
		}
		
		/*--Prize--add by liyu--for dialog style--2015-12-05--end*/
		
		/*add by liyu--dialog_style--20150910--start--*/
		if(TextUtils.isEmpty(mButtonNeutralText)) {
			if(TextUtils.isEmpty(mButtonNegativeText)) {
				if(TextUtils.isEmpty(mButtonPositiveText)) {
					mButtonNeutral.setVisibility(View.GONE);
					...
					mButtonPositive.setVisibility(View.VISIBLE);
					mButtonPositive.setText(mButtonPositiveText);
					mButtonPositive.setBackgroundResource(R.drawable.ic_dialog_left_single_selector);
					whichButtons = whichButtons | BIT_BUTTON_POSITIVE;
				}
			}else {
				if(TextUtils.isEmpty(mButtonPositiveText)) {
					...
					mButtonPositive.setVisibility(View.GONE);
					mButtonNegative.setText(mButtonNegativeText);
					mButtonNegative.setBackgroundResource(R.drawable.ic_dialog_left_single_selector);
					whichButtons = whichButtons | BIT_BUTTON_NEGATIVE;
				}else {
					mButtonNeutral.setVisibility(View.GONE);
					mButtonNegative.setVisibility(View.VISIBLE);
					...
					mButtonNegative.setText(mButtonNegativeText);
					mButtonPositive.setText(mButtonPositiveText);
					mButtonNegative.setBackgroundResource(R.drawable.ic_dialog_left_selector);
					mButtonPositive.setBackgroundResource(R.drawable.ic_dialog_right_selector);
					whichButtons = whichButtons | BIT_BUTTON_NEGATIVE | BIT_BUTTON_POSITIVE;
				}
			}
		}else {
			if(TextUtils.isEmpty(mButtonNegativeText)) {
				if(TextUtils.isEmpty(mButtonPositiveText)) {
					...
					mButtonPositive.setVisibility(View.GONE);
					mButtonNeutral.setText(mButtonNeutralText);
					mButtonNeutral.setBackgroundResource(R.drawable.ic_dialog_left_single_selector);
					whichButtons = whichButtons | BIT_BUTTON_NEUTRAL;
				}else {
					mButtonNeutral.setVisibility(View.VISIBLE);
					mButtonNegative.setVisibility(View.GONE);
					...
					mButtonNeutral.setText(mButtonNeutralText);
					mButtonPositive.setText(mButtonPositiveText);
					mButtonNeutral.setBackgroundResource(R.drawable.ic_dialog_left_selector);
					mButtonPositive.setBackgroundResource(R.drawable.ic_dialog_right_selector);
					whichButtons = whichButtons | BIT_BUTTON_NEUTRAL | BIT_BUTTON_POSITIVE;
				}
			}else {
				if(TextUtils.isEmpty(mButtonPositiveText)) {
					mButtonNeutral.setVisibility(View.VISIBLE);
					...
					mButtonNegative.setText(mButtonNegativeText);
					mButtonNeutral.setBackgroundResource(R.drawable.ic_dialog_left_selector);
					mButtonNegative.setBackgroundResource(R.drawable.ic_dialog_right_selector);
					whichButtons = whichButtons | BIT_BUTTON_NEUTRAL | BIT_BUTTON_NEGATIVE;
				}else {
					mButtonNeutral.setVisibility(View.VISIBLE);
					mButtonNegative.setVisibility(View.VISIBLE);
					mButtonPositive.setVisibility(View.VISIBLE);
					...
					mButtonPositive.setText(mButtonPositiveText);
					mButtonNeutral.setBackgroundResource(R.drawable.ic_dialog_left_selector);
					mButtonNegative.setBackgroundResource(R.drawable.ic_dialog_middle_selector);
					mButtonPositive.setBackgroundResource(R.drawable.ic_dialog_right_selector);
					whichButtons = whichButtons | BIT_BUTTON_NEUTRAL | BIT_BUTTON_NEGATIVE | BIT_BUTTON_POSITIVE;
				}
			}
		}
		/*add by liyu--dialog_style--20150910--end--*/
    ...
    public static class AlertParams {
        ...
        private void createListView(final AlertController dialog) {
			/*PRIZE-shut_menu-xiaxuefeng-2015-5-18-start*/
            final RecycleListView listView;
			//remove liup 20170810 dialogui
			//if(SystemProperties.get("ro.prize_shut_menu").equals("1")){
			//	listView = (RecycleListView)
            //        mInflater.inflate(com.android.internal.R.layout.select_dialog, null);
			//} else {
				listView = (RecycleListView)
                    mInflater.inflate(dialog.mListLayout, null);
			//}	
			/*PRIZE-shut_menu-xiaxuefeng-2015-5-18-end*/
