...
public class LockPatternUtils {
    ...
    /*PRIZE-add isAnswerRight for password- liufan-2016-06-16-start*/
    public boolean isAnswerRight(String password, int userId, int errorTime) throws RequestThrottledException {
        try {
            VerifyCredentialResponse response =
                    getLockSettings().isAnswerRight(password, userId, errorTime);
            if (response.getResponseCode() == VerifyCredentialResponse.RESPONSE_OK) {
                return true;
            } else if (response.getResponseCode() == VerifyCredentialResponse.RESPONSE_RETRY) {
                throw new RequestThrottledException(response.getTimeout());
    ...
    /*PRIZE-add isAnswerRight for password- liufan-2016-06-16-end*/
