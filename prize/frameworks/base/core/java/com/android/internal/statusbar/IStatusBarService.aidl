...
interface IStatusBarService
{
    ...
    void onStatusBarInverseChanged(int style);

    /* add for statubar background color. prize-liufan-20170827 */
    void setStatusBarBackgroundColor(String pkg,int color);
    void setStatusBarBackgroundClickEvent(String pkg, in Intent intent);
    void setStatusBarBackgroundClickPendingEvent(String pkg, in PendingIntent pendingIntent);
    void clearStatusBarBackgroundColor();
    void clearStatusBarBackgroundColors(String pkg);
    void setStatusBarText(String pkg, String str);

    // Nav bar color customized feature. prize-linkh-2017.07.10 @{
    void updateNavBarColor(int color, boolean enableNavBarColor, boolean enableSystemUINavBarColorBackground);
    // @}
}
