...
import android.widget.Toolbar.ActionBarContainerListener;
...
public class ActionBarContainer extends FrameLayout {
    ...
    ActionBarContainerListener mListener = new ActionBarContainerListener(){
		...
		public void setPadding(int dimensLeft){
            mTitleTextView.setPadding(dimensLeft,0,0,0);;
        }
    };
    /*add by liuweiquan actionbar 20160802 end*/
    ...
    public void onFinishInflate() {
        ...
        /*add by liuweiquan actionbar 20160802 start*/
        mTitleTextView = (TextView)findViewById(com.android.internal.R.id.actionbar_title_prize);
        TypedValue typedValue = new TypedValue(); 
        getContext().getTheme().resolveAttribute(android.R.attr.prizeActiobBarStyle, typedValue, true);
        int[] attribute = new int[] { android.R.attr.visibility };
        TypedArray array = getContext().obtainStyledAttributes(typedValue.resourceId, attribute);
        final int visibility = array.getInt(0, -1);
        array.recycle(); 
        if(visibility==View.VISIBLE&&null!=mActionContextView){
            if(mActionBarView instanceof Toolbar){
                ((Toolbar)mActionBarView).addListener(mListener);
            }
        }   
        /*add by liuweiquan actionbar 20160802 end*/
    }
