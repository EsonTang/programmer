...
/* prize-modify-by-lijimeng-for language-20180310-start*/
import android.widget.ImageView;
/* prize-modify-by-lijimeng-for language-20180310-end*/
        ...
        return new ArrayAdapter<LocaleInfo>(context, layoutId, fieldId, localeInfos) {
            ...
            public View getView(int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    holder.text = (TextView) convertView.findViewById(fieldId);
                    holder.imageView = (ImageView) convertView.findViewById(R.id.select_image);
				...
				if(locale != null && locale.equals(item.getLocale().toString())){
