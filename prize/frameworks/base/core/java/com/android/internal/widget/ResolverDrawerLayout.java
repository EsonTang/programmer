...
public class ResolverDrawerLayout extends ViewGroup {
    ...
    public void setMaxCollapsedHeight(int height) {
        mMaxCollapsedHeight = height;
    }

    public void setMaxCollapsedHeightSmall(int height) {
        mMaxCollapsedHeightSmall = height;
    }

    // solve bug-50789
    private boolean mIgnoredHeightAdjustmentOnMeasure = false;
    public void setIgnoredHeightAdjustmentOnMeasure(boolean ignored) {
        mIgnoredHeightAdjustmentOnMeasure = ignored;
    }    
    //end....
    ...
    private int getHeightUsed(View child) {
        ...
        if (child instanceof AbsListView) {
            ...
            /* app multi instances feature. prize-linkh-20180306 @{ */
            // solve bug-50789
            // After Gridview has valid children on onLayout(), system
            // may doesn't perform a new measurement.
            if (mIgnoredHeightAdjustmentOnMeasure) {
