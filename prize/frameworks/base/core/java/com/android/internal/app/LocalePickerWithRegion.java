...
public class LocalePickerWithRegion extends ListFragment implements SearchView.OnQueryTextListener {
    ...
    public void onResume() {
		...
		setEmptyText(getContext().getResources().getString(R.string.prize_add_language_empty_prompt));
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        TextView empty = (TextView)view.findViewById(R.id.internalEmpty);
        if(empty != null){
            empty.setTextSize(15);
            empty.setTextColor(getContext().getResources().getColor(R.color.prize_preference_title_textcolor));
        }
        return view;
    }
