...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent {
	...
	private boolean mActionBarElevation;
	...
	// prize-add-by-lijimeng-for actionbar elevation-20180205-start
	private int prizeTranslationSize = 0;
	// prize-add-by-lijimeng-for actionbar elevation-20180205-end
    ...
    static final int[] ATTRS = new int [] {
            ...
            com.android.internal.R.attr.prizeActiobBarStyleElevation
    };
    ...
    private void init(Context context) {
		...
		mActionBarElevation= ta.getBoolean(2,false);
        ta.recycle();
		...
		// prize-add-by-lijimeng-for actionbar elevation-20180205-start
		prizeTranslationSize = context.getResources().getDimensionPixelSize(com.android.internal.R.dimen.prize_content_translation_size);
		// prize-add-by-lijimeng-for actionbar elevation-20180205-end
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (!mOverlayMode && !stable) {
            mContentInsets.top += topInset;
			 //Log.d(TAG,"mActionBarElevation == "+mActionBarElevation);
			if(mActionBarElevation){
				 mContentInsets.bottom += bottomInset-prizeTranslationSize;
			}else{
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE) {
				...
				int id = child.getId();
				//Log.d(TAG,"mActionBarElevation11 == "+mActionBarElevation);
				if(com.android.internal.R.id.content == id && mActionBarElevation){
					child.layout(childLeft, childTop-prizeTranslationSize, childLeft + width, childTop + height);
				}else{
