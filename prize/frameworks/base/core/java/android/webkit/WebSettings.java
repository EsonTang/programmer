...
public abstract class WebSettings {
    ...
    public void setDoubleTapZoom(int doubleTapZoom) {
        ...
        try {
            Method getAwSettings= this.getClass().getDeclaredMethod("getAwSettings");
            getAwSettings.setAccessible(true);
            Object mAwSettings = getAwSettings.invoke(this);
            Method method = mAwSettings.getClass().getMethod("setDoubleTapZoom", int.class);
            method.invoke(mAwSettings, doubleTapZoom);
