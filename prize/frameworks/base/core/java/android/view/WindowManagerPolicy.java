...
public interface WindowManagerPolicy {
    ...
    public interface WindowState {
        ...
        public boolean prizeAnimatingExit(); // prize-add- 0 180 rotation, fullscreen app,  cut lcd ears-liyongli-20180628
    }
    ...
    public interface WindowManagerFuncs {
        ...
        void overridePlayingAppAnimationsLw(Animation a);
		        // Nav bar color customized feature. prize-linkh-2017.08.04 @{
        // Should be only called in "Lw" methods!
        public WindowState getInputMethodTarget();
        public boolean forceClearSysUiVisLw(WindowState win, int diff);
        // @}
