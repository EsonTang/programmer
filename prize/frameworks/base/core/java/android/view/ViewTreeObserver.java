...
import android.util.Log;//fix from google 8.1 by liufan-2018-4-23
...
public final class ViewTreeObserver {
    ...
    private boolean mInDispatchOnDraw;//fix from google 8.1 by liufan-2018-4-23
    private ArrayList<OnDrawListener> mOnDrawListeners;
    private static boolean sIllegalOnDrawModificationIsFatal;//fix from google 8.1 by liufan-2018-4-23
     ...
     */
    ViewTreeObserver() {
        sIllegalOnDrawModificationIsFatal = true;//fix from google 8.1 by liufan-2018-4-23
    }
    ...
    public void addOnDrawListener(OnDrawListener listener) {
        ...
        //fix from google 8.1 by liufan-2018-4-23-start
		...
		//fix from google 8.1 by liufan-2018-4-23-end
    ...
    public final void dispatchOnDraw() {
        if (mOnDrawListeners != null) {
            mInDispatchOnDraw = true;//fix from google 8.1 by liufan-2018-4-23
            final ArrayList<OnDrawListener> listeners = mOnDrawListeners;
            int numListeners = listeners.size();
            for (int i = 0; i < numListeners; ++i) {
                listeners.get(i).onDraw();
            }
            mInDispatchOnDraw = false;//fix from google 8.1 by liufan-2018-4-23
        }
    }
