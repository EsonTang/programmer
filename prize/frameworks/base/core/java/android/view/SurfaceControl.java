...
public class SurfaceControl {
    ...
    public static Bitmap screenshot(Rect sourceCrop, int width, int height,
        ...
        /* prize-xuchunming-20170710-add circle window at screen four corners-start */
        return transform(nativeScreenshot(displayToken, sourceCrop, width, height,
    ...
    public static Bitmap screenshot(int width, int height) {
        ...
        IBinder displayToken = SurfaceControl.getBuiltInDisplay(
                SurfaceControl.BUILT_IN_DISPLAY_ID_MAIN);
        /* prize-xuchunming-20170710-add circle window at screen four corners-start */
        return transform(nativeScreenshot(displayToken, new Rect(), width, height, 0, 0, true,
                false, Surface.ROTATION_0));
        /* prize-xuchunming-20170710-add circle window at screen four corners-end */
    }
    /*prize-add another screenshot method used by SystemUI's A Key clean-up -liufan-2016-01-29-start*/
    public static Bitmap screenshot(int width, int height, int minLayer, int maxLayer, boolean allLayers) {
        // TODO: should take the display as a parameter
        IBinder displayToken = SurfaceControl.getBuiltInDisplay(
                SurfaceControl.BUILT_IN_DISPLAY_ID_MAIN);
        /* prize-xuchunming-20170710-add circle window at screen four corners-start */
        return transform(nativeScreenshot(displayToken, new Rect(), width, height, minLayer, maxLayer, allLayers,
                false, Surface.ROTATION_0));
        /* prize-xuchunming-20170710-add circle window at screen four corners-end */
    }
    /*prize-add another screenshot method used by SystemUI's A Key clean-up -liufan-2016-01-29-end*/
    ...
    public static Bitmap transform(Bitmap source){
      /*prize-change-hpf-2018-1-4-start*/
    	//boolean enable = SystemProperties.getInt("ro.prize.screen.circlecorner", 0) == 1 ? true : false;
      boolean enable = false;
      /*prize-change-hpf-2018-1-4-end*/ 
    	if(enable == true && source != null && source.getWidth() >= 720){
    		int width = source.getWidth();
    		int height = source.getHeight();
    		float mRadius = width* 40f / 720  ;
