...
public interface WindowManager extends ViewManager {
	...
	/**
	 *  PRIZE- Disalbe FloatWindow - chenlong - 20150-6-18
	 */
	public void setFloatEnable(String packageName, boolean enable);

	/**
     *  PRIZE- Disalbe FloatWindow - chenlong - 20150-6-18
	 */
	public boolean getFloatEnable(String packageName);
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams implements Parcelable {
         ...
         * @hide
         */         
        public int statusBarInverse = -1;
        /*
         * @hide
         */
        public int statusBarAutoInverse = -1;
        /**
         * Dynamically hiding nav bar feature.
         * Solve an issue for dynamically hiding nav bar(bug-19908). prize-linkh-20160808
         * If keyguard sets Gone for nav bar, then let phone window manger to know this event
         * for choosing a policy that still calulates nav bar to avoid causing relayout  
         * other windows. If not, phone window manager will ignore calculating region of nav
         * bar. 
         *
         * Note: when invoking copyFrom(), it only fills this field and doesn't supply a change flag 
         *       to notify whether these two layout params aren't different.
         *
         * @hide
         */
        public String navBarGoneReason;

        /**
         * Nav bar color customized feature. prize-linkh-2017.08.03 @{
         * @hide
         */
        // this flag reprents this window don't draw its nav bar color and 
        // let SystemUI to draw nav bar color backgroud for it.
        public boolean enableSystemUINavBarColorBackground;
        // pure white color represents this window needn't nav bar color.
        /** @hide */
        public boolean alwaysDisableNavbarColorCust;
        // this flag represents if this window should set nav bar color.
        /** @hide */
         ...
         * @hide
         */
        public int applicationInfoFlags = 0;
        /*-prize-add by lihuangyuan,for notchscreen cut systemui-2018-05-05-end*/
        
        public int prizeWinMoveEarlcdBottom = -1; // prize-add- 0 180 rotation, fullscreen app,  cut lcd ears then Force SHOW statusbar-liyongli-20180510
        ...
        public void writeToParcel(Parcel out, int parcelableFlags) {
            ...
            //add for status bar inverse style. prize-linkh-20150903
            out.writeInt(statusBarInverse);
            out.writeInt(statusBarAutoInverse);

            /* Dynamically hiding nav bar feature. prize-linkh-20160808*/
            out.writeString(navBarGoneReason);
            // Nav bar color customized feature. prize-linkh-2017.08.03 @{
            out.writeInt(enableSystemUINavBarColorBackground ? 1 : 0);
            out.writeInt(alwaysDisableNavbarColorCust ? 1 : 0);
            out.writeInt(hasSetNavBarColor ? 1 : 0);
            out.writeInt(navBarColor);
            // @}
            /*-prize-add by lihuangyuan,for notchscreen cut systemui-2018-05-05-start*/
            out.writeInt(applicationInfoFlags);
           /*-prize-add by lihuangyuan,for notchscreen cut systemui-2018-05-05-end*/
        ...
        public LayoutParams(Parcel in) {
            ...
            //add for status bar inverse style. prize-linkh-20150903
            statusBarInverse = in.readInt();
            statusBarAutoInverse = in.readInt();
            /* Dynamically hiding nav bar feature. prize-linkh-20160808*/
            navBarGoneReason = in.readString();       
            // Nav bar color customized feature. prize-linkh-2017.08.03 @{
            enableSystemUINavBarColorBackground = in.readInt() != 0;
            alwaysDisableNavbarColorCust = in.readInt() != 0;
            hasSetNavBarColor = in.readInt() != 0;
        ...
        //add for status bar inverse style. prize-linkh-20150903
        /** {@hide} */
        public static final int STATUS_BAR_INVERSE_CHANGED = 1 << 26;
        /** {@hide} */
        public static final int STATUS_BAR_INVERSE_AUTO_CHANGED = 1 << 27;

        // Nav bar color customized feature. prize-linkh-2017.08.03 @{
        /** {@hide} */
        public static final int NAV_BAR_COLOR_CUST_CHANGED = 1 << 28;
        // @}
        ...
        public final int copyFrom(LayoutParams o) {
            ...
            //add for status bar inverse style. prize-linkh-20150903
            if (statusBarInverse != o.statusBarInverse) {
                statusBarInverse = o.statusBarInverse;
                changes |= STATUS_BAR_INVERSE_CHANGED;
            }
            if (statusBarAutoInverse != o.statusBarAutoInverse) {
                statusBarAutoInverse = o.statusBarAutoInverse;
                changes |= STATUS_BAR_INVERSE_AUTO_CHANGED;
            }            
            /* Dynamically hiding nav bar feature. prize-linkh-20160808*/
            navBarGoneReason = o.navBarGoneReason;
            //END...

            // Nav bar color customized feature. prize-linkh-2017.08.03 @{
            // Don't need changed event.
            enableSystemUINavBarColorBackground = o.enableSystemUINavBarColorBackground;
            alwaysDisableNavbarColorCust = o.alwaysDisableNavbarColorCust;
            
            if (navBarColor != o.navBarColor || hasSetNavBarColor != o.hasSetNavBarColor) {
                hasSetNavBarColor = o.hasSetNavBarColor;
                navBarColor = o.navBarColor;
                changes |= NAV_BAR_COLOR_CUST_CHANGED;
            }
            // @}
            /*-prize-add by lihuangyuan,for notchscreen cut systemui-2018-05-05-start*/
            applicationInfoFlags = o.applicationInfoFlags;
           /*-prize-add by lihuangyuan,for notchscreen cut systemui-2018-05-05-end*/
        ...
        public String toString() {
            ...
            if(statusBarInverse >= 0) {
                sb.append(" statusBarInverse=");
                sb.append(statusBarInverse);
            }
            if(statusBarAutoInverse >= 0) {
                sb.append(" statusBarAutoInverse=");
                sb.append(statusBarAutoInverse);
            }
            /* Dynamically hiding nav bar feature. prize-linkh-20160808*/
            if (navBarGoneReason != null) {
                sb.append(" navBarGoneReason=");
                sb.append(navBarGoneReason);
            } //END...

            // Nav bar color customized feature. prize-linkh-2017.08.03 @{
            if (enableSystemUINavBarColorBackground) {
                sb.append(" enableSystemUINavBarColorBackground=true");
            }
            if (alwaysDisableNavbarColorCust) {
                sb.append(" alwaysDisableNavbarColorCust=true");
            }
            if (hasSetNavBarColor) {
                sb.append(" navBarColor=0x" + Integer.toHexString(navBarColor));
            }
            if (dimAmount != 1.0f) {
                sb.append(" dimAmount=" + dimAmount + "f");
            }
            // @}
            /*-prize-add by lihuangyuan,for notchscreen cut systemui-2018-05-05-start*/
            if (applicationInfoFlags != 0) {
                sb.append(" applicationInfoFlags=" + applicationInfoFlags);
            }
           /*-prize-add by lihuangyuan,for notchscreen cut systemui-2018-05-05-end*/
