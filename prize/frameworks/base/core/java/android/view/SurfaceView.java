...
public class SurfaceView extends View {
    ...
    private static final int DBG_UPDATE_CONTENT = 0x00000002;
    ...
    private final SurfaceHolder mSurfaceHolder = new SurfaceHolder() {
        ...
        private final Canvas internalLockCanvas(Rect dirty) {
            ...
            if (IS_ENG_BUILD || LOG_UPDATE_CONTENT) {
                Log.i(TAG, System.identityHashCode(this) + " " + "Locking canvas... stopped="
            ...
            if (IS_ENG_BUILD || LOG_UPDATE_CONTENT) {
                Log.i(TAG, System.identityHashCode(this) + " " + "Returned canvas: " + c);
            }
            if (c != null) {
        ...
        public void unlockCanvasAndPost(Canvas canvas) {
            if (IS_ENG_BUILD || LOG_UPDATE_CONTENT) {
                Log.i(TAG, System.identityHashCode(this) + " " + "UnLocking canvas... "
                    + ", win=" + mWindow);
            }
    ...
    private static void checkLogProperty() {
        ...
        if (dumpString != null) {
            ...
            LOG_UPDATE_CONTENT = (logFilter & DBG_UPDATE_CONTENT) == DBG_UPDATE_CONTENT;

            Log.d(TAG, "checkSurfaceViewlLogProperty debug filter: " +
                    ",UPDATE_WINDOW= " + LOG_UPDATE_WINDOW +
                    ",UPDATE_CONTENT= " + LOG_UPDATE_CONTENT);
        }
    }
