...
interface IWindowManager
{
    ...
    void setFloatPackageEnable(String packageNameSetting, boolean enable);
    boolean getFloatPackageEnable(String packageNameSetting);
    int getFloatPackageEnableForWM(String packageNameSetting);
