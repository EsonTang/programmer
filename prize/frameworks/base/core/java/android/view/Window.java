...
public abstract class Window {
     ...
     */
    /** {@hide} */
    public static final int SET_ALWAYS_DISABLE_NAV_BAR_COLOR_CUST = 1 << 0;
    /** {@hide} */
    public static final int SET_ENABLE_SYSTEM_UI_NAV_BAR_COLOR_BACKGROUND = 1 << 1;
    
    private int mForcedPrizeFlags;
    private int mPrizeFlags;
    private boolean mDisableCustNavBarColor;
    private boolean mEnableSystemUINavBarColorBackground;
    private boolean mIgnoreDimAmountAdjustment;

    /** {@hide} */
    public void setIgnoreDimAmountAdjustment(boolean ignored) {
        mIgnoreDimAmountAdjustment = ignored;
        dispatchWindowAttributesChanged(getAttributes());
    }

    /** {@hide} */
    public boolean getIgnoreDimAmountAdjustment() {
        return mIgnoreDimAmountAdjustment;
    }

    /** {@hide} */
    public void setDisableCustNavBarColor(boolean disable) {
        mForcedPrizeFlags |= SET_ALWAYS_DISABLE_NAV_BAR_COLOR_CUST;
        mDisableCustNavBarColor = disable;
        dispatchWindowAttributesChanged(getAttributes());
    }

    /** {@hide} */
    public boolean getDisableCustNavBarColor() {
        return mDisableCustNavBarColor;
    }

    /** {@hide} */
    public void setEnableSystemUINavBarColorBackground(boolean enable) {
        mForcedPrizeFlags |= SET_ENABLE_SYSTEM_UI_NAV_BAR_COLOR_BACKGROUND;
        mEnableSystemUINavBarColorBackground = enable;
        dispatchWindowAttributesChanged(getAttributes());
    }

    /** {@hide} */
    public boolean getEnableSystemUINavBarColorBackground() {
        return mEnableSystemUINavBarColorBackground;
    }

    /** {@hide} */
    public int getForcedPrizeFlags() {
        return mForcedPrizeFlags;
    }

    /** {@hide} */
    public int getPrizeFlags() {
        return mPrizeFlags;
    }     
    // @}  
