...
public class Toolbar extends ViewGroup {
    ...
    public interface ActionBarContainerListener {
        public void setVisibility(int visibility);
        public void setText(CharSequence title);
		public void setPadding(int dimensLeft);
    }
    
    private ActionBarContainerListener mActionBarContainerListener;

    public void addListener(ActionBarContainerListener listener){
        mActionBarContainerListener = listener;
    }
    /*
    @Override
    public void removeView(View view) {
        super.removeView(view);
        if(null!=mActionBarContainerListener&&view==mTitleTextView){
            Log.d("lwq","-------removeView---------");
            mActionBarContainerListener.setVisibility(View.INVISIBLE);
        }
    }
    */
    ...
    public void setTitle(CharSequence title) {
        if (!TextUtils.isEmpty(title)) {
            ...
            /*add by liuweiquan actionbar 20160802 start*/
            if(null!=mActionBarContainerListener){
                Log.d(TAG,"-------isChildOrHidden removeView---------");
                mActionBarContainerListener.setVisibility(View.INVISIBLE);
            }
            /*add by liuweiquan actionbar 20160802 end*/
        }
        if (mTitleTextView != null) {
            ...
            if(null!=mActionBarContainerListener){
                ...
                Log.d(TAG,"-------mActionBarContainerListener setText---------"+title);
                mActionBarContainerListener.setText(title);
    ...
    private void addSystemView(View v, boolean allowHide) {
        ...
        if (allowHide && mExpandedActionView != null) {
            ...
            if(null!=mActionBarContainerListener){
                mActionBarContainerListener.setVisibility(View.INVISIBLE);
                Log.d(TAG,"-------addSystemView INVISIBLE---------");
            }
            /*add by liuweiquan actionbar 20160802 end*/
        } else {
            addView(v, lp);
            /*add by liuweiquan actionbar 20160802 start*/
            if(null!=mActionBarContainerListener){
                mActionBarContainerListener.setVisibility(View.VISIBLE);
				/* prize-add-by-lijimeng-for actionbar-20180418-start*/
				if(PrizeOption.PRIZE_NOTCH_SCREEN){
					int prizeDimenLeft = 100;
					if(mNavButtonView != null && shouldLayout(mNavButtonView)){
						if(mPopupContext != null){
							prizeDimenLeft = mPopupContext.getResources().getDimensionPixelSize(R.dimen.prize_actionbar_title_manginLeft_hasHomeBotton_size);
						}
						mActionBarContainerListener.setPadding(prizeDimenLeft);
					}else if(mNavButtonView != null && !shouldLayout(mNavButtonView)){
						if(mPopupContext != null){
							prizeDimenLeft = mPopupContext.getResources().getDimensionPixelSize(R.dimen.prize_actionbar_title_manginLeft_size);
						}
						mActionBarContainerListener.setPadding(prizeDimenLeft);
					}
				}
				/* prize-add-by-lijimeng-for actionbar-20180418-end*/
                Log.d(TAG,"-------addSystemView VISIBLE---------");
            }
            /*add by liuweiquan actionbar 20160802 end*/
        }
    }
    ...
    void removeChildrenForExpandedActionView() {
        ...
        for (int i = childCount - 1; i >= 0; i--) {
            ...
            if (lp.mViewType != LayoutParams.EXPANDED && child != mMenuView) {
                /*add by liuweiquan actionbar 20160802 start*/
                if(child==mTitleTextView){
                    if(null!=mActionBarContainerListener){
                        Log.d(TAG,"-------removeChildrenForExpandedActionView---------");
                        mActionBarContainerListener.setVisibility(View.INVISIBLE);
                    }
                }
                /*add by liuweiquan actionbar 20160802 end*/
    ...
    void addChildrenForExpandedActionView() {
        ...
        for (int i = count - 1; i >= 0; i--) {
            /*add by liuweiquan actionbar 20160802 start*/
            if(mHiddenViews.get(i)==mTitleTextView){
                if(null!=mActionBarContainerListener){
                    Log.d(TAG,"-------addChildrenForExpandedActionView---------");
                    mActionBarContainerListener.setVisibility(View.VISIBLE);
				/* prize-add-by-lijimeng-for actionbar-20180418-start*/
				if(PrizeOption.PRIZE_NOTCH_SCREEN){
					int prizeDimenLeft = 100;
