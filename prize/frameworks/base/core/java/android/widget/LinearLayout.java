...
public class LinearLayout extends ViewGroup {
    ...
    void measureVertical(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DBG && sDebugLayout) {
            Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.1, this=" + this);
        }
        ...
        for (int i = 0; i < count; ++i) {
            ...
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Child in Pass1: " + i + ", child=" + child
                        + ", this=" + this);
            }
            ...
            if (heightMode == MeasureSpec.EXACTLY && useExcessSpace) {
                ...
                if (DBG && sDebugLayout) {
                    Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-1: " + i
                ...
                if (useExcessSpace) {
                    ...
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-2-1: " + i
                                + ", child=" + child + ", this=" + this + ", "
                ...
                if (DBG && sDebugLayout) {
                    Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-2-2: " + i
                            + ", child=" + child + ", this=" + this + ", "
        ...
        if (useLargestChild &&
            ...
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.1.5, this=" + this);
            }
        ...
        if (DBG && sDebugLayout) {
            Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.2, this=" + this + ", "
                    + "remainingExcess=" + remainingExcess + ", " + "heightSize=" + heightSize
                    + ", mTotalLength=" + mTotalLength);
        }
        if (skippedMeasure || remainingExcess != 0 && totalWeight > 0.0f) {
            ...
            for (int i = 0; i < count; ++i) {
                ...
                if (DBG && sDebugLayout) {
                    Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Child in Pass2: " + i + ", "
                            + "child=" + child + ", this=" + this);
                }
                ...
                if (childWeight > 0) {
                    ...
                    if (mUseLargestChild && heightMode != MeasureSpec.EXACTLY) {
                        ...
                        if (DBG && sDebugLayout) {
                            Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-1-1-1: " + i
                                    + ", child=" + child + ", this=" + this + ", "
                        ...
                        if (DBG && sDebugLayout) {
                            Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-1-1-2: " + i
                                    + ", child=" + child + ", this=" + this + ", "
                                    + "status=Measured, share=" + share
                                    + ", mTotalLength=" + mTotalLength);
                        }
                    ...
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-1-2: " + i
                                + ", child=" + child + ", this=" + this + ", "
                                + "status=Skipped"
                                + ", mTotalLength=" + mTotalLength);
                    }
            ...
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Pass.2-1, this=" + this + ", "
                        + "maxWidth=" + maxWidth + ", weightedMaxWidth=" + weightedMaxWidth
                        + ", alternativeMaxWidth=" + alternativeMaxWidth
                        + ", mTotalLength=" + mTotalLength);
            ...
            if (useLargestChild && heightMode != MeasureSpec.EXACTLY) {
                for (int i = 0; i < count; i++) {
                    ...
                    if (DBG && sDebugLayout) {
                        ...
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-2: " + i
            ...
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Pass.2-2, this=" + this + ", "
                        + "maxWidth=" + maxWidth + ", weightedMaxWidth=" + weightedMaxWidth
                        + ", alternativeMaxWidth=" + alternativeMaxWidth
                        + ", mTotalLength=" + mTotalLength
        ...
        if (matchWidth) {
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.3, this=" + this
    ...
    void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DBG && sDebugLayout) {
            Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.1 (Horizontal), this=" + this);
        }
        ...
        for (int i = 0; i < count; ++i) {
            ...
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Child in Pass1: " + i
                        + ", child=" + child + ", this=" + this);
            }
            ...
            if (widthMode == MeasureSpec.EXACTLY && useExcessSpace) {
                ...
                if (baselineAligned) {
                    ...
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-1-1: " + i
                                + ", child=" + child + ", this=" + this + ", "
                    ...
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass1-1-2: " + i
                                + ", child=" + child + ", this=" + this + ", "
                                + "status=Skipped, mTotalLength=" + mTotalLength
                                + ", totalWeight=" + totalWeight);
                    }
        ...
        if (useLargestChild &&
            ...
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.1.5 (Horizontal), this=" + this);
            }
            mTotalLength = 0;
        ...
        if (DBG && sDebugLayout) {
            Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.2 (Horizontal), this=" + this
                    + ", remainingExcess = " + remainingExcess + ", " + "widthSize = " + widthSize
                    + ", mTotalLength = " + mTotalLength);
        }
        if (skippedMeasure || remainingExcess != 0 && totalWeight > 0.0f) {
            float remainingWeightSum = mWeightSum > 0.0f ? mWeightSum : totalWeight;
            ...
            for (int i = 0; i < count; ++i) {
                ...
                if (childWeight > 0) {
                    ...
                    if (DBG && sDebugLayout) {
                        Log.d(DEBUG_LOG_TAG, "[LinearLayout] - Child in Pass2-1-3: " + i
                                + ", child=" + child + ", this=" + this
                                + ", mTotalLength=" + mTotalLength);
                    }
                }
        ...
        if (matchHeight) {
            if (DBG && sDebugLayout) {
                Log.d(DEBUG_LOG_TAG, "[LinearLayout] + Pass.3 (Horizontal), this=" + this
