...
public class Build {
    ...
    /** The name of system version */
    public static final String SYSTEM_VERSION = getString("ro.product.system.version");
    ...
    public static boolean isPermissionReviewRequired() {
        return PERMISSIONS_REVIEW_REQUIRED;// prize liup 20161116 change {PERMISSIONS_REVIEW_REQUIRED || CtaUtils.isCtaSupported()}
    }
    ///@}
}
