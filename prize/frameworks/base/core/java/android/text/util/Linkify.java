...
public class Linkify {
    static IPatterns IPatternsPlugin = (IPatterns) MPlugin.createInstance(
            IPatterns.class.getName());
    static IWebProtocolNames IWebProtocolNamesPlugin = (IWebProtocolNames) MPlugin.createInstance(
