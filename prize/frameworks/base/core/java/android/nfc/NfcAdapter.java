...
public final class NfcAdapter {
    ...
    public INfcCardEmulation getCardEmulationService() {
        ...
        /// M: ALPS03303926, Fix JE when entering Tap & pay option menu @{
        /*
           In NFC service, if the HCE is on, we can get the INfcCardEmulation interface.
           The cached status may not sync with NFC service. Thus, we force to get the result
           from NFC service.
         */
        try {
