...
public final class BluetoothDevice implements Parcelable {
    ...
    public String toString() {
        if (!USER_MODE || mAddress == null || mAddress.length() < ADDRESS_LENGTH) {
            ...
            return mAddress.substring(0, 9) + "XX:XX:XX";
        }
    }
    ...
    public boolean createBond() {
        ...
        try {
            Log.i(TAG, "createBond() for device " + toString() +
    ...
    public boolean cancelBondProcess() {
        ...
        try {
            Log.i(TAG, "cancelBondProcess() for device " + toString() +
                    " called by pid: " + Process.myPid() +
                    " tid: " + Process.myTid());
    ...
    public boolean removeBond() {
        ...
        try {
            Log.i(TAG, "removeBond() for device " + toString() +
                    " called by pid: " + Process.myPid() +
                    " tid: " + Process.myTid());
