...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        public static final String PRIZE_SALES_STATIS_NET = "prize_sales_statis_net";
        public static final String PRIZE_SALES_STATIS_MMS = "prize_sales_statis_mms";
        public static final String PRIZE_FLIP_SILENT = "prize_flip_silent";
        public static final String PRIZE_SMART_ANSWER_CALL = "prize_smart_answer_call";
        public static final String PRIZE_SMART_DIALING = "prize_smart_dialing";
        public static final String PRIZE_POCKET_MODE = "prize_pocket_mode";
        public static final String PRIZE_ANTIFAKE_TOUCH = "prize_antifake_touch";
        public static final String PRIZE_NON_TOUCH_OPERATION = "prize_non_touch_operation";
        public static final String PRIZE_NON_TOUCH_OPERATION_UNLOCK = "prize_non_touch_operation_unlock";
        public static final String PRIZE_NON_TOUCH_OPERATION_GALLERY = "prize_non_touch_operation_gallery";
        public static final String PRIZE_NON_TOUCH_OPERATION_LAUNCHER = "prize_non_touch_operation_launcher";
        public static final String PRIZE_NON_TOUCH_OPERATION_VIDEO = "prize_non_touch_operation_video";
        public static final String PRIZE_NON_TOUCH_OPERATION_MUSIC = "prize_non_touch_operation_music";
        /**prize-add-by-zhongweilin-end*/
        private static final float DEFAULT_FONT_SCALE = 1.0f;
        
        /** @hide*/
        public static final String PRIZE_SALES_STATIS = "prize_sales_statis";
		/* prize-add-by-lijimeng-20180110-start*/
		/** @hide*/
        public static final String PRIZE_RINGTONE_NAME = "prize_ringtone_name";
		/** @hide*/
        public static final String PRIZE_FACEID_SWITCH = "prize_faceid_switch";
		/** @hide*/
        public static final String PRIZE_VIBRATE_IN_SILENT = "prize_vibrate_in_silent";
		/* prize-add-by-lijimeng-20180110-end*/
        /** @hide */
        ...
        static {
			...
			MOVED_TO_GLOBAL.add(Settings.Global.PRIZE_KGWALLPAPER_PATH);
        ...
        /**
         * The screen auto backlight brightness between 0 and 255.
         * @hide
         * prize-wuliang 20180227 for auto brightness
         */
        public static final String SCREEN_AUTO_MODE_BRIGHTNESS = "screen_auto_mode_brightness";
        /**
         * The screen auto temp backlight brightness between 0 and 255.
         * @hide
         * prize-wuliang 20180227 for auto brightness
         */
        public static final String SCREEN_AUTO_MODE_TEMP_BRIGHTNESS = "screen_auto_mode_temp_brightness";
        ...
        /*** begin prize add by liangchangwei for support double Card Ringtone && notificationsound*/
        /**
         * Persistent store for the system-wide default ringtone URI.
         * <p>
         * If you need to play the default ringtone at any given time, it is recommended
        ...
        private static final Validator RINGTONE2_VALIDATOR = sUriValidator;
         ...
         * @see #DEFAULT_NOTIFICATION_URI
         */
        public static final String NOTIFICATION2_SOUND = "notification2_sound";

        private static final Validator NOTIFICATION2_SOUND_VALIDATOR = sUriValidator;
         ...
         * @see #DEFAULT_RINGTONE_URI
         */
        public static final Uri DEFAULT_NOTIFICATION2_URI = getUriFor(NOTIFICATION2_SOUND);

        /** {@hide} */
        public static final String NOTIFICATION2_SOUND_CACHE = "notification2_sound_cache";
        /** {@hide} */
        public static final Uri NOTIFICATION2_SOUND_CACHE_URI = getUriFor(NOTIFICATION2_SOUND_CACHE);
        /*** end prize add by liangchangwei for support double Card Ringtone && notificationsound  */
		...
		/** @hide */
		@Deprecated
		public static final String PRIZE_KGWALLPAPER_PATH = Global.PRIZE_KGWALLPAPER_PATH;
		/*PRIZE-prize-public-standard:Changed lock screen-liuweiquan-20151210-end*/
        /**
       ...
       /**
         ...
         */
         ...
         /// MTK ADD END. @}
		/*prize-public-standard:magazine lock screen-liuweiquan-20161018-start*/
		public static final String PRIZE_MAGAZINE_KGWALLPAPER_SWITCH = "prize_magazine__kgwallpaper_switch";
		/*prize-public-standard:magazine lock screen-liuweiquan-201618-end*/
		/*PRIZE-prize-public-standard:Changed lock screen-liuweiquan-20151210-start*/
		public static final String PRIZE_KGWALLPAPER_SWITCH = "prize_kgwallpaper_switch";
		/*PRIZE-prize-public-standard:Changed lock screen-liuweiquan-20151210-end*/
		/*PRIZE-prize-public-standard:Allow drop-down notification bar-liuweiquan-20160803-start*/
		public static final String PRIZE_ALLOW_DROPDOWN_NOTIFICATIONBAR_SWITCH = "prize_allow_dropdown_notificationbar_switch";
		/*PRIZE-prize-public-standard:Allow drop-down notification bar-liuweiquan-20160803-end*/
		/*PRIZE-prize-public-standard:screen on when comes notification-liuweiquan-20160803-start*/
		public static final String PRIZE_SCREEN_ON_FOR_NOTIFICATION_SWITCH = "prize_screen_on_for_notification_switch";
		public static final String PRIZE_REAL_TIME_NETWORK_SPEED_SWITCH = "prize_real_time_network_speed_switch";
		/*PRIZE-prize-public-standard:screen on when comes notification-liuweiquan-20160803-end*/
		/*PRIZE-PowerExtendMode-wangxianzhen-2015-04-14-start*/
        public static final String POWER_EXTEND_BK_GPS_ON = "kk_pw_ext_bk_gps_on";
        public static final String POWER_EXTEND_BK_GPRS_ON = "kk_pw_ext_bk_gprs_on";
        public static final String POWER_EXTEND_BK_GPRS_CONNECTION_SETTING = "kk_pw_ext_bk_gprs_connection_setting";
        public static final String POWER_EXTEND_BK_GPRS_CONNECTION_SIM_SETTING = "kk_pw_ext_bk_gprs_connection_sim_setting";
        public static final String POWER_EXTEND_BK_NFC_ON = "kk_pw_ext_bk_nfc_on";
        public static final String POWER_EXTEND_BK_WIFI_ON = "kk_pw_ext_bk_wifi_on";
        public static final String POWER_EXTEND_BK_BLUETOOTH = "kk_pw_ext_bk_bluetooth_on";
        public static final String POWER_EXTEND_BK_LOCATION_PROVIDERS_ALLOWED = "kk_pw_ext_bk_location";
        public static final String POWER_EXTEND_BK_SCREEN_BRIGHTNESS = "kk_pw_ext_bk_scr_brightness";
        public static final String POWER_EXTEND_BK_SCREEN_OFF_TIMEOUT = "kk_pw_ext_bk_scr_off_timeout";
        public static final String POWER_EXTEND_BK_SCREEN_BRIGHTNESS_MODE = "kk_pw_ext_bk_screen_brightness_mode";
        public static final String POWER_EXTEND_BK_ACCELEROMETER_ROTATION= "kk_pw_ext_bk_accelerometer_rotation";
        public static final String POWER_EXTEND_BK_HAPTIC_FEEDBACK_ENABLED= "kk_pw_ext_bk_haptic_feedback_enabled";
        public static final String POWER_EXTEND_BK_SYNC_STATUS= "kk_pw_ext_bk_sync_status";
        public static final String POWER_EXTEND_BK_WIDGETS_ENABLE = "kk_pw_ext_bk_widgets_enable";
        /*PRIZE-PowerExtendMode-wangxianzhen-2015-05-30-end*/
         /// MTK ADD END. @}
		/**
		*@hide
		*/
	 public static final String POWER_EXTEND_BK_PRIZE_VOICE_KEY = "kk_pw_ext_bk_prize_voice_key";//add by lihuangyuan,for voice switch

        /**
         *@hide
         */
        public static final String POWER_EXTEND_BK_PRIZE_BARRAGE_ENABLE = "kk_pw_ext_bk_barrage_enable";//add by yueliu,for barrage window

        /*prize-add-by-zhongweilin-start*/
        public static final String PRIZE_FLASH_STATUS = "flashstatus";//flash light status
        /*prize-add-by-zhongweilin-end*/
	 /**
         * @hide
         */
	 public static final String PRIZE_FINGERPRINT_TOKEN = "prize_fingerprint_token";//add by liyu 2016.07.05
	/**prize-add-by-liyu-20160616-end*/
		
	/* PRIZE-Add for BluLight-zhudaopeng-2017-05-04-Start */
	 /**
         * @hide
         */  
	 public static final String PRIZE_BLULIGHT_MODE_STATE = "prize_blulight_mode_state";
	 /**
         * @hide
         */
	 public static final String PRIZE_BLULIGHT_TIME_STATE = "prize_blulight_time_state";
	 /**
         * @hide
         */
	 public static final String PRIZE_BLULIGHT_OLD_BLU_VALUE = "prize_blulight_old_blu_value";
	 /**
         * @hide
         */
	 public static final String PRIZE_BLULIGHT_TIMING_STATE = "prize_blulight_timing_state";
	 /**
         * @hide
         */
	 public static final String PRIZE_BLULIGHT_START_TIME = "prize_blulight_start_time";
	 /**
         * @hide
         */
	 public static final String PRIZE_BLULIGHT_END_TIME = "prize_blulight_end_time";
	/* PRIZE-Add for BluLight-zhudaopeng-2017-05-04-End */
        ...
        public static final String[] SETTINGS_TO_BACKUP = {
            ...
            SCREEN_BRIGHTNESS,
            //prize-wuliang 20180227 for auto brightness
            SCREEN_AUTO_MODE_BRIGHTNESS,
            SCREEN_AUTO_MODE_TEMP_BRIGHTNESS,
        ...
        static {
            ...
            PUBLIC_SETTINGS.add(NOTIFICATION2_SOUND);
			...
			/*Add-by-zhudaopeng-2016-11-21-start*/
			PUBLIC_SETTINGS.add(DATA_SAVING_KEY);
			/*Add-by-zhudaopeng-2016-11-21-End*/
			...
			/*prize-add-by-zhongweilin-start*/
            PUBLIC_SETTINGS.add(PRIZE_FLASH_STATUS);
            /*prize-add-by-zhongweilin-end*/
        ...
        static {
            ...
            //prize-wuliang 20180227 for auto brightness
            PRIVATE_SETTINGS.add(SCREEN_AUTO_MODE_BRIGHTNESS);
            PRIVATE_SETTINGS.add(SCREEN_AUTO_MODE_TEMP_BRIGHTNESS);
        ...
        static {
			...
			//prize-wuliang 20180228 auto brightness
            VALIDATORS.put(SCREEN_AUTO_MODE_BRIGHTNESS, SCREEN_BRIGHTNESS_VALIDATOR);
            VALIDATORS.put(SCREEN_AUTO_MODE_TEMP_BRIGHTNESS, SCREEN_BRIGHTNESS_VALIDATOR);
            VALIDATORS.put(MODE_RINGER_STREAMS_AFFECTED, MODE_RINGER_STREAMS_AFFECTED_VALIDATOR);
            VALIDATORS.put(MUTE_STREAMS_AFFECTED, MUTE_STREAMS_AFFECTED_VALIDATOR);
            VALIDATORS.put(VIBRATE_ON, VIBRATE_ON_VALIDATOR);
            VALIDATORS.put(RINGTONE, RINGTONE_VALIDATOR);
            VALIDATORS.put(NOTIFICATION_SOUND, NOTIFICATION_SOUND_VALIDATOR);
            VALIDATORS.put(RINGTONE2, RINGTONE2_VALIDATOR);
            VALIDATORS.put(NOTIFICATION2_SOUND, NOTIFICATION2_SOUND_VALIDATOR);
       ...
       /**
		...
		/** @hide */
		public static final String PRIZE_SETTING_UPDATE_NETWORK_DATA = "prize_update_network_data";
		...
		/** @hide */
		public static final String PRIZE_LUCKY_MONEY_NOTICE_SOUNDS = "prize_lucky_money_notice_sounds";
		/** @hide */
		public static final String PRIZE_LUCKY_MONEY_NOTICE_SOUND_DEFAULT = "prize_lucky_money_notice_sound_default";
		/** @hide */
		public static final String PRIZE_LUCKY_MONEY_HELPER_ENABLE = "prize_lucky_money_helper_enable";
		 
		 /**prize-add-game-reading-mode-liup-20150420-start*/	
		 /** @hide */
         public static final String PRIZE_GAME_MODE = "prize_game_mode";
		 /** @hide */
         public static final String PRIZE_READING_MODE = "prize_reading_mode";
		 /**prize-add-game-reading-mode-liup-20150420-start*/	
		 /**prize-add-floatwindow-liup-20150427-start*/	
		 /** @hide */
         public static final String PRIZE_FLOAT_WINDOW = "prize_float_window";
		 /**prize-add-floatwindow-liup-20150427-start*/
		 /**prize-notification-custom-liup-20150515-start*/	
		 /** @hide */
		 public static final String PRIZE_NOTIFICATION_CUSTOM = "prize_notification_custom";
		 /**prize-notification-custom-liup-20150515-end*/
        /**prize-add-PRIZE_BARRAGE_WINDOW-yueliu-20180721-start*/
        /** @hide */
        public static final String PRIZE_BARRAGE_WINDOW = "prize_barrage_window";
        /**prize-add-barragewindow-yueliu-20180721-end*/
		/**prize-sleepgesture-liup-20150519-start*/	
		/** @hide */
		public static final String PRIZE_SLEEP_GESTURE = "prize_sleep_gesture";
		/**prize-sleepgesture-liup-20150519-end*/
		/** @hide */
        public static final String PRIZE_NEW_FLOAT_WINDOW = "prize_new_float_window";		
		/** three finger SlideScreenshot **/
		/** @hide */
		public static final String PRIZE_SLIDE_SCREENSHOT = "prize_slide_screenshot";
		/** @hide */
		public static final String PRIZE_SLIDE_SPLIT_SCREEN = "prize_slide_split_screen";
		/**prize-doublesleep-wangyunhe-20151008-start*/	
		/** @hide */
		public static final String PRIZE_DBLCLICK_SLEEP = "prize_dblclick_sleep";
		/** @hide */
		public static final String PRIZE_LOCKSCREEN_OPEN_TORCH = "prize_lockscreen_open_torch";
		/**prize-doublesleep-wangyunhe-20151008-end*/	
		
        /* app multi instances feature. prize-linkh-20151223 */
        /** @hide */
        public static final String PRIZE_DISABLE_PACKAGES_FOR_APP_INST = "prize_disabled_packages_for_app_inst";
        /* Reposition nav bar back key feature & Dynamically hiding nav bar feature. prize-linkh-20161115 */
        /** @hide */
        public static final String PRIZE_NAVIGATION_BAR_STYLE = "prize_navbar_style";
        /* Dynamically changing Recents function feature. prize-linkh-20161115 */
        /** @hide */
        public static final String PRIZE_TREAT_RECENTS_AS_MENU = "prize_treat_recents_as_menu";        
        /* Dynamically hiding nav bar feature. prize-linkh-20161115 */
        /** @hide */
        public static final String PRIZE_NAVBAR_STATE = "prize_navbar_state";
        /* Nav bar related to mBack key feature. prize-linkh-20161115 */
        /** @hide */
        public static final String PRIZE_NAVBAR_STATE_FOR_MBACK = "prize_navbar_state_for_mback";

		//prize tangzhengrong 20180417 Swipe-up Gesture Nagation bar start
		/** @hide */
		public static final String PRIZE_SWIPE_UP_GESTURE_STATE = "prize_swpie_up_gesture_state";
		/** @hide */
		public static final String PRIZE_HIDE_SWIPE_UP_GESTURE_INDICATOR = "prize_hide_swpie_up_gesture_indicator";
		//prize tangzhengrong 20180417 Swipe-up Gesture Nagation bar end

        /* Disallow inter-launching apps feature. prize-linkh-20160307 */
        /** @hide */
        public static final String PRIZE_DISALLOW_INTER_LAUNCHING = "prize_disallow_inter_launching";        
        /* Intercept wake up alarms. prize-linkh-20160603 */
        /** @hide */
        public static final String PRIZE_INTERCEPT_WAKEUP_ALARM_STATE = "prize_intercept_wakeup_alarm_state";        
        /* Support controlling app network for sleeping. prize-linkh-20160713 */
        /** @hide */
        public static final String PRIZE_CONTROL_APP_NETWORK_STATE = "prize_ctl_app_net_state";
        /* Nav bar color customized feature. prize-linkh-2017.07.12 */
        /** @hide */
        public static final String PRIZE_NAV_BAR_BG_COLOR = "prize_nav_bar_bg_color";
		/** @hide */
        public static final String PRIZE_OLD_LAUNCHER = "prize_old_launcher";
		/** @hide */
		public static final String PRIZE_VOICE_KEY = "prize_voice_key";
		/** @hide */
		public static final String PRIZE_VOICE_DIALER_KEY = "prize_voice_dialer_key";
		/** @hide */
		public static final String PRIZE_VOICE_CALL_KEY = "prize_voice_call_key";
		/** @hide */
		...
		/** @hide */
		public static String PRIZE_SYSTEM_UPDATE_CHANGE = "prize_system_update_change";
    }
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String BLUETOOTH_INTEROPERABILITY_LIST = "bluetooth_interoperability_list";
		...
		/*PRIZE-prize-public-standard:Changed lock screen-liuweiquan-20151210-start*/
		public static final String PRIZE_KGWALLPAPER_PATH = "prize_kgwallpaper_path";
		/*PRIZE-prize-public-standard:Changed lock screen-liuweiquan-20151210-end*/
        /**
