...
//      }
    ...
    public ActivityResult execStartActivity(
        ...
        try {
            ...
            if(who instanceof Activity)
            {
                ...
                //Log.d("lhy","execStartActivity set fromsource "+Intent.FROM_ACTIVITY);
            }
    ...
    public ActivityResult execStartActivityAsCaller(
        ...
        try {
            ...
            {
                intent.setIntentFromSource(Intent.FROM_ACTIVITY);
                //Log.d("lhy","execStartActivityAsCaller set fromsource "+Intent.FROM_ACTIVITY);
            }
            /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-end*/
            int result = ActivityManagerNative.getDefault()
    ...
    public void execStartActivityFromAppTask(
        ...
        try {
            ...
            {
                intent.setIntentFromSource(Intent.FROM_ACTIVITY);
                //Log.d("lhy","execStartActivityFromAppTask set fromsource "+Intent.FROM_ACTIVITY);
            }
            /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-end*/
