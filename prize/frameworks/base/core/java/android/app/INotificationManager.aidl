...
interface INotificationManager
{
    ...
    void enqueueNotificationWithTagForAppInst(String pkg, String opPkg, String tag, int id,
            in Notification notification, inout int[] idReceived, int userId, int appInstanceIndex);
    void cancelNotificationWithTagForAppInst(String pkg, String tag, int id, int userId, int appInstanceIndex);
    void cancelAllNotificationsForAppInst(String pkg, int userId, int appInstanceIndex);
    //end...
}
