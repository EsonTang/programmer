...
/*-prize add by lihuangyuan,for whitelist -2017-05-06-start-*/
     ...
     * @hide
     */
    public static final int START_PERMISSION_USER_DENIED = -11;
    // @}
/*-prize add by lihuangyuan,for whitelist -2017-05-06-end-*/
    ...
    public static class RecentTaskInfo implements Parcelable {
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            /* app multi instances feature. prize-linkh-20151120 */
            dest.writeInt(appInstanceIndex);			
        }
        ...
        public void readFromParcel(Parcel source) {
            ...
            /* app multi instances feature. prize-linkh-20151120 */
            appInstanceIndex = source.readInt();			
        }
    ...
    public static class RunningAppProcessInfo implements Parcelable {
        ...
        /* app multi instances feature. prize-linkh-12080320 */
        /**
         * @hide
         */
        public int appInstanceIndex;
    ...
    /// M: Mediatek added APIs end
      ...
      *@hide
      */	
    public void setPropertyForExternal(String key, String value) {
         try {
             ActivityManagerNative.getDefault().setPropertyForExternal(key ,value);
         } catch (RemoteException e) {
         }
     }
