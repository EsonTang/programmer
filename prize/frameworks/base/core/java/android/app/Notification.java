...
public class Notification implements Parcelable
{
    ...
    /**
     * prize-linkh-2016-04-21
     * @hide
     * flag for preventing the orignal notification icon from replacing by Status Bar Inverse.
     */
    public static final int FLAG_KEEP_NOTIFICATION_ICON  = 0x20000000;
    ...
    public static class Builder {
        ...
        /*PRIZE-notification icon and right_icon background-liufan-2015-09-09-start*/
        int resolveContrastColor() {
            if (mCachedContrastColorIsFor == mN.color && mCachedContrastColor != COLOR_INVALID) {
                return 0xffffffff;//mCachedContrastColor;
            }
            final int contrasted = NotificationColorUtil.resolveContrastColor(mContext, mN.color);

            mCachedContrastColorIsFor = mN.color;
            return mCachedContrastColor = 0xffffffff;//contrasted;
        }
        /*PRIZE-notification icon and right_icon background-liufan-2015-09-09-end*/
