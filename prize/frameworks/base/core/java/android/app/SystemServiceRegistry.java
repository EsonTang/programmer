...
final class SystemServiceRegistry {
	...
	/*-prize add by lihuangyuan,for whitelist -2017-05-06-start-*/
       registerService(Context.WHITELIST_SERVICE, WhiteListManager.class,
                new CachedServiceFetcher<WhiteListManager>() {
            @Override
            public WhiteListManager createService(ContextImpl ctx) {
                return new WhiteListManager(ctx);
            }});
	/*-prize add by lihuangyuan,for whitelist -2017-05-06-end-*/
