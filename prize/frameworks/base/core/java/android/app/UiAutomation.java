...
public final class UiAutomation {
    ...
    public Bitmap takeScreenshot() {
        ...
        if ("1".equals(SystemProperties.get("ro.mtk_fullscreen_switch"))) {
            int cellValue = displayWidth / SWITCH_TARGET_WIDTH;
            if ((displayHeight / SWITCH_TARGET_HEIGHT) == cellValue) {
                displayHeight = cellValue * SWITCH_ORIGINAL_HEIGHT;
                Log.e(LOG_TAG, " takeScreenshot displayHeight = "
                        + displayHeight);
            }
        }
        /// @}
    ...
    private static final int SWITCH_ORIGINAL_HEIGHT = 18;
    /// @}
