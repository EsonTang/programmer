...
public interface IActivityManager extends IInterface {
     ...
     *  Add these methods to let this app can have permission to 
     *  read oom adj of other app processes and kill other app processes.
     *  This methods can work for other packages that have same uid 1000.
     */
    // This method is executed without holding ActivityManagerService lock.
    public void killProcess(int[] pids) throws RemoteException;
    // If it can't get oom adj for specified pid, it will be set as 100.
    ...
    /* app multi instances feature. prize-linkh-20151207 */
    int GET_APP_INSTANCE_INDEX = IBinder.FIRST_CALL_TRANSACTION + 600;
    int FORCE_STOP_PACKAGE_FOR_APP_INSTANCE = IBinder.FIRST_CALL_TRANSACTION + 601;
    int SET_ENABLE_MULTI_INSTANCE_MODE = IBinder.FIRST_CALL_TRANSACTION + 602;
    //end...
	    /*prize-add dump kill flag-liufan-2016-04-28-start*/
    int QS_CLEANUP_DUMP_STATE = IBinder.FIRST_CALL_TRANSACTION + 610;
    public void setDumpKill(boolean isDumpKill) throws RemoteException;
    /*prize-add dump kill flag-liufan-2016-04-28-end*/
    /* PrizeDebugTool: dynamically adjust min free of LMK. prize-linkh-20160923 */
    int GET_OOM_ADJ_OF_LMK = IBinder.FIRST_CALL_TRANSACTION + 620;    
    int GET_MIN_FREE_OF_LMK = IBinder.FIRST_CALL_TRANSACTION + 621;
    int SET_MIN_FREE_OF_LMK = IBinder.FIRST_CALL_TRANSACTION + 622;
	 // prize:add-by-zhongweilin-start
     // setProperty (ex:sys.prize.dualcamera) for no system permission application
     int SET_PROPERTY_FOR_EXTERNAL = IBinder.FIRST_CALL_TRANSACTION + 411;
     //prize:add-by-zhongweilin-end
    //END...
    /* prize-add-split screen-liyongli-20170809-start */
    int QQMOVE_TASK_TO_DOCKED_STACK_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 623;
    int QQRESIZE_DOCKED_STACK_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 624;
    /* prize-add-split screen-liyongli-20170809-end */    
    /* prize-add-fix 53589, add function for WMS  handleTapOutsideTask -liyongli-20180404-start */
    int PRIZE_SET_FOCUSED_TASK_TRANSACTION = IBinder.FIRST_CALL_TRANSACTION + 626;
    /* prize-add-fix 53589-liyongli-20180404-end */

    /** 
     * Added for PrizeSysResMon.apk. Prize-linkh-20180126 @{
     */
    int KILL_PROCESS = IBinder.FIRST_CALL_TRANSACTION + 630;
    int GET_OOM_ADJ_FROM_KERNEL = IBinder.FIRST_CALL_TRANSACTION + 631;
    int GET_FORE_GROUND_PKG = IBinder.FIRST_CALL_TRANSACTION + 632;
    // Added for PrizeSysResMon.apk @}
	
    /* prize-xuchunming-20170710-add circle window at screen four corners-start */
    int ON_SCREEN_ORIENT_CHANGE = IBinder.FIRST_CALL_TRANSACTION+700;
    /* prize-xuchunming-20170710-add circle window at screen four corners-end */
    /*-prize add by lihuangyuan,for notchscreen -2018-04-24-start*/
    int SHOW_NOTCH_SCREEN = IBinder.FIRST_CALL_TRANSACTION+701;
    /*-prize add by lihuangyuan,for notchscreen -2018-04-24-end*/
