...
public final class ActivityThread {
    ...
    final void handleResumeActivity(IBinder token,
        ...
        if (r != null) {
            ...
            if (localLOGV) Slog.v(
                TAG, "handleResumeActivity r.window = "  + r.window +
                      " !a.mFinished = " + !a.mFinished  +
            ...
            if (r.window == null && !a.mFinished && willBeVisible) {
                ...
                if (localLOGV) Slog.v(
                    TAG, "handleResumeActivity r.mPreserveWindow = "  + r.mPreserveWindow);
                ...
                if (localLOGV) Slog.v(
                    TAG, "handleResumeActivity r.mVisibleFromClient = "  + r.mPreserveWindow +
                     "  !a.mWindowAdded = " + !a.mWindowAdded);
    ...
    private void handleBindApplication(AppBindData data) {
        ...
        if(PrizeOption.PRIZE_APP_MULTI_INSTANCES) {
            mAppInstanceIndex = data.appInfo.appInstanceIndex;
            if(data.appInfo.appInstanceIndex > 0 && 
                PrizeAppInstanceUtils.getInstance(getSystemContext()).supportMultiInstance(data.appInfo.packageName)) {
                data.info.adjustDataDirForAppInst(data.appInfo.appInstanceIndex);
            }
        } //end....        
