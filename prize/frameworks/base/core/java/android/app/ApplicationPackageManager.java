...
public class ApplicationPackageManager extends PackageManager {
    ...
    public boolean hasSystemFeature(String name, int version) {
        if("com.oppo.feature.screen.heteromorphism".equals(name)){
            String pkg = mContext.getPackageName();
            Log.w(TAG, "com.oppo.feature.screen.heteromorphism  "+pkg );
            //+" " +mContext.getUserId()
             //,   new Throwable() );             
            if("com.youdao.dict".equals(pkg)){
                return true;
            }
            return false;
        }        
    ...
    public CharSequence getText(String packageName, @StringRes int resid,
        ...
        if (false) Log.d("PackageManager", "Query text for package: " + packageName
                        + "resid: " + resid);
		//prize liup 20161118 change icon&label start	
		CharSequence text = loadAppLabel(packageName,name);
		
        //CharSequence text = getCachedString(name);
		//prize liup 20161118 change icon&label end
        if (text != null) {
            return text;
        }
        if (appInfo == null) {
    ...
    public Drawable loadUnbadgedItemIcon(PackageItemInfo itemInfo, ApplicationInfo appInfo) {
        ...
        if (itemInfo.packageName != null) {
			//modify prize liup 20161118 start
			dr = loadAppIcon(itemInfo.packageName,itemInfo.icon, appInfo);
			
            //dr = getDrawable(itemInfo.packageName, itemInfo.icon, appInfo);
			//modify prize liup 20161118 end
        }
        if (dr == null) {
	...
	//prize liup 20161118 change icon&label start
	private CharSequence loadAppLabel(String packageName,ResourceName name) {
		if (packageName != null) {
			/*
			if(packageName.contains("com.baidu.BaiduMap")){
    			return mContext.getResources().getString(com.prize.internal.R.string.prize_baidumap);
			}else if(packageName.contains("com.andreader.prein")){
				return mContext.getResources().getString(com.prize.internal.R.string.prize_reader);
			}else if(packageName.contains("com.baidu.searchbox")){
				return mContext.getResources().getString(com.prize.internal.R.string.prize_search);
			}else if(packageName.contains("com.tencent.news")){
				return mContext.getResources().getString(com.prize.internal.R.string.prize_news);
			}else if(packageName.contains("com.tencent.reading")){
				return mContext.getResources().getString(com.prize.internal.R.string.prize_yidian);
			}else */
			if(packageName.contains("sogou.mobile.explorer.koobee")){
				return mContext.getResources().getString(com.prize.internal.R.string.prize_sogou_browser);
			//}if(packageName.equals("com.tencent.qqlive")){
			//	return mContext.getResources().getString(com.prize.internal.R.string.prize_tencent_vedio);
			}else return getCachedString(name);
		}
		return null;
	}
    private Drawable loadAppIcon(String packageName,int icon,ApplicationInfo appInfo) {
        if (packageName != null) {
			/* prize-midify-by-lijimeng-for bugid 44730-20171207-start*/
    		if(packageName.contains("com.android.dialer")){
    			return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_phone);
			}else if(packageName.contains("com.android.mms")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_sms);
			}else if(packageName.contains("sogou.mobile.explorer.koobee")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_sogou_browser);
			}else if(packageName.contains("com.android.browser")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_browser);
			}else if(packageName.contains("com.mediatek.camera")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_camera);
			}else if(packageName.contains("com.android.calendar")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_calendar);
			}else if(packageName.contains("com.android.deskclock")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_clock);
			}else if(packageName.contains("com.prize.weather")){
			    return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_weather);
			}else if(packageName.contains("com.android.settings")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_settings);
			}else if(packageName.contains("com.android.gallery3d")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_gallery);
			// }else if(packageName.contains("com.baidu.BaiduMap")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_baidumap);
			}else if(packageName.contains("com.prize.music")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_music);
			}else if(packageName.contains("com.prize.videoc")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_videoc);
			// }else if(packageName.contains("com.tencent.reading")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_yidian);
			// }else if(packageName.contains("com.andreader.prein")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_reader);
			// }else if(packageName.contains("com.baidu.searchbox")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_search);
			}else if(packageName.contains("com.android.fmradio")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_fmradio);
			}else if(packageName.contains("com.android.soundrecorder")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_record);
			}else if(packageName.contains("com.android.contacts")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_contacts);
			}else if(packageName.contains("com.android.notepad")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_memo);
			}else if(packageName.contains("com.android.calculator2")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_calculator);
			}else if(packageName.contains("com.android.providers.downloads.ui")){//com.android.documentsui
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_download);
			}else if(packageName.contains("com.android.stk")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_simtoolkit);
			}else if(packageName.contains("com.prize.lockscreen")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_cocolocker);
			}else if(packageName.contains("com.android.email")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_email);
			}else if(packageName.contains("com.prize.compass")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_compass);
			}else if(packageName.contains("com.assistant.icontrol")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_icontrol);
			// }else if(packageName.contains("com.tencent.qqpimsecure")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_shoujiguanjia);
			}else if(packageName.contains("com.android.utk")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_uim);
			// }else if(packageName.contains("com.tencent.news")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_news);
			}else if(packageName.contains("com.prize.appcenter")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_androidmarket);
			}else if(packageName.contains("com.pr.scuritycenter")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_mobilesafe);
			}else if(packageName.contains("com.nqmobile.live.base")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_nqmobile);
			}else if(packageName.contains("com.koobee.koobeecenter02")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_koobee02);
			}else if(packageName.contains("com.mediatek.filemanager")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_folder);
			// }else if(packageName.contains("com.qiyi.video")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_iqy);
			// }else if(packageName.contains("com.ss.android.article.news")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_jinritoutiao);
			// }else if(packageName.contains("com.sankuai.meituan")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_meituan);
			// }else if(packageName.contains("com.duomi.android")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_duomi);
			// }else if(packageName.contains("sogou.mobile.explorer")){
				// return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_browser);
			}else if(packageName.contains("com.prize.prizethemecenter")){
				return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_nqmobile);
			//}else if(packageName.equals("com.tencent.qqlive")){
				//return mContext.getResources().getDrawable(com.prize.internal.R.drawable.prize_videoc);
			}else return getDrawable(packageName, icon, appInfo);
			/* prize-midify-by-lijimeng-for bugid 44730-20171207-start*/
        }
        return null;
    }
