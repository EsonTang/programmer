...
public abstract class ActivityManagerNative extends Binder implements IActivityManager
{
    ...
    public boolean onTransact(int code, Parcel data, Parcel reply, int flags)
        ...
        case QQMOVE_TASK_TO_DOCKED_STACK_TRANSACTION: {
            data.enforceInterface(IActivityManager.descriptor);
            int taskId = data.readInt();
            int createMode = data.readInt();
            boolean toTop = data.readInt() != 0;
            ...
            final boolean moveHomeStackFront = data.readInt() != 0;
            final boolean res = QQmoveTaskToDockedStack(
                    taskId, createMode, toTop, animate, bounds, moveHomeStackFront);
            reply.writeNoException();
            reply.writeInt(res ? 1 : 0);
            return true;
        ...
        /* prize-add-split screen-liyongli-20170809-start */
        case QQRESIZE_DOCKED_STACK_TRANSACTION: {
            data.enforceInterface(IActivityManager.descriptor);
            final boolean hasBounds = data.readInt() != 0;
            Rect bounds = null;
            if (hasBounds) {
            ...
            QQresizeDockedStack(bounds, tempDockedTaskBounds, tempDockedTaskInsetBounds,
                    tempOtherTaskBounds, tempOtherTaskInsetBounds);
            reply.writeNoException();
            return true;
        }
        ...
        /*prize-add dump kill flag-liufan-2016-04-28-start*/
        case QS_CLEANUP_DUMP_STATE: {
            data.enforceInterface(IActivityManager.descriptor);
            boolean isDumpKill = data.readInt() != 0;
            setDumpKill(isDumpKill);
            reply.writeNoException();
            return true;
        }
        /*prize-add dump kill flag-liufan-2016-04-28-end*/
        ...
        case GET_APP_INSTANCE_INDEX: {
            data.enforceInterface(IActivityManager.descriptor);
            int appInst = getAppInstanceIndex(data.readInt());
            reply.writeNoException();
            reply.writeInt(appInst);
            return true;
        }
        case FORCE_STOP_PACKAGE_FOR_APP_INSTANCE: {
            data.enforceInterface(IActivityManager.descriptor);
            String packageName = data.readString();
            int appInst = data.readInt();
            int userId = data.readInt();
            forceStopPackage(packageName, appInst, userId);
            reply.writeNoException();
            return true;
        }
        case SET_ENABLE_MULTI_INSTANCE_MODE: {
            data.enforceInterface(IActivityManager.descriptor);
            String packageName = data.readString();
            boolean enabled = (data.readInt() == 1) ? true : false;
            int userId = data.readInt();
            setEnableMultiInstanceMode(packageName, enabled, userId);
            reply.writeNoException();
            return true;
        }        
        //end.....

        // Added for PrizeSysResMon.apk. Prize-linkh-20180126 @{
        case KILL_PROCESS: {
            data.enforceInterface(IActivityManager.descriptor);
            killProcess(data.createIntArray());
            reply.writeNoException();
            return true;
        }
        case GET_OOM_ADJ_FROM_KERNEL: {
            data.enforceInterface(IActivityManager.descriptor);
            int[] adjs = getOomAdjFromKernel(data.createIntArray());
            reply.writeNoException();
            reply.writeIntArray(adjs);
            return true;

        }
        case GET_FORE_GROUND_PKG: {
            data.enforceInterface(IActivityManager.descriptor);
            List<String> pkgs = getFgPackages();
            reply.writeNoException();
            reply.writeStringList(pkgs);
            return true;

        }
        // Added for PrizeSysResMon.apk @}

        /* PrizeDebugTool: dynamically adjust min free of LMK. prize-linkh-20160923 */
        case GET_OOM_ADJ_OF_LMK: {
            data.enforceInterface(IActivityManager.descriptor);
            int[] oomAdj = getOomAdjOfLMK();
            reply.writeNoException();
            reply.writeIntArray(oomAdj);
            return true;
        }
        case GET_MIN_FREE_OF_LMK: {
            data.enforceInterface(IActivityManager.descriptor);
            int[] minfree = getMinfreeOfLMK();
            reply.writeNoException();
            reply.writeIntArray(minfree);
            return true;
        }
        case SET_MIN_FREE_OF_LMK: {
            data.enforceInterface(IActivityManager.descriptor);
            setMinfreeOfLMK(data.createIntArray());
            reply.writeNoException();
            return true;
        }        
        /* prize-add-fix 53589, add function for WMS  handleTapOutsideTask -liyongli-20180404-start */
        case PRIZE_SET_FOCUSED_TASK_TRANSACTION: {
            data.enforceInterface(IActivityManager.descriptor);
            int taskId = data.readInt();
            prizeTapOutsideTask_setFocusedTask(taskId);
            reply.writeNoException();
            return true;
        }
        /* prize-add-fix 53589 -liyongli-20180404-end */
            
		 // prize:add-by-zhongweilin-start
        // setProperty (ex:sys.prize.dualcamera) for no system permission application
 	    case SET_PROPERTY_FOR_EXTERNAL: {
             data.enforceInterface(IActivityManager.descriptor);
 	        String key = data.readString();
 	        String value = data.readString();
             setPropertyForExternal(key, value);
             reply.writeNoException();
             return true;
         }
     	//prize:add-by-zhongweilin-end 
	    /* prize-xuchunming-20170710-add circle window at screen four corners-start */
	    case ON_SCREEN_ORIENT_CHANGE: {
	    	 int screenWidth = data.readInt();
	    	 int screenHeight = data.readInt();
               int rotation = data.readInt();
	    	 screenOrientChange(screenWidth, screenHeight,rotation);
	         reply.writeNoException();
             return true;
        }
        ...
        case SHOW_NOTCH_SCREEN:
            {
                data.enforceInterface(IActivityManager.descriptor);
                boolean isshow = (data.readInt() == 1) ? true : false;                
                showNotchScreen(isshow);
                reply.writeNoException();
                return true;
            }
...
class ActivityManagerProxy implements IActivityManager
{
    ...
    /* prize-add-split screen-liyongli-20170809-start */
    @Override
    public boolean QQmoveTaskToDockedStack(int taskId, int createMode, boolean toTop, boolean animate,
            Rect initialBounds, boolean moveHomeStackFront) throws RemoteException
    {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        ...
        data.writeInt(moveHomeStackFront ? 1 : 0);
        mRemote.transact(QQMOVE_TASK_TO_DOCKED_STACK_TRANSACTION, data, reply, 0);
        reply.readException();
        boolean res = reply.readInt() > 0;
        data.recycle();
        reply.recycle();
    ...
    /* prize-add-split screen-liyongli-20170809-start */
    @Override
    public void QQresizeDockedStack(Rect dockedBounds, Rect tempDockedTaskBounds,
            Rect tempDockedTaskInsetBounds,
            Rect tempOtherTaskBounds, Rect tempOtherTaskInsetBounds)
            throws RemoteException
    {
        ...
        mRemote.transact(QQRESIZE_DOCKED_STACK_TRANSACTION, data, reply, 0);
        reply.readException();
        data.recycle();
        reply.recycle();
    }
    ...
    /*prize-add dump kill flag-liufan-2016-04-28-start*/
    public void setDumpKill(boolean isDumpKill)
            throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeInt(isDumpKill ? 1 : 0);
        mRemote.transact(QS_CLEANUP_DUMP_STATE, data, reply, 0);
        reply.readException();
        data.recycle();
        reply.recycle();
    }
    ...
    /* app multi instances feature. prize-linkh-20151207 */
    @Override
    public int getAppInstanceIndex(int pid)  throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeInt(pid);
        mRemote.transact(GET_APP_INSTANCE_INDEX, data, reply, 0);
        reply.readException();
        int appInst = reply.readInt();
        data.recycle();
        reply.recycle();
        return appInst;
    }
    ...
    @Override
    public void forceStopPackage(final String packageName, int appInst, int userId) throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeString(packageName);
        data.writeInt(appInst);
        data.writeInt(userId);
        mRemote.transact(FORCE_STOP_PACKAGE_FOR_APP_INSTANCE, data, reply, 0);
        reply.readException();
        data.recycle();
        reply.recycle();
    }
    ...
    @Override
    public void setEnableMultiInstanceMode(final String packageName, boolean enabled, int userId) throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeString(packageName);
        data.writeInt(enabled ? 1 : 0);
        data.writeInt(userId);        
        mRemote.transact(SET_ENABLE_MULTI_INSTANCE_MODE, data, reply, 0);
        reply.readException();
        data.recycle();
        reply.recycle();
    }    
    ...
    /* PrizeDebugTool: dynamically adjust min free of LMK. prize-linkh-20160923 */
    public int[] getOomAdjOfLMK() throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        mRemote.transact(GET_OOM_ADJ_OF_LMK, data, reply, 0);
        reply.readException();
        int[] res = reply.createIntArray();        
        data.recycle();
        reply.recycle();
        return res;
    }
    
    public int[] getMinfreeOfLMK() throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        mRemote.transact(GET_MIN_FREE_OF_LMK, data, reply, 0);
        reply.readException();
        int[] res = reply.createIntArray();
        data.recycle();
        reply.recycle();
    ...
    public void setMinfreeOfLMK(int[] minfree) throws RemoteException {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeIntArray(minfree);
        mRemote.transact(SET_MIN_FREE_OF_LMK, data, reply, 0);
        reply.readException();
        data.recycle();
        reply.recycle();
    }
    ...
    // Added for PrizeSysResMon.apk. Prize-linkh-20180126 @{
    @Override
    public void killProcess(int[] pids) throws RemoteException {
        ...
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeIntArray(pids);
        mRemote.transact(KILL_PROCESS, data, reply, 0);
        reply.readException();
        data.recycle();
        reply.recycle();
    }
    ...
    @Override
    public int[] getOomAdjFromKernel(int[] pids) throws RemoteException {
        if (pids == null || pids.length < 1) {
        ...
        data.writeInterfaceToken(IActivityManager.descriptor);        
        data.writeIntArray(pids);
        mRemote.transact(GET_OOM_ADJ_FROM_KERNEL, data, reply, 0);
        reply.readException();
        int[] adjs = reply.createIntArray();
        data.recycle();
        reply.recycle();
        return adjs;
    ...
    @Override
    public List<String> getFgPackages() throws RemoteException {            
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);        
        mRemote.transact(GET_FORE_GROUND_PKG, data, reply, 0);
        reply.readException();
        ArrayList<String> list
        = reply.createStringArrayList();
        data.recycle();
        reply.recycle();
        return list;
    }
    ...
    /* prize-add-fix 53589, add function for WMS  handleTapOutsideTask -liyongli-20180404-start */
    @Override
    public void prizeTapOutsideTask_setFocusedTask(int taskId) throws RemoteException
    {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);
        data.writeInt(taskId);
        mRemote.transact(PRIZE_SET_FOCUSED_TASK_TRANSACTION, data, reply, 0);
        reply.readException();
        data.recycle();
        reply.recycle();
    }
    /* prize-add-fix 53589 -liyongli-20180404-end */
	 ...
	 // prize:add-by-zhongweilin-start
     // setProperty (ex:sys.prize.dualcamera) for no system permission application
     public void setPropertyForExternal(String key, String value) throws RemoteException {
         Log.v("prize_zwl","[DoubleCamera] ActivityManagerNative setPropertyForExternal-->start");
 	    Parcel data = Parcel.obtain();
         Parcel reply = Parcel.obtain();
         data.writeInterfaceToken(IActivityManager.descriptor);
         data.writeString(key);
 	    data.writeString(value);
         mRemote.transact(SET_PROPERTY_FOR_EXTERNAL, data, reply, 0);
         reply.readException();
         data.recycle();
         reply.recycle();
         Log.v("prize_zwl","[DoubleCamera] ActivityManagerNative setPropertyForExternal-->end");
     }
     //prize:add-by-zhongweilin-end

    /* prize-xuchunming-20170710-add circle window at screen four corners-start */
    @Override
    public void screenOrientChange(int screenWidth, int screenHeight,int rotation) throws RemoteException {
    	...
    	// TODO Auto-generated method stub
          ...
          mRemote.transact(ON_SCREEN_ORIENT_CHANGE, data, reply, 0);
          reply.readException();
          data.recycle();
          reply.recycle();
    }
    ...
    /*-prize add by lihuangyuan,for notchscreen -2018-04-24-start*/
    @Override
    public void showNotchScreen(boolean isshow) throws RemoteException
    {
        Parcel data = Parcel.obtain();
        Parcel reply = Parcel.obtain();
        data.writeInterfaceToken(IActivityManager.descriptor);       
        data.writeInt(isshow ? 1 : 0);  
        mRemote.transact(SHOW_NOTCH_SCREEN, data, reply, 0);
        reply.readException();
        data.recycle();
        reply.recycle();
    }
