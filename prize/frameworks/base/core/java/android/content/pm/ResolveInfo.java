...
public class ResolveInfo implements Parcelable {
    ...
    /** 
    * zero represents the orignal app.
    * @hide 
    */
    ...
    public void dump(Printer pw, String prefix, int flags) {
        ...
        /* app multi instances feature. prize-linkh-20151027 */
        if(PrizeAppInstanceUtils.DUMP_APP_INST && appInstanceIndex > 0) {
            pw.println(prefix + "aii=" + appInstanceIndex);
        } //end...
    ...
    public ResolveInfo(ResolveInfo orig) {
        ...
        /* app multi instances feature. prize-linkh-20151027 */
        appInstanceIndex = orig.appInstanceIndex;
    }
    ...
    public String toString() {
        ...
        /* app multi instances feature. prize-linkh-20151027 */
        if(PrizeAppInstanceUtils.DUMP_APP_INST && appInstanceIndex > 0) {
            sb.append(" aii=" + appInstanceIndex);
        } //end...
