...
public class ApplicationInfo extends PackageItemInfo implements Parcelable {
     ...
     * {@hide}
     */
    public static final int FLAG_IS_PREBUILT_THIRD_APPS = 1 << 0;
    /** {@hide} */
    public int prizeFlags = 0;
    /** {@hide} */
    public boolean  isPrebuiltThirdApp() {
        return (prizeFlags & FLAG_IS_PREBUILT_THIRD_APPS) != 0;
    }    
    //end.......
    ...
    public void dump(Printer pw, String prefix, int flags) {
        ...
        // add for conveniently managing third apps that are prebuilt in system. prize-linkh-20160525
        if(prizeFlags != 0) {
            pw.println(prefix + "prizeFlags=0x" + Integer.toHexString(prizeFlags));
        } //end...
        if ((flags&DUMP_FLAG_DETAILS) != 0) {
    ...
    /**
     * M: for checking /vendor/operator/app or /cutomer/app
     * @hide
     */
    public boolean isVendorApp() {
        return (flagsEx & ApplicationInfo.FLAG_EX_OPERATOR) != 0;
    }
