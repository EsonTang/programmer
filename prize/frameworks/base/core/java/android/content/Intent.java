...
public class Intent implements Parcelable, Cloneable {
   ...
   /**
     ...
     */
    @SdkConstant(SdkConstantType.BROADCAST_INTENT_ACTION)
    public static final String ACTION_INTO_POWER_SAVER = "android.intent.action.INTO_POWER_SAVER";
    public static final String ACTION_QUIT_POWER_SAVER = "android.intent.action.QUIT_POWER_SAVER";
    ...
    /* app multi instances feature. prize-linkh-20151110 */
    private int appInstanceIndex = -1; //must be low than zero when initialized!!!
    private boolean shouldGenVirtualInfoForAppInstances = false;
    private static final boolean SHOULD_SAVE_APP_INST_INFO = true;
    /** @hide */
    public static final String SELECT_APP_INST_INTENT = "prize.intent.select.app.inst";    
    /** @hide */
    public static final String EXTRA_APP_INST_PKG_NAME = "appInst_pkgName";
    /** @hide */
    public static final String EXTRA_APP_INST_INTENT = "appInst_intent";
    /** @hide */
    public static final String EXTRA_FROM_RESOLVER_ACTIVITY = "from_resolver_act";    
    //end...
    /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-start*/
    private int intentFromSource = 0;
    /** @hide */
    public static final int FROM_SYSTEMUI_NOTIFICATION = 0x00000001;
    /** @hide */
    public static final int FROM_WIDGET = 0x00000002;
    /** @hide */
    public static final int FROM_ACTIVITY = 0x00000004;
    ...
    public Intent(Intent o) {
        ...
        /* app multi instances feature. prize-linkh-20151110 */
        this.appInstanceIndex = o.appInstanceIndex;
        this.shouldGenVirtualInfoForAppInstances = o.shouldGenVirtualInfoForAppInstances;
        //end...
        /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-start*/
	 this.intentFromSource = o.intentFromSource;
	 /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-end*/
    }
    ...
    public static Intent parseUri(String uri, int flags) throws URISyntaxException {
        ...
        try {
            ...
            while (i >= 0 && !uri.startsWith("end", i)) {
                ...
                /* app multi instances feature. prize-linkh-20151216 */
                else if(SHOULD_SAVE_APP_INST_INFO && uri.startsWith("appInstIdx=", i)) {
                    intent.appInstanceIndex = Integer.decode(value).intValue();
                }
                //end...
    ...
    /* app multi instances feature. prize-linkh-20151110 */
    /** {@hide} */
    public void setAppInstanceIndex(int index) {
        if(index < 0 && index != -1) {
            return;
        }

        appInstanceIndex = index;
    }
    ...
    /** {@hide} */
    public void setGenInfoForAppInstances(boolean needed) {
        shouldGenVirtualInfoForAppInstances = needed;
    }

    /** {@hide} */
    public boolean shouldGenInfoForAppInstances() {
        return shouldGenVirtualInfoForAppInstances;
    }        
    //end...
    /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-start*/
    /** {@hide} */
    public void setIntentFromSource(int intentsource) {
        intentFromSource = intentsource;
    } 
    /** {@hide} */
    public int getIntentFromSource()
    {
    	return intentFromSource;
    }
    /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-end*/
    ...
    public void toShortString(StringBuilder b, boolean secure, boolean comp, boolean extras,
        ...
        /* app multi instances feature. prize-linkh-20151216 */
        if(android.util.PrizeAppInstanceUtils.DUMP_APP_INST && appInstanceIndex != -1) {
            if (!first) {
                b.append(' ');
            }
            first = false;            
            b.append("aii=").append(appInstanceIndex);
        } //end...
    ...
    private void toUriInner(StringBuilder uri, String scheme, String defAction,
        ...
        /* app multi instances feature. prize-linkh-20151216 */
        if(SHOULD_SAVE_APP_INST_INFO) {
            uri.append("appInstIdx=").append(appInstanceIndex).append(';');
        }
        //end...
    ...
    public void writeToParcel(Parcel out, int flags) {
        ...
        /* app multi instances feature. prize-linkh-20151110 */
        out.writeInt(appInstanceIndex);
        out.writeInt(shouldGenVirtualInfoForAppInstances ? 1 : 0);
        //end....
        /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-start*/
	 out.writeInt(intentFromSource);
	 /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-end*/
        if (mSourceBounds != null) {
            out.writeInt(1);
    ...
    public void readFromParcel(Parcel in) {
        ...
        /* app multi instances feature. prize-linkh-20151110 */
        appInstanceIndex = in.readInt();
        shouldGenVirtualInfoForAppInstances = in.readInt() == 1 ? true : false;
        //end...
        /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-start*/
	 intentFromSource = in.readInt();
	 /*prize-add by lihuangyuan,for fingerapplock-2017-07-04-end*/
        if (in.readInt() != 0) {
    ...
    public void prepareToLeaveProcess(Context context) {
        /*prize-modify by lihuangyuan,for applock 2017-10-23-start*/
        final boolean leavingPackage = (mComponent == null)
                || (!Objects.equals(mComponent.getPackageName(), context.getPackageName()) && !Objects.equals(context.getPackageName(),"com.prize.applock.fingerprintapplock"));
        /*prize-modify by lihuangyuan,for applock 2017-10-23-end*/
