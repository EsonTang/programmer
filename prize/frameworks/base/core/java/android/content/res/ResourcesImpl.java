...
public class ResourcesImpl {
	...
	private String[]whitePackageName = {"com.android.settings","com.android.dialer",
										"com.android.contacts","com.android.mms","com.android.lpserver",
										"com.koobee.koobeecenter02","com.android.providers.media",
										"com.android.phone"};
	private String mPrizeCurrentLanguage = "zh_CN";	
	...
	/* prize-add-by-lijimeng-for fontsize-20180522-start*/
    private final DisplayMetrics mPrizeMetrics = new DisplayMetrics();
	private final Configuration mPrizeConfig = new Configuration();
	 private final DisplayAdjustments mPrizeDisplayAdjustments;
	/* prize-add-by-lijimeng-for fontsize-20180522-end*/
    ...
    public ResourcesImpl(@NonNull AssetManager assets, @Nullable DisplayMetrics metrics,
		...
		/* prize-add-by-lijimeng-for fontsize-20180522-start*/
		mPrizeMetrics.setToDefaults();
		mPrizeDisplayAdjustments = displayAdjustments;
		/* prize-add-by-lijimeng-for fontsize-20180522-end*/
    ...
    public DisplayAdjustments getDisplayAdjustments() {
		/* prize-add-by-lijimeng-for fontsize-20180522-start*/
		if(isLargest()){
			return mPrizeDisplayAdjustments;
		}
		/* prize-add-by-lijimeng-for fontsize-20180522-end*/
        ...
        try {
            synchronized (mAccessLock) {
                ...
                if (compat != null) {
					...
					/* prize-add-by-lijimeng-for fontsize-20180522-start*/
                    mPrizeDisplayAdjustments.setCompatibilityInfo(compat);
					/* prize-add-by-lijimeng-for fontsize-20180522-end*/
                }
                if (metrics != null) {
                    mMetrics.setTo(metrics);
					/* prize-add-by-lijimeng-for fontsize-20180522-start*/
                    mPrizeMetrics.setTo(mMetrics);
					/* prize-add-by-lijimeng-for fontsize-20180522-end*/
                }
				...
				/* prize-add-by-lijimeng-for fontsize-20180522-start*/
                mPrizeDisplayAdjustments.getCompatibilityInfo().applyToDisplayMetrics(mPrizeMetrics);
				/* prize-add-by-lijimeng-for fontsize-20180522-end*/
				...
				/* prize-add-by-lijimeng-for fontsize-20180522-start*/
                mPrizeMetrics.scaledDensity = mPrizeMetrics.density * 1.70f;
				/* prize-add-by-lijimeng-for fontsize-20180522-end*/
			...
			/* prize-add-by-lijimeng-for fontsize-20180522-start*/
			Locale prizeLocale = mConfiguration.getLocales().get(0);
			if(prizeLocale != null){
				mPrizeCurrentLanguage = prizeLocale.toString();
			}
			/* prize-add-by-lijimeng-for fontsize-20180522-end*/
        } finally {
    ...
    public @Config int calcConfigChanges(@Nullable Configuration config) {
		...
		/* prize-add-by-lijimeng-for fontsize-20180522-start*/
		mPrizeConfig.setTo(mTmpConfig);
		mPrizeConfig.fontScale = 1.70f;
		mPrizeDisplayAdjustments.getCompatibilityInfo().applyToConfiguration(density, mPrizeConfig);
		/* prize-add-by-lijimeng-for fontsize-20180522-end*/
	...
	private boolean isLargest(){
		...
		if(whitePackageName!= null && currentPackageName != null && isPrizeFontSize && !(mPrizeCurrentLanguage.equals("en_US"))){
			for(String packageName : whitePackageName){
