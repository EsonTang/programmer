...
public abstract class DisplayManagerInternal {
    ...
    /**
    * powermanagerservice tell displaymanagerservice the reason of wakeup
    *@hide
    */
    public abstract void setWakeupReason(int reason);
    /**
    * powermanagerservice tell displaymanagerservice turn screen on now
    *@hide
    */
    public abstract void turnOnScreenNow();
    /**
    * powermanagerservice get wakeupreason
    *@hide
    */
    public abstract int   wakeupReason();
    /**
    * powermanagerservice rewakeup turn screen now
    *@hide
    */
    public abstract void rewakeupTurnOnScreenNow();
