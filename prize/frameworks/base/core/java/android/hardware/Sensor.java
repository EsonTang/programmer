...
public final class Sensor {
     ...
     * @hide
     */
    public static final int TYPE_FLOOR_COUNT = 46;
    /**
     * @hide
     */
     ...
     * @hide
     */
    public static final int TYPE_PRESSURE_UNCALIBRATED = 50;
    /**
     * @hide
     */
    public static final String STRING_TYPE_PRESSURE_UNCALIBRATED =
      "android.sensor.pressure_uncalibrated";
    ...
    private static final int[] sSensorReportingModes = {
            ...
            1, // reserved
            1, // STRING_TYPE_FLOOR_COUNT
            1, // reserved
            1, // reserved
            1, // reserved
            3  // STRING_TYPE_PRESSURE_UNCALIBRATED
    };
     ...
     * <ul>
     * <li>Either unregister from the sensors when they do not need them, usually in the activity
    ...
    private boolean setType(int value) {
        ...
        switch (mType) {
            ...
            case TYPE_DYNAMIC_SENSOR_META:
                ...
                return true;
            case TYPE_FLOOR_COUNT:
                mStringType = STRING_TYPE_FLOOR_COUNT;
                return true;
            case TYPE_PRESSURE_UNCALIBRATED:
                mStringType = STRING_TYPE_PRESSURE_UNCALIBRATED;
                return true;
            default:
                return false;
        }
