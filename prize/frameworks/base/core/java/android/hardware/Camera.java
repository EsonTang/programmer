...
/*modify for bugid:55742 system monkey Crash camera java util ConcurrentModificationException-xiaoping-20180523-start*/
import java.util.concurrent.ConcurrentHashMap;
/*modify for bugid:55742 system monkey Crash camera java util ConcurrentModificationException-xiaoping-20180523-end*/
...
/*prize-xuchunming-20180620-bugid:62789-start*/
import android.widget.Toast;
/*prize-xuchunming-20180620-bugid:62789-end*/
...
public class Camera {
	...
	/*prize-xuchunming-20180620-bugid:62789-start*/
	private static final int CAMERA_MSG_SPANMODE_WARNING = 0x1000;
	/*prize-xuchunming-20180620-bugid:62789-end*/
    //!++
                ...
                case MTK_CAMERA_MSG_EXT_NOTIFY_METADATA_DONE:
                    if (mEnableRaw16) {
                        try {
                            ...
                            getMetadata(resultMeta, characteristicMeta);
                            //
                            CaptureResult result = new CaptureResult(resultMeta, 0);
                            CameraCharacteristics characteristic = new CameraCharacteristics(
                                characteristicMeta);
                            //
...
*/
                ...
                return;
			/*prize-xuchunming-20180620-bugid:62789-start*/
		    case CAMERA_MSG_SPANMODE_WARNING:
				try {
					Toast.makeText(ActivityThread.currentApplication(),ActivityThread.currentApplication().getResources().getString(com.prize.internal.R.string.clone_app_wenxin_camera_waringinfo), Toast.LENGTH_SHORT).show();
...
/*        if (!"1".equals(SystemProperties.get("ro.mtk_bsp_package"))) {
    ...
    */
        ...
        */
        ...
        private Parameters() {
            mMap = new ConcurrentHashMap<String, String>(128);
        }
        ...
        public Parameters copy() {
            ...
            para.mMap = new ConcurrentHashMap<String, String>(mMap);
			/*modify for bugid:55742 system monkey Crash camera java util ConcurrentModificationException-xiaoping-20180523-end*/
            return para;
        }
         /**
        ...
        public String flatten() {
            ...
            for (String k : mMap.keySet()) {
                ...
                flattened.append(";");
				/*add for bugid:57717 list all preview-size */
				if("preview-size-values".equals(k)) {
					Log.e(TAG, "preview-size-values: "+mMap.get(k));
				}
            }
    ...
    */
    ...
    /*prize-xuchunming-20180620-bugid:62789-start*/
	public boolean prizeLimitCameraOpen(){
		if(isSplitScreenMode() && ActivityThread.currentOpPackageName().equals("com.tencent.mm")){
			
			Log.d(TAG,"tencent.mm show waring info :Camera Open is not allowed at split screen mode");
			try {
				mEventHandler.sendEmptyMessage(CAMERA_MSG_SPANMODE_WARNING);
	...
	public boolean isSplitScreenMode(){
	    if(SystemProperties.getInt("persist.split.stack", 0)==1){
			Log.d(TAG, "isSplitScreenMode return true");
			return true;
		}else{
			return false;
		}
