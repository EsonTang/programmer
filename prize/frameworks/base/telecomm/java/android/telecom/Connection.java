...
public abstract class Connection extends Conferenceable {
     ...
     * @hide
     */
    public static final int CAPABILITY_VIDEO_RINGTONE = 0x40000000;
    /// @}
    //**********************************************************************************************
    // Next CAPABILITY value: 0x80000000
    //**********************************************************************************************
    ...
    private static String capabilitiesToStringInternal(int capabilities, boolean isLong) {
       ...
       /// M: For video ringtone @{
        if ((capabilities & CAPABILITY_VIDEO_RINGTONE) != 0) {
    ...
    protected FormattedLog.Builder configDumpLogBuilder(FormattedLog.Builder builder) {
        ...
        if (mAddress != null) {
            builder.setCallNumber(Rlog.pii(SDBG, mAddress.getSchemeSpecificPart()));
        }
        /// @}
