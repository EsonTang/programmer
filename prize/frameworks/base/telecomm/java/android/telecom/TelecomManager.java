...
public class TelecomManager {
    ...
    */
    ...
    public String getSystemDialerPackage() {
        try {
            if (isServiceConnected()) {
                /// M: Monkey test would seldom crash here for unknown reason.
                /// Error handling and leave enough log for reproduce @{
                ITelecomService telecomService = getTelecomService();
                if (telecomService == null) {
                    Slog.wtf(TAG,
                            "TelecomService disappear unexpected!!! " +
                            "mTelecomServiceOverride = " + mTelecomServiceOverride +
                            ", Context.getSystemService: " + mContext.getSystemService(
                ...
                return telecomService.getSystemDialerPackage();
                /// @}
            }
        } catch (RemoteException e) {
