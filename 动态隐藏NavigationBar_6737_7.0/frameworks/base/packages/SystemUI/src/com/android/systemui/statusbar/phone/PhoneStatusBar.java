...
import java.text.NumberFormat;  //jty added for battery percent
...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    //jty added for battery percent start
    ...
    //jty added for battery percent end
    ...
    // ================================================================================
    private TextView mBatteryLevel;//jty added for battery percent
    ...
    protected PhoneStatusBarView makeStatusBarView() {
        ...
        mBatteryLevel = (TextView) mStatusBarView.findViewById(R.id.battery_level);//jty added for battery percent
...
//longliang start
    View.OnTouchListener mHideNavBarTouchListener = new View.OnTouchListener() {
        public boolean onTouch(View v, MotionEvent event) {
    ...
    private View.OnClickListener mHideNavBarClickListener = new View.OnClickListener() {
        public void onClick(View v) {
			awakenDreams();
			removeNavigationBar();
        }
    ...
    private void prepareNavigationBarView(boolean forceReset) {  
        ...
        //for jty screen shot start
        ButtonDispatcher screenShotButton = mNavigationBarView.getScreenShotButton();
        //for jty screen shot end

        mNavigationBarView.getHideNavBarButton().setOnClickListener(mHideNavBarClickListener);//longliang
        ...
        if (forceReset) {  
           ...
           mNavigationBarMode = 0;  
            ...
            setSystemUiVisibility(newVal, 0,0,/*SYSTEM_UI_VISIBILITY_MASK*/0xffffffff,mLastFullscreenStackBounds, mLastDockedStackBounds);  
    ...
    private void addNavigationBar(boolean forceReset) {
        ...
        mNavigationBarView.getVolumeUpButton().setVisibility(isLand ? View.VISIBLE : View.GONE);
        mNavigationBarView.getVolumeDownButton().setVisibility(isLand ? View.VISIBLE : View.GONE);
    }
//longliang end 
    ...
    private BroadcastReceiver mBroadcastReceiver = new BroadcastReceiver() {
        public void onReceive(Context context, Intent intent) {
            ...
            }else if(KEY_OPEN_BATTERY_LEVEL.equals(action)){ //jty added for battery percent start
