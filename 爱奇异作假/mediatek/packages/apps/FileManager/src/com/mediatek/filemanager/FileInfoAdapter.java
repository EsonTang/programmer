...
//lqh : fake storage size
    private static final String DATA_DIRECTORY = "/data";
    private static final String EXTERNAL_SD0_DIRECTORY = "/storage/sdcard0";
//lqh : fake storage size end
...
//lqh : fake storage size
		...
		long tempUserSpace = (long)fileInfo.getFile().getTotalSpace() - (long)fileInfo.getFile().getFreeSpace();
               // long freeSpace = (long)(fileInfo.getFile().getFreeSpace() * JTY_ROM_MULTIPLE);
		long freeSpace = (long)(fileInfo.getFile().getTotalSpace() * JTY_ROM_MULTIPLE) - tempUserSpace;
                String freeSpaceString = FileUtils.sizeToString(freeSpace);
                long totalSpace = (long)(fileInfo.getFile().getTotalSpace() * JTY_ROM_MULTIPLE);
