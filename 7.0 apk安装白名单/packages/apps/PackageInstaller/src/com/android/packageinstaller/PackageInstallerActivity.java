...
public class PackageInstallerActivity extends Activity implements OnCancelListener, OnClickListener {
	...
	private static final int DLG_INSTALL_LIMIT = DLG_BASE + 10;//longliang 
    ...
    public Dialog onCreateDialog(int id, Bundle bundle) {
        ...
        case DLG_PACKAGE_ERROR :
            return new AlertDialog.Builder(this)
                    ...
                    .create();
//longliang 
        case DLG_INSTALL_LIMIT :
            return new AlertDialog.Builder(this)
                    .setTitle(R.string.Parse_limit_dlg_title)
                    .setMessage(R.string.Parse_limit_dlg_text)
                    .setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            finish();
                        }
...
//longliang 
        try {
            pkgInfo = mPm.getPackageInfo(packageUri.getSchemeSpecificPart(),
		...
		if(pkgInfo != null){
			if(pkgInfo.packageName.indexOf("tongyi.edu") != -1 ||
				pkgInfo.packageName.indexOf("clovsoft.tongyi.teacher") != -1 ||
					pkgInfo.packageName.indexOf("clovsoft.tongyi.student") != -1){
				//allow installation
			}else{
	            showDialogInner(DLG_INSTALL_LIMIT);
