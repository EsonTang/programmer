...
#define FAST_CHARGING_NUM_PERCENT_INDEX   56
	...
	// wqxga 1600*2560
	// battery capacity rectangle
	#define CAPACITY_LEFT                (556+80) // battery capacity center
	#define CAPACITY_TOP                 (1112+3)
	#define CAPACITY_RIGHT               (882+80)
	#define CAPACITY_BOTTOM              (1630+3)

	// first number rectangle
	#define NUMBER_LEFT                  (570+80) // number
	#define NUMBER_TOP                   (770+3)
	#define NUMBER_RIGHT                 (660+80)
	#define NUMBER_BOTTOM                (898+3)

	// %  rectangle
	#define PERCENT_LEFT                 (750+80) // percent number_left + 2*number_width
	#define PERCENT_TOP                  (770+3)
	#define PERCENT_RIGHT                (864+80)
	#define PERCENT_BOTTOM               (898+3)

	// top animation part
	#define TOP_ANIMATION_LEFT           (556+80) // top animation
	#define TOP_ANIMATION_TOP            (100+3)
	#define TOP_ANIMATION_RIGHT          (882+80)
	#define TOP_ANIMATION_BOTTOM         (158+3)

	// for old animation
	#define BAR_LEFT            (443+80)
	#define BAR_TOP             (337+3)
	#define BAR_RIGHT           (574+80)
	#define BAR_BOTTOM          (641+3)
#elif defined(WQXGANL)
	// wqhd 2560*1600
	#define CAPACITY_LEFT                (1117-2) // battery capacity center 326
	#define CAPACITY_TOP                 (541+105)
	#define CAPACITY_RIGHT               (1117+326-2)
	#define CAPACITY_BOTTOM              (1059+105)

	#define NUMBER_LEFT                  (1117+10) // number
	#define NUMBER_TOP                   (124+100)
	#define NUMBER_RIGHT                 (1117+10+90) //855+84
	#define NUMBER_BOTTOM                (245+10+100)

	#define PERCENT_LEFT                 (1117+10+180) // percent number_left + 2*number_width
	#define PERCENT_TOP                  (124+100)
	#define PERCENT_RIGHT                (1117+190+114) //1023+108
	#define PERCENT_BOTTOM               (245+10+100)  //124+121

	#define TOP_ANIMATION_LEFT           (1117-2) // top animation
	#define TOP_ANIMATION_TOP            (100)
	#define TOP_ANIMATION_RIGHT          (1117+326-2) //806+304
...
#elif defined(QHD) || defined(CU_QHD) || defined(CMCC_QHD) || defined(CT_QHD) || defined(CMCC_LTE_QHD) || defined(CT_LTE_QHD) || defined(CU_LTE_QHD)
	// qhd 540*960
...
#elif defined(WVGA) || defined(CU_WVGA) || defined(CMCC_WVGA) || defined(CT_WVGA) || defined(CMCC_LTE_WVGA) || defined(CT_LTE_WVGA) || defined(CU_LTE_WVGA)
...
#elif defined(HVGA) || defined(CU_HVGA) || defined(CMCC_HVGA) || defined(CT_HVGA) || defined(CMCC_LTE_HVGA) || defined(CT_LTE_HVGA) || defined(CU_LTE_HVGA)
...
#elif defined(QVGA) || defined(CU_QVGA) || defined(CMCC_QVGA) || defined(CT_QVGA) || defined(CMCC_LTE_QVGA) || defined(CT_LTE_QVGA) || defined(CU_LTE_QVGA)

	// qvga 240*240

	// battery capacity rectangle
	#define CAPACITY_LEFT                (82) // battery capacity center
	#define CAPACITY_TOP                 (62)
	#define CAPACITY_RIGHT               (158)
	#define CAPACITY_BOTTOM              (179)

	// first number rectangle
	#define NUMBER_LEFT                  (92) // number
	#define NUMBER_TOP                   (8)
	#define NUMBER_RIGHT                 (108)
	#define NUMBER_BOTTOM                (31)

	// %  rectangle
	#define PERCENT_LEFT                 (124) // percent number_left + 2*number_width
	#define PERCENT_TOP                  (8)
	#define PERCENT_RIGHT                (144)
	#define PERCENT_BOTTOM               (31)
...
#elif defined(WUXGA) || defined(CU_WUXGA) || defined(CU_LTE_WUXGA)
	// wuxga 1200*1920
