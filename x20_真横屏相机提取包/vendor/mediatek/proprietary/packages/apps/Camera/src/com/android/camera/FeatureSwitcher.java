...
//        Log.d(TAG, "isMtkFatOnNand() return " + enable);
    ...
    public static boolean isMultiWindow() {
        boolean sIsMultiWin = android.os.SystemProperties.getInt("ro.mtk_multiwindow", 0) == 1
                              ? true : false;
...
//        Log.i(TAG, "[isAppGuideEnable]return :" + enable);
    ...
    public static boolean isCfbEnable() {
        boolean enable = SystemProperties.getInt("ro.mtk_cam_cfb", 0) == 1 ? true : false;
        return enable;
    }
...
//        Log.i(TAG, "isApi2Enable:" + api2Enable);
    ...
    public static boolean isCrossMountSupported() {
        boolean enabled = SystemProperties.getInt("ro.mtk_crossmount_support",
...
//        Log.i(TAG, "isCrossMountSupported enable : " + enabled);
    ...
    public static boolean isGpsLocationSupported() {
        boolean enabled = MTK_FEATURE_SUPPORT.equals(SystemProperties.get("ro.mtk_gps_support"));
