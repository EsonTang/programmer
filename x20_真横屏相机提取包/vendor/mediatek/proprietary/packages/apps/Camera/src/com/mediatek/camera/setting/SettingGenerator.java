...
//        Log.d(TAG, "isCFBSupported = " + support);
	...
	//add by zeng
	      else if (size.x * size.y == 1600*1200) {
                entry = mContext.getResources()
                    .getString(R.string.setting_summary_megapixels, "2");
            } else if (size.x * size.y == 2048*1536) {
                entry = mContext.getResources()
                    .getString(R.string.setting_summary_megapixels, "3");
            } else if (size.x * size.y == 2560*1920) {
                entry = mContext.getResources()
                    .getString(R.string.setting_summary_megapixels, "5");
            }
			else if (size.x * size.y == 1280*960) { //longliang 
				entry = mContext.getResources()
                    .getString(R.string.setting_summary_megapixels, "1");
			}
