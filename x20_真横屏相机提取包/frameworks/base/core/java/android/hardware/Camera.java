...
public class Camera {
    ...
    public static void getCameraInfo(int cameraId, CameraInfo cameraInfo) {
        ...
        if(ActivityThread.currentOpPackageName().equalsIgnoreCase("com.tencent.mm")){
            Log.i(TAG,"set cameraInfo orientation");
           if(cameraInfo.facing == CameraInfo.CAMERA_FACING_BACK){
            cameraInfo.orientation = 90;
           }else if(cameraInfo.facing == CameraInfo.CAMERA_FACING_FRONT){
            cameraInfo.orientation = 90;
           }
        }else if(ActivityThread.currentOpPackageName().equalsIgnoreCase("com.facebook.katana")){
            if(cameraInfo.facing == CameraInfo.CAMERA_FACING_BACK){
                cameraInfo.orientation = 90;
            }else if(cameraInfo.facing == CameraInfo.CAMERA_FACING_FRONT){
                cameraInfo.orientation = 90;
            }
        }else if(ActivityThread.currentOpPackageName().equalsIgnoreCase("com.facebook.orca")){
            if(cameraInfo.facing == CameraInfo.CAMERA_FACING_BACK){
                cameraInfo.orientation = 90;
            }else if(cameraInfo.facing == CameraInfo.CAMERA_FACING_FRONT){
                cameraInfo.orientation = 90;
            }
        }else if(ActivityThread.currentOpPackageName().equalsIgnoreCase("kik.android")){
            if(cameraInfo.facing == CameraInfo.CAMERA_FACING_BACK){
                cameraInfo.orientation = 90;
            }else if(cameraInfo.facing == CameraInfo.CAMERA_FACING_FRONT){
                cameraInfo.orientation = 90;
            ...
            case MTK_CAMERA_MSG_EXT_NOTIFY:
                ...
                case MTK_CAMERA_MSG_EXT_NOTIFY_RAW_DUMP_STOPPED:
                    if (mPreviewRawDumpCallback != null) {
                        mPreviewRawDumpCallback.onNotify(
                                MTK_CAMERA_MSG_EXT_NOTIFY_RAW_DUMP_STOPPED);
                        return;
                    }
                    break;
...
/*
                        IntBuffer intBuf = ByteBuffer.wrap(byteArray).order(
...
*/
    ...
    */
    public native final void getMetadata(CameraMetadataNative result,
                                            CameraMetadataNative characteristic);
  ...
  /**
   ...
   /**
    ...
    public static String getScreenSize() {
        ...
        android.hardware.display.DisplayManagerGlobal dmGlobal =
                android.hardware.display.DisplayManagerGlobal.getInstance();
        android.view.Display dispaly = dmGlobal.getCompatibleDisplay(
    ...
    public Parameters getParameters() {
        ...
        if (!"1".equals(SystemProperties.get("ro.mtk_bsp_package"))) {
            ...
            if (isRestricted(android.os.Binder.getCallingPid())) {
                if ("tablet".equals(android.os.SystemProperties.get(
    ...
    public class Parameters {
        ...
        private static final String KEY_ENG_VIDEO_RAW_DUMP_MANUAL_FRAME_RATE_SUPPORTED =
                                                                                     "vrd-mfr-s";
        ...
        private static final String KEY_ENG_VIDEO_RAW_DUMP_MANUAL_FRAME_RATE_RANGE_LOW =
                                                                                   "vrd-mfr-low";
        private static final String KEY_ENG_VIDEO_RAW_DUMP_MANUAL_FRAME_RATE_RANGE_HIGH =
                                                                                   "vrd-mfr-high";
    ...
    private static final String KEY_MUTE_RECORDING_SOUND = "rec-mute-ogg";
        ...
        private static final String KEY_DYNAMIC_FRAME_RATE_SUPPORTED =
                                                       "dynamic-frame-rate-supported";
    ...
    */
    ...
    //!--
         ...
         * @param value: see #CAMERA_MODE_NORMAL, #CAMERA_MODE_MTK_PRV,
         * #CAMERA_MODE_MTK_VDO, #CAMERA_MODE_MTK_VT
         */
