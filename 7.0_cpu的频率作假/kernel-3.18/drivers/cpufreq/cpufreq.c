 ...
 * "unsigned int".
 */
#define MODIFY_MAXCPUFREQ   //modify cpu freq

#define MAX_CPU_FREQ   2000000  //modify cpu's max freq
...
//modify at 20120705 by zhu for test cpufreq
#ifdef MODIFY_MAXCPUFREQ
#define show_one_cpufreq(file_name, object)			\
static ssize_t show_##file_name				\
(struct cpufreq_policy *policy, char *buf)		\
{							\
	return sprintf(buf, "%u\n", MAX_CPU_FREQ);	\
...
#endif
//modify at 20120705 by zhu end
show_one(cpuinfo_min_freq, cpuinfo.min_freq);
//modify at 20120705 by zhu for test cpufreq
#ifdef MODIFY_MAXCPUFREQ
show_one_cpufreq(cpuinfo_max_freq, cpuinfo.max_freq);
#else
...
//modify at 20120705 by zhu for test cpufreq
#ifdef MODIFY_MAXCPUFREQ
show_one_cpufreq(scaling_max_freq, max);
#else
