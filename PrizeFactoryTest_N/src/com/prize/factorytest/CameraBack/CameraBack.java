	...
	public void surfaceChanged(SurfaceHolder surfaceholder, int format, int w,
		...
		if (mCamera != null) {
			...
			try {
				...
				parameters.setPreviewSize(previewSizeList.get(previewSizeList.size() -1).width, previewSizeList.get(previewSizeList.size() -1).height);
				Log.e("xxx","previewSizeList.get(previewSizeList.size() -1).height = " + previewSizeList.get(previewSizeList.size() -1).height + "previewSizeList.get(previewSizeList.size() -1).width = " + previewSizeList.get(previewSizeList.size() -1).width);
				/*
