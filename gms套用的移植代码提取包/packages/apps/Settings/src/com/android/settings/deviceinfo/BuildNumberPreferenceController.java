...
public class BuildNumberPreferenceController extends PreferenceController
    ...
    private static final String CUSTOM_BUILD_NUMBER_PROPERTY = "ro.jty.display.id";
    ...
    public BuildNumberPreferenceController(Context context, Activity activity, Fragment fragment,
        ...
        mExt = UtilsExt.getDeviceInfoSettingsPlugin(mActivity);
    }
    ...
    public void displayPreference(PreferenceScreen screen) {
        ...
        if (preference != null) {
            try {
                preference.setSummary(SystemProperties.get(CUSTOM_BUILD_NUMBER_PROPERTY,
                	mContext.getResources().getString(R.string.device_info_default)));
                preference.setEnabled(true);
                mExt.updateSummary(preference, SystemProperties.get(CUSTOM_BUILD_NUMBER_PROPERTY),
